...
def get_game_center_from_wiki_tables(wiki_tables):
    """
    Get game centers from wiki tables
    about game centers

    Args:
        wiki_tables(list): Wiki tables list

    Return:
        dict: Game center dictionary
    """
...
def get_game_centers_from_city(city_name):
    ...
    for content in contents:
        ...
        if len(wiki_tables) > 0:
            ...
            center = get_game_center_from_wiki_tables(wiki_tables)
