...
comandos = ['init', 'skeleton', 'render', 'link', 'rsync', 'version']
...
class WebSkeleton(object):
    ...
    parser.add_argument(
        "command",
        choices=comandos,
        help="Available commands (WARNING: to be executed in the web-skeleton3.ini directory):\n"
