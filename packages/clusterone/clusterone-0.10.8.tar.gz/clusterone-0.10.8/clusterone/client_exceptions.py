...
class FailedCommitReference(ClusteroneException):
    def __str__(self):
        return "Cannot find commit of this hash. Are you sure that such a commit exists?"
...
class SoftInternalServiceError(ClusteroneException):
    ...
    def __str__(self):
        return "Something went wrong on our side. Could you please logout the login again? If the problem perssits please contact us for immediate support."
