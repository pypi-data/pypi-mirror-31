...
def command(context, custom_arguments, **kwargs):
    ...
    job_sessionuration['parameters']['mode'] = "distributed"
    ...
    # TODO: Test this
    if job_sessionuration['parameters']['framework']['slug'] == 'pytorch-1.0.0':
    ...
    job_sessionuration['parameters']['parameter_servers'] = \
        {
            'slug': kwargs['ps_type'],
