...
_download_url = 'https://github.com/Aerolyzer/Aerolyzer/archive/0.0.0.9.tar.gz'
_requirements = ['exifread', 'numpy>=1.13.3', 'opencv-python>=3.3.0', 'pyyaml']
_pyrequirements = '>=2.7.12'
...
setup(
    ...
    python_requires=_pyrequirements,
    keywords=_keywords,
    license=_license,
