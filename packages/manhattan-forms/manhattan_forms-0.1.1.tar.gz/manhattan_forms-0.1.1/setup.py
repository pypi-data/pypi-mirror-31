...
setup(
    ...
    packages=find_packages('manhattan_forms'),
    package_dir={'': 'manhattan_forms'},
    ...
    extras_require={
        'develop': ['pytest', 'pytest-flask', 'requests-mock', 'tox'],
        'test': ['pytest', 'pytest-flask', 'requests-mock', 'tox']
    },
