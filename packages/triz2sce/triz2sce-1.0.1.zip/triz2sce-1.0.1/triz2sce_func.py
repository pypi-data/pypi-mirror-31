...
def imprimeSTX(f):
      ...
      print('/4',file=f)
      print('',file=f)
      print('¿Qué quieres que hacer ahora?',file=f)
      print('/5',file=f)
      print('',file=f)
...
def imprimePRO0(f):
      ...
      print('/PRO 0', file=f)
      print('', file=f)
      print('_       _       AT      0               ; Empezamos una partida', file=f)
      print('                PROCESS 6               ; El proceso de inicialización', file=f)
      print('_       _       PROCESS 9', file=f)
      print('', file=f)
      print('_       _       PROCESS 11', file=f)	
      print('', file=f)
      print('_       _       WINDOW  0               ; Ventana de gráficos', file=f)
      print('                CLEAR   DarkF           ; Asume que hay luz', file=f)
      print(';                MINUS   2       1       ; Decrementa flag 2 (Ver notas arriba)', file=f)
      print('                NOTZERO 0', file=f)
      print(';                MINUS   3       1       ; y Flag 3 si oscuro (Ver notas)', file=f)
      print('                ABSENT  0', file=f)
      print(';                MINUS   4       1       ; y Flag 4 si no hay lampara(Ver notas)', file=f)
      print('                SET     DarkF           ; Oscuro', file=f)
      print('', file=f)
      print('_       _       PICTURE [Player]        ; Si hay gráfico, cárgalo', file=f)
      print('                DISPLAY [DarkF]         ; Muestralo si no oscuro; si oscuro', file=f)
      print('                                        ; hace un CLS', file=f)
      print('_       _       WINDOW  1', file=f)
      print('                NOTZERO DarkF           ; Oscuro', file=f)
      print('                SYSMESS 0', file=f)
      print('', file=f)
      print('_       _       ZERO    DarkF', file=f)
      print('                DESC    [Player]        ; DESC No sale del bucle ahora', file=f)
      print('', file=f)
      print('_       _       PROCESS 3', file=f)
      print('', file=f)
      print('; Ahora usamos el proceso 1 como el bucle principal del juego. Un retorno desde', file=f)
      print('; él significa el fin del juego', file=f)
      print('', file=f)
...
def imprimePRO1(f):
      ...
      print('/PRO 1', file=f)
      print('', file=f)
      print('_       _       PROCESS 4               ; Lo que en el PAW era el proceso 2', file=f)
      print('', file=f)
      print(';_       _       MINUS   5       1       ; Actualiza más banderas "automáticas"', file=f)
      print(';                MINUS   6       1       ; Ya no se usan. Los primeros flags', file=f)
      print(';                MINUS   7       1       ; están reservados para implementar', file=f)
      print(';                MINUS   8       1       ; una pequeña pila si hace falta.', file=f)
      print(';                NOTZERO 0               ; (Ver SYMBOLS.SCE)', file=f)
      print(';                MINUS   9       1       ; De todas formas aquí está el código', file=f)
      print(';                ABSENT  0               ; que emula al PAW por si hace falta', file=f)
      print(';                MINUS   10      1', file=f)
      print('', file=f)
      print('_       _       PARSE   0               ; Toma sentencia lógica del buffer', file=f)
      print('                PROCESS 2               ; Sentencia no válida o timeout', file=f)
      print('                REDO', file=f)
      print('', file=f)
      print('_       _       EQ      Turns   255     ; El valo máximo de un byte', file=f)
      ...
      print('_       _       PROCESS 11', file=f)
      print('', file=f)
      print('_       _       PROCESS 5               ; La antigua tabla de respuestas', file=f)
      print('                ISDONE                  ; Ha hecho algo?', file=f)
      print('                REDO                    ; Sí: pedimos otra orden del jugador', file=f)
      print('', file=f)
      print('_       _       MOVE    Player          ; No: intentamos mover al jugador', file=f)
      print('                RESTART                 ;Lo movimos: salta al principio de PRO 0', file=f)
      print('', file=f)
...
def imprimePRO2(f):
      ...
      print('                DONE', file=f)
      print('', file=f)
      print('_       _       SYSMESS 6               ; I didnt understand', file=f)
      print('', file=f)
      print(';------------------------------------------------------------------------------', file=f)
      print('OK.')	
...
def imprimePRO3(f):
      ...
      print('', file=f)		
      print('_       _       NEWLINE', file=f)
      print('                ZERO    DarkF            ; No está oscuro', file=f)
...
def imprimePRO5(f, helpMessage1, helpMessage2):
      ...
      print('                END', file=f)
      print('', file=f)
      print('FIN     _       DONE                    ;Not like QUIT on PAW', file=f)
      print('', file=f)
      print('SAVE    _       SAVE    0               ;ditto', file=f)
      print('                RESTART', file=f)
      print('', file=f)
      ...
      print('                RESTART', file=f)
      print('', file=f)
      print('RAMLO   _       RAMLOAD 255             ;Reload all flags', file=f)
      print('                RESTART', file=f)
      print('', file=f)
...
def imprimePRO6(f,startRoom):
      ...
      print('		CLS', file=f)	
      print('_       _       PROCESS 9', file=f)
      print('_       _       DESC    0               ; Introducción', file=f)
      print('                ANYKEY', file=f)
      print('                CLS', file=f)
      print('                MESSAGE 14', file=f)
      print('                ANYKEY', file=f)	
      print('                CLEAR   255             ; Pone a cero todas las banderas', file=f)
      print('', file=f)
      print('_       _       NOTEQ   255     GFlags  ; menos GFlags!!!', file=f)
      print('                CLEAR   [255]', file=f)
      print('', file=f)
      print('_       _       PLUS    255     1', file=f)
      print('                LT      255     255     ; Al final lo dejamos con valor 255', file=f)
      print('                SKIP    -2              ; para indicer que hemos inicializado', file=f)
      print('', file=f)
      print('_       _       RESET                   ; Objetos a su loc. inicial / Flag 1', file=f)
      print('                LET     Strength 10', file=f)
      print('                LET     MaxCarr  4', file=f)
      print('                SET     CPNoun', file=f)
      print('                SET     CPAdject', file=f)
      print('                LET     53 64           ; Listado continuo de objetos', file=f)	
      print('                GOTO    '+str(startRoom)+'               ; Primera localidad del juego', file=f)
      print('', file=f)
      print('OK.')

def imprimeOtrosPros(f):
      print('Imprimiendo otros PROs',end=' -> ')
      print('/PRO 7                              ;Texto "arriba"',file=f)
      print('_    _     WINDOW 1',file=f)
      print('           WINAT 1 0',file=f)
      print('           WINSIZE ROWS 127',file=f)
      print('           CLS',file=f)
      print('',file=f)
      print('/PRO 8                              ;Texto "abajo"',file=f)
      print('_    _     WINDOW 1',file=f)
      print('           WINAT 14 0',file=f)
      print('           WINSIZE ROWS 127',file=f)
      print('           CLS',file=f)
      print('',file=f)	
      print('/PRO 9                              ;Recoloca las ventanas de texto',file=f)
