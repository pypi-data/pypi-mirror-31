...
class Configuration(with_metaclass(SingletonType, object)):
    ...
    # TODO: Make certain configs non-upgradable
    # TODO: Allow examples not to be loaded from templates if config already exists at upgrade time
    ...
    def __upgrade_cfg(self,
        ...
        if upgradable:
            ...
            try:
                            ...
                            for value in error.validator_value:
                                if value not in old_cfg:
                                    ...
                                    if cfg_template_obj is not None:
                                        # TODO: cfg_template_obj[value] can raise KeyError if not found!
                ...
                # Upgrade the config
                for cfg_key, cfg_item in iter(old_cfg.cfg.items()):
