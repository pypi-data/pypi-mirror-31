...
MODULE_NAME = u'configurationutil'  # The module name must match this!
...
setup(
    ...
    keywords=[u'configuration', u'config'],
    ...
    extras_require={
        u'test': test_dependencies + ui_dependencies,
        u'ui': ui_dependencies
    },

    # Reference any non-python files to be included here
    package_data={
        '': ['*.md', '*.rst', '*.db', '*.txt', '*.conf', '*.json', '*.yaml'],
    },
