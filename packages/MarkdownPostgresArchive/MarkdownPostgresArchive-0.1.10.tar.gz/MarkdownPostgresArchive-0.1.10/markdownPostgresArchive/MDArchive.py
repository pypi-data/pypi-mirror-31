...
from DisplayHistory import displayHistoryConsole, displayHistoryContents
from RestorePage import RestorePage
...
if __name__ == '__main__':
    try:
        ...
        if args.store:
            if args.path:
                try:
                    ...
                    print "Error: please check your inputted filename and path (path must include the file name)"
            else:
            ...
            if args.path:
                try:
                    ...
                    print "Error: please check your inputted commit_id filename and path (path must include the file name)"
            else:
                print "Restore requires a name, commit_id, and path to execute"
        elif args.show:
            try:
                displayHistoryConsole(args.name)
            except:
                print "Error: Failed to show please check your file name given"
        ...
        print 'Please use MDArchiveSetup to give database credentials'