...
class quarchPPM(quarchDevice):
    ...
    def startStream(self, fileName='streamData.txt', fileMaxMB=2000, streamAverage = None):
        return self.connectionObj.qis.startStream(self.ConString.replace(':', '::'), fileName, fileMaxMB, streamAverage)
