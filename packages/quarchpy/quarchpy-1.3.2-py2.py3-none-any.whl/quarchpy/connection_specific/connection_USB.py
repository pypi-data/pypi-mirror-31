...
import inspect
import ctypes
#from QuarchImportLibusb import usb1
...
def USB(SerID = ''):
	...
	if quarchDevice == None:
		if SerID.lower() != "list":
			print ('Quarch device ' + SerID + ' not found!')
		return None
	else:
		QuarchDevice = TQuarchUSB_IF( context )
		QuarchDevice.connection = quarchDevice
		QuarchDevice.OpenPort()
		QuarchDevice.SetTimeout(2000)
	return QuarchDevice
...
class USBConn:
    def __init__(self, ConnTarget):
        ...
        if self.Connection is None:
            sys.exit("The requested module is not connected to this system.")
