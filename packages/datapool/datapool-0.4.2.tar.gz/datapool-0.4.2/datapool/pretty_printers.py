...
from .db_objects import (SiteDbo, PictureDbo, ParameterDbo, ParameterAveragingDbo, SourceDbo,
                         SourceTypeDbo, SpecialValueDefinitionDbo)

from .domain_objects import (Site, Picture, Parameter, Parameters, Source, SourceType,
                             ParameterAveraging, SpecialValueDefinition)
...
def pretty_print_parameter_averaging_dbo(parameter_averaging, file=sys.stdout, indent=""):
...
def pretty_print_parameter_averaging(parameter_averaging, file=sys.stdout, indent=""):
    ...
    _pretty_print_parameter_averaging("ParameterAveraging", parameter_averaging, file, indent)
...
def pretty_print_special_value_definition_dbo(source_type, file=sys.stdout, indent=""):
    _pretty_print_special_value_definition("SpecialValueDefinitionDbo", fields(source_type), file,
                                           indent)


@pretty_print.register(SpecialValueDefinition)
def pretty_print_special_value_definition(source_type, file=sys.stdout, indent=""):
    _pretty_print_special_value_definition("SpecialValueDefinition", source_type, file, indent)
