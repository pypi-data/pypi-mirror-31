...
#$Id: bldanaimg.py,v 4535bdde0166 2018/04/28 06:23:18 watabe $
import numpy
...
#        self.originator = self.originator.tostring()
        ...
        self.generated =  numpyio.fread(fd,10,'c',self.swap)
        self.generated = str(self.generated.tostring(),'utf8')
        self.scannum =  numpyio.fread(fd,10,'c',self.swap)
        self.scannum = str(self.scannum.tostring(),'utf8')
        self.patient_id =  numpyio.fread(fd,10,'c',self.swap)
        self.patient_id = str(self.patient_id.tostring(),'utf8')
        self.exp_date =  numpyio.fread(fd,10,'c',self.swap)
        self.exp_date = str(self.exp_date.tostring(),'utf8')
        self.exp_time =  numpyio.fread(fd,10,'c',self.swap)
        self.exp_time = str(self.exp_time.tostring(),'utf8')
        self.hist_un0 =  numpyio.fread(fd,3,'c',self.swap)
        self.hist_un0 = str(self.hist_un0.tostring(),'utf8')
