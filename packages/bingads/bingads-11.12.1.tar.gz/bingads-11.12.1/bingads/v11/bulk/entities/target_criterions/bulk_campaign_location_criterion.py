    ...
    * :class:`.BulkFileWriter`
    ...
    _MAPPINGS = [
        ...
        _SimpleBulkMapping(
            ...
            csv_to_field=lambda c, v: csv_to_field_LocationTarget(c.biddable_campaign_criterion, long(v) if v else None)
        ),
        _SimpleBulkMapping(
    ...
    def process_mappings_from_row_values(self, row_values):
        ...
        self._biddable_campaign_criterion.Criterion = _CAMPAIGN_OBJECT_FACTORY_V11.create('LocationCriterion')
