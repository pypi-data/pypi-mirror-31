...
class BulkProductAd(_BulkAd):
    ...
    * :class:`.BulkFileWriter`
    ...
    def process_mappings_from_row_values(self, row_values):
        self.product_ad = _CAMPAIGN_OBJECT_FACTORY_V11.create('ProductAd')
...
class BulkTextAd(_BulkAd):
    ...
    * :class:`.BulkFileWriter`
    ...
    def process_mappings_from_row_values(self, row_values):
        self.text_ad = _CAMPAIGN_OBJECT_FACTORY_V11.create('TextAd')
...
class BulkAppInstallAd(_BulkAd):
    ...
    * :class:`.BulkFileWriter`
    ...
    def process_mappings_from_row_values(self, row_values):
        self.app_install_ad = _CAMPAIGN_OBJECT_FACTORY_V11.create('AppInstallAd')
...
class BulkExpandedTextAd(_BulkAd):
    ...
    * :class:`.BulkFileWriter`
    ...
    def process_mappings_from_row_values(self, row_values):
        self.expanded_text_ad = _CAMPAIGN_OBJECT_FACTORY_V11.create('ExpandedTextAd')
