...
class BulkAdGroupSiteLinkAdExtension(_BulkAdGroupAdExtensionAssociation):
    ...
    For more information, see AdGroup Sitelink Ad Extension at https://go.microsoft.com/fwlink/?linkid=846127.
...
class BulkSiteLink(_SingleRecordBulkEntity):
    ...
    * :class:`.BulkFileWriter`
    ...
    def process_mappings_from_row_values(self, row_values):
        self._site_link = _CAMPAIGN_OBJECT_FACTORY_V11.create('SiteLink')
    ...
    * :class:`.BulkFileWriter`
    ...
    def __init__(self,
        ...
        if self._identifier:
            ...
            self._site_links_ad_extension = _CAMPAIGN_OBJECT_FACTORY_V11.create('SiteLinksAdExtension')
