...
BudgetLimitType = _CAMPAIGN_OBJECT_FACTORY_V11.create('BudgetLimitType')
DynamicSearchAdsSetting = _CAMPAIGN_OBJECT_FACTORY_V11.create('DynamicSearchAdsSetting')
Webpage = _CAMPAIGN_OBJECT_FACTORY_V11.create('ns0:Webpage')
WebpageConditionOperand = _CAMPAIGN_OBJECT_FACTORY_V11.create('WebpageConditionOperand')

RemarketingRule = _CAMPAIGN_OBJECT_FACTORY_V11.create('ns0:RemarketingRule')
PageVisitorsRule = _CAMPAIGN_OBJECT_FACTORY_V11.create('ns0:PageVisitorsRule')
PageVisitorsWhoVisitedAnotherPageRule = _CAMPAIGN_OBJECT_FACTORY_V11.create('ns0:PageVisitorsWhoVisitedAnotherPageRule')
PageVisitorsWhoDidNotVisitAnotherPageRule = _CAMPAIGN_OBJECT_FACTORY_V11.create('ns0:PageVisitorsWhoDidNotVisitAnotherPageRule')
CustomEventsRule = _CAMPAIGN_OBJECT_FACTORY_V11.create('ns0:CustomEventsRule')
StringOperator = _CAMPAIGN_OBJECT_FACTORY_V11.create('StringOperator')
NumberOperator = _CAMPAIGN_OBJECT_FACTORY_V11.create('NumberOperator')
...
def parse_date(d_str):
    ...
    bing_ads_date = _CAMPAIGN_OBJECT_FACTORY_V11.create('Date')
...
def csv_to_field_UrlCustomParameters(entity, value):
    ...
    #params = _CAMPAIGN_OBJECT_FACTORY_V11.create("ns0:ArrayOfCustomParameter")
    params = []
    param_strs = splitter.split(value)
    for param_str in param_strs:
        match = pattern.match(param_str)
        if match:
            custom_parameter = _CAMPAIGN_OBJECT_FACTORY_V11.create("ns0:CustomParameter")
...
def field_to_csv_BidStrategyType(entity):
    ...
    :return: csv content
    """
    if entity.BiddingScheme is None or type(entity.BiddingScheme) == type(_CAMPAIGN_OBJECT_FACTORY_V11.create('BiddingScheme')):
        return None
    elif type(entity.BiddingScheme) == type(_CAMPAIGN_OBJECT_FACTORY_V11.create('EnhancedCpcBiddingScheme')):
        return 'EnhancedCpc'
    elif type(entity.BiddingScheme) == type(_CAMPAIGN_OBJECT_FACTORY_V11.create('InheritFromParentBiddingScheme')):
        return 'InheritFromParent'
    elif type(entity.BiddingScheme) == type(_CAMPAIGN_OBJECT_FACTORY_V11.create('MaxConversionsBiddingScheme')):
        return 'MaxConversions'
    elif type(entity.BiddingScheme) == type(_CAMPAIGN_OBJECT_FACTORY_V11.create('ManualCpcBiddingScheme')):
        return 'ManualCpc'
    elif type(entity.BiddingScheme) == type(_CAMPAIGN_OBJECT_FACTORY_V11.create('TargetCpaBiddingScheme')):
        return 'TargetCpa'
    elif type(entity.BiddingScheme) == type(_CAMPAIGN_OBJECT_FACTORY_V11.create('MaxClicksBiddingScheme')):
        return 'MaxClicks'
    else:
...
def parse_ad_rotation(value):
    if not value:
        return None
    ad_rotation = _CAMPAIGN_OBJECT_FACTORY_V11.create('AdRotation')
...
def format_Day(value):
    Day = _CAMPAIGN_OBJECT_FACTORY_V11.create('Day')
...
def csv_to_field_AdSchedule(entity, value):
    ...
    for daytime_str in daytime_strs:
        ...
        if match:
            daytime = _CAMPAIGN_OBJECT_FACTORY_V11.create('DayTime')
...
def csv_to_field_BudgetType(entity, value, version=11):
    if value is None or value == '':
        entity.BudgetType = None
    elif value == 'MonthlyBudgetSpendUntilDepleted' and version == 11:
...
def csv_to_field_DSAWebsite(entity, value):
    ...
    if len(entity.Settings.Setting) > 0 and entity.Settings.Setting[0].Type == 'DynamicSearchAdsSetting':
        ...
        setting = _CAMPAIGN_OBJECT_FACTORY_V11.create('DynamicSearchAdsSetting')
...
def parse_rule_PageVisitorsWhoDidNotVisitAnotherPage(rule_str):
    rule = _CAMPAIGN_OBJECT_FACTORY_V11.create('ns0:PageVisitorsWhoDidNotVisitAnotherPageRule')
...
def parse_rule_CustomEvents(rule_str):
    rule = _CAMPAIGN_OBJECT_FACTORY_V11.create('ns0:CustomEventsRule')
...
def parse_rule_groups(groups_str):
    ...
    rule_item_groups = _CAMPAIGN_OBJECT_FACTORY_V11.create('ns0:ArrayOfRuleItemGroup')
...
def parse_rule_items(items_str):
    ...
    rule_item_group = _CAMPAIGN_OBJECT_FACTORY_V11.create('ns0:RuleItemGroup')
...
def parse_string_rule_item(item_str):
    ...
    item = _CAMPAIGN_OBJECT_FACTORY_V11.create('ns0:StringRuleItem')
    item.Type = 'String'
