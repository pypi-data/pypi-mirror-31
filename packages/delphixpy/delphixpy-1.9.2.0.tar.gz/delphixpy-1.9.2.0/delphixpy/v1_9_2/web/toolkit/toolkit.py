...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_9_2.web.objects.Toolkit.Toolkit` object
    :type ref: ``str``
    :rtype: :py:class:`v1_9_2.web.vo.Toolkit`
    """
...
def get_all(engine, source_environment=None):
    ...
    :rtype: ``list`` of :py:class:`v1_9_2.web.vo.Toolkit`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def disable_all_sources(engine, ref, source_disable_parameters=None):
    ...
    :type source_disable_parameters:
        :py:class:`v1_9_2.web.vo.SourceDisableParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
