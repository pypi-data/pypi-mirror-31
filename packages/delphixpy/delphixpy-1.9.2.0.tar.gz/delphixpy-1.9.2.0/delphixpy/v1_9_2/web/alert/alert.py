...
from delphixpy.v1_9_2.web.alert import profile
import urllib
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_9_2.web.objects.Alert.Alert` object
    :type ref: ``str``
    :rtype: :py:class:`v1_9_2.web.vo.Alert`
    """
...
def get_all(engine, to_date=None, page_offset=None, search_text=None, target=None, page_size=None, ascending=None, from_date=None, sort_by=None, max_total=None):
    ...
    :type max_total: ``int``
    :rtype: ``list`` of :py:class:`v1_9_2.web.vo.Alert`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
