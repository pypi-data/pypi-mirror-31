...
class MSSqlDatabaseContainer(DatabaseContainer):
    """
    *(extends* :py:class:`v1_9_2.web.vo.DatabaseContainer` *)* A MSSQL Database
    Container.
    """
    ...
    def is_dirty(self):
        return any([self._delphix_managed_status[1], self._runtime[1]])
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`v1_9_2.web.vo.MSSqlDBContainerRuntime`
        """
