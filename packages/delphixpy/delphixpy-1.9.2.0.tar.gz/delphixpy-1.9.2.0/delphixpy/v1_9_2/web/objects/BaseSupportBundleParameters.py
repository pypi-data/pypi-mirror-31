...
class BaseSupportBundleParameters(TypedObject):
    """
    *(extends* :py:class:`v1_9_2.web.vo.TypedObject` *)* Parameters to be used
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._include_analytics_data[0] is not None and obj._include_analytics_data[0] is not obj.__undef__:
            assert isinstance(obj._include_analytics_data[0], bool), ("Expected one of [u'boolean'], but got %s" % type(obj._include_analytics_data[0]))
        ...
        if obj._bundle_type[0] is not None and obj._bundle_type[0] is not obj.__undef__:
            assert isinstance(obj._bundle_type[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._bundle_type[0]))
            assert obj._bundle_type[0] in [u'PHONEHOME', u'MDS', u'OS', u'CORE', u'LOG', u'DROPBOX', u'STORAGE_TEST', u'MASKING', u'ALL'], "Expected enum [u'PHONEHOME', u'MDS', u'OS', u'CORE', u'LOG', u'DROPBOX', u'STORAGE_TEST', u'MASKING', u'ALL'] but got %s" % obj._bundle_type[0]
            common.validate_format(obj._bundle_type[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False):
        dct = super(BaseSupportBundleParameters, self).to_dict(dirty)
