...
def get(engine, ref):
    ...
    :param ref: Reference to a :py:class:`delphixpy.v1_9_2.web.objects.JSDailyO
        perationDuration.JSDailyOperationDuration` object
    :type ref: ``str``
    :rtype: :py:class:`v1_9_2.web.vo.JSDailyOperationDuration`
    """
...
def get_all(engine, usage_object=None):
    ...
    :rtype: ``list`` of :py:class:`v1_9_2.web.vo.JSDailyOperationDuration`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
