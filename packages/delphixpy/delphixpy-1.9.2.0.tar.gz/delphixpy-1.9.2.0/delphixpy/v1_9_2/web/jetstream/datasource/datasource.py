...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_9_2.web.objects.JSDataSource.JSDataSource`
        object
    :type ref: ``str``
    :rtype: :py:class:`v1_9_2.web.vo.JSDataSource`
    """
...
def get_all(engine, data_layout=None, container=None):
    ...
    :rtype: ``list`` of :py:class:`v1_9_2.web.vo.JSDataSource`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def update(engine, ref, js_data_source=None):
    ...
    :type js_data_source: :py:class:`v1_9_2.web.vo.JSDataSource`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/jetstream/datasource/%s" % ref
...
def data_timestamps(engine, js_source_data_timestamp_parameters):
    ...
    :type js_source_data_timestamp_parameters:
        :py:class:`v1_9_2.web.vo.JSSourceDataTimestampParameters`
    :rtype: ``list`` of :py:class:`v1_9_2.web.vo.JSSourceDataTimestamp`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
