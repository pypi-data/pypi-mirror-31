...
def create(engine, certificate_import_parameters):
    ...
    :type certificate_import_parameters:
        :py:class:`v1_9_2.web.vo.CertificateImportParameters`
    :rtype: ``basestring``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_9_2.web.objects.TlsCaCert.TlsCaCert` object
    :type ref: ``str``
    :rtype: :py:class:`v1_9_2.web.vo.TlsCaCert`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def get_all(engine, alias=None):
    ...
    :rtype: ``list`` of :py:class:`v1_9_2.web.vo.TlsCaCert`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/service/tls/cacert"
