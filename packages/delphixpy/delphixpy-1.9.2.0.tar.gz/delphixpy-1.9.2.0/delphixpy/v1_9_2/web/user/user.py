...
def create(engine, user=None):
    ...
    :type user: :py:class:`v1_9_2.web.vo.User`
    :rtype: ``basestring``
    """
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.v1_9_2.web.objects.User.User` object
    :type ref: ``str``
    :rtype: :py:class:`v1_9_2.web.vo.User`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def get_all(engine, domain_user_type=None, type=None):
    ...
    :rtype: ``list`` of :py:class:`v1_9_2.web.vo.User`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/user"
...
def update_credential(engine, ref, credential_update_parameters=None):
    ...
    :type credential_update_parameters:
        :py:class:`v1_9_2.web.vo.CredentialUpdateParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def current_auth_info(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.v1_9_2.delphix_engine.DelphixEngine`
    :rtype: :py:class:`v1_9_2.web.vo.UserAuthInfo`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
