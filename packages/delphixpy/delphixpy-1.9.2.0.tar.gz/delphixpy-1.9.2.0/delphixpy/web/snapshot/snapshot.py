...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.web.objects.TimeflowSnapshot.TimeflowSnapshot`
        object
    :type ref: ``str``
    :rtype: :py:class:`delphixpy.web.vo.TimeflowSnapshot`
    """
    ...
    return response_validator.parse_result(result, undef_enabled=True, return_types=[u'TimeflowSnapshot'], returns_list=False, raw_result=raw_result)

def get_all(engine, to_date=None, page_offset=None, page_size=None, database=None, timeflow=None, missing_non_logged_data_only=None, from_date=None, traverse_timeflows=None):
    """
    ...
    :rtype: ``list`` of :py:class:`delphixpy.web.vo.TimeflowSnapshot`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/snapshot"
    query_params = {"toDate": to_date, "pageOffset": page_offset, "pageSize": page_size, "database": database, "timeflow": timeflow, "missingNonLoggedDataOnly": missing_non_logged_data_only, "fromDate": from_date, "traverseTimeflows": traverse_timeflows}
    ...
    result = response_validator.validate(response, engine)
    raw_result = getattr(engine, 'raw_result', False)
    return response_validator.parse_result(result, undef_enabled=True, return_types=[u'TimeflowSnapshot'], returns_list=True, raw_result=raw_result)
...
def update(engine, ref, timeflow_snapshot=None):
    ...
    :type timeflow_snapshot: :py:class:`delphixpy.web.vo.TimeflowSnapshot`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/snapshot/%s" % ref
...
def timeflow_range(engine, ref, traverse_timeflows=None):
    ...
    :type traverse_timeflows: ``basestring``
    :rtype: :py:class:`delphixpy.web.vo.TimeflowRange`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    ...
    result = response_validator.validate(response, engine)
    raw_result = getattr(engine, 'raw_result', False)
    return response_validator.parse_result(result, undef_enabled=True, return_types=[u'TimeflowRange'], returns_list=False, raw_result=raw_result)
...
def spacemap(engine, snapshot_space_parameters):
    ...
    :type snapshot_space_parameters:
        :py:class:`delphixpy.web.vo.SnapshotSpaceParameters`
    :rtype: :py:class:`delphixpy.web.vo.SnapshotSpaceMap`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    ...
    result = response_validator.validate(response, engine)
    raw_result = getattr(engine, 'raw_result', False)
    return response_validator.parse_result(result, undef_enabled=True, return_types=[u'SnapshotSpaceMap'], returns_list=False, raw_result=raw_result)

def find_by_location(engine, container=None, location=None):
    """
    ...
    query_params = {"container": container, "location": location}
    query_dct = {k: query_params[k] for k in query_params if query_params[k] is not None}
    if query_dct:
        url_params = urllib.urlencode(query_dct)
        url += "?%s" % url_params
...
def batch_delete(engine, batch_snapshot_delete_parameters):
    ...
    :type batch_snapshot_delete_parameters:
        :py:class:`delphixpy.web.vo.BatchSnapshotDeleteParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def space(engine, snapshot_space_parameters):
    ...
    :type snapshot_space_parameters:
        :py:class:`delphixpy.web.vo.SnapshotSpaceParameters`
    :rtype: :py:class:`delphixpy.web.vo.SnapshotSpaceResult`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    ...
    result = response_validator.validate(response, engine)
    raw_result = getattr(engine, 'raw_result', False)
    return response_validator.parse_result(result, undef_enabled=True, return_types=[u'SnapshotSpaceResult'], returns_list=False, raw_result=raw_result)
