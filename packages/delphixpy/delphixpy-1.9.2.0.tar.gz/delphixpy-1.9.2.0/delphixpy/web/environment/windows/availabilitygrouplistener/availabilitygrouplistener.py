...
def get_all(engine, availabilitygroup=None):
    ...
    :rtype: ``list`` of
        :py:class:`delphixpy.web.vo.MSSqlAvailabilityGroupListener`
    """
    ...
    return response_validator.parse_result(result, undef_enabled=True, return_types=[u'MSSqlAvailabilityGroupListener'], returns_list=True, raw_result=raw_result)
