...
def get_all(engine, repository=None):
    ...
    :rtype: ``list`` of
        :py:class:`delphixpy.web.vo.MSSqlFailoverClusterInstance`
    """
    ...
    return response_validator.parse_result(result, undef_enabled=True, return_types=[u'MSSqlFailoverClusterInstance'], returns_list=True, raw_result=raw_result)
