...
def get_all(engine, date=None):
    ...
    :rtype: ``list`` of :py:class:`delphixpy.web.vo.TimeZone`
    """
    ...
    return response_validator.parse_result(result, undef_enabled=True, return_types=[u'TimeZone'], returns_list=True, raw_result=raw_result)
