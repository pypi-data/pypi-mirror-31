...
def connector(engine, connector_connectivity=None):
    ...
    :type connector_connectivity:
        :py:class:`delphixpy.web.vo.ConnectorConnectivity`
    :rtype: ``basestring``
    """
...
def jdbc(engine, jdbc_connectivity=None):
    ...
    :type jdbc_connectivity: :py:class:`delphixpy.web.vo.JDBCConnectivity`
    :rtype: ``basestring``
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def ssh(engine, ssh_connectivity=None):
    ...
    :type ssh_connectivity: :py:class:`delphixpy.web.vo.SSHConnectivity`
    :rtype: ``basestring``
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
