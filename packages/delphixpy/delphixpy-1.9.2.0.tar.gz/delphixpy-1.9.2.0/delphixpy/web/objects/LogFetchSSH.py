...
class LogFetchSSH(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Parameters to fetch
    ...
    def is_dirty(self):
        return any([self._username[1], self._host[1], self._directory[1], self._credentials[1], self._ssh_verification_strategy[1], self._port[1]])
