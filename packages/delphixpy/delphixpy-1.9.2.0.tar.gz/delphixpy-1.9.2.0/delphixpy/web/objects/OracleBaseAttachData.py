...
class OracleBaseAttachData(AttachData):
    """
    *(extends* :py:class:`delphixpy.web.vo.AttachData` *)* Represents common
    ...
    def to_dict(self, dirty=False):
        dct = super(OracleBaseAttachData, self).to_dict(dirty)
    ...
    def is_dirty(self):
        return any([self._operations[1], self._number_of_connections[1], self._external_file_path[1], self._files_per_set[1], self._check_logical[1], self._backup_level_enabled[1], self._db_user[1], self._link_now[1], self._rman_channels[1], self._encrypted_linking_enabled[1], self._environment_user[1], self._db_credentials[1], self._force[1], self._compressed_linking_enabled[1], self._bandwidth_limit[1]])
