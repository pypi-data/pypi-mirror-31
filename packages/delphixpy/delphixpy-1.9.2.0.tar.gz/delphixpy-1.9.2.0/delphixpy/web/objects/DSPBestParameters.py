...
class DSPBestParameters(PersistentObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.PersistentObject` *)* DSP
    parameters, found by autotuner, that give the highest throughput for a
    certain target.
    """
    def __init__(self, undef_enabled=True):
        super(DSPBestParameters, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(DSPBestParameters, cls).from_dict(data, dirty, undef_enabled)
        ...
        if obj._buffer_size[0] is not None and obj._buffer_size[0] is not obj.__undef__:
            assert isinstance(obj._buffer_size[0], int), ("Expected one of [u'integer'], but got %s" % type(obj._buffer_size[0]))
            common.validate_format(obj._buffer_size[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False):
        dct = super(DSPBestParameters, self).to_dict(dirty)
    ...
    def is_dirty(self):
        return any([self._num_connections[1], self._remote_host[1], self._destination_type[1], self._queue_depth[1], self._throughput[1], self._remote_delphix_engine_info[1], self._buffer_size[1]])
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DSPBestParameters):
            return False
        return super(DSPBestParameters, self).__eq__(other) and \
    ...
    def remote_delphix_engine_info(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.RemoteDelphixEngineInfo`
        """
