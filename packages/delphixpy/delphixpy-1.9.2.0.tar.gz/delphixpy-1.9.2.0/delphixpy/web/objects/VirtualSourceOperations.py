...
class VirtualSourceOperations(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Describes
    operations which are performed on virtual sources at various times.
    """
    ...
    def is_dirty(self):
        return any([self._post_refresh[1], self._pre_start[1], self._pre_refresh[1], self._configure_clone[1], self._pre_rollback[1], self._pre_stop[1], self._post_snapshot[1], self._pre_snapshot[1], self._post_rollback[1], self._post_stop[1], self._post_start[1]])
