...
class CertificateImportParameters(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Parameters for
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._alias[0] is not None and obj._alias[0] is not obj.__undef__:
            assert isinstance(obj._alias[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._alias[0]))
        ...
        if obj._certificate[0] is not None and obj._certificate[0] is not obj.__undef__:
            assert isinstance(obj._certificate[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._certificate[0]))
            common.validate_format(obj._certificate[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False):
        dct = super(CertificateImportParameters, self).to_dict(dirty)
        ...
        def dictify(obj):
            if isinstance(obj, list):
                ...
                return obj
        if "alias" == "type" or (self.alias is not self.__undef__ and not (dirty and not self._alias[1])):
            dct["alias"] = dictify(self.alias)
        if "certificate" == "type" or (self.certificate is not self.__undef__ and not (dirty and not self._certificate[1])):
    ...
    def is_dirty(self):
        return any([self._alias[1], self._certificate[1]])
