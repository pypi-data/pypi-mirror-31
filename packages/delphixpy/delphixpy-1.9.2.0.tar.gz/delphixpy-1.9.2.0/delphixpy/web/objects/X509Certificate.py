...
class X509Certificate(UserObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.UserObject` *)* X509 Certificate.
    """
    ...
    def is_dirty(self):
        return any([self._valid_from[1], self._sha1_fingerprint[1], self._valid_to[1], self._serial_number[1], self._issued_by_dn[1], self._md5_fingerprint[1], self._accepted[1], self._issued_to_dn[1]])
