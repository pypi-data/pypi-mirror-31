...
class OracleVirtualPdbSource(OracleVirtualSource):
    ...
    *(extends* :py:class:`delphixpy.web.vo.OracleVirtualSource` *)* A virtual
    ...
    def to_dict(self, dirty=False):
        dct = super(OracleVirtualPdbSource, self).to_dict(dirty)
    ...
    def is_dirty(self):
        return any([self._config_params[1], self._node_listeners[1], self._redo_log_groups[1], self._redo_log_size_in_mb[1], self._archivelog_mode[1], self._config_template[1]])
