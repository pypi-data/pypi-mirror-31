...
class BatchContainerDeleteParameters(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* The parameters to
    ...
    def to_dict(self, dirty=False):
        dct = super(BatchContainerDeleteParameters, self).to_dict(dirty)
    ...
    def is_dirty(self):
        return any([self._delete_parameters[1], self._containers[1]])
    ...
    def __eq__(self, other):
        ...
        return super(BatchContainerDeleteParameters, self).__eq__(other) and \
               self.delete_parameters == other.delete_parameters and \
