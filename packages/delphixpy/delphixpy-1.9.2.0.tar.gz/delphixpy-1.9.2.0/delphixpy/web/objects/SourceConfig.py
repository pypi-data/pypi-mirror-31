...
class SourceConfig(ReadonlyNamedUserObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.ReadonlyNamedUserObject` *)* The
    ...
    def is_dirty(self):
        return any([self._discovered[1], self._linking_enabled[1], self._repository[1], self._environment_user[1]])
