...
class ASEInstance(SourceRepository):
    """
    *(extends* :py:class:`delphixpy.web.vo.SourceRepository` *)* The SAP ASE
    source repository.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._instance_owner_gid[0] is not None and obj._instance_owner_gid[0] is not obj.__undef__:
            assert isinstance(obj._instance_owner_gid[0], int), ("Expected one of [u'integer'], but got %s" % type(obj._instance_owner_gid[0]))
        ...
        if obj._instance_owner_uid[0] is not None and obj._instance_owner_uid[0] is not obj.__undef__:
            assert isinstance(obj._instance_owner_uid[0], int), ("Expected one of [u'integer'], but got %s" % type(obj._instance_owner_uid[0]))
        ...
        if obj._isql_path[0] is not None and obj._isql_path[0] is not obj.__undef__:
            assert isinstance(obj._isql_path[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._isql_path[0]))
        ...
        if obj._service_principal_name[0] is not None and obj._service_principal_name[0] is not obj.__undef__:
            assert isinstance(obj._service_principal_name[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._service_principal_name[0]))
    ...
    def to_dict(self, dirty=False):
        ...
        if "isql_path" == "type" or (self.isql_path is not self.__undef__ and not (dirty and not self._isql_path[1])):
        ...
        if "service_principal_name" == "type" or (self.service_principal_name is not self.__undef__ and not (dirty and not self._service_principal_name[1])):
    ...
    def is_dirty(self):
        return any([self._instance_owner_gid[1], self._installation_path[1], self._page_size[1], self._instance_owner_uid[1], self._isql_path[1], self._db_user[1], self._discovered[1], self._instance_owner[1], self._service_principal_name[1], self._credentials[1], self._instance_name[1], self._ports[1]])
    ...
    def credentials(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.Credential`
        """
