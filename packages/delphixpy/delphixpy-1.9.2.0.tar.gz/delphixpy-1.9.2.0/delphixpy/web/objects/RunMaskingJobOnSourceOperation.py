...
class RunMaskingJobOnSourceOperation(SourceOperation):
    """
    *(extends* :py:class:`delphixpy.web.vo.SourceOperation` *)* An operation
    that runs a Masking Job on the local Delphix Masking Engine instance.
    """
    ...
    def is_dirty(self):
        return any([self._application_id[1], self._masking_job_id[1]])
