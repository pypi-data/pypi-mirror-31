...
class SSHConnectivity(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Mechanism to test
    SSH connectivity of arbitrary hosts.
    """
    ...
    def is_dirty(self):
        return any([self._username[1], self._credentials[1], self._ssh_verification_strategy[1], self._port[1], self._address[1]])
