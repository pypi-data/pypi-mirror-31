...
class UserAuthInfo(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Summary
    authorization information about the current user.
    """
    ...
    def is_dirty(self):
        return any([self._owner_role[1], self._provisioner_role[1], self._authorizations[1], self._user[1], self._jet_stream_user_role[1]])
    ...
    def __eq__(self, other):
        ...
        return super(UserAuthInfo, self).__eq__(other) and \
               ...
               self.jet_stream_user_role == other.jet_stream_user_role
