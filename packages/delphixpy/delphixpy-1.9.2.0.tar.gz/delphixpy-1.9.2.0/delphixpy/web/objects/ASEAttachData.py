...
class ASEAttachData(AttachData):
    """
    *(extends* :py:class:`delphixpy.web.vo.AttachData` *)* Represents the SAP
    ASE specific parameters of an attach request.
    """
    ...
    def is_dirty(self):
        return any([self._operations[1], self._staging_repository[1], self._load_backup_path[1], self._external_file_path[1], self._validated_sync_mode[1], self._load_location[1], self._mount_base[1], self._staging_host_user[1], self._staging_post_script[1], self._db_user[1], self._db_credentials[1], self._source_host_user[1], self._staging_pre_script[1], self._config[1], self._dump_credentials[1]])
