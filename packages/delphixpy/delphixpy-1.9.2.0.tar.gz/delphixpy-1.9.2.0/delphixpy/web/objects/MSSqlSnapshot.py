...
class MSSqlSnapshot(TimeflowSnapshot):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def is_dirty(self):
        return any([self._first_change_point[1], self._runtime[1], self._latest_change_point[1], self._internal_version[1], self._backup_set_uuid[1]])
    ...
    def __eq__(self, other):
        ...
        return super(MSSqlSnapshot, self).__eq__(other) and \
               ...
               self.backup_set_uuid == other.backup_set_uuid
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.MSSqlTimeflowPoint`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.MSSqlSnapshotRuntime`
        """
