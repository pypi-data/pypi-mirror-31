...
class JSDataContainer(JSDataLayout):
    """
    *(extends* :py:class:`delphixpy.web.vo.JSDataLayout` *)* A container
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._lock_user_reference[0] is not None and obj._lock_user_reference[0] is not obj.__undef__:
            assert isinstance(obj._lock_user_reference[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._lock_user_reference[0]))
        ...
        if obj._lock_user_name[0] is not None and obj._lock_user_name[0] is not obj.__undef__:
            assert isinstance(obj._lock_user_name[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._lock_user_name[0]))
    ...
    def is_dirty(self):
        return any([self._state[1], self._lock_user_reference[1], self._template[1], self._owner[1], self._lock_user_name[1], self._operation_count[1]])
    ...
    def __eq__(self, other):
        ...
        return super(JSDataContainer, self).__eq__(other) and \
               ...
               self.lock_user_name == other.lock_user_name and \
