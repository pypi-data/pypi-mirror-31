...
class StorageDeviceRemovalVerifyResult(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* The .
    """
    ...
    def is_dirty(self):
        return any([self._new_mapping_memory[1], self._old_mapping_memory[1], self._old_free_bytes[1], self._new_free_bytes[1]])
