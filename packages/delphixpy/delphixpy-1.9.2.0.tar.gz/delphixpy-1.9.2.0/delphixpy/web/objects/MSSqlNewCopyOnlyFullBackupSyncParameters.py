    ...
    *(extends* :py:class:`delphixpy.web.vo.MSSqlSyncParameters` *)* The
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._compression_enabled[0] is not None and obj._compression_enabled[0] is not obj.__undef__:
            assert isinstance(obj._compression_enabled[0], bool), ("Expected one of [u'boolean'], but got %s" % type(obj._compression_enabled[0]))
            common.validate_format(obj._compression_enabled[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False):
        dct = super(MSSqlNewCopyOnlyFullBackupSyncParameters, self).to_dict(dirty)
        ...
        def dictify(obj):
            if isinstance(obj, list):
                ...
                return obj
        if "compression_enabled" == "type" or (self.compression_enabled is not self.__undef__ and not (dirty and not self._compression_enabled[1])):
