...
class UserInterfaceConfig(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* User Interface
    Configuration.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._analytics_enabled[0] is not None and obj._analytics_enabled[0] is not obj.__undef__:
            assert isinstance(obj._analytics_enabled[0], bool), ("Expected one of [u'boolean'], but got %s" % type(obj._analytics_enabled[0]))
            common.validate_format(obj._analytics_enabled[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False):
        dct = super(UserInterfaceConfig, self).to_dict(dirty)
        ...
        def dictify(obj):
            if isinstance(obj, list):
                ...
                return obj
        if "analytics_enabled" == "type" or (self.analytics_enabled is not self.__undef__ and not (dirty and not self._analytics_enabled[1])):
