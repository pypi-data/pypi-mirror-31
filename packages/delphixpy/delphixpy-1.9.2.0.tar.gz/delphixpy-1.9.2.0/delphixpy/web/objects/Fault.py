...
class Fault(PersistentObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.PersistentObject` *)* A
    ...
    def is_dirty(self):
        return any([self._status[1], self._description[1], self._title[1], self._date_resolved[1], self._resolution_comments[1], self._response[1], self._target_object_type[1], self._target[1], self._action[1], self._bundle_id[1], self._target_name[1], self._date_diagnosed[1], self._severity[1]])
