...
class AppDataSnapshot(TimeflowSnapshot):
    """
    *(extends* :py:class:`delphixpy.web.vo.TimeflowSnapshot` *)* Snapshot of an
    AppData TimeFlow.
    """
    ...
    def is_dirty(self):
        return any([self._first_change_point[1], self._runtime[1], self._latest_change_point[1], self._toolkit[1], self._metadata[1]])
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.AppDataTimeflowPoint`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.AppDataSnapshotRuntime`
        """
    ...
    def metadata(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.Json`
        """
