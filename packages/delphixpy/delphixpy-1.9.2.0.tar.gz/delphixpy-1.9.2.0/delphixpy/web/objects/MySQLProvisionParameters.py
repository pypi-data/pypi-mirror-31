...
class MySQLProvisionParameters(ProvisionParameters):
    ...
    *(extends* :py:class:`delphixpy.web.vo.ProvisionParameters` *)* The
    ...
    def source(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.MySQLVirtualSource`
        """
    ...
    def container(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.MySQLDatabaseContainer`
        """
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.MySQLServerConfig`
        """
