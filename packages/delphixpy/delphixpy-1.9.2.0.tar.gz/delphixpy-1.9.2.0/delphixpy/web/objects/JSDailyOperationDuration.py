...
class JSDailyOperationDuration(JSUsageData):
    """
    *(extends* :py:class:`delphixpy.web.vo.JSUsageData` *)* Information about
    ...
    def is_dirty(self):
        return any([self._daily_average_duration[1], self._daily_min_duration[1], self._operation[1], self._daily_count[1], self._daily_max_duration[1]])
