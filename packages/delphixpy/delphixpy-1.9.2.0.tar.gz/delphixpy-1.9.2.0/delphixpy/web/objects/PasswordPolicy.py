...
class PasswordPolicy(NamedUserObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.NamedUserObject` *)* Password
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._digit[0] is not None and obj._digit[0] is not obj.__undef__:
            assert isinstance(obj._digit[0], bool), ("Expected one of [u'boolean'], but got %s" % type(obj._digit[0]))
        ...
        if obj._min_length[0] is not None and obj._min_length[0] is not obj.__undef__:
            assert isinstance(obj._min_length[0], int), ("Expected one of [u'integer'], but got %s" % type(obj._min_length[0]))
        ...
        if obj._symbol[0] is not None and obj._symbol[0] is not obj.__undef__:
            assert isinstance(obj._symbol[0], bool), ("Expected one of [u'boolean'], but got %s" % type(obj._symbol[0]))
        ...
        if obj._disallow_username_as_password[0] is not None and obj._disallow_username_as_password[0] is not obj.__undef__:
            assert isinstance(obj._disallow_username_as_password[0], bool), ("Expected one of [u'boolean'], but got %s" % type(obj._disallow_username_as_password[0]))
        ...
        if obj._lowercase_letter[0] is not None and obj._lowercase_letter[0] is not obj.__undef__:
            assert isinstance(obj._lowercase_letter[0], bool), ("Expected one of [u'boolean'], but got %s" % type(obj._lowercase_letter[0]))
        ...
        if obj._reuse_disallow_limit[0] is not None and obj._reuse_disallow_limit[0] is not obj.__undef__:
            assert isinstance(obj._reuse_disallow_limit[0], int), ("Expected one of [u'integer'], but got %s" % type(obj._reuse_disallow_limit[0]))
        ...
        if obj._uppercase_letter[0] is not None and obj._uppercase_letter[0] is not obj.__undef__:
            assert isinstance(obj._uppercase_letter[0], bool), ("Expected one of [u'boolean'], but got %s" % type(obj._uppercase_letter[0]))
            common.validate_format(obj._uppercase_letter[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False):
        dct = super(PasswordPolicy, self).to_dict(dirty)
        ...
        def dictify(obj):
            if isinstance(obj, list):
                ...
                return obj
        if "digit" == "type" or (self.digit is not self.__undef__ and not (dirty and not self._digit[1])):
            dct["digit"] = dictify(self.digit)
        if "name" == "type" or (self.name is not self.__undef__ and not (dirty and not self._name[1])):
            dct["name"] = dictify(self.name)
        if "min_length" == "type" or (self.min_length is not self.__undef__ and not (dirty and not self._min_length[1])):
            dct["minLength"] = dictify(self.min_length)
        if "symbol" == "type" or (self.symbol is not self.__undef__ and not (dirty and not self._symbol[1])):
            dct["symbol"] = dictify(self.symbol)
        if "disallow_username_as_password" == "type" or (self.disallow_username_as_password is not self.__undef__ and not (dirty and not self._disallow_username_as_password[1])):
            dct["disallowUsernameAsPassword"] = dictify(self.disallow_username_as_password)
        if "lowercase_letter" == "type" or (self.lowercase_letter is not self.__undef__ and not (dirty and not self._lowercase_letter[1])):
            dct["lowercaseLetter"] = dictify(self.lowercase_letter)
        if "reuse_disallow_limit" == "type" or (self.reuse_disallow_limit is not self.__undef__ and not (dirty and not self._reuse_disallow_limit[1])):
            dct["reuseDisallowLimit"] = dictify(self.reuse_disallow_limit)
        if "uppercase_letter" == "type" or (self.uppercase_letter is not self.__undef__ and not (dirty and not self._uppercase_letter[1])):
    ...
    def is_dirty(self):
        return any([self._digit[1], self._name[1], self._min_length[1], self._symbol[1], self._disallow_username_as_password[1], self._lowercase_letter[1], self._reuse_disallow_limit[1], self._uppercase_letter[1]])
    ...
    def __eq__(self, other):
        ...
        return super(PasswordPolicy, self).__eq__(other) and \
               ...
               self.disallow_username_as_password == other.disallow_username_as_password and \
               self.lowercase_letter == other.lowercase_letter and \
               self.reuse_disallow_limit == other.reuse_disallow_limit and \
               self.uppercase_letter == other.uppercase_letter
