...
class OracleBaseProvisionParameters(ProvisionParameters):
    """
    *(extends* :py:class:`delphixpy.web.vo.ProvisionParameters` *)* Parameters
    ...
    def to_dict(self, dirty=False):
        dct = super(OracleBaseProvisionParameters, self).to_dict(dirty)
    ...
    def is_dirty(self):
        return any([self._username[1], self._source[1], self._source_config[1], self._container[1], self._credential[1]])
