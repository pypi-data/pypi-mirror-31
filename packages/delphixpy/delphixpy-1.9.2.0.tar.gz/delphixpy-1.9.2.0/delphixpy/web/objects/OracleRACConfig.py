...
class OracleRACConfig(OracleDBConfig):
    """
    *(extends* :py:class:`delphixpy.web.vo.OracleDBConfig` *)* Representation
    of the properties specific to a RAC Oracle DB configuration.
    """
    ...
    def instances(self):
        ...
        :rtype: ``list`` of :py:class:`delphixpy.web.vo.OracleRACInstance`
        """
