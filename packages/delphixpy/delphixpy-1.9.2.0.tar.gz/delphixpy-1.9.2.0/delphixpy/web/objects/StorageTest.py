...
class StorageTest(ReadonlyNamedUserObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.ReadonlyNamedUserObject` *)* Test
    ...
    def is_dirty(self):
        return any([self._parameters[1], self._state[1], self._end_time[1], self._test_results[1], self._start_time[1]])
    ...
    def parameters(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.StorageTestParameters`
        """
    ...
    def test_results(self):
        ...
        :rtype: ``list`` of :py:class:`delphixpy.web.vo.StorageTestResult`
        """
