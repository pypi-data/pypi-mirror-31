...
class Alert(PersistentObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.PersistentObject` *)* An alert
    ...
    def is_dirty(self):
        return any([self._event_title[1], self._event_response[1], self._target[1], self._event_description[1], self._event_severity[1], self._timestamp[1], self._event_command_output[1], self._event_action[1], self._target_object_type[1], self._target_name[1], self._event[1]])
