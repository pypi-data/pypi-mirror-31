...
class MySQLLinkedSource(MySQLSource):
    """
    *(extends* :py:class:`delphixpy.web.vo.MySQLSource` *)* A linked MySQL
    source.
    """
    ...
    def is_dirty(self):
        return any([self._operations[1], self._staging_source[1], self._runtime[1], self._config[1], self._config_params[1]])
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.MySQLSourceRuntime`
        """
