...
class ToolkitLinkedStagedSource(ToolkitLinkedSource):
    """
    *(extends* :py:class:`delphixpy.web.vo.ToolkitLinkedSource` *)* A linked
    ...
    def is_dirty(self):
        return any([self._status[1], self._worker[1], self._ownership_spec[1], self._stop_staging[1], self._start_staging[1], self._resync[1], self._mount_spec[1]])
    ...
    def __eq__(self, other):
        ...
        return super(ToolkitLinkedStagedSource, self).__eq__(other) and \
               ...
               self.mount_spec == other.mount_spec
