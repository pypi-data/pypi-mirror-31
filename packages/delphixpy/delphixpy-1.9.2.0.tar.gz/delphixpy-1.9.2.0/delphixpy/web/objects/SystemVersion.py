...
class SystemVersion(NamedUserObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.NamedUserObject` *)* Describes a
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._status[0] is not None and obj._status[0] is not obj.__undef__:
            ...
            assert obj._status[0] in [u'PREVIOUS', u'CURRENTLY_RUNNING', u'DEFERRED', u'UPLOADED', u'UNPACKING', u'DELETING', u'VERIFYING', u'VERIFIED', u'APPLYING', u'UNKNOWN', u'DISABLE_FAILED'], "Expected enum [u'PREVIOUS', u'CURRENTLY_RUNNING', u'DEFERRED', u'UPLOADED', u'UNPACKING', u'DELETING', u'VERIFYING', u'VERIFIED', u'APPLYING', u'UNKNOWN', u'DISABLE_FAILED'] but got %s" % obj._status[0]
