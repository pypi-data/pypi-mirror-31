...
class OracleVirtualCdbProvisionParameters(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* The parameters to
    ...
    def __init__(self, undef_enabled=True):
        super(OracleVirtualCdbProvisionParameters, self).__init__()
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(OracleVirtualCdbProvisionParameters, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False):
        dct = super(OracleVirtualCdbProvisionParameters, self).to_dict(dirty)
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OracleVirtualCdbProvisionParameters):
            return False
        return super(OracleVirtualCdbProvisionParameters, self).__eq__(other) and \
    ...
    def source(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleVirtualCdbSource`
        """
