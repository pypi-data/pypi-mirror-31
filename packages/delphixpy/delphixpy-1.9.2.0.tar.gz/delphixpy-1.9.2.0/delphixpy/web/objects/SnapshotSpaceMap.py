...
class SnapshotSpaceMap(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Mapping of
    containers and snapshots to their respective space usage.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._size_map[0] is not None and obj._size_map[0] is not obj.__undef__:
            assert isinstance(obj._size_map[0], dict), ("Expected one of [u'object'], but got %s" % type(obj._size_map[0]))
            common.validate_format(obj._size_map[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False):
        dct = super(SnapshotSpaceMap, self).to_dict(dirty)
