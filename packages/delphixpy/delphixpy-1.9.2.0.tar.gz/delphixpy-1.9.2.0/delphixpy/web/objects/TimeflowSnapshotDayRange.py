...
class TimeflowSnapshotDayRange(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Count of TimeFlow
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._count[0] is not None and obj._count[0] is not obj.__undef__:
            assert isinstance(obj._count[0], float), ("Expected one of [u'number'], but got %s" % type(obj._count[0]))
        ...
        if obj._date[0] is not None and obj._date[0] is not obj.__undef__:
            assert isinstance(obj._date[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._date[0]))
        ...
        if obj._start_of_day[0] is not None and obj._start_of_day[0] is not obj.__undef__:
            assert isinstance(obj._start_of_day[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._start_of_day[0]))
        ...
        if obj._end_of_day[0] is not None and obj._end_of_day[0] is not obj.__undef__:
            assert isinstance(obj._end_of_day[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._end_of_day[0]))
            common.validate_format(obj._end_of_day[0], "date", None, None)
        return obj

    def to_dict(self, dirty=False):
        dct = super(TimeflowSnapshotDayRange, self).to_dict(dirty)
