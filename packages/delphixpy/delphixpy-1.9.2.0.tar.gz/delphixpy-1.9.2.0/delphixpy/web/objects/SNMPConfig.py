...
class SNMPConfig(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* SNMP configuration.
    """
    ...
    def is_dirty(self):
        return any([self._community[1], self._enabled[1], self._severity[1], self._authorized_network[1], self._location[1]])
