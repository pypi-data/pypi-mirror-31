...
#     /delphix-js-data-container-reset-parameters.json
#
...
class JSDataContainerResetParameters(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* The parameters used
    to reset a data container..
    """
    def __init__(self, undef_enabled=True):
        super(JSDataContainerResetParameters, self).__init__()
        self._type = ("JSDataContainerResetParameters", True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(JSDataContainerResetParameters, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False):
        dct = super(JSDataContainerResetParameters, self).to_dict(dirty)
    ...
    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, JSDataContainerResetParameters):
            return False
        return super(JSDataContainerResetParameters, self).__eq__(other) and \
