    ...
    *(extends* :py:class:`delphixpy.web.vo.UserObject` *)* Replication setup.
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._automatic_replication[0] is not None and obj._automatic_replication[0] is not obj.__undef__:
            assert isinstance(obj._automatic_replication[0], bool), ("Expected one of [u'boolean'], but got %s" % type(obj._automatic_replication[0]))
    ...
    def to_dict(self, dirty=False):
        ...
        if "automatic_replication" == "type" or (self.automatic_replication is not self.__undef__ and not (dirty and not self._automatic_replication[1])):
    ...
    def is_dirty(self):
        return any([self._object_specification[1], self._number_of_connections[1], self._description[1], self._schedule[1], self._encrypted[1], self._target_port[1], self._automatic_replication[1], self._tag[1], self._use_system_socks_setting[1], self._target_principal[1], self._target_credential[1], self._target_host[1], self._runtime[1], self._bandwidth_limit[1]])
