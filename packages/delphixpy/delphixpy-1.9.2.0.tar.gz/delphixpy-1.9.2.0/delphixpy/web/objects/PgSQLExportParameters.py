...
class PgSQLExportParameters(DbExportParameters):
    ...
    *(extends* :py:class:`delphixpy.web.vo.DbExportParameters` *)* The
    parameters to use as input to export PostgreSQL databases.
    """
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.PgSQLDBClusterConfig`
        """
    ...
    def filesystem_layout(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.TimeflowFilesystemLayout`
        """
