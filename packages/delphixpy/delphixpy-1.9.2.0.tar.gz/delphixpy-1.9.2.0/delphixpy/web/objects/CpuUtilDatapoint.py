...
class CpuUtilDatapoint(Datapoint):
    """
    *(extends* :py:class:`delphixpy.web.vo.Datapoint` *)* An analytics
    datapoint generated by the CPU_UTIL statistic type.
    """
    ...
    def is_dirty(self):
        return any([self._kernel[1], self._idle[1], self._user[1], self._dtrace[1]])
