...
class OracleListener(NamedUserObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.NamedUserObject` *)* An Oracle
    listener.
    """
    ...
    def to_dict(self, dirty=False):
        ...
        if "protocol_addresses" == "type" or (self.protocol_addresses is not self.__undef__ and not (dirty and not self._protocol_addresses[1])):
            dct["protocolAddresses"] = dictify(self.protocol_addresses)
