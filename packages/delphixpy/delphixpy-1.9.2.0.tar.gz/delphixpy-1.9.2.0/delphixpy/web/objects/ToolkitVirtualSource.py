...
class ToolkitVirtualSource(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* A virtual source
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._ownership_spec[0] is not None and obj._ownership_spec[0] is not obj.__undef__:
            assert isinstance(obj._ownership_spec[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._ownership_spec[0]))
    ...
    def is_dirty(self):
        return any([self._status[1], self._configure[1], self._parameters[1], self._stop[1], self._ownership_spec[1], self._start[1], self._unconfigure[1], self._reconfigure[1], self._initialize[1], self._mount_spec[1], self._post_snapshot[1], self._pre_snapshot[1]])
    ...
    def __eq__(self, other):
        ...
        return super(ToolkitVirtualSource, self).__eq__(other) and \
               ...
               self.pre_snapshot == other.pre_snapshot
