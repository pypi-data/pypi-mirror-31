...
class TlsCaCert(NamedUserObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.NamedUserObject` *)* Trusted CA
    certificate.
    """
    def __init__(self, undef_enabled=True):
        super(TlsCaCert, self).__init__()
        self._type = ("TlsCaCert", True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(TlsCaCert, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False):
        dct = super(TlsCaCert, self).to_dict(dirty)
    ...
    def is_dirty(self):
        return any([self._name[1], self._sha1_fingerprint[1], self._valid_to[1], self._serial_number[1], self._issued_by_dn[1], self._md5_fingerprint[1], self._valid_from[1], self._issued_to_dn[1]])

    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, TlsCaCert):
            return False
        return super(TlsCaCert, self).__eq__(other) and \
