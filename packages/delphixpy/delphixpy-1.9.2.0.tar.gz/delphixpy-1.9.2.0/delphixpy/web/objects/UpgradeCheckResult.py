...
class UpgradeCheckResult(NamedUserObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.NamedUserObject` *)* Describes
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._impact[0] is not None and obj._impact[0] is not obj.__undef__:
            assert isinstance(obj._impact[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._impact[0]))
        ...
        if obj._severity[0] is not None and obj._severity[0] is not obj.__undef__:
            ...
            assert obj._severity[0] in [u'WARNING', u'CRITICAL', u'INFORMATIONAL'], "Expected enum [u'WARNING', u'CRITICAL', u'INFORMATIONAL'] but got %s" % obj._severity[0]
        ...
        if obj._output[0] is not None and obj._output[0] is not obj.__undef__:
            assert isinstance(obj._output[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._output[0]))
    ...
    def is_dirty(self):
        return any([self._impact[1], self._status[1], self._description[1], self._title[1], self._severity[1], self._version[1], self._action[1], self._output[1], self._bundle_id[1]])
