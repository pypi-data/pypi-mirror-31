...
class JSOperation(NamedUserObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.NamedUserObject` *)* An operation
    that occurred on a Jet Stream data layout.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._force_option[0] is not None and obj._force_option[0] is not obj.__undef__:
            assert isinstance(obj._force_option[0], bool), ("Expected one of [u'boolean'], but got %s" % type(obj._force_option[0]))
        ...
        if obj._operation[0] is not None and obj._operation[0] is not obj.__undef__:
            ...
            assert obj._operation[0] in [u'REFRESH', u'RESET', u'CREATE_BRANCH', u'DELETE_BRANCH', u'CREATE_BOOKMARK', u'DELETE_BOOKMARK', u'ENABLE', u'DISABLE', u'ACTIVATE', u'DEACTIVATE', u'RECOVER', u'RESTORE', u'UNDO', u'LOCK', u'UNLOCK'], "Expected enum [u'REFRESH', u'RESET', u'CREATE_BRANCH', u'DELETE_BRANCH', u'CREATE_BOOKMARK', u'DELETE_BOOKMARK', u'ENABLE', u'DISABLE', u'ACTIVATE', u'DEACTIVATE', u'RECOVER', u'RESTORE', u'UNDO', u'LOCK', u'UNLOCK'] but got %s" % obj._operation[0]
    ...
    def is_dirty(self):
        return any([self._data_layout[1], self._data_parent[1], self._data_time[1], self._start_time[1], self._bookmark[1], self._root_action[1], self._force_option[1], self._user[1], self._branch[1], self._operation[1], self._end_time[1], self._description[1]])
    ...
    def __eq__(self, other):
        ...
        return super(JSOperation, self).__eq__(other) and \
               ...
               self.force_option == other.force_option and \
    ...
    def data_parent(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.JSDataParent`
        """
