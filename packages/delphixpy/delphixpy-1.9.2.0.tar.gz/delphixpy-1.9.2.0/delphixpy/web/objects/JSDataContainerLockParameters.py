...
class JSDataContainerLockParameters(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* The parameters used
    ...
    def to_dict(self, dirty=False):
        dct = super(JSDataContainerLockParameters, self).to_dict(dirty)
        ...
        def dictify(obj):
            if isinstance(obj, list):
                ...
                return obj
        if "lock_user" == "type" or (self.lock_user is not self.__undef__ and not (dirty and not self._lock_user[1])):
