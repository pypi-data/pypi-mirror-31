...
class JSDataContainerCreateParameters(JSDataLayoutCreateParameters):
    """
    *(extends* :py:class:`delphixpy.web.vo.JSDataLayoutCreateParameters` *)*
    The parameters used to create a data container.
    """
    ...
    def is_dirty(self):
        return any([self._owners[1], self._template[1]])
