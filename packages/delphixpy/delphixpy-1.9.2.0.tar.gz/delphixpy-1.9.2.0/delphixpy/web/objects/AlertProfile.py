...
class AlertProfile(PersistentObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.PersistentObject` *)* A profile that
    ...
    def filter_spec(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.AlertFilter`
        """
    ...
    def actions(self):
        ...
        :rtype: ``list`` of :py:class:`delphixpy.web.vo.AlertAction`
        """
