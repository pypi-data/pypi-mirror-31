...
class AggregateCapacityData(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Capacity data for
    an aggregation of containers.
    """
    ...
    def is_dirty(self):
        return any([self._timestamp[1], self._virtual[1], self._source[1]])
    ...
    def virtual(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.CapacityBreakdown`
        """
