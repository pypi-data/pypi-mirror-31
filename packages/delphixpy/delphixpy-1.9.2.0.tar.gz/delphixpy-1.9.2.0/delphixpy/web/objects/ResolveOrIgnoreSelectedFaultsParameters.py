...
class ResolveOrIgnoreSelectedFaultsParameters(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* The parameters to
    ...
    def to_dict(self, dirty=False):
        dct = super(ResolveOrIgnoreSelectedFaultsParameters, self).to_dict(dirty)
        ...
        if "fault_references" == "type" or (self.fault_references is not self.__undef__ and not (dirty and not self._fault_references[1])):
            dct["faultReferences"] = dictify(self.fault_references)
        return dct
    ...
    def is_dirty(self):
        return any([self._ignore[1], self._fault_references[1]])
