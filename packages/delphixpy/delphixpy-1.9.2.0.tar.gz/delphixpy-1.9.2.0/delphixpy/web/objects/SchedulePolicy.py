...
class SchedulePolicy(Policy):
    """
    *(extends* :py:class:`delphixpy.web.vo.Policy` *)* The base type for all
    schedule policies.
    """
    ...
    def timezone(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.TimeZone`
        """
    ...
    def schedule_list(self):
        ...
        :rtype: ``list`` of :py:class:`delphixpy.web.vo.Schedule`
        """
