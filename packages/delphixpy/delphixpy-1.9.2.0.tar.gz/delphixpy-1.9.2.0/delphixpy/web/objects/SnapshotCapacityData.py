...
class SnapshotCapacityData(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Capacity metrics
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._space[0] is not None and obj._space[0] is not obj.__undef__:
            assert isinstance(obj._space[0], float), ("Expected one of [u'number'], but got %s" % type(obj._space[0]))
    ...
    def is_dirty(self):
        return any([self._descendant_vd_bs[1], self._manual_retention[1], self._container[1], self._space[1], self._snapshot[1], self._snapshot_timestamp[1], self._policy_retention[1]])
