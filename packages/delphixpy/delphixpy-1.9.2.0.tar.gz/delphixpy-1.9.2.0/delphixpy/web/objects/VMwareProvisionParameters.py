...
class VMwareProvisionParameters(ProvisionParameters):
    ...
    *(extends* :py:class:`delphixpy.web.vo.ProvisionParameters` *)* The
    parameters to use as input to provision VMware.
    """
    ...
    def source(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.VMwareVirtualSource`
        """
    ...
    def container(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.VMwareContainer`
        """
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.VMwareMachineConfig`
        """
