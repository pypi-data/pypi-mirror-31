...
class OracleBaseSourceRuntime(SourceRuntime):
    """
    *(extends* :py:class:`delphixpy.web.vo.SourceRuntime` *)* Runtime (non-
    ...
    def active_instances(self):
        ...
        :rtype: ``list`` of :py:class:`delphixpy.web.vo.OracleActiveInstance`
        """
    ...
    def database_stats(self):
        ...
        :rtype: ``list`` of
            :py:class:`delphixpy.web.vo.OracleDatabaseStatsSection`
        """
