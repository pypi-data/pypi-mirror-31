...
class StorageDeviceRemovalStatus(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* The status of a
    device removal of the storage in the system.
    """
    ...
    def is_dirty(self):
        return any([self._start_time[1], self._state[1], self._total[1], self._copied[1], self._mapping_memory[1]])
