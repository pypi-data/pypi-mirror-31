...
class StorageDeviceInitializeStatus(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* The status of an
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._state[0] is not None and obj._state[0] is not obj.__undef__:
            ...
            assert obj._state[0] in [u'NONE', u'ACTIVE', u'CANCELED', u'SUSPENDED', u'COMPLETED'], "Expected enum [u'NONE', u'ACTIVE', u'CANCELED', u'SUSPENDED', u'COMPLETED'] but got %s" % obj._state[0]
        ...
        if obj._bytes_done[0] is not None and obj._bytes_done[0] is not obj.__undef__:
            assert isinstance(obj._bytes_done[0], float), ("Expected one of [u'number'], but got %s" % type(obj._bytes_done[0]))
        ...
        if obj._bytes_est[0] is not None and obj._bytes_est[0] is not obj.__undef__:
            assert isinstance(obj._bytes_est[0], float), ("Expected one of [u'number'], but got %s" % type(obj._bytes_est[0]))
            common.validate_format(obj._bytes_est[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False):
        dct = super(StorageDeviceInitializeStatus, self).to_dict(dirty)
