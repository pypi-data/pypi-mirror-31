...
class LoginRequest(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Represents a
    Delphix user authentication request.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._keep_alive_mode[0] is not None and obj._keep_alive_mode[0] is not obj.__undef__:
            assert isinstance(obj._keep_alive_mode[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._keep_alive_mode[0]))
            assert obj._keep_alive_mode[0] in [u'ALL_REQUESTS', u'KEEP_ALIVE_HEADER_ONLY'], "Expected enum [u'ALL_REQUESTS', u'KEEP_ALIVE_HEADER_ONLY'] but got %s" % obj._keep_alive_mode[0]
    ...
    def is_dirty(self):
        return any([self._username[1], self._password[1], self._target[1], self._keep_alive_mode[1]])
    ...
    def __eq__(self, other):
        ...
        return super(LoginRequest, self).__eq__(other) and \
               ...
               self.keep_alive_mode == other.keep_alive_mode
