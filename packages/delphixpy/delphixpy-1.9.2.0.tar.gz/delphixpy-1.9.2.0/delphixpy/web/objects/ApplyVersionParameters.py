    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* The parameters to
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._ignore_quiesce_sources_failures[0] is not None and obj._ignore_quiesce_sources_failures[0] is not obj.__undef__:
            assert isinstance(obj._ignore_quiesce_sources_failures[0], bool), ("Expected one of [u'boolean'], but got %s" % type(obj._ignore_quiesce_sources_failures[0]))
        ...
        if obj._verify[0] is not None and obj._verify[0] is not obj.__undef__:
            assert isinstance(obj._verify[0], bool), ("Expected one of [u'boolean'], but got %s" % type(obj._verify[0]))
    ...
    def to_dict(self, dirty=False):
        ...
        if "ignore_quiesce_sources_failures" == "type" or (self.ignore_quiesce_sources_failures is not self.__undef__ and not (dirty and not self._ignore_quiesce_sources_failures[1])):
            dct["ignoreQuiesceSourcesFailures"] = dictify(self.ignore_quiesce_sources_failures)
        if "verify" == "type" or (self.verify is not self.__undef__ and not (dirty and not self._verify[1])):
    ...
    def is_dirty(self):
        return any([self._defer[1], self._enable_sources_on_failure[1], self._ignore_quiesce_sources_failures[1], self._verify[1], self._quiesce_sources[1], self._reboot[1]])
