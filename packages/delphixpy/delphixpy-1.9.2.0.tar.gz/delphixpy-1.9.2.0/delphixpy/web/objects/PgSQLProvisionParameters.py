...
class PgSQLProvisionParameters(ProvisionParameters):
    """
    *(extends* :py:class:`delphixpy.web.vo.ProvisionParameters` *)* The
    parameters to use as input to provision PostgreSQL databases.
    """
    ...
    def source(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.PgSQLVirtualSource`
        """
    ...
    def container(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.PgSQLDatabaseContainer`
        """
