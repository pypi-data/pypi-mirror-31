...
class PgSQLHBAEntry(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* An entry in the
    ...
    def is_dirty(self):
        return any([self._auth_options[1], self._database[1], self._auth_method[1], self._user[1], self._address[1], self._entry_type[1]])
