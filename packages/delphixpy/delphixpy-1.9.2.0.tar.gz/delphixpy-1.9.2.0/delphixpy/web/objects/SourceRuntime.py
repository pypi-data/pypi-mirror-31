...
class SourceRuntime(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Runtime properties
    of a linked or virtual source database.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._accessible_timestamp[0] is not None and obj._accessible_timestamp[0] is not obj.__undef__:
            assert isinstance(obj._accessible_timestamp[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._accessible_timestamp[0]))
    ...
    def is_dirty(self):
        return any([self._status[1], self._accessible[1], self._accessible_timestamp[1], self._enabled[1], self._not_accessible_reason[1], self._database_size[1]])
