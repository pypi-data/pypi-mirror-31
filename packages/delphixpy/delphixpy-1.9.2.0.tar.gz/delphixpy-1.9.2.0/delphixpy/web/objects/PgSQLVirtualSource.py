...
class PgSQLVirtualSource(PgSQLSource):
    """
    *(extends* :py:class:`delphixpy.web.vo.PgSQLSource` *)* A virtual
    PostgreSQL source.
    """
    ...
    def is_dirty(self):
        return any([self._operations[1], self._config_params[1], self._file_mapping_rules[1], self._mount_base[1], self._allow_auto_vdb_restart_on_host_reboot[1], self._ident_entries[1], self._hba_entries[1]])
    ...
    def ident_entries(self):
        ...
        :rtype: ``list`` of :py:class:`delphixpy.web.vo.PgSQLIdentEntry`
        """
    ...
    def hba_entries(self):
        ...
        :rtype: ``list`` of :py:class:`delphixpy.web.vo.PgSQLHBAEntry`
        """
