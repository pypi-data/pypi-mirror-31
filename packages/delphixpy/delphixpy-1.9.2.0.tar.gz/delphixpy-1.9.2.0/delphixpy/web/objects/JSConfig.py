...
class JSConfig(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Jet Stream
    configuration.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._retry_attempts[0] is not None and obj._retry_attempts[0] is not obj.__undef__:
            assert isinstance(obj._retry_attempts[0], int), ("Expected one of [u'integer'], but got %s" % type(obj._retry_attempts[0]))
        ...
        if obj._default_bookmark_expiration[0] is not None and obj._default_bookmark_expiration[0] is not obj.__undef__:
            assert isinstance(obj._default_bookmark_expiration[0], int), ("Expected one of [u'integer'], but got %s" % type(obj._default_bookmark_expiration[0]))
            common.validate_format(obj._default_bookmark_expiration[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False):
        dct = super(JSConfig, self).to_dict(dirty)
        ...
        def dictify(obj):
            if isinstance(obj, list):
                ...
                return obj
        if "retry_attempts" == "type" or (self.retry_attempts is not self.__undef__ and not (dirty and not self._retry_attempts[1])):
            dct["retryAttempts"] = dictify(self.retry_attempts)
        if "default_bookmark_expiration" == "type" or (self.default_bookmark_expiration is not self.__undef__ and not (dirty and not self._default_bookmark_expiration[1])):
    ...
    def is_dirty(self):
        return any([self._retry_attempts[1], self._default_bookmark_expiration[1]])
    ...
    def __eq__(self, other):
        ...
        return super(JSConfig, self).__eq__(other) and \
               self.retry_attempts == other.retry_attempts and \
               self.default_bookmark_expiration == other.default_bookmark_expiration
