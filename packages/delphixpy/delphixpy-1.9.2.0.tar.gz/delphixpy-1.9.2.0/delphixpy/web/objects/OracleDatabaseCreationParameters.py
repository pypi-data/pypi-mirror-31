...
class OracleDatabaseCreationParameters(EmptyDatasetCreationParameters):
    """
    *(extends* :py:class:`delphixpy.web.vo.EmptyDatasetCreationParameters` *)*
    The parameters to use as input when creating a new Oracle database.
    """
    ...
    def is_dirty(self):
        return any([self._source_config[1], self._delphix_username[1], self._container[1], self._timezone_file_version[1], self._max_instances[1], self._max_data_files[1], self._force_logging[1], self._max_log_files[1], self._character_set[1], self._sys_datafile[1], self._source[1], self._temp_tablespace[1], self._grant_select_any_dictionary[1], self._redo_logs[1], self._sys_password[1], self._delphix_password[1], self._national_character_set[1], self._undo_tablespace[1], self._max_log_history[1], self._system_password[1], self._sysaux_datafile[1]])
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleBaseDBConfig`
        """
    ...
    def container(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleDatabaseContainer`
        """
    ...
    def sys_datafile(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleSystemDatafileSpecification`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleWarehouseSource`
        """
    ...
    def temp_tablespace(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleTempfileSpecification`
        """
    ...
    def redo_logs(self):
        ...
        :rtype: ``list`` of
            :py:class:`delphixpy.web.vo.OracleRedoLogFileSpecification`
        """
    ...
    def undo_tablespace(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleUndoDatafileSpecification`
        """
    ...
    def sysaux_datafile(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleSysauxDatafileSpecification`
        """
