...
class OracleSIConfig(OracleDBConfig):
    """
    *(extends* :py:class:`delphixpy.web.vo.OracleDBConfig` *)* The
    representation of a single-instance Oracle DB configuration.
    """
    ...
    def instance(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleInstance`
        """
