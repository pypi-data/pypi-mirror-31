...
class StatisticSlice(NamedUserObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.NamedUserObject` *)* Collects a
    slice of a multidimensional analytics statistic.
    """
    ...
    def is_dirty(self):
        return any([self._state[1], self._statistic_type[1], self._collection_axes[1], self._axis_constraints[1], self._collection_interval[1]])
    ...
    def axis_constraints(self):
        ...
        :rtype: ``list`` of :py:class:`delphixpy.web.vo.AxisConstraint`
        """
