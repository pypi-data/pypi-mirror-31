...
class OracleMultitenantProvisionParameters(OracleBaseProvisionParameters):
    """
    *(extends* :py:class:`delphixpy.web.vo.OracleBaseProvisionParameters` *)*
    The parameters to use as input to provision Oracle multitenant databases.
    """
    ...
    def to_dict(self, dirty=False):
        dct = super(OracleMultitenantProvisionParameters, self).to_dict(dirty)
        ...
        if "virtual_cdb" == "type" or (self.virtual_cdb is not self.__undef__ and not (dirty and not self._virtual_cdb[1])):
            dct["virtualCdb"] = dictify(self.virtual_cdb)
    ...
    def is_dirty(self):
        return any([self._source_config[1], self._virtual_cdb[1], self._source[1]])
    ...
    def __eq__(self, other):
        ...
        return super(OracleMultitenantProvisionParameters, self).__eq__(other) and \
               ...
               self.virtual_cdb == other.virtual_cdb and \
    ...
    def source_config(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OraclePDBConfig`
        """
    ...
    def virtual_cdb(self):
        ...
        :rtype:
            :py:class:`delphixpy.web.vo.OracleVirtualCdbProvisionParameters`
        """
    ...
    def source(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleVirtualPdbSource`
        """
