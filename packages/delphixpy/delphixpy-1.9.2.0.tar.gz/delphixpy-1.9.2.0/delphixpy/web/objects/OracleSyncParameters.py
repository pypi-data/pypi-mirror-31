...
class OracleSyncParameters(SyncParameters):
    """
    *(extends* :py:class:`delphixpy.web.vo.SyncParameters` *)* The parameters
    to use as input to sync Oracle databases.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._do_not_resume[0] is not None and obj._do_not_resume[0] is not obj.__undef__:
            assert isinstance(obj._do_not_resume[0], bool), ("Expected one of [u'boolean'], but got %s" % type(obj._do_not_resume[0]))
    ...
    def to_dict(self, dirty=False):
        ...
        def dictify(obj):
            if isinstance(obj, list):
                ...
                return obj
        if "do_not_resume" == "type" or (self.do_not_resume is not self.__undef__ and not (dirty and not self._do_not_resume[1])):
    ...
    def is_dirty(self):
        return any([self._do_not_resume[1], self._skip_space_check[1], self._double_sync[1], self._force_full_backup[1]])
