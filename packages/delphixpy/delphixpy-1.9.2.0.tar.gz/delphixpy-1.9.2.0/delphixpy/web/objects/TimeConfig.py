...
class TimeConfig(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Get and set the
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._system_time_zone_offset_string[0] is not None and obj._system_time_zone_offset_string[0] is not obj.__undef__:
            assert isinstance(obj._system_time_zone_offset_string[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._system_time_zone_offset_string[0]))
        ...
        if obj._system_time_zone_offset[0] is not None and obj._system_time_zone_offset[0] is not obj.__undef__:
            assert isinstance(obj._system_time_zone_offset[0], int), ("Expected one of [u'integer'], but got %s" % type(obj._system_time_zone_offset[0]))
    ...
    def is_dirty(self):
        return any([self._ntp_config[1], self._current_time[1], self._system_time_zone[1], self._system_time_zone_offset_string[1], self._system_time_zone_offset[1]])
    ...
    def __eq__(self, other):
        ...
        return super(TimeConfig, self).__eq__(other) and \
               ...
               self.system_time_zone_offset == other.system_time_zone_offset
    ...
    def ntp_config(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.NTPConfig`
        """
