...
class PgSQLSourceConnectionInfo(SourceConnectionInfo):
    """
    *(extends* :py:class:`delphixpy.web.vo.SourceConnectionInfo` *)* Contains
    ...
    def is_dirty(self):
        return any([self._user[1], self._host[1], self._jdbc_string[1], self._port[1], self._pg_data_directory[1]])
    ...
    def __eq__(self, other):
        ...
        return super(PgSQLSourceConnectionInfo, self).__eq__(other) and \
               ...
               self.pg_data_directory == other.pg_data_directory
