...
class MySQLNewMySQLDumpSyncParameters(MySQLSyncParameters):
    """
    *(extends* :py:class:`delphixpy.web.vo.MySQLSyncParameters` *)* The
    parameters to use as input to sync requests for MySQL databases using a new
    MySQL dump taken by Delphix.
    """
