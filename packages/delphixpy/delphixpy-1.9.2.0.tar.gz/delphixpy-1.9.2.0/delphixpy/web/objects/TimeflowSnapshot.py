...
class TimeflowSnapshot(ReadonlyNamedUserObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.ReadonlyNamedUserObject` *)*
    Snapshot of a point within a TimeFlow that is used as the basis for
    provisioning.
    """
    ...
    def is_dirty(self):
        return any([self._missing_non_logged_data[1], self._temporary[1], self._creation_time[1], self._timeflow[1], self._latest_change_point[1], self._timezone[1], self._version[1], self._first_change_point[1], self._consistency[1], self._container[1], self._runtime[1], self._retention[1]])
    ...
    def latest_change_point(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.TimeflowPoint`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.SnapshotRuntime`
        """
