...
class ToolkitDiscoveryDefinition(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Defines the
    discovery schemas and workflow scripts for a toolkit.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._manual_source_config_discovery[0] is not None and obj._manual_source_config_discovery[0] is not obj.__undef__:
            assert isinstance(obj._manual_source_config_discovery[0], bool), ("Expected one of [u'boolean'], but got %s" % type(obj._manual_source_config_discovery[0]))
    ...
    def is_dirty(self):
        return any([self._source_config_identity_fields[1], self._source_config_name_field[1], self._repository_identity_fields[1], self._repository_schema[1], self._source_config_discovery[1], self._manual_source_config_discovery[1], self._repository_discovery[1], self._repository_name_field[1], self._source_config_schema[1]])
    ...
    def __eq__(self, other):
        ...
        return super(ToolkitDiscoveryDefinition, self).__eq__(other) and \
               ...
               self.manual_source_config_discovery == other.manual_source_config_discovery and \
