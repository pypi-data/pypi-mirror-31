...
#     /delphix-js-data-container-refresh-parameters.json
#
...
class JSDataContainerRefreshParameters(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* The parameters used
    to refresh a data container.
    """
    def __init__(self, undef_enabled=True):
        super(JSDataContainerRefreshParameters, self).__init__()
        self._type = ("JSDataContainerRefreshParameters", True)
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        obj = super(JSDataContainerRefreshParameters, cls).from_dict(data, dirty, undef_enabled)
    ...
    def to_dict(self, dirty=False):
        dct = super(JSDataContainerRefreshParameters, self).to_dict(dirty)
    ...
    def is_dirty(self):
        return any([self._force_option[1]])

    def __eq__(self, other):
        if other is None:
            return False
        if not isinstance(other, JSDataContainerRefreshParameters):
            return False
        return super(JSDataContainerRefreshParameters, self).__eq__(other) and \
