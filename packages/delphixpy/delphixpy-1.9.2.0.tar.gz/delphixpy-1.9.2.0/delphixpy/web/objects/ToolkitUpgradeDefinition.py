...
class ToolkitUpgradeDefinition(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* The toolkit upgrade
    logic to upgrade metadata from the previous version of the toolkit.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._from_version[0] is not None and obj._from_version[0] is not obj.__undef__:
            assert isinstance(obj._from_version[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._from_version[0]))
        ...
        if obj._upgrade_virtual_source[0] is not None and obj._upgrade_virtual_source[0] is not obj.__undef__:
            assert isinstance(obj._upgrade_virtual_source[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._upgrade_virtual_source[0]))
        ...
        if obj._upgrade_linked_source[0] is not None and obj._upgrade_linked_source[0] is not obj.__undef__:
            assert isinstance(obj._upgrade_linked_source[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._upgrade_linked_source[0]))
        ...
        if obj._upgrade_manual_source_config[0] is not None and obj._upgrade_manual_source_config[0] is not obj.__undef__:
            assert isinstance(obj._upgrade_manual_source_config[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._upgrade_manual_source_config[0]))
        ...
        if obj._upgrade_snapshot[0] is not None and obj._upgrade_snapshot[0] is not obj.__undef__:
            assert isinstance(obj._upgrade_snapshot[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._upgrade_snapshot[0]))
            common.validate_format(obj._upgrade_snapshot[0], "None", None, None)
        return obj

    def to_dict(self, dirty=False):
        dct = super(ToolkitUpgradeDefinition, self).to_dict(dirty)
        ...
        def dictify(obj):
            if isinstance(obj, list):
                ...
                return obj
        if "from_version" == "type" or (self.from_version is not self.__undef__ and not (dirty and not self._from_version[1])):
            dct["fromVersion"] = dictify(self.from_version)
        if "upgrade_virtual_source" == "type" or (self.upgrade_virtual_source is not self.__undef__ and not (dirty and not self._upgrade_virtual_source[1])):
            dct["upgradeVirtualSource"] = dictify(self.upgrade_virtual_source)
        if "upgrade_linked_source" == "type" or (self.upgrade_linked_source is not self.__undef__ and not (dirty and not self._upgrade_linked_source[1])):
        ...
        if "upgrade_snapshot" == "type" or (self.upgrade_snapshot is not self.__undef__ and not (dirty and not self._upgrade_snapshot[1])):
    ...
    def is_dirty(self):
        return any([self._from_version[1], self._upgrade_virtual_source[1], self._upgrade_linked_source[1], self._upgrade_manual_source_config[1], self._upgrade_snapshot[1]])
    ...
    def __eq__(self, other):
        ...
        return super(ToolkitUpgradeDefinition, self).__eq__(other) and \
               self.from_version == other.from_version and \
               ...
               self.upgrade_snapshot == other.upgrade_snapshot
