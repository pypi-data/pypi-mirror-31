...
class OracleDatabaseContainer(DatabaseContainer):
    ...
    *(extends* :py:class:`delphixpy.web.vo.DatabaseContainer` *)* Data
    container for Oracle databases, both linked and virtual.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._performance_mode[0] is not None and obj._performance_mode[0] is not obj.__undef__:
            ...
            assert obj._performance_mode[0] in [u'TEMPORARILY_ENABLED', u'ENABLED', u'DISABLED'], "Expected enum [u'TEMPORARILY_ENABLED', u'ENABLED', u'DISABLED'] but got %s" % obj._performance_mode[0]
    ...
    def is_dirty(self):
        return any([self._content_type[1], self._physical_standby[1], self._diagnose_no_logging_faults[1], self._sourcing_policy[1], self._performance_mode[1], self._pre_provisioning_enabled[1], self._database_fraction[1], self._runtime[1], self._cross_platform_ready[1], self._live_source[1]])
    ...
    def sourcing_policy(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleSourcingPolicy`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleDBContainerRuntime`
        """
