...
class MaskingServiceConfig(UserObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.UserObject` *)* Configuration for
    the Masking Service this Engine communicates with.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._scheme[0] is not None and obj._scheme[0] is not obj.__undef__:
            assert isinstance(obj._scheme[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._scheme[0]))
            assert obj._scheme[0] in [u'HTTP', u'HTTPS'], "Expected enum [u'HTTP', u'HTTPS'] but got %s" % obj._scheme[0]
    ...
    def to_dict(self, dirty=False):
        ...
        if "scheme" == "type" or (self.scheme is not self.__undef__ and not (dirty and not self._scheme[1])):
    ...
    def is_dirty(self):
        return any([self._username[1], self._name[1], self._server[1], self._credentials[1], self._scheme[1], self._port[1]])
