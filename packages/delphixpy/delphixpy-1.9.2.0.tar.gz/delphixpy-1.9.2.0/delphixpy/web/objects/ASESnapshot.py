...
class ASESnapshot(TimeflowSnapshot):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TimeflowSnapshot` *)* Provisionable
    ...
    def is_dirty(self):
        return any([self._first_change_point[1], self._runtime[1], self._latest_change_point[1]])
    ...
    def first_change_point(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.ASETimeflowPoint`
        """
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.ASESnapshotRuntime`
        """
