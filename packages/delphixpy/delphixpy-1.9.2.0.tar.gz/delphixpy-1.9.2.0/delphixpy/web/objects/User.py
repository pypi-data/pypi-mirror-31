...
class User(NamedUserObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.NamedUserObject` *)* Delphix users.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._password_update_request[0] is not None and obj._password_update_request[0] is not obj.__undef__:
            assert isinstance(obj._password_update_request[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._password_update_request[0]))
            assert obj._password_update_request[0] in [u'NONE', u'FIRST_LOGIN', u'ADMIN_REQUEST', u'PASSWORD_POLICY'], "Expected enum [u'NONE', u'FIRST_LOGIN', u'ADMIN_REQUEST', u'PASSWORD_POLICY'] but got %s" % obj._password_update_request[0]
    ...
    def to_dict(self, dirty=False):
        ...
        if "password_update_request" == "type" or (self.password_update_request is not self.__undef__ and not (dirty and not self._password_update_request[1])):
    ...
    def is_dirty(self):
        return any([self._credential[1], self._name[1], self._authentication_type[1], self._user_type[1], self._locale[1], self._last_name[1], self._enabled[1], self._public_key[1], self._session_timeout[1], self._email_address[1], self._first_name[1], self._password_update_request[1], self._home_phone_number[1], self._mobile_phone_number[1], self._work_phone_number[1], self._is_default[1], self._principal[1]])
