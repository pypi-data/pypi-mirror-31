...
class SMTPConfig(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* SMTP configuration.
    """
    ...
    def is_dirty(self):
        return any([self._username[1], self._password[1], self._send_timeout[1], self._tls_enabled[1], self._enabled[1], self._server[1], self._authentication_enabled[1], self._from_address[1], self._port[1]])
