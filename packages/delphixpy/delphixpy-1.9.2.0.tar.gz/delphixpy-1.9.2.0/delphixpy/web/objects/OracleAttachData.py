...
class OracleAttachData(OracleBaseAttachData):
    """
    *(extends* :py:class:`delphixpy.web.vo.OracleBaseAttachData` *)* Represents
    parameters to attach non-pluggable Oracle databases.
    """
    ...
    def is_dirty(self):
        return any([self._config[1], self._double_sync[1]])
    ...
    def __eq__(self, other):
        ...
        return super(OracleAttachData, self).__eq__(other) and \
               ...
               self.double_sync == other.double_sync
