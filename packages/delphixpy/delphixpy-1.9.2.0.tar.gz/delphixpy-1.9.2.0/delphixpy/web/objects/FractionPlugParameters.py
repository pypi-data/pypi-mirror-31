...
class FractionPlugParameters(TypedObject):
    ...
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* The parameters to
    use as input when transporting a transportable tablespace.
    """
    ...
    def is_dirty(self):
        return any([self._schemas_prefix[1], self._timeflow_point_parameters[1], self._tablespaces_prefix[1]])
    ...
    def timeflow_point_parameters(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.TimeflowPointParameters`
        """
