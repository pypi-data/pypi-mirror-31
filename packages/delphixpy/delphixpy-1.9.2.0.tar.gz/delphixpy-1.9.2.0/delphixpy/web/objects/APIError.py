...
class APIError(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Description of an
    ...
    def is_dirty(self):
        return any([self._action[1], self._diagnoses[1], self._id[1], self._command_output[1], self._details[1]])
