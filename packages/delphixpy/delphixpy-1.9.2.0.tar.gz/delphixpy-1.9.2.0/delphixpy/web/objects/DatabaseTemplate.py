...
class DatabaseTemplate(NamedUserObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.NamedUserObject` *)* Parameter
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._source_type[0] is not None and obj._source_type[0] is not obj.__undef__:
            ...
            assert obj._source_type[0] in [u'MySQLVirtualSource', u'OracleVirtualSource', u'MSSqlVirtualSource', u'PgSQLVirtualSource'], "Expected enum [u'MySQLVirtualSource', u'OracleVirtualSource', u'MSSqlVirtualSource', u'PgSQLVirtualSource'] but got %s" % obj._source_type[0]
