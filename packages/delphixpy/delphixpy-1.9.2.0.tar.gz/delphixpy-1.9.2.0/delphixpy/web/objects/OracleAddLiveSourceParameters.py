...
class OracleAddLiveSourceParameters(AddLiveSourceParameters):
    """
    *(extends* :py:class:`delphixpy.web.vo.AddLiveSourceParameters` *)* The
    ...
    def is_dirty(self):
        return any([self._username[1], self._source[1], self._source_config[1], self._credential[1]])
    ...
    def source(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.OracleLiveSource`
        """
