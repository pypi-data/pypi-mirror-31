...
class TimeflowBookmark(NamedUserObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.NamedUserObject` *)* A TimeFlow
    ...
    def is_dirty(self):
        return any([self._timestamp[1], self._retention_proof[1], self._timeflow[1], self._tag[1], self._location[1]])
