...
class MSSqlBaseClusterRepository(MSSqlRepository):
    """
    *(extends* :py:class:`delphixpy.web.vo.MSSqlRepository` *)* The
    ...
    def instances(self):
        ...
        :rtype: ``list`` of
            :py:class:`delphixpy.web.vo.MSSqlBaseClusterInstance`
        """
    ...
    def listeners(self):
        ...
        :rtype: ``list`` of
            :py:class:`delphixpy.web.vo.MSSqlBaseClusterListener`
        """
