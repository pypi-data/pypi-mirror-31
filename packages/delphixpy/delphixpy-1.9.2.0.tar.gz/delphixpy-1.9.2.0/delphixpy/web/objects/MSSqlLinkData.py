...
class MSSqlLinkData(LinkData):
    """
    *(extends* :py:class:`delphixpy.web.vo.LinkData` *)* MSSQL specific
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._delphix_managed_status[0] is not None and obj._delphix_managed_status[0] is not obj.__undef__:
            assert isinstance(obj._delphix_managed_status[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._delphix_managed_status[0]))
            assert obj._delphix_managed_status[0] in [u'DELPHIX_MANAGED_UNCOMPRESSED', u'DELPHIX_MANAGED_COMPRESSED', u'NOT_DELPHIX_MANAGED'], "Expected enum [u'DELPHIX_MANAGED_UNCOMPRESSED', u'DELPHIX_MANAGED_COMPRESSED', u'NOT_DELPHIX_MANAGED'] but got %s" % obj._delphix_managed_status[0]
    ...
    def to_dict(self, dirty=False):
        ...
        if "delphix_managed_status" == "type" or (self.delphix_managed_status is not self.__undef__ and not (dirty and not self._delphix_managed_status[1])):
    ...
    def is_dirty(self):
        return any([self._operations[1], self._ppt_host_user[1], self._staging_pre_script[1], self._external_file_path[1], self._validated_sync_mode[1], self._encryption_key[1], self._backup_location_credentials[1], self._shared_backup_location[1], self._staging_post_script[1], self._delphix_managed_status[1], self._db_user[1], self._source_host_user[1], self._backup_location_user[1], self._config[1], self._ppt_repository[1], self._db_credentials[1], self._sync_parameters[1]])
    ...
    def __eq__(self, other):
        ...
        return super(MSSqlLinkData, self).__eq__(other) and \
               ...
               self.delphix_managed_status == other.delphix_managed_status and \
    ...
    def operations(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.LinkedSourceOperations`
        """
    ...
    def delphix_managed_status(self):
        ...
        *(default value: NOT_DELPHIX_MANAGED)* Specifies whether Delphix should
        manage the backups for this container and if so, specify whether the
        backups are compressed or uncompressed. *(permitted values:
    ...
    def sync_parameters(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.MSSqlSyncParameters`
        """
