    ...
    *(extends* :py:class:`delphixpy.web.vo.SshVerifyBase` *)* SSH verification
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._raw_key[0] is not None and obj._raw_key[0] is not obj.__undef__:
            assert isinstance(obj._raw_key[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._raw_key[0]))
            common.validate_format(obj._raw_key[0], "hostKey", None, None)
        return obj

    def to_dict(self, dirty=False):
        dct = super(SshVerifyRawKey, self).to_dict(dirty)
        ...
        def dictify(obj):
            if isinstance(obj, list):
                ...
                return obj
        if "raw_key" == "type" or (self.raw_key is not self.__undef__ and not (dirty and not self._raw_key[1])):
