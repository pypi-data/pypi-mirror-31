...
class AppDataSource(Source):
    """
    *(extends* :py:class:`delphixpy.web.vo.Source` *)* An AppData source.
    """
    ...
    def is_dirty(self):
        return any([self._runtime[1], self._toolkit[1]])
    ...
    def runtime(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.AppDataSourceRuntime`
        """
