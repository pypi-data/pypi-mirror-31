...
class MSSqlProvisionParameters(ProvisionParameters):
    ...
    *(extends* :py:class:`delphixpy.web.vo.ProvisionParameters` *)* The
    parameters to use as input to provision MSSQL databases.
    """
    ...
    def source(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.MSSqlVirtualSource`
        """
    ...
    def container(self):
        ...
        :rtype: :py:class:`delphixpy.web.vo.MSSqlDatabaseContainer`
        """
