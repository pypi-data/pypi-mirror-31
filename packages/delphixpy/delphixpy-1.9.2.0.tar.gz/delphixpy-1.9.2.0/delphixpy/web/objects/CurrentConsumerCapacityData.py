...
class CurrentConsumerCapacityData(BaseConsumerCapacityData):
    """
    *(extends* :py:class:`delphixpy.web.vo.BaseConsumerCapacityData` *)*
    Current data about a particular capacity consumer.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._storage_container[0] is not None and obj._storage_container[0] is not obj.__undef__:
            assert isinstance(obj._storage_container[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._storage_container[0]))
    ...
    def is_dirty(self):
        return any([self._storage_container[1]])
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CurrentConsumerCapacityData):
            return False
        return super(CurrentConsumerCapacityData, self).__eq__(other) and \
               self.storage_container == other.storage_container
