    ...
    *(extends* :py:class:`delphixpy.web.vo.ExportParameters` *)* The parameters
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._data_diskgroup[0] is not None and obj._data_diskgroup[0] is not obj.__undef__:
            assert isinstance(obj._data_diskgroup[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._data_diskgroup[0]))
        ...
        if obj._parallel[0] is not None and obj._parallel[0] is not obj.__undef__:
            assert isinstance(obj._parallel[0], int), ("Expected one of [u'integer'], but got %s" % type(obj._parallel[0]))
        ...
        if obj._redo_diskgroup[0] is not None and obj._redo_diskgroup[0] is not obj.__undef__:
            assert isinstance(obj._redo_diskgroup[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._redo_diskgroup[0]))
    ...
    def to_dict(self, dirty=False):
        dct = super(OracleExportAsmParameters, self).to_dict(dirty)
        ...
        if "data_diskgroup" == "type" or (self.data_diskgroup is not self.__undef__ and not (dirty and not self._data_diskgroup[1])):
            dct["dataDiskgroup"] = dictify(self.data_diskgroup)
        if "parallel" == "type" or (self.parallel is not self.__undef__ and not (dirty and not self._parallel[1])):
            dct["parallel"] = dictify(self.parallel)
        if "redo_diskgroup" == "type" or (self.redo_diskgroup is not self.__undef__ and not (dirty and not self._redo_diskgroup[1])):
    ...
    def is_dirty(self):
        return any([self._source[1], self._data_diskgroup[1], self._parallel[1], self._redo_diskgroup[1], self._source_config[1]])
