...
class DSPAutotunerParameters(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Network information
    ...
    def to_dict(self, dirty=False):
        dct = super(DSPAutotunerParameters, self).to_dict(dirty)
    ...
    def is_dirty(self):
        return any([self._direction[1], self._destination_type[1], self._remote_host[1], self._remote_delphix_engine_info[1]])
