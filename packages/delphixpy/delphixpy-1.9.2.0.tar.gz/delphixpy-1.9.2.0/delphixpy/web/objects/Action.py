...
class Action(PersistentObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.PersistentObject` *)* Represents an
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._origin_ip[0] is not None and obj._origin_ip[0] is not obj.__undef__:
            assert isinstance(obj._origin_ip[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._origin_ip[0]))
    ...
    def to_dict(self, dirty=False):
        ...
        if "origin_ip" == "type" or (self.origin_ip is not self.__undef__ and not (dirty and not self._origin_ip[1])):
    ...
    def is_dirty(self):
        return any([self._details[1], self._state[1], self._origin_ip[1], self._title[1], self._failure_message_code[1], self._failure_description[1], self._parent_action[1], self._action_type[1], self._user[1], self._start_time[1], self._report[1], self._user_agent[1], self._work_source[1], self._end_time[1], self._failure_action[1], self._work_source_name[1]])
