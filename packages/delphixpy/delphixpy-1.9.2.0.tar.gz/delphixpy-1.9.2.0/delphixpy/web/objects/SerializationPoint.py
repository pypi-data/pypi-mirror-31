...
class SerializationPoint(UserObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.UserObject` *)* A serialization
    point represents the data and metadata associated with a replication spec
    at a point in time.
    """
    ...
    def is_dirty(self):
        return any([self._elapsed_time_nanos[1], self._tag[1], self._data_timestamp[1], self._average_throughput[1], self._bytes_transferred[1]])
