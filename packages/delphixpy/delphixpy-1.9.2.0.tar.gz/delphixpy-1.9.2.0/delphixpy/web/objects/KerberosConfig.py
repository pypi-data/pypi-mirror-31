...
class KerberosConfig(UserObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.UserObject` *)* Kerberos Client
    Configuration.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._realm[0] is not None and obj._realm[0] is not obj.__undef__:
            assert isinstance(obj._realm[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._realm[0]))
        ...
        if obj._keytab[0] is not None and obj._keytab[0] is not obj.__undef__:
            assert isinstance(obj._keytab[0], basestring), ("Expected one of [u'string'], but got %s" % type(obj._keytab[0]))
    ...
    def to_dict(self, dirty=False):
        dct = super(KerberosConfig, self).to_dict(dirty)
        ...
        def dictify(obj):
            if isinstance(obj, list):
                ...
                return obj
        if "realm" == "type" or (self.realm is not self.__undef__ and not (dirty and not self._realm[1])):
            dct["realm"] = dictify(self.realm)
        if "kdcs" == "type" or (self.kdcs is not self.__undef__ and not (dirty and not self._kdcs[1])):
            dct["kdcs"] = dictify(self.kdcs)
        if "keytab" == "type" or (self.keytab is not self.__undef__ and not (dirty and not self._keytab[1])):
    ...
    def is_dirty(self):
        return any([self._realm[1], self._kdcs[1], self._keytab[1], self._enabled[1], self._principal[1]])
    ...
    def kdcs(self):
        ...
        :rtype: ``list`` of :py:class:`delphixpy.web.vo.KerberosKDC`
        """
        return self._kdcs[0]
