...
class ChecklistItemDetail(ChecklistItem):
    """
    *(extends* :py:class:`delphixpy.web.vo.ChecklistItem` *)* Fields to
    indicate detailed status for a specific checklist item.
    """
    ...
    def is_dirty(self):
        return any([self._status[1], self._message[1], self._name[1], self._description[1]])
