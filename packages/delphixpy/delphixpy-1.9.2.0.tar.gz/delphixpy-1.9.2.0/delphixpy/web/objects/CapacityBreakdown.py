...
class CapacityBreakdown(TypedObject):
    """
    *(extends* :py:class:`delphixpy.web.vo.TypedObject` *)* Storage stats
    breakdown.
    """
    ...
    def from_dict(cls, data, dirty=False, undef_enabled=True):
        ...
        if obj._unowned_snapshot_space[0] is not None and obj._unowned_snapshot_space[0] is not obj.__undef__:
            assert isinstance(obj._unowned_snapshot_space[0], float), ("Expected one of [u'number'], but got %s" % type(obj._unowned_snapshot_space[0]))
    ...
    def is_dirty(self):
        return any([self._manual_space[1], self._unvirtualized_space[1], self._policy_space[1], self._active_space[1], self._log_space[1], self._unowned_snapshot_space[1], self._timeflow_unvirtualized_space[1], self._sync_space[1], self._descendant_space[1], self._actual_space[1]])
