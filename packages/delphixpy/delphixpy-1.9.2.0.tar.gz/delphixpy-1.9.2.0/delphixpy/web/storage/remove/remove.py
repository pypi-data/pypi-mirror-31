...
def get(engine):
    ...
    :rtype: :py:class:`delphixpy.web.vo.StorageDeviceRemovalStatus`
    """
    ...
    return response_validator.parse_result(result, undef_enabled=True, return_types=[u'StorageDeviceRemovalStatus'], returns_list=False, raw_result=raw_result)
