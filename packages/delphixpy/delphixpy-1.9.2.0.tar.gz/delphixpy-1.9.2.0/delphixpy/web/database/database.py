...
from delphixpy.web.database import performanceHistory
import urllib
...
def get(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.web.objects.Container.Container` object
    :type ref: ``str``
...
def get_all(engine, no_js_container_data_source=None, provision_container=None, group=None, no_js_data_source=None, valid_for_secure_replication=None):
    ...
    :rtype: ``list`` of :py:class:`delphixpy.web.vo.Container`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def update(engine, ref, container=None):
    ...
    :type container: :py:class:`delphixpy.web.vo.Container`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
    url = "/resources/json/delphix/database/%s" % ref
...
def delete(engine, ref, delete_parameters=None):
    ...
    :type delete_parameters: :py:class:`delphixpy.web.vo.DeleteParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def connection_info(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`delphixpy.web.vo.SourceConnectionInfo`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def rollback(engine, ref, rollback_parameters):
    ...
    :type rollback_parameters: :py:class:`delphixpy.web.vo.RollbackParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def add_live_source(engine, ref, add_live_source_parameters):
    ...
    :type add_live_source_parameters:
        :py:class:`delphixpy.web.vo.AddLiveSourceParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def add_live_source_defaults(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`delphixpy.web.vo.AddLiveSourceParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def create_transformation(engine, ref, create_transformation_parameters):
    ...
    :type create_transformation_parameters:
        :py:class:`delphixpy.web.vo.CreateTransformationParameters`
    :rtype: ``basestring``
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def sync(engine, ref, sync_parameters=None):
    ...
    :type sync_parameters: :py:class:`delphixpy.web.vo.SyncParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def request_xpp_download(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`delphixpy.web.vo.FileDownloadResult`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def switch_timeflow(engine, ref, switch_timeflow_parameters):
    ...
    :type switch_timeflow_parameters:
        :py:class:`delphixpy.web.vo.SwitchTimeflowParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def timeflow_snapshot_day_range(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: ``list`` of :py:class:`delphixpy.web.vo.TimeflowSnapshotDayRange`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def xpp_status(engine, ref):
    ...
    :param ref: Reference to a
        :py:class:`delphixpy.web.objects.Container.Container` object
    :type ref: ``str``
    :rtype: :py:class:`delphixpy.web.vo.XppStatus`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def attach_source(engine, ref, attach_source_parameters):
    ...
    :type attach_source_parameters:
        :py:class:`delphixpy.web.vo.AttachSourceParameters`
    :rtype: ``basestring``
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def detach_source(engine, ref, detach_source_parameters):
    ...
    :type detach_source_parameters:
        :py:class:`delphixpy.web.vo.DetachSourceParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def refresh(engine, ref, refresh_parameters):
    ...
    :type refresh_parameters: :py:class:`delphixpy.web.vo.RefreshParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def purge_logs(engine, ref, purge_logs_parameters):
    ...
    :type purge_logs_parameters:
        :py:class:`delphixpy.web.vo.PurgeLogsParameters`
    :rtype: :py:class:`delphixpy.web.vo.PurgeLogsResult`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def file_mapping(engine, file_mapping_parameters):
    ...
    :type file_mapping_parameters:
        :py:class:`delphixpy.web.vo.FileMappingParameters`
    :rtype: :py:class:`delphixpy.web.vo.FileMappingResult`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def create_empty(engine, empty_dataset_creation_parameters):
    ...
    :type empty_dataset_creation_parameters:
        :py:class:`delphixpy.web.vo.EmptyDatasetCreationParameters`
    :rtype: ``basestring``
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def oracle_supported_character_sets(engine):
    ...
    :param engine: The Delphix Engine
    :type engine: :py:class:`delphixpy.delphix_engine.DelphixEngine`
    :rtype: ``list`` of :py:class:`delphixpy.web.vo.OracleCharacterSet`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def export(engine, export_parameters):
    ...
    :type export_parameters: :py:class:`delphixpy.web.vo.ExportParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def validate_xpp(engine, timeflow_point_parameters):
    ...
    :type timeflow_point_parameters:
        :py:class:`delphixpy.web.vo.TimeflowPointParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def link(engine, link_parameters):
    ...
    :type link_parameters: :py:class:`delphixpy.web.vo.LinkParameters`
    :rtype: ``basestring``
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def link_defaults(engine, config=None):
    ...
    :rtype: :py:class:`delphixpy.web.vo.LinkParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def batch_delete(engine, batch_container_delete_parameters):
    ...
    :type batch_container_delete_parameters:
        :py:class:`delphixpy.web.vo.BatchContainerDeleteParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def xpp(engine, oracle_provision_parameters):
    ...
    :type oracle_provision_parameters:
        :py:class:`delphixpy.web.vo.OracleProvisionParameters`
    :rtype: ``basestring``
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def xpp_defaults(engine, timeflow_point_parameters):
    ...
    :type timeflow_point_parameters:
        :py:class:`delphixpy.web.vo.TimeflowPointParameters`
    :rtype: :py:class:`delphixpy.web.vo.ProvisionParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def provision(engine, provision_parameters):
    ...
    :type provision_parameters:
        :py:class:`delphixpy.web.vo.ProvisionParameters`
    :rtype: ``basestring``
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
...
def batch_refresh(engine, batch_container_refresh_parameters):
    ...
    :type batch_container_refresh_parameters:
        :py:class:`delphixpy.web.vo.BatchContainerRefreshParameters`
    """
    assert API_VERSION == engine.API_VERSION, "Wrong API version (%s) for parameter 'engine' (%s)" % (API_VERSION, engine.API_VERSION)
