...
def get_all(engine):
    ...
    :rtype: ``list`` of :py:class:`delphixpy.web.vo.CurrentGroupCapacityData`
    """
    ...
    return response_validator.parse_result(result, undef_enabled=True, return_types=[u'CurrentGroupCapacityData'], returns_list=True, raw_result=raw_result)
