...
def get_all(engine, start_date=None, end_date=None, resolution=None):
    ...
    :type resolution: ``int``
    :rtype: ``list`` of
        :py:class:`delphixpy.web.vo.HistoricalSystemCapacityData`
    """
    ...
    return response_validator.parse_result(result, undef_enabled=True, return_types=[u'HistoricalSystemCapacityData'], returns_list=True, raw_result=raw_result)
