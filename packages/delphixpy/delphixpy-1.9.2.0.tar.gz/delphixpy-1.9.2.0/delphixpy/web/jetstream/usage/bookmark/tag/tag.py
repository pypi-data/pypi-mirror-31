...
def list_bookmark_tag_usage_data(engine, bookmark_tag=None):
    ...
    :type bookmark_tag: ``basestring``
    :rtype: ``list`` of :py:class:`delphixpy.web.vo.JSBookmarkTagUsageData`
    """
    ...
    return response_validator.parse_result(result, undef_enabled=True, return_types=[u'JSBookmarkTagUsageData'], returns_list=True, raw_result=raw_result)
