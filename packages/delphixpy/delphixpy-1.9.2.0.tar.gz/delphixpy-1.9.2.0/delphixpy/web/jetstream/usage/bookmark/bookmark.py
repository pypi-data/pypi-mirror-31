...
def list_bookmark_usage_data(engine, data_layout=None):
    ...
    :rtype: ``list`` of :py:class:`delphixpy.web.vo.JSBookmarkUsageData`
    """
    ...
    return response_validator.parse_result(result, undef_enabled=True, return_types=[u'JSBookmarkUsageData'], returns_list=True, raw_result=raw_result)
