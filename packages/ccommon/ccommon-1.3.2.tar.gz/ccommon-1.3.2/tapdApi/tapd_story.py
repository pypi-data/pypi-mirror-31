...
class TapdStorys(tapd.Tapd):
    ...
    def storyChange(self,workspace_id,story_id,creator=None,created=None,order=None,limit=None,page=None,fields=None):
        '''
    ...
    def listStory(self,workspace_id,id=None,name=None,creator=None,status=None,description=None,owner=None,cc=None,size=None,priority=None,created=None,begin=None,due=None,modified=None,iteration_id=None,developer=None,test_focus=None,type=None,source=None,version=None,category_id=None,business_value=None,limit=None,page=None,fields=None):
        '''
