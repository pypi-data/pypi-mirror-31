...
@click.option('--group_meth', '-gm',default='等距法', help='针对WOE编码：分组的方法，默认为“等距法”')
...
def featreng(**kwargs):
    ...
    file_ouput = kwargs['file_ouput']
    featureEngineer.featureEngineering(featureFile, labelFile, colF, colL, label, border, groupNum, groupMeth, file_ouput)
