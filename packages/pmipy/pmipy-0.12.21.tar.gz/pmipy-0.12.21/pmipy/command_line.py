...
@click.option('--lnglat', '-ll',multiple=True, default=('经度','纬度'), help='输入f1文件存放存放经度、纬度的列名，默认为“-l 经度 -l纬度”')
...
@click.option('--lnglat', '-l',multiple=True, default=('经度','纬度'), help='输入f文件存放经度、纬度的列名，默认为“-l 经度 -l纬度”')
