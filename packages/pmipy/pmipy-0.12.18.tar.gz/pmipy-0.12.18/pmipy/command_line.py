...
@click.option('--address', '-a', default=['地址'], help='输入描述性地址所在列的列名，多列请输入“-a column1 -a column2 ...”，\
...
@click.option('--lnglat', '-l',multiple=True, default=['经度','纬度'], help='输入f文件存放经纬度的列名，默认为“-l 经度 -l纬度”')
