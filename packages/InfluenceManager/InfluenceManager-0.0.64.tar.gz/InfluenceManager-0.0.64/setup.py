...
setup(
    ...
    scripts=["InfluenceManager/bin/topic_query", "InfluenceManager/bin/log_daily_scores"],
    install_requires=["pymongo", "nltk", "twython", "matplotlib", "wordcloud", "networkx", "scipy"]
)
