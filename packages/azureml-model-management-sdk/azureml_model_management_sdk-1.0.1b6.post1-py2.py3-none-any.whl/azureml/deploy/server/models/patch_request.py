...
class PatchRequest(object):
    ...
    def __init__(self, snapshot_id=None, code=None, description=None, operation_id=None, input_parameter_definitions=None, output_parameter_definitions=None, runtime_type=None, init_code=None, output_file_names=None):
        ...
        self.swagger_types = {
            ...
            'output_parameter_definitions': 'list[ServicesInputParameterDefinitions]',
            'runtime_type': 'str',
            'init_code': 'str',
    ...
    def snapshot_id(self):
        """
        Gets the snapshot_id of this PatchRequest.
        ID of the snapshot to be used for service. **Optional**

        :return: The snapshot_id of this PatchRequest.
        :rtype: str
        """
    ...
    def snapshot_id(self, snapshot_id):
        """
        Sets the snapshot_id of this PatchRequest.
        ID of the snapshot to be used for service. **Optional**

        :param snapshot_id: The snapshot_id of this PatchRequest.
        :type: str
        """
    ...
    def code(self, code):
        """
        Sets the code of this PatchRequest.
        Code to execute. Specific to the runtime type. **<font color = 'red'>Required</font>**

        :param code: The code of this PatchRequest.
        :type: str
        """
    ...
    def description(self):
        """
        Gets the description of this PatchRequest.
        Description for the web service. **Optional**

        :return: The description of this PatchRequest.
        :rtype: str
        """
    ...
    def description(self, description):
        """
        Sets the description of this PatchRequest.
        Description for the web service. **Optional**

        :param description: The description of this PatchRequest.
        :type: str
        """
    ...
    def operation_id(self):
        """
        Gets the operation_id of this PatchRequest.
        Swagger operationId/alias for web service. **Optional**

        :return: The operation_id of this PatchRequest.
        :rtype: str
        """
    ...
    def operation_id(self, operation_id):
        """
        Sets the operation_id of this PatchRequest.
        Swagger operationId/alias for web service. **Optional**

        :param operation_id: The operation_id of this PatchRequest.
        :type: str
        """
    ...
    def input_parameter_definitions(self):
        """
        Gets the input_parameter_definitions of this PatchRequest.
        Input parameters definitions for the execution. **Optional**

        :return: The input_parameter_definitions of this PatchRequest.
    ...
    def input_parameter_definitions(self, input_parameter_definitions):
        """
        Sets the input_parameter_definitions of this PatchRequest.
        Input parameters definitions for the execution. **Optional**

        :param input_parameter_definitions: The input_parameter_definitions of this PatchRequest.
    ...
    def output_parameter_definitions(self):
        """
        Gets the output_parameter_definitions of this PatchRequest.
        Output parameter definitions for the execution. **Optional**

        :return: The output_parameter_definitions of this PatchRequest.
        :rtype: list[ServicesInputParameterDefinitions]
        """
    ...
    def output_parameter_definitions(self, output_parameter_definitions):
        """
        Sets the output_parameter_definitions of this PatchRequest.
        Output parameter definitions for the execution. **Optional**

        :param output_parameter_definitions: The output_parameter_definitions of this PatchRequest.
        :type: list[ServicesInputParameterDefinitions]
        """
    ...
    def runtime_type(self):
        """
        Gets the runtime_type of this PatchRequest.
        Type of the runtime. **Optional [Default R]**

        :return: The runtime_type of this PatchRequest.
        :rtype: str
        """
    ...
    def runtime_type(self, runtime_type):
        """
        Sets the runtime_type of this PatchRequest.
        Type of the runtime. **Optional [Default R]**

        :param runtime_type: The runtime_type of this PatchRequest.
        :type: str
        """
    ...
    def init_code(self):
        """
        Gets the init_code of this PatchRequest.
        Code that runs before each request. Specific to the runtime type. **Optional**

        :return: The init_code of this PatchRequest.
        :rtype: str
        """
    ...
    def init_code(self, init_code):
        """
        Sets the init_code of this PatchRequest.
        Code that runs before each request. Specific to the runtime type. **Optional**

        :param init_code: The init_code of this PatchRequest.
        :type: str
        """
    ...
    def output_file_names(self):
        """
        Gets the output_file_names of this PatchRequest.
        Files that are returned by the response. **Optional**

        :return: The output_file_names of this PatchRequest.
        :rtype: list[str]
        """
    ...
    def output_file_names(self, output_file_names):
        """
        Sets the output_file_names of this PatchRequest.
        Files that are returned by the response. **Optional**

        :param output_file_names: The output_file_names of this PatchRequest.
        :type: list[str]
        """
