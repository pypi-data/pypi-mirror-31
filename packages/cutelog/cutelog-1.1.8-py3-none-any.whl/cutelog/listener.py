...
from .config import CONFIG, MSGPACK_SUPPORT
...
class LogConnection(QThread):
    ...
    def __init__(self, parent, socketDescriptor, name, stop_signal, log):
        ...
        if MSGPACK_SUPPORT:
            ...
            self.serializers['msgpack'] = partial(msgpack.loads, raw=False)  # raw=False needed for UTF-8
        self.deserialize = self.serializers[CONFIG['default_serializer']]
