...
class ImageTrigger(TBase):
    ...
    def __init__(self, tagValue="image.tag", repoValue="image.repository", repoPrefixValue="image.prefix", track="Newest",):
...
class DeploymentTrigger(TBase):
    ...
    def __init__(self, github=None, image=None,):
        self.github = github
        self.image = image
...
class Release(TBase):
    ...
    def __init__(self, name=None, chart=None, valuesFile=None, values=None, trigger=None, triggers=None,):
        self.name = name
        self.chart = chart
...
class GkeProvider(TBase):
    ...
    def __init__(self, project=None, clusterName=None, zone=None,):
...
class Provider(TBase):
    ...
    def __init__(self, gke=None, minikube=None,):
        self.gke = gke
...
class KubeCDConfig(TBase):
    ...
    def __init__(self, clusters=None, environments=None, helmRepos=None,):
...
ImageTrigger.thrift_spec = (
    ...
    (4, TType.STRING, 'track', 'UTF8', "Newest", ),  # 4
)
all_structs.append(DeploymentTrigger)
DeploymentTrigger.thrift_spec = (
    None,  # 0
    (1, TType.STRUCT, 'github', [GithubTrigger, None], None, ),  # 1
    (2, TType.STRUCT, 'image', [ImageTrigger, None], None, ),  # 2
)
...
Release.thrift_spec = (
    ...
    (5, TType.STRUCT, 'trigger', [DeploymentTrigger, None], None, ),  # 5
    (6, TType.LIST, 'triggers', (TType.STRUCT, [DeploymentTrigger, None], False), None, ),  # 6
)
