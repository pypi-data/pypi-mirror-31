...
#   to Picwin32.dll and Ganessa_SIM.dll (resp. Ganessa_TH.dll) kernels. 
...
#   * "Gfi Progiciels/Piccolo6_<lang>[_ck]/Picwin32.dll" or 
#   * "Gfi Progiciels/Picalor6_<lang>[_ck]/Picwin32.dll" or 
