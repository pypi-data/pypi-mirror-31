  ...
  if not _ctx.executing_eagerly():
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._handle, _ctx.device_name, "BipartiteMatch", name,
        _ctx._post_execution_callbacks, distance_mat, num_valid_rows, "top_k",
        top_k)
      _result = _BipartiteMatchOutput._make(_result)
      return _result
    except _core._FallbackException:
      return bipartite_match_eager_fallback(
          distance_mat, num_valid_rows, top_k=top_k, name=name)
...
def bipartite_match_eager_fallback(distance_mat, num_valid_rows, top_k=-1, name=None):
...
def image_connected_components(image, name=None):
  ...
  if not _ctx.executing_eagerly():
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._handle, _ctx.device_name, "ImageConnectedComponents", name,
        _ctx._post_execution_callbacks, image)
      return _result
    except _core._FallbackException:
...
def image_connected_components_eager_fallback(image, name=None):
  r"""This is the slowpath function for Eager mode.
...
def image_projective_transform(images, transforms, interpolation, name=None):
  ...
  if not _ctx.executing_eagerly():
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._handle, _ctx.device_name, "ImageProjectiveTransform", name,
        _ctx._post_execution_callbacks, images, transforms, "interpolation",
        interpolation)
      return _result
    except _core._FallbackException:
...
def image_projective_transform_eager_fallback(images, transforms, interpolation, name=None):
  r"""This is the slowpath function for Eager mode.
