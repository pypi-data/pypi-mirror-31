...
@tf_export('hyperplane_lsh_probes')
  ...
  if not _ctx.executing_eagerly():
    ...
    try:
      _result = _pywrap_tensorflow.TFE_Py_FastPathExecute(
        _ctx._handle, _ctx.device_name, "HyperplaneLSHProbes", name,
        _ctx._post_execution_callbacks, point_hyperplane_product, num_tables,
        num_hyperplanes_per_table, num_probes)
      _result = _HyperplaneLSHProbesOutput._make(_result)
      return _result
    except _core._FallbackException:
      return hyperplane_lsh_probes_eager_fallback(
          point_hyperplane_product, num_tables, num_hyperplanes_per_table,
          num_probes, name=name)
...
def hyperplane_lsh_probes_eager_fallback(point_hyperplane_product, num_tables, num_hyperplanes_per_table, num_probes, name=None):
  r"""This is the slowpath function for Eager mode.
  This is for function hyperplane_lsh_probes
  """
  _ctx = _context.context()
