...
try:
    ...
    import ifupdown2.backend.nlmanager.nlpacket

    from ifupdown2.backend.nlmanager.nlmanager import Link, Address, Route, NetlinkPacket

    from ifupdown2.backend.cache import *
    from ifupdown2.backend.utilsbase import utilsBase
...
class Netlink(utilsBase):
    ...
    def __init__(self, *args, **kargs):
        ...
        try:
            ...
            from ifupdown2.backend.nlmanager.nlmanager import NetlinkManager
            ...
            ifupdown2.backend.nlmanager.nlpacket.mac_int_to_str = self.mac_int_to_str
