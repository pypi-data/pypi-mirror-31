...
try:
    ...
    import ifupdown2.backend.policymanager
    import ifupdown2.backend.ifupdownflags

    import ifupdown2.backend.cache
    import ifupdown2.backend.mstpctlutil
    import ifupdown2.backend.LinkUtils

    import ifupdown2.backend.statemanager as statemanager
    import ifupdown2.backend.ifupdownflags as ifupdownflags
    import ifupdown2.backend.ifupdownconfig as ifupdownConfig

    from ifupdown2.core.graph import *
    from ifupdown2.backend.iface import *
    from ifupdown2.core.scheduler import *
    from ifupdown2.backend.exceptions import *
    from ifupdown2.core.networkinterfaces import *
...
class ifupdownMain(ifupdownBase):
    ...
    addon_modules_dir = ifupdown2.__addon_modules_dir__
    addon_modules_configfile = ifupdown2.__addons_conf_path__
    ...
    def reset_ifupdown2(self):
        ...
        ifupdown2.backend.statemanager.reset()
        ifupdown2.backend.policymanager.reset()
        ifupdown2.backend.ifupdownflags.reset()
        ifupdown2.backend.ifupdownconfig.reset()
        ifupdown2.backend.mstpctlutil.mstpctlutil.reset()
        ifupdown2.backend.LinkUtils.LinkUtils.reset()

        ifupdown2.backend.cache.linkCache.reset()
        ifupdown2.backend.cache.MSTPAttrsCache.invalidate()
