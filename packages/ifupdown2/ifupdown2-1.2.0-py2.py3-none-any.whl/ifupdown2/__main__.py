...
def ifupdown2_standalone():
    import ifupdown2.core.main
    ifupdown2 = ifupdown2.core.main.Ifupdown2(daemon=False, uid=os.geteuid())
...
def main():
    try:
        if 'use_daemon=yes' in open(ifupdown2.__ifupdown2_conf_path__).read():
