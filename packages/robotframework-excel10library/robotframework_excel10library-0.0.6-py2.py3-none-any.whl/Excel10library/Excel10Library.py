...
class Excel10Library:
    ...
    def open_excel_current_directory(self, filename):
        ...
        Arguments:
                |  File Name (string)  | The file name string value that represents the excel file.  |
        Example:

        | *Keywords*           |  *Parameters*         |
        | Open Excel           |  ExcelRobotTest.xlsx  |
    ...
    def get_column_count(self, sheetname, scanmaxrows=150):
        ...
        Note: setting the scanmaxrows to a high number may result in a very slow functioning keyword and may cause time-outs.
    ...
    def get_row_count(self, sheetname, scanmaxcolumns = 100):
        ...
        Note: setting the scanmaxcolumns to a high number may result in a very slow functioning keyword and may cause time-outs.
    ...
    def get_column_values(self, sheetname, column, includeEmptyCells=True):
        ...
        | *Keywords*           |  *Parameters*                                          |
        | Open Excel           |  C:\\Python27\\ExcelRobotTest\\ExcelRobotTest.xlsx |   |
        | Get Column Values    |  TestSheet1                                        | 1 |
    ...
    def check_cell_type(self, sheetname, column, row):
        ...
        | *Keywords*           |  *Parameters*                                              |
        | Open Excel           |  C:\\Python27\\ExcelRobotTest\\ExcelRobotTest.xlsx |   |   |
        | Check Cell Type      |  TestSheet1                                        | 1 | 1 |
...
#            print "The cell value has an error"
    ...
    def put_value_to_cell(self, sheetname, column, row, value):
        ...
        | *Keywords*           |  *Parameters*                                                          |
        | Open Excel           |  C:\\Python27\\ExcelRobotTest\\ExcelRobotTest.xlsx  |     |     |      |
        | Put Value To Cell    |  TestSheet1                                         |  1  |  1  |  34  |
        """
        sheet = self.wb.sheets[sheetname]
        #import pdb, sys
        #pdb.Pdb(stdout=sys.__stdout__).set_trace()
    ...
    def put_number_to_cell(self, sheetname, column, row, value):
        ...
        | *Keywords*           |  *Parameters*                                                         |
        | Open Excel           |  C:\\Python27\\ExcelRobotTest\\ExcelRobotTest.xlsx |     |     |      |
        | Put Number To Cell   |  TestSheet1                                        |  1  |  1  |  34  |
    ...
    def put_string_to_cell(self, sheetname, column, row, value):
        ...
        | *Keywords*           |  *Parameters*                                                           |
        | Open Excel           |  C:\\Python27\\ExcelRobotTest\\ExcelRobotTest.xlsxx |     |     |        |
        | Put String To Cell   |  TestSheet1                                         |  1  |  1  |  Hello |
    ...
    def put_date_to_cell(self, sheetname, column, row, value, informat='%d-%m-%Y'):
        ...
        | *Keywords*           |  *Parameters*                                                               |
        | Open Excel           |  C:\\Python27\\ExcelRobotTest\\ExcelRobotTest.xlsx |     |     |            |
        | Put Date To Cell     |  TestSheet1                                        |  1  |  1  |  12-3-1999 |
    ...
    def modify_cell_with(self, sheetname, column, row, op, val):
        ...
        | *Keywords*           |  *Parameters*                                                               |
        | Open Excel           |  C:\\Python27\\ExcelRobotTest\\ExcelRobotTest.xlsx |     |     |     |      |
        | Modify Cell With     |  TestSheet1                                        |  1  |  1  |  *  |  56  |
    ...
    def subtract_from_date(self, sheetname, column, row, numdays):
        ...
        | *Keywords*           |  *Parameters*                                                        |
        | Open Excel           |  C:\\Python27\\ExcelRobotTest\\ExcelRobotTest.xlsx |     |     |     |
        | Subtract From Date   |  TestSheet1                                        |  1  |  1  |  7  |
    ...
    def save_excel(self, filename, useTempDir=False):
        ...
        | *Keywords*           |  *Parameters*                                       |
        | Open Excel           |  C:\\Python27\\ExcelRobotTest\\ExcelRobotTest.xlsx  |
        | Save Excel           |  NewExcelRobotTest.xlsx                             |
