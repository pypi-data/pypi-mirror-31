...
class DynamicProperty(property):
    ...
    def __get__(self, obj, type_=None):
        ...
        if (is_exec_env and obj.is_loaded()) or (not is_exec_env and not obj.is_persistent()):
            ...
            return getRuntime().execute_implementation_aux(DCLAY_GETTER_PREFIX + self.p_name, obj, ())
    ...
    def __set__(self, obj, value):
        ...
        if (is_exec_env and obj.is_loaded()) or (not is_exec_env and not obj.is_persistent()): 
            ...
            getRuntime().execute_implementation_aux(DCLAY_SETTER_PREFIX + self.p_name, obj, (value,))
