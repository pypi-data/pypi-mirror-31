	...
	def run(self,args,io = None):
		...
		try:
			...
			if (cmd1 == "git"):
				...
				if (pos27 < 0):
					pos27 = 0
				res27 = args[pos27:(pos27 + len)]
				del args[pos27:(pos27 + len)]
				types = res27
			...
			if git:
				...
				if (pos28 < 0):
					pos28 = 0
				res28 = args[pos28:(pos28 + ct)]
				del args[pos28:(pos28 + ct)]
				git_args = res28
				...
				if (pos29 < 0):
					pos29 = 0
				res29 = args[pos29:(pos29 + len1)]
				del args[pos29:(pos29 + len1)]
				res29
				offset = 0
	...
	def show(t):
		...
		while ((_g < h)):
			...
			while ((_g1 < w)):
				...
				txt = (HxOverrides.stringOrNull(txt) + " ")
			txt = (HxOverrides.stringOrNull(txt) + "\n")
		haxe_Log.trace(txt,_hx_AnonObject({'fileName': "Coopy.hx", 'lineNumber': 1157, 'className': "Coopy", 'methodName': "show"}))
