...
setup(
    ...
    url='https://github.com/david-pettifor-nd/easy-google-docs',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='David W Pettifor',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='David.W.Pettifor.1@nd.edu',  # Optional
    ...
    keywords='google api sheets docs',  # Optional
    ...
    install_requires=['google-api-python-client', 'xlrd', 'webbrowser'],  # Optional
