...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBool, TypeInputNotifyPeer, TypeReportReason, TypeAccountDaysTTL, TypeInputPeerNotifySettings, TypeInputPrivacyRule, TypeInputPrivacyKey, TypeInputPeer
