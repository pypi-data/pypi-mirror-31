...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputSingleMedia, TypeSendMessageAction, TypeMessagesFilter, TypeInputBotInlineResult, TypeInputEncryptedFile, TypeInputPeer, TypeBool, TypeReportReason, TypeInputChatPhoto, TypeMessageEntity, TypeInputDialogPeer, TypeInputDocument, TypeReplyMarkup, TypeInputMessage, TypeInputUser, TypeInputStickeredMedia, TypeInputBotInlineMessageID, TypeShippingOption, TypeInputStickerSet, TypeInputEncryptedChat, TypeInlineBotSwitchPM, TypeInputMedia, TypeInputGeoPoint
...
class EditInlineBotMessageRequest(TLObject):
    ...
    def from_reader(cls, reader):
        ...
        if flags & 8192:
            ...
            _geo_point = None
        return cls(id=_id, no_webpage=_no_webpage, stop_geo_live=_stop_geo_live, message=_message, reply_markup=_reply_markup, entities=_entities, geo_point=_geo_point)
...
class EditMessageRequest(TLObject):
    ...
    def from_reader(cls, reader):
        ...
        if flags & 8192:
            ...
            _geo_point = None
        return cls(peer=_peer, id=_id, no_webpage=_no_webpage, stop_geo_live=_stop_geo_live, message=_message, reply_markup=_reply_markup, entities=_entities, geo_point=_geo_point)
...
class GetDialogsRequest(TLObject):
    ...
    def from_reader(cls, reader):
        ...
        _limit = reader.read_int()
        return cls(offset_date=_offset_date, offset_id=_offset_id, offset_peer=_offset_peer, limit=_limit, exclude_pinned=_exclude_pinned)
...
class GetMessagesRequest(TLObject):
    ...
    def resolve(self, client, utils):
        self.id = [utils.get_input_message(_x) for _x in self.id]
...
class GetMessagesViewsRequest(TLObject):
    ...
    def on_response(self, reader):
        ...
        self.result = [reader.read_int() for _ in range(reader.read_int())]
...
class GetPeerDialogsRequest(TLObject):
    ...
    def resolve(self, client, utils):
        self.peers = [utils.get_input_dialog(client.get_input_entity(_x)) for _x in self.peers]
...
class GetStickersRequest(TLObject):
    ...
    def from_reader(cls, reader):
        ...
        _hash = reader.tgread_string()
        return cls(emoticon=_emoticon, hash=_hash, exclude_featured=_exclude_featured)
...
class ReceivedQueueRequest(TLObject):
    ...
    def on_response(self, reader):
        reader.read_int()  # Vector ID
        self.result = [reader.read_long() for _ in range(reader.read_int())]
...
class ReorderPinnedDialogsRequest(TLObject):
    ...
    def resolve(self, client, utils):
        self.order = [utils.get_input_dialog(client.get_input_entity(_x)) for _x in self.order]
...
class SearchStickerSetsRequest(TLObject):
...
class ToggleDialogPinRequest(TLObject):
    ...
    def resolve(self, client, utils):
        self.peer = utils.get_input_dialog(client.get_input_entity(self.peer))
