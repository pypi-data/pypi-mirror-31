...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputUser, TypeInputStickerSet, TypeInputChannel, TypeChannelParticipantsFilter, TypeChannelAdminLogEventsFilter, TypeBool, TypeInputChatPhoto, TypeChannelBannedRights, TypeInputMessage, TypeChannelAdminRights
