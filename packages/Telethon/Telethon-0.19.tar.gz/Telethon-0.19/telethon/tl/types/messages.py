...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeEncryptedFile, TypeChat, TypeInlineBotSwitchPM, TypeHighScore, TypeStickerPack, TypeMessage, TypeDocument, TypeDialog, TypeStickerSet, TypeStickerSetCovered, TypeFoundGif, TypeChatFull, TypeBotInlineResult, TypeUser
