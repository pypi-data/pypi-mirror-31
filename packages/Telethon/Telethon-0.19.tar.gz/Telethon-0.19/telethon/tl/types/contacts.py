...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactLink, TypePeer, TypeChat, TypeContact, TypeImportedContact, TypeContactBlocked, TypeTopPeerCategoryPeers, TypePopularContact, TypeUser
