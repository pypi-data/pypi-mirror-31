...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputStickerSet, TypeInputUser, TypeChannelAdminRights, TypeInputChatPhoto, TypeInputChannel, TypeInputMessage, TypeChannelParticipantsFilter, TypeBool, TypeChannelAdminLogEventsFilter, TypeChannelBannedRights
