...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeReplyMarkup, TypeReportReason, TypeInputBotInlineResult, TypeInlineBotSwitchPM, TypeInputPeer, TypeInputDialogPeer, TypeShippingOption, TypeInputEncryptedChat, TypeInputChatPhoto, TypeInputStickerSet, TypeSendMessageAction, TypeInputMessage, TypeBool, TypeInputEncryptedFile, TypeInputBotInlineMessageID, TypeInputGeoPoint, TypeInputMedia, TypeInputUser, TypeInputSingleMedia, TypeMessageEntity, TypeInputStickeredMedia, TypeInputDocument, TypeMessagesFilter
