...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPrivacyKey, TypeReportReason, TypeInputPeer, TypeInputNotifyPeer, TypeInputPrivacyRule, TypeBool, TypeInputPeerNotifySettings, TypeAccountDaysTTL
