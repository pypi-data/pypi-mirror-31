...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactLink, TypeChat, TypeTopPeerCategoryPeers, TypePopularContact, TypePeer, TypeImportedContact, TypeContactBlocked, TypeUser, TypeContact
