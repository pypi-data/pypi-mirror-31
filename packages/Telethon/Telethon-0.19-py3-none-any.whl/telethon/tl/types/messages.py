...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBotInlineResult, TypeInlineBotSwitchPM, TypeMessage, TypeChat, TypeStickerSetCovered, TypeDialog, TypeEncryptedFile, TypeStickerPack, TypeUser, TypeFoundGif, TypeChatFull, TypeStickerSet, TypeDocument, TypeHighScore
