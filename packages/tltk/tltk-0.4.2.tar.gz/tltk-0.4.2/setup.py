...
setup(
    ...
    #url='https://github.com/cunlp/cunlp',
...
#    install_requires=['nltk', 'pickle'],
  ...
  #  },
    ...
    package_data={
        'tltk': ['sylrule.lts', 'thaisyl.dict', 'sylseg.3g', 'thdict', 'BEST.dict','tnc-tagger.pick', 'sent_segment_rfs.pick', 'ner-tagger.pick'],
    },
