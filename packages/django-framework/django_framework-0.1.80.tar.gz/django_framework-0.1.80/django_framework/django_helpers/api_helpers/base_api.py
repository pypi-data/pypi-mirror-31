...
try:
    ...
    print('There was an issue setting the Default Show Number, it has been reverted to default.', e)
    DEFAULT_SHOW_NUMBER = 10
    
try:
    DEFAULT_PAGE_NUMBER = int(settings.DEFAULT_PAGE_NUMBER)
except Exception as e:
    print('There was an issue setting the Default Page Number, it has been reverted to default.', e)
    DEFAULT_PAGE_NUMBER = 1

try:
    DEFAULT_FORMAT = settings.DEFAULT_FORMAT
except Exception as e:
    print('There was an issue setting the Default API format - typically json, it has been reverted to default.', e)
    DEFAULT_FORMAT = 'json'
