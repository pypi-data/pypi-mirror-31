...
class BaseManagerGet(object):
    ...
    LIST_TYPE_FILTERS = ["distinct", "order_by", "q_or", "select_related", "prefetch_related"]
...
#         cls.set_distinct_params(query_params)  # we are not allowed to distinct using mysql
        ...
        for allowed_query_param in ["q_or", "filter", "exclude", "distinct", "order_by","prefetch_related", "select_related", "custom"]: # this needs to be ordered to run specifically in this way!
