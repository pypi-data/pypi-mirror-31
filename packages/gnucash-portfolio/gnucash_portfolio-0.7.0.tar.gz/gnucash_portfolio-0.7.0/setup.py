...
setup(
    ...
    name='gnucash_portfolio',  # Required
    ...
    description='Portfolio tools for GnuCash',  # Required
    ...
    url='https://github.com/MisterY/gnucash-portfolio',  # Optional
    ...
    keywords='personal finance gnucash portfolio tools',  # Optional
