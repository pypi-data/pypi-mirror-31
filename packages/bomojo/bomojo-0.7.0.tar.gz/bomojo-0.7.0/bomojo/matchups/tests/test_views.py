...
from bomojo.matchups.tests.helpers import create_movie
...
class CreateTestCase(TestCase):
    ...
    def setUpClass(cls):
        ...
        create_movie('Foo')
        create_movie('Foo 2', external_id='foo2')
        create_movie('Foo 3', external_id='foo3')
        create_movie('Bar')
...
class ListTestCase(TestCase):
    ...
    def test_my_matchups(self):
        ...
        with freeze_time('2018-04-30 06:47:01'):
            bob.matchups.create(title='foo trilogy',
                                description='all three foo movies',
                                movies=['foo1', 'foo2', 'foo3'],
                                period='30d',
                                featured=True)
        ...
        alice.matchups.create(title='bar vs baz',
                              description='matchup between bar and baz',
                              movies=['bar', 'baz'],
                              period='30d',
                              featured=True)
