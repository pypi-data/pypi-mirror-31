...
class ProductRegressor(Serializable):
    ...
    def fit(self, xs, ys):
        for regressor, split_ys in izip(self.regressors, self._split_ys(ys)):
    ...
    def set_param_values(self, flattened_params, **tags):
        ...
        for regressor, split_param_values in izip(self.regressors, np.split(flattened_params, split_ids)):
