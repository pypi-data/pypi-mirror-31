...
class PygameDraw(b2DrawExtended):
    ...
    def DrawSegment(self, p1, p2, color):
        ...
        """
        pygame.draw.aaline(self.surface, color.str, p1, p2)
    ...
    def DrawCircle(self, center, radius, color, drawwidth=1):
        ...
        pygame.draw.circle(self.surface, color.str,
    ...
    def DrawSolidCircle(self, center, radius, axis, color):
        ...
        pygame.draw.circle(
            self.surface,
            (color / 2).str + [127], center, radius, 0)
        pygame.draw.circle(
            self.surface,
            color.str, center, radius, 1)
    ...
    def DrawPolygon(self, vertices, color):
        ...
        if len(vertices) == 2:
            pygame.draw.aaline(self.surface, color.str,
                               vertices[0], vertices)
        else:
            pygame.draw.polygon(self.surface, color.str, vertices, 1)
    ...
    def DrawSolidPolygon(self, vertices, color):
        ...
        if len(vertices) == 2:
            ...
            pygame.draw.polygon(
                self.surface, (color / 2).str + [127], vertices, 0)
            pygame.draw.polygon(self.surface, color.str, vertices, 1)
...
#                 self.DrawStringAt = lambda *args: 0
    ...
    viewZoom = property(lambda self: self._viewZoom, setZoom,
                        doc=u'Zoom factor for the display')
    viewCenter = property(lambda self: self._viewCenter / self._viewZoom,
                          setCenter, doc=u'Screen center in camera coordinates')
    viewOffset = property(lambda self: self._viewOffset,
                          doc=u'The offset of the top-left corner of the '
                              u'screen')
