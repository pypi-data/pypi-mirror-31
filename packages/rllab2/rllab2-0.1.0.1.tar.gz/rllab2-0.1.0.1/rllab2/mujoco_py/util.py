...
class UserString(object):
    def __init__(self, seq):
        if isinstance(seq, basestring):
            ...
            self.data = unicode(seq)
    def __str__(self): return unicode(self.data)
    ...
    def __add__(self, other):
        if isinstance(other, UserString):
            ...
            return self.__class__(self.data + unicode(other))
    def __radd__(self, other):
        if isinstance(other, basestring):
            return self.__class__(other + self.data)
        else:
            return self.__class__(unicode(other) + self.data)
    def __mul__(self, n):
...
class MutableString(UserString):
    ...
    def __init__(self, string=u""):
        self.data = string
    def __hash__(self):
        raise TypeError(u"unhashable type (it is mutable)")
    ...
    def __setslice__(self, start, end, sub):
        ...
        if isinstance(sub, UserString):
            ...
            self.data =  self.data[:start]+unicode(sub)+self.data[end:]
...
class String(MutableString, Union):
    ...
    _fields_ = [(u'raw', POINTER(c_char)),
                (u'data', c_char_p)]

    def __init__(self, obj=u""):
        if isinstance(obj, six.text_type):
            self.data = obj.encode(u'ascii')
