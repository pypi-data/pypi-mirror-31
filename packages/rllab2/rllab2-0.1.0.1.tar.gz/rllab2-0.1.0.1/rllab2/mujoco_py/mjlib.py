...
if sys.platform.startswith(u"darwin"):
    libfile = osp.abspath(osp.join(osp.dirname(__file__),u"../../vendor/mujoco/libmujoco131.dylib"))
elif sys.platform.startswith(u"linux"):
    libfile = osp.abspath(osp.join(osp.dirname(__file__),u"../../vendor/mujoco/libmujoco131.so"))
elif sys.platform.startswith(u"win"):
    libfile = osp.abspath(osp.join(osp.dirname(__file__),u"../../vendor/mujoco/mujoco.lib"))
else:
