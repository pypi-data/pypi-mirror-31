...
setup(
    ...
    url='https://github.com/adimajo/glmdisc_python',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='Adrien Ehrhardt',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='adrien.ehrhardt@centraliens-lille.org',  # Optional
    ...
    keywords='discretization logistic regression levels grouping',  # Optional
