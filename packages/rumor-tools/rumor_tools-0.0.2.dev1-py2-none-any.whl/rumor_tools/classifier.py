...
class EmotionCause(object):
    ...
    def train(self, X_train, y_train, X_test, y_test):
        ...
        logger.info('Test accuracy: {0}'.format(acc))
...
if __name__ == '__main__':
    ...
    # PROJECT_PATH = "/home/maxen/Documents/Code/PycharmProjects/MyWeb/MyWeb/rumor_web/rumor"
    # EMOTION_CAUSE_MODEL = "data/emotion_causes/model_file/model.h5"
    #
    # word2vec_model = word2vec.Word2Vec.load("/home/maxen/Documents/Code/PycharmProjects/MyWeb/MyWeb/rumor_web/rumor/data/word2vec/zh/zh.bin")
    #
    # emotion_cause = EmotionCause(word2vec=word2vec_model)
    # X_train, y_train, X_test, y_test = emotion_cause.load_data(path="/home/maxen/Documents/Code/PycharmProjects/MyWeb/MyWeb/rumor_web/rumor/data/emotion_causes/HLTEmotionml.eml")
    #
    ...
    #     os.path.join(PROJECT_PATH, "data/emotion_causes/model_file/parameters.ec"),
