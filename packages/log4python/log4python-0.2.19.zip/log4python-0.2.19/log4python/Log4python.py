...
class log:
    ...
    def update_logger_config(self):
        ...
        for config_appender in self.config_appender_list:
            ...
            logType = str(config_appender['type']).upper()
            ...
            if logType == "FILE":
                ...
                if filename[0] == "/":
                    ...
                    log_path = dirname("%s/%s" % (self.basePath, filename))
    ...
    def critical(self, msg, *args, **kwargs):
        try:
            ...
            self.debugLog("critical:Module[%s]: %s" % (self.module_name, ex))
    ...
    def error(self, msg, *args, **kwargs):
        try:
            ...
            self.debugLog("error:Module[%s]: %s" % (self.module_name, ex))
    ...
    def warning(self, msg, *args, **kwargs):
        try:
            ...
            self.debugLog("warning:Module[%s]: %s" % (self.module_name, ex))
    ...
    def info(self, msg, *args, **kwargs):
        try:
            ...
            self.debugLog("info:Module[%s]: %s" % (self.module_name, ex))
    ...
    def debug(self, msg, *args, **kwargs):
        try:
            ...
            self.debugLog("debug:Module[%s]: %s" % (self.module_name, ex))
