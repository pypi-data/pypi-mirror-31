...
class log:
    ...
    def critical(self, msg, *args, **kwargs):
        try:
            ...
            self.debugLog("critical:Module[%s]: %s" % (self.logger.name, ex))
    ...
    def error(self, msg, *args, **kwargs):
        try:
            ...
            self.debugLog("error:Module[%s]: %s" % (self.logger.name, ex))
    ...
    def warning(self, msg, *args, **kwargs):
        try:
            ...
            self.debugLog("warning:Module[%s]: %s" % (self.logger.name, ex))
    ...
    def info(self, msg, *args, **kwargs):
        try:
            ...
            self.debugLog("info:Module[%s]: %s" % (self.logger.name, ex))
    ...
    def debug(self, msg, *args, **kwargs):
        try:
            ...
            self.debugLog("debug:Module[%s]: %s" % (self.logger.name, ex))
