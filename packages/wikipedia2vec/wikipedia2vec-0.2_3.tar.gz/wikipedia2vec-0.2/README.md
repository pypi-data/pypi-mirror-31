...
**English embeddings based on enwiki-20180420-pages-articles.xml.bz2:**

- *enwiki_20180420*: [100d (binary)](), [100d (word2vec)](), [300d (binary)](), [300d (word2vec)]()<br />
  (window: 5, iteration: 10, negative: 15, tokenizer: icu)
- *enwiki_20180420_win10*: [100d (binary)](), [100d (word2vec)](), [300d (binary)](), [300d (word2vec)]()<br />
  (window: 10, iteration: 10, negative: 15, tokenizer: icu)
- *enwiki_20180420_nolg*: [100d (binary)](), [100d (word2vec)](), [300d (binary)](), [300d (word2vec)]()<br />
  (no link graph model, window: 5, iteration: 10, negative: 15, tokenizer: icu)

The embedding files in the word2vec's format can be loaded from other libraries such as Gensim's [`load_word2vec_format()`](https://radimrehurek.com/gensim/models/keyedvectors.html#gensim.models.keyedvectors.Word2VecKeyedVectors.load_word2vec_format) function.
