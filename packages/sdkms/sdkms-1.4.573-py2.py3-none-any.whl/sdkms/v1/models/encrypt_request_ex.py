...
class EncryptRequestEx(object):
    ...
    def ad(self):
        ...
        For symmetric ciphers with cipher mode GCM or CCM, this is the authentication data used by the cipher. If not provided, SDKMS will generate random authentication data and return it with the response. 
