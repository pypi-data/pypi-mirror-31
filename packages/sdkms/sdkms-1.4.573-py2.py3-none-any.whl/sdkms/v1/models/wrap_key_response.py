...
class WrapKeyResponse(object):
    ...
    def tag(self):
        ...
        For symmetric ciphers with cipher mode GCM or CCM, the authentication data produced by the cipher. Its length will match the tag length specified by the encryption request. 
