...
*ProvDmApi* | [**store_relation**](docs/ProvDmApi.md#store_relation) | **POST** /provdm/graphs/{resource}/links | Store a relation between PROV DM tokens
