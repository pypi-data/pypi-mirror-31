...
setup(
    ...
    description='A middleware dispatcher for Flask based on \
            werkzeug.wsgi.DispatcherMiddleware.',
    long_description=long_description,

    # The project's main homepage (@@ add github url once public)
    url='https://git.getme.co.uk/manhattan/manhattan_dispatch',
    ...
    packages=find_packages('manhattan_dispatch'),
    package_dir={'': 'manhattan_dispatch'},
