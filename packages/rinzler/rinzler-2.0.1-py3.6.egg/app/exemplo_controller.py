...
class ExemploController(TemplateView):
    """
    ...
    def connect(self, app: Rinzler) -> RouteMapping:
        ...
        router.delete("/{exemplo_id}/", self.atualizar_exemplo)
    ...
    def inserir_exemplo(self, request: HttpRequest, app: Rinzler, **params: dict):
        ...
        try:
            ...
            resultado = self.service\
                .set_payload(payload.decode())\
                .set_jwt(jwt_token)\
                .set_jwt_data(jwt_data['data'])\
                .set_exemplo()
    ...
    def atualizar_exemplo(self, request: HttpRequest, app: Rinzler, **params: dict):
        ...
        try:
            ...
            if resultado is not True:
                raise RuntimeError("Falha ao atualizar exemplo.")
    ...
    def deletar_exemplo(self, request: HttpRequest, app: Rinzler, **params: dict):
        ...
        try:
            ...
            if resultado is not True:
                raise RuntimeError("Falha ao remover exemplo.")
