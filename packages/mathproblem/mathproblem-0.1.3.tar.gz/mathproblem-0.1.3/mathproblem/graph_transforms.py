...
def generate_graph_transform_problem(level: int = 1) -> GraphTransformProblem:
    ...
    for i in range(level):
        ...
        if xform == 0 and graph_data.horiz_translation_mod is "":
            ...
            graph_data.add_vertical_translation()
        else:
            graph_data.add_vertical_stretch()

    problem = GraphTransformProblem()
    problem.prompt = "List all transformations: " + graph_data.get_prompt()
