...
class ApiClient(object):
    ...
    def __init__(self, apiKey=None, appSid=None, apiServer='https://api.aspose.cloud', configuration=None, header_name=None, header_value=None, cookie=None):
        
        if apiKey == None:
            raise Exception('You must pass an apiKey when instantiating the '
                            'APIClient')
        if appSid == None:
            raise Exception('You must pass an appSid when instantiating the '
                            'APIClient')
    ...
    def get_access_token(self):
        """
        Get Access Token for OAuth 2.O Authentication
        """
        params = locals()

        form_params = []
        form_params.append(('grant_type', 'client_credentials'))
        form_params.append(('client_id', self.appSid))
        form_params.append(('client_secret', self.apiKey))

        header_params = {}
        header_params['Accept'] = 'application/json'
        header_params['Content-Type'] = 'application/x-www-form-urlencoded'

        self.access_token_api_call = True
        access_token_response = self.call_api('/oauth2/token', 'POST',
                                        {},
                                        [],
                                        header_params,
                                        body=None,
        ...
        self.refresh_token = "{} {}".format(access_token_response.token_type, access_token_response.access_token)
        self.access_token_api_call = False 
