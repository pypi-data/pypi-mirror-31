...
class Auth0Middleware(AbstractBaseMiddleware):
    ...
    def __init__(self, auth_config: Dict[str, Union[str, Dict[str, str]]], claims_config: dict,
    ...
    def __process_claims(self, claims: dict) -> dict:
        """ Process claims returned by parsing the JWT Authorization based on
    ...
    def process_request(self, req: Request, resp: Response) -> NoReturn:
        ...
        _jwks = loads(_jwks_raw) if _jwks_raw is not None else {}
