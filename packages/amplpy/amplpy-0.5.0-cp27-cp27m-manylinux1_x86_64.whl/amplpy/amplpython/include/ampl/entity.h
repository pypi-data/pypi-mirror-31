...
* suffixes for that entities), use the function AMPL::getValues().
* <p>
...
public:
  ...
  */
  std::string name() const { return internal::AMPL_EntityBase_name(impl_); }
  ...
  * Entity::get() in order to access an instance of this entity.
  ...
  */
  std::size_t indexarity() const { return internal::AMPL_EntityBase_indexarity(impl_); }
  ...
  */
  bool isScalar() const { return (internal::AMPL_EntityBase_indexarity(impl_) == 0); }
...
public:
  ...
  */
  ...
  /**
  Get members of this %Set. Valid only for non indexed sets.
