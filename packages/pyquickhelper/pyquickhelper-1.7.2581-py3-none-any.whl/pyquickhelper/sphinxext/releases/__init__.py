...
def visit_Release(self, node):
    """
    `releases <https://github.com/bitprophet/releases>`_ sometimes fails if not present.
    """
    pass
...
def setup(app):
    ...
    app.add_node(Release,
                 html=(visit_Release, depart_Release),
                 latex=(visit_Release, depart_Release),
                 rst=(visit_Release, depart_Release),
                 text=(visit_Release, depart_Release))

    app.add_node(Issue,
                 html=(visit_Issue, depart_Issue),
                 latex=(visit_Issue, depart_Issue),
                 rst=(visit_Issue, depart_Issue),
                 text=(visit_Issue, depart_Issue))
