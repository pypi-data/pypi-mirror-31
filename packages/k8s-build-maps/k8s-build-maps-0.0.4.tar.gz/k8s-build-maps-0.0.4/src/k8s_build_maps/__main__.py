...
def main():
    ...
    for src_path, dirnames, basenames in os.walk(src_root, topdown=True):
        ...
        for basename in basenames:
            ...
            files_filename = os.path.join(src_path, files_dirname)
            ...
            file_basenames = [
                file_basename
                for file_basename in os.listdir(files_filename)
            ...
            for file_basename in file_basenames:
                file_filename = os.path.join(files_filename, file_basename)
            ...
            if dst_filename.endswith(".json"):
                json.dump(open(dst_filename, "w"), manifest)
            else:
