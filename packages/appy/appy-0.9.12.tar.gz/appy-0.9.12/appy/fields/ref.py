...
class Ref(Field):
       ...
       <div class="dropdownMenu inline"
        ...
        <x if="singleObject" var2="tied=menu.objects[0]; zt=tied.o">
         <x if="field.menuUrlMethod"
            var2="mUrl,mTarget=field.getMenuUrl(zobj,tied)">::zt.getListTitle(\
             target=mTarget, baseUrl=mUrl, css='dropdownMenu', \
         ...
         <x if="not field.menuUrlMethod"
            var2="linkInPopup=inPopup or (target.target != '_self');
                  baseUrl=zt.getUrl(nav='no',
                            inPopup=linkInPopup)">::zt.getListTitle(\
        ...
        <div id=":dropdownId" class="dropdown" style="width:150px">
         <div for="tied in menu.objects"
          ...
          <!-- A specific link may have to be computed from
               field.menuUrlMethod -->
          <x if="field.menuUrlMethod"
             var2="mUrl,mTarget=field.getMenuUrl(zobj, \
               tied)">::tied.o.getListTitle(target=mTarget, baseUrl=mUrl)</x>
    ...
    def __init__(self, klass=None, attribute=None, validator=None,
      ...
      filterable=True, supTitle=None, subTitle=None):
