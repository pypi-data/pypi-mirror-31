...
from ._version import git_pieces_from_vcs as _git_pieces_from_vcs
from ._version import run_command, register_vcs_handler
from ._version import render as _render
from ._version import render_pep440_auto
from ._version import render_pep440_micro, render_pep440_develop
from ._version import get_versions as _get_versions
from ._version import get_config, get_keywords
from ._version import git_versions_from_keywords, versions_from_parentdir
from ._version import NotThisMethod
