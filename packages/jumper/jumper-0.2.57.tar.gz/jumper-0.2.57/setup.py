...
files = ['LICENSE.txt', 'NOTICE.txt', 'hci/bsp.json', 'hci/program.bin', 'hci/instructions.so', 'stm32f4_default_board.json', 'nrf52_default_board.json', 'examples_hash_list.json']
