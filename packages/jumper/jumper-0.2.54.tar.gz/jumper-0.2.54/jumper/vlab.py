...
from .jemu_vars import get_jemu_path, CORE_LINUX_OS, CORE_MAC_OS, CORE_WINDOWS_OS1, CORE_WINDOWS_OS2
...
class Vlab(object):
    ...
    def stop(self):
        ...
        if self._jemu_process and self._jemu_process.poll() is None:
            if self.SUDO and self._jemu_connection:
                self.SUDO.terminate()
            else:
    ...
    def _raise_jemu_process_for_failure(self):
        ...
        if jemu_exit_code is not None and jemu_exit_code != 0:
