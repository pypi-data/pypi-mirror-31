...
on 30 Apr 2018 11:56:28.  This interface was written by Ian Bell. 
...
class REFPROPInstance(object):
    ...
    def __init__(self, dll, managed_handle = None):
        ...
        self._ALLPROPS20dlloutput_tuple = namedtuple('ALLPROPS20dlloutput',["Output","hUnits","iUCodeArray","ierr","herr"])
        self._ALLPROPSdlloutput_tuple = namedtuple('ALLPROPSdlloutput',["Output","hUnits","iUCodeArray","ierr","herr"])
        ...
        self._REFPROP1dlloutput_tuple = namedtuple('REFPROP1dlloutput',["c","q","ierr","herr"])
        ...
        self._DPDDXdll = self._getfcn(self.dll, 'DPDDXdll')
        self._DPDTXdll = self._getfcn(self.dll, 'DPDTXdll')
    ...
    def ABFL2dll(self,a,b,z,kq,ksat,ab):
        ...
        return self._ABFL2dlloutput_tuple(Tbub.value,Tdew.value,Pbub.value,Pdew.value,Dlbub.value,Dvdew.value,list(ybub),list(xdew),T.value,P.value,Dl.value,Dv.value,list(x),list(y),q.value,ierr.value,trim(herr.raw))
    ...
    def ABFLSHdll(self,ab,a,b,z,iFlag):
        ...
        return self._ABFLSHdlloutput_tuple(T.value,P.value,D.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,h.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def ALLPROPS0dll(self,iIn,iOut,iFlag,T,D,z):
        ...
        return self._ALLPROPS0dlloutput_tuple(list(Output),ierr.value,trim(herr.raw))
    ...
    def ALLPROPS20dll(self,hOut,iUnits,iMass,iFlag,T,D,z):
        """
        Output,hUnits,iUCodeArray,ierr,herr = ALLPROPS20dll(hOut,iUnits,iMass,iFlag,T,D,z)
        """
        hOut = ct.create_string_buffer(hOut.encode('utf-8'),255)
        iUnits = ct.c_long(iUnits)
        iMass = ct.c_long(iMass)
        iFlag = ct.c_long(iFlag)
        T = ct.c_double(T)
        D = ct.c_double(D)
        z = (len(z)*ct.c_double)(*z)
        Output = (20*ct.c_double)()
        hUnits = ct.create_string_buffer(1000)
        iUCodeArray = (20*ct.c_long)()
        ierr = ct.c_long()
        herr = ct.create_string_buffer(255)

        if self._ALLPROPS20dll is None: raise ValueError("The function ALLPROPS20dll could not be loaded from the shared library.") 
        self._ALLPROPS20dll(hOut,ct.byref(iUnits),ct.byref(iMass),ct.byref(iFlag),ct.byref(T),ct.byref(D),z,Output,hUnits,iUCodeArray,ct.byref(ierr),herr,255,1000,255)

        return self._ALLPROPS20dlloutput_tuple(list(Output),trim(hUnits.raw),list(iUCodeArray),ierr.value,trim(herr.raw))

    def ALLPROPSdll(self,hOut,iUnits,iMass,iFlag,T,D,z):
        """
        Output,hUnits,iUCodeArray,ierr,herr = ALLPROPSdll(hOut,iUnits,iMass,iFlag,T,D,z)
        """
        ...
        z = (len(z)*ct.c_double)(*z)
        Output = (200*ct.c_double)()
        hUnits = ct.create_string_buffer(10000)
        iUCodeArray = (200*ct.c_long)()
        ierr = ct.c_long()
        herr = ct.create_string_buffer(255)

        if self._ALLPROPSdll is None: raise ValueError("The function ALLPROPSdll could not be loaded from the shared library.") 
        self._ALLPROPSdll(hOut,ct.byref(iUnits),ct.byref(iMass),ct.byref(iFlag),ct.byref(T),ct.byref(D),z,Output,hUnits,iUCodeArray,ct.byref(ierr),herr,10000,10000,255)

        return self._ALLPROPSdlloutput_tuple(list(Output),trim(hUnits.raw),list(iUCodeArray),ierr.value,trim(herr.raw))
    ...
    def CHEMPOTdll(self,T,D,z):
        ...
        return self._CHEMPOTdlloutput_tuple(list(u),ierr.value,trim(herr.raw))
    ...
    def DBFL2dll(self,D,b,z,kq,ab):
        ...
        return self._DBFL2dlloutput_tuple(T.value,P.value,Dl.value,Dv.value,list(x),list(y),q.value,ierr.value,trim(herr.raw))
    ...
    def DEFLSHdll(self,D,e,z):
        ...
        return self._DEFLSHdlloutput_tuple(T.value,P.value,Dl.value,Dv.value,list(x),list(y),q.value,h.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def DHFLSHdll(self,D,h,z):
        ...
        return self._DHFLSHdlloutput_tuple(T.value,P.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def DPDDXdll(self,T,D,z):
        ...
        if self._DPDDXdll is None: raise ValueError("The function DPDDXdll could not be loaded from the shared library.") 
        self._DPDDXdll(ct.byref(T),ct.byref(D),z,ct.byref(dPdD))

        return dPdD.value

    def DPDTXdll(self,T,D,z):
        """
        dPdT = DPDTXdll(T,D,z)
        """
        T = ct.c_double(T)
        ...
        if self._DPDTXdll is None: raise ValueError("The function DPDTXdll could not be loaded from the shared library.") 
        self._DPDTXdll(ct.byref(T),ct.byref(D),z,ct.byref(dPdT))
    ...
    def DQFL2dll(self,D,q,z,kq):
        ...
        return self._DQFL2dlloutput_tuple(T.value,P.value,Dl.value,Dv.value,list(x),list(y),ierr.value,trim(herr.raw))
    ...
    def DSFLSHdll(self,D,s,z):
        ...
        return self._DSFLSHdlloutput_tuple(T.value,P.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,h.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def ESFLSHdll(self,e,s,z):
        ...
        return self._ESFLSHdlloutput_tuple(T.value,P.value,D.value,Dl.value,Dv.value,list(x),list(y),q.value,h.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def FGCTY2dll(self,T,D,z):
        ...
        return self._FGCTY2dlloutput_tuple(list(f),ierr.value,trim(herr.raw))
    ...
    def FUGCOFdll(self,T,D,z):
        ...
        return self._FUGCOFdlloutput_tuple(list(phi),ierr.value,trim(herr.raw))

    def GERG04dll(self,ncomp,iFlag):
        """
        ierr,herr = GERG04dll(ncomp,iFlag)
        """
        ncomp = ct.c_long(ncomp)
        iFlag = ct.c_long(iFlag)
        ierr = ct.c_long()
        herr = ct.create_string_buffer(255)
    ...
    def GETFIJdll(self,hmodij):
        ...
        return self._GETFIJdlloutput_tuple(list(fij),trim(hfij.raw),trim(hmxrul.raw))
    ...
    def GETKTVdll(self,icomp,jcomp):
        ...
        return self._GETKTVdlloutput_tuple(trim(hmodij.raw),list(fij),trim(hFmix.raw),trim(hfij.raw),trim(hbinp.raw),trim(hmxrul.raw))
    ...
    def HSFLSHdll(self,h,s,z):
        ...
        return self._HSFLSHdlloutput_tuple(T.value,P.value,D.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def PASSCMNdll(self,hvr,iset,icomp,jcomp,hstr,ilng,dbl,arr):
        ...
        return self._PASSCMNdlloutput_tuple(trim(hstr.raw),ilng.value,dbl.value,list(arr),ierr.value,trim(herr.raw))
    ...
    def PDFLSHdll(self,P,D,z):
        ...
        return self._PDFLSHdlloutput_tuple(T.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,h.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def PEFLSHdll(self,P,e,z):
        ...
        return self._PEFLSHdlloutput_tuple(T.value,D.value,Dl.value,Dv.value,list(x),list(y),q.value,h.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def PHFLSHdll(self,P,h,z):
        ...
        return self._PHFLSHdlloutput_tuple(T.value,D.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def PHIDERVdll(self,iderv,T,D,z):
        ...
        return self._PHIDERVdlloutput_tuple(list(dadn),list(dnadn),ierr.value,trim(herr.raw))
    ...
    def PQFLSHdll(self,P,q,z,kq):
        ...
        return self._PQFLSHdlloutput_tuple(T.value,D.value,Dl.value,Dv.value,list(x),list(y),e.value,h.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def PSFLSHdll(self,P,s,z):
        ...
        return self._PSFLSHdlloutput_tuple(T.value,D.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,h.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def QMASSdll(self,qmol,xl,xv):
        ...
        return self._QMASSdlloutput_tuple(qkg.value,list(xlkg),list(xvkg),wliq.value,wvap.value,ierr.value,trim(herr.raw))
    ...
    def QMOLEdll(self,qkg,xlkg,xvkg):
        ...
        return self._QMOLEdlloutput_tuple(qmol.value,list(xl),list(xv),wliq.value,wvap.value,ierr.value,trim(herr.raw))
    ...
    def REFPROP1dll(self,hIn,hOut,iUnits,iMass,a,b,z):
        """
        c,q,ierr,herr = REFPROP1dll(hIn,hOut,iUnits,iMass,a,b,z)
        """
        ...
        return self._REFPROP1dlloutput_tuple(c.value,q.value,ierr.value,trim(herr.raw))
    ...
    def REFPROPdll(self,hFld,hIn,hOut,iUnits,iMass,iFlag,a,b,z):
        ...
        return self._REFPROPdlloutput_tuple(list(z),list(Output),trim(hUnits.raw),iUCode.value,list(x),list(y),list(x3),q.value,ierr.value,trim(herr.raw))
    ...
    def SATDdll(self,D,z,kph):
        ...
        return self._SATDdlloutput_tuple(kr.value,T.value,P.value,Dl.value,Dv.value,list(x),list(y),ierr.value,trim(herr.raw))

    def SATESTdll(self,iFlash,T,P,z):
        """
        T,P,x,y,ierr,herr = SATESTdll(iFlash,T,P,z)
        """
        iFlash = ct.c_long(iFlash)
        T = ct.c_double(T)
        P = ct.c_double(P)
        z = (len(z)*ct.c_double)(*z)
        x = (20*ct.c_double)()
        ...
        return self._SATESTdlloutput_tuple(T.value,P.value,list(x),list(y),ierr.value,trim(herr.raw))
    ...
    def SATGUESSdll(self,kph,iprop,x,T,P,D,h,s,Dy,y):
        ...
        return self._SATGUESSdlloutput_tuple(T.value,P.value,D.value,h.value,s.value,Dy.value,list(y),ierr.value,trim(herr.raw))
    ...
    def SATGVdll(self,T,P,z,vf,b,ipv,ityp,isp,Dx,Dy,x,y):
        ...
        return self._SATGVdlloutput_tuple(T.value,P.value,Dx.value,Dy.value,list(x),list(y),ierr.value,trim(herr.raw))
    ...
    def SATPESTdll(self,P,z,kph):
        ...
        return self._SATPESTdlloutput_tuple(T.value,list(x2),ierr.value,trim(herr.raw))
    ...
    def SATPdll(self,P,z,kph):
        ...
        return self._SATPdlloutput_tuple(T.value,Dl.value,Dv.value,list(x),list(y),ierr.value,trim(herr.raw))
    ...
    def SATTESTdll(self,T,z,kph):
        ...
        return self._SATTESTdlloutput_tuple(P.value,list(x2),ierr.value,trim(herr.raw))
    ...
    def SATTPdll(self,T,P,z,iFlsh,iGuess,D,Dl,Dv,x,y):
        ...
        return self._SATTPdlloutput_tuple(T.value,P.value,D.value,Dl.value,Dv.value,list(x),list(y),q.value,ierr.value,trim(herr.raw))
    ...
    def SATTdll(self,T,z,kph):
        ...
        return self._SATTdlloutput_tuple(P.value,Dl.value,Dv.value,list(x),list(y),ierr.value,trim(herr.raw))
    ...
    def SETMIXTUREdll(self,hMixNme,z):
        """
        ierr = SETMIXTUREdll(hMixNme,z)
        """
    ...
    def SETMIXdll(self,hMixNme,hFmix,hrf):
        ...
        return self._SETMIXdlloutput_tuple(ncc.value,trim(hFiles.raw),list(z),ierr.value,trim(herr.raw))
    ...
    def TDFLSHdll(self,T,D,z):
        ...
        return self._TDFLSHdlloutput_tuple(P.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,h.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def TEFLSHdll(self,T,e,z,kr):
        ...
        return self._TEFLSHdlloutput_tuple(P.value,D.value,Dl.value,Dv.value,list(x),list(y),q.value,h.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def THFLSHdll(self,T,h,z,kr):
        ...
        return self._THFLSHdlloutput_tuple(P.value,D.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def TPFL2dll(self,T,P,z):
        ...
        return self._TPFL2dlloutput_tuple(Dl.value,Dv.value,list(x),list(y),q.value,ierr.value,trim(herr.raw))
    ...
    def TPFLSHdll(self,T,P,z):
        ...
        return self._TPFLSHdlloutput_tuple(D.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,h.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def TQFLSHdll(self,T,q,z,kq):
        ...
        return self._TQFLSHdlloutput_tuple(P.value,D.value,Dl.value,Dv.value,list(x),list(y),e.value,h.value,s.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def TSFLSHdll(self,T,s,z,kr):
        ...
        return self._TSFLSHdlloutput_tuple(P.value,D.value,Dl.value,Dv.value,list(x),list(y),q.value,e.value,h.value,Cv.value,Cp.value,w.value,ierr.value,trim(herr.raw))
    ...
    def XMASSdll(self,xmol):
        ...
        return self._XMASSdlloutput_tuple(list(xkg),wmix.value)
    ...
    def XMOLEdll(self,xkg):
        ...
        return self._XMOLEdlloutput_tuple(list(xmol),wmix.value)
