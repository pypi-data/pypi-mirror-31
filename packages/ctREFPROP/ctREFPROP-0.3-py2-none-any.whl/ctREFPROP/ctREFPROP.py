...
on 17 Apr 2018 15:26:05.  This interface was written by Ian Bell. 
...
class REFPROPInstance(object):
    ...
    def __init__(self, dll, managed_handle = None):
        ...
        self._ERRMSGdlloutput_tuple = namedtuple('ERRMSGdlloutput',["ierr","herr"])
    ...
    def ERRMSGdll(self,):
        ...
        return self._ERRMSGdlloutput_tuple(ierr.value,trim(herr.raw))
    ...
    def PASSCMNdll(self,hvr,iset,icomp,jcomp,hstr,ilng,dbl,arr):
        ...
        """
        hvr = ct.create_string_buffer(hvr,lenhvr)
        iset = ct.c_long(iset)
        icomp = ct.c_long(icomp)
        jcomp = ct.c_long(jcomp)
        ...
        self._PASSCMNdll(hvr,ct.byref(iset),ct.byref(icomp),ct.byref(jcomp),hstr,ct.byref(ilng),ct.byref(dbl),arr,ct.byref(ierr),herr,10000,255,255)
