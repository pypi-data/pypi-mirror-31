...
class DataDictionary(object):
	...
	class Choice(object):
		...
		def get_label(self, key):
			...
			for value, label in self.__data.itervalues():
				if value == key:
					return label
	...
	def __init__(self, data):
		self.__data = data
		self.__table_data = {}
		for name, tabledata in self.__data['tables'].iteritems():
	...
	def get_tables_list(self):
		...
		return self.__data['tables'].keys()
	...
	def get_fields_list(self, tablename):
		...
		return self.__table_data[tablename.lower()]['fields'].keys()
	...
	def get_choice(self, choicename):
		...
		for value, option_data in options.iteritems():
