...
REPARTI_ALIQUOTA_MISMATCH = 5341                               #: L'aliquota IVA associata al reparto deve essere uguale a quella associata all'articolo per le vendite/resi al banco per il reparto stesso
...
EB_DACF_ANNO_INV = 5412                                        #: Impossibile registrare i Dati annuali clienti fornitori senza specificare una nno valido!
...
DESC_INCASSO_AUTO = 6010                                       #: Incasso Automatico
...
ERROR_SA_LOCK = 7277
GIORNCONT_NUMPAG_ZERO = 7278                                   #: Il numero dell'ultima pagina stampata in definitivo è stato azzerato poiché l'ultima registrazione su bollato è del 31 Dicembre!
