...
from LoreleiClient.UIObjects.Input import Box, Label, InputBox, Dropdown, DropdownDirection, WrappedLabel, ConditionalUI
...
class ChatBox(Box):
    ...
    def addMessage(self, message):
        ...
        self.chatLines.insert(0, ChatLine(message, self.rect.w-(ChatBox.WBuffer * 2)))
...
class ChatModule(Component):
    ...
    def __init__(self, x, y, connection):
        ...
        self.whisperTargetBox = ConditionalUI(InputBox(x + self.messageTypeOption.rect.w + 2, y + self.height + 2, 100, self.messageTypeOption.rect.h, fontSize=24), self.showWhisperBox)
