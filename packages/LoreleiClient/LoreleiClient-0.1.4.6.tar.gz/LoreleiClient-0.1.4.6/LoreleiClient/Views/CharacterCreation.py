...
from LoreleiClient.UIObjects.Input import Label, Dropdown, IntValueBox, LabelRightAligned, Box, ObservableValue, ParagraphBox
...
class CharacterCreationView(UIView):
    ...
    def make_view(self):
        if self.connection is None:
            ...
            self.add_ui_object(ParagraphBox(300, 50, 150, 150, 3, "Race Description", "Select a race to see its description", self.raceDescription))
            self.add_ui_object(ParagraphBox(300, 220, 150, 150, 3, "Class Description", "Select a class to see its description", self.classDescription))
