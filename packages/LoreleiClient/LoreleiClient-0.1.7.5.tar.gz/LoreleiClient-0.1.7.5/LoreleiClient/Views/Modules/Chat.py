...
class ChatModule(Component):
    ...
    def __init__(self, x, y, connection):
        ...
        self.whisperTargetBox = ConditionalUI(InputBox(x + self.messageTypeOption.rect.w + 2, y + self.height + 2, 100, self.messageTypeOption.rect.h, fontSize=24, inactiveCallback=self.searchWhisperTarget), self.showWhisperBox, self.showWhisperBox)
