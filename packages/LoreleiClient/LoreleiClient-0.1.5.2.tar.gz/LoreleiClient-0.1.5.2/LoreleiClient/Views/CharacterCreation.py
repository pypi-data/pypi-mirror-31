...
class CharacterCreationView(UIView):
    ...
    def __init__(self, character=None, connection=None):
        ...
        super(CharacterCreationView, self).__init__(self.makeView, connection)
    ...
    def handle_data(self, data):
        if isinstance(data, ClassOptions):
            ...
            print data.character.equipment.__dict__.iteritems()
...
class CharacterSummaryView(UIView):
    ...
    def __init__(self, character, connection):
        ...
        self.notification = None
        self.character = character
        super(CharacterSummaryView, self).__init__(self.makeView, connection)
    ...
    def makeView(self):
        ...
        if self.connection is None:
            ...
            self.add_ui_object(Box(250, 50, 300, 140, 3, "Equipment"))
            y = 60
            print self.character.equipment
