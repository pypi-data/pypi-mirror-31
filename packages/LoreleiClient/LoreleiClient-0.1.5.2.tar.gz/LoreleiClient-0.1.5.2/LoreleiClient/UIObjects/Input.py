...
class Box(object):
    ...
    def __init__(self, x, y, w, h, box_width, name="", font_size=18):
        self.rect = pg.Rect(x, y, w, h)
        self.boxWidth = box_width
        self.font = pg.font.Font(None, font_size)
        self.name = name
        self.txt_surface = self.font.render(name, True, COLOR_ACTIVE)
        self.textRect = pg.Rect(x + 16, y-(font_size/3), self.font.size(self.name)[0], self.font.size(self.name)[1])
...
class ParagraphBox(Box):
    ...
    def __init__(self, x, y, w, h, box_width, name="", observable=None, font_size=16):
        super(ParagraphBox, self).__init__(x, y, w, h, box_width, name)
...
class Dropdown(object):
    ...
    def getLargestItemSize(self):
        ...
        if self.minWidth > size[0]:
            size = (self.minWidth, size[1])
        return largest
...
class Notification(object):
    ...
    def __init__(self, text, callback=None, button_text="Ok", text_color=COLOR_INACTIVE, font_size=18, hideButton=False):
        self.padding = 10
        self.color = COLOR_INACTIVE
        self.font = pg.font.Font(None, font_size)
        self.callback = callback
