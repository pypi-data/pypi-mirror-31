...
class Route(models.Model):
    ...
    # TODO: add redirect_condition and redirect_to_home_page field
    # redirect_condition = Always, if anonymous user, if logged user, if staff user, if superuser
    # redirect_to_root = models.BooleanField(default=False)
    # redirect_to_parent = models.BooleanField(default=False)
    ...
    # redirect_to_first_pagination_page = models.BooleanField(default=False)
