    ...
    def to_pandas(self):
        ...
        for tag in self.internal_representation['data']['items']:
            for match in tag['matches']:
                matches.append({'tag': tag['tagId'], 'match': match['tagId'], 'score': match['score'], 'platform': match['platform']})
        if matches:
...
class TimeSeries(object):
    ...
    def __init__(self, timeseries, is_string=False, metadata=None, unit=None, asset_id=None, description=None, security_categories=None, step=None):
        self.name = timeseries
...
class Asset(object):
    ...
    def __init__(self, name, parent_id=None, description=None, metadata=None, ref_id=None, parent_name=None, parent_ref_id=None):
        self.name = name
...
class Event(object):
    ...
    def __init__(self, start_time=None, end_time=None, description=None, type=None, sub_type=None, metadata=None, asset_ids=None):
