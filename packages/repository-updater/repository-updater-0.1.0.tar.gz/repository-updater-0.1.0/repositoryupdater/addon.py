...
class Addon:
    ...
    def __init__(self, repository: Repo, repository_target: str, image: str,
                 ...
                 updating: bool):
        """Initializes a new Hass.io add-on object"""
        self.repository_target = repository_target
        self.addon_target = addon_target
        self.image = image
        self.repository = repository
        self.addon_repository: Repository = addon_repository
    ...
    def update(self, force):
        """Updates this add-on inside the given add-on repository"""
    ...
    def __load_current_info(self):
        """Load current add-on version information and current configuration"""
    ...
    def __load_latest_info(self, channel: str):
        """Determines latest available add-on version and configuration
        information"""
        for release in self.addon_repository.get_releases():
            self.latest_version = release.tag_name.lstrip('vV')
    ...
    def needs_update(self, force: bool):
        """Returns whether or not there are updates available for this
        add-on"""
    ...
    def generate_addon_config(self):
        """Generates add-on configuration file"""
    ...
    def update_static_files(self):
        """Updates the static add-on files within the repository"""
    ...
    def get_template_data(self):
        """Returns a dictionary with add-on information"""
        data = {}
        data['name'] = self.name
