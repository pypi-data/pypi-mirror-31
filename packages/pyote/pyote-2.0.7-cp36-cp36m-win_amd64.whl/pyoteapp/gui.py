...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.manualTimestampCheckBox = QtWidgets.QCheckBox(self.widget)
        self.manualTimestampCheckBox.setObjectName("manualTimestampCheckBox")
        self.gridLayout_2.addWidget(self.manualTimestampCheckBox, 0, 0, 1, 1)
        ...
        self.lightCurveNumberLabel = QtWidgets.QLabel(self.widget)
        ...
        self.curveToAnalyzeSpinBox = QtWidgets.QSpinBox(self.widget)
        ...
        self.normLabel = QtWidgets.QLabel(self.widget)
        ...
        self.enableTooltipsCheckBox = QtWidgets.QCheckBox(self.widget)
        ...
        self.calcFlashEdge = QtWidgets.QPushButton(self.widget)
        ...
        spacerItem3 = QtWidgets.QSpacerItem(284, 13, QtWidgets.QSizePolicy.Minimum, QtWidgets.QSizePolicy.Expanding)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.manualTimestampCheckBox.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt; font-weight:600;\">Check this box if there are no timestamps in the file.</span></p><p><span style=\" font-size:18pt; font-weight:600;\">Check this box if there </span><span style=\" font-size:18pt; font-weight:600; text-decoration: underline;\">are</span><span style=\" font-size:18pt; font-weight:600;\"> timestamps, but manual entry of timing information is required because of major errors in those timestamps.</span></p></body></html>"))
        self.manualTimestampCheckBox.setText(_translate("MainWindow", "Use/force  manual timestamp entry"))
        ...
        self.enableTooltipsCheckBox.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:18pt;\">Hovering the mouse pointer over a button will cause a \'tool tip\' to appear.  These \'tips\' are instructive and considered as part of the documentation for this program.</span></p><p><span style=\" font-size:18pt;\">Once a user has become familiar with what the buttons and widgets do, these \'tips\' popping up become a nuisance.  This checkbox can be used to stop the tooltips from appearing.</span></p></body></html>"))
