...
class Logger:
    ...
    def __init__(self,host=None,port=None,name=None,level=None):
        ...
        if self.name == 'controller' or self.name == 'server' or self.name == 'parser' or self.name == 'rss_consumer' or self.name == 'teacher' or self.name == 'teacher_consumer' or self.name == 'reccomender' or self.name == 'reccomender_consumer' or self.name == 'news_consumer' or self.name == 'controller_consumer' or self.name == 'matrix' or self.name == 'watcher' or self.name == 'amazon_consumer' or self.name == 'skyscanner_consumer' or self.name == 'shopping_consumer' or self.name == 'travel_consumer' or self.name == 'mio_cugino':
            pass
        else:
            raise Exception
        ...
        # si attacca l'handler al logger che si prende dal config
            ...
            h = handler.FluentHandler('fluentd.justpith', host=self.host, port=self.port)
