...
class Credentials(object):
    ...
    def setup(self):
        ...
        with os.fdopen(
                 os.open(self.creds_file, os.O_WRONLY | os.O_CREAT, 0o600),
                 'w') as _:
    ...
    def read(self):
        ...
        if (os.path.exists(self.creds_file) and
    ...
    def set(self, profile=None, api_key=None,
            api_server=None, auth_token=None):
        if profile is None:
            return None
