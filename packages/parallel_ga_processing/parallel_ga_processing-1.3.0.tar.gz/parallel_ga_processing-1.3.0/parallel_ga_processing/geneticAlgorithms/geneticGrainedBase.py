...
class GrainedGeneticAlgorithmBase(GeneticAlgorithmBase):
    ...
    def _start_MPI(self, channels):
        logger.info("_start_MPI"+str(self._server_ip_addr) + str(self._server_user) + str(
    ...
    def __call__(self, initial_data, channels, server_ip_addr, server_user, server_password):
