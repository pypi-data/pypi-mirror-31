...
class Messenger(threading.Thread):
    ...
    def __init__(self, server_user, server_password, server_ip_addr, exchange, exchange_type,
                 queue, subscription_routing_keys, production_routing_keys,
                 produced_messages,
                 consumed_messages):
        ...
        self._production_routing_keys = production_routing_keys
    ...
    def subscription_routing_keys(self):
        return self._subscription_routing_keys

    @property
    def production_routing_keys(self):
        return self._production_routing_keys
    ...
    def on_message(self, unused_channel, basic_deliver, properties, body):
        ...
        if received is not None:
            if received.message_type is geneticGrainedBase.MessageType.DATA:
