            ...
            if token.ttype == self.TOK_TYPE_WSPACE:
                if (tokens.BOF()) or (tokens.EOF()):
                    ...
                    pass
                                ...
                                ((tokens.__next__().ttype == self.TOK_TYPE_FUNCTION) and (tokens.__next__().tsubtype == self.TOK_SUBTYPE_START)) or
                                ((tokens.__next__().ttype == self.TOK_TYPE_SUBEXPR) and (tokens.__next__().tsubtype == self.TOK_SUBTYPE_START)) or
                            (tokens.__next__().ttype == self.TOK_TYPE_OPERAND)
                )
                      ):
                    pass
                else:
