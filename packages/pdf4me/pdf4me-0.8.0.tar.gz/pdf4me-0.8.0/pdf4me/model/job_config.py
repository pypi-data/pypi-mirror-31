...
class JobConfig(object):
    ...
    def __init__(self, job_config_id=None, enabled=None, active=None, creation_date=None, mod_date=None, name=None, user_id=None, source_folder=None, execution_trigger=None, action_flow=None, target_folder=None):  # noqa: E501
