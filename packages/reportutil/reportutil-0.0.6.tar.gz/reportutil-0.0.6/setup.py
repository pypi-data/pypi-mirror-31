...
MODULE_NAME = u'reportutil'  # The module name must match this!
...
setup(
    ...
    package_data={
        ...
        'reportutil.resources': ['*.*', '**/*.*', '**/**/*.*'],  # Folders up to 2 levels deep will be included
    },
