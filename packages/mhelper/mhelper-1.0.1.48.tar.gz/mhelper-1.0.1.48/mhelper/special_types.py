...
class Sentinel:
    """
    Type used for sentinel objects.
    Adds a name to the object which can be useful for debugging.
    """
...
class EFileMode( MEnum ):
    ...
    :data READ:     Or `"r"`, open file for reading
    :data WRITE:    Or `"w"`, open file for writing
    :data OUTPUT:   Or `"o"`, open file for writing, accepts output names supported by :func:`io_helper.open_write`.
    """
    UNKNOWN = 0
    READ = 1
    WRITE = 2
