...
setup(
    ...
    name='django-orion-model',  # Required
    ...
    description='A Django model to manage Fiware Orion Entities as local models ',  # Required
    ...
    url='https://github.com/deusto-tech/django-orion-model/',  # Optional
    ...
    keywords='Fiware Orion development',  # Optional
