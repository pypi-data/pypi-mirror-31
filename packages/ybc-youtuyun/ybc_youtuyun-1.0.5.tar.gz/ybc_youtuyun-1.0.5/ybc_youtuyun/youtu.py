...
class YouTu(object):
    ...
    '''人脸融合'''
    def gestureRecog(self, src_image):
        '''
        src_image:原图片
        '''
        req_type = 'cgi-bin/pitu_open_access_for_youtu.fcg'
        ...
        filepath = os.path.abspath(src_image)
    ...
    '''人脸融合'''
    def FaceMix(self, src_image, model_id=0, return_type=0):
        '''
        src_image:原图片
        model_id:合成图片的模板，默认是军官照
        return_type:0(返回url)1(返回合成之后的图片)
        '''
        req_type = 'cgi-bin/pitu_open_access_for_youtu.fcg'
        headers = self.get_headers(req_type)
        ...
        if not os.path.exists(filepath):
            return {'httpcode':0, 'errorcode':self.IMAGE_FILE_NOT_EXISTS, 'errormsg':'IMAGE_FILE_NOT_EXISTS'}
        data["img_data"] = base64.b64encode(open(filepath, 'rb').read()).rstrip().decode('utf-8')

        # if data_type == 0:
        #     data['rsp_img_type'] = 'url'
        # elif data_type == 1:
        #     data['rsp_img_type'] = 'base64'
        data['rsp_img_type'] = 'url'

        MODEL_TYPE = {
            0:'hezuo_junzhuangzhao_2007m_20170919141654',#07式军服男
            1:'hezuo_junzhuangzhao_2007w_20170919141715',#07式军服女
            2:'hezuo_junzhuangzhao_1999w_20170919141627',#99式军服女
            3:'hezuo_junzhuangzhao_1999m_20170919141604',#99式军服男
            4:'hezuo_junzhuangzhao_1987w_20170919141529	',#87式军服女
            5:'hezuo_junzhuangzhao_1987m_20170919141505	',#87式军服男
            6:'hezuo_junzhuangzhao_1965w_20170919141337',#65式军服女
            7:'hezuo_junzhuangzhao_1965m_20170919141309	',#65式军服男
            8:'hezuo_junzhuangzhao_1950w_20170919141055',#50式军服女
            9:'hezuo_junzhuangzhao_1950m_20170919141035	',#50式军服男
            10:'hezuo_junzhuangzhao_1948w_20170919141013',#解放战争女
            11:'hezuo_junzhuangzhao_1948m_20170919140951',#解放战争男
            12:'hezuo_junzhuangzhao_1937w_20170919140927',#抗日战争女
            13:'hezuo_junzhuangzhao_1937m_20170919140902',#抗日战争男
            14:'hezuo_junzhuangzhao_1927w2_20170919140735',#南昌起义女
            15:'hezuo_junzhuangzhao_1927m_20170919140703',#南昌起义男
            16:'cf_yuren_smart',#红发贵族
            17:'cf_yuren_roushan',#天使脸蛋
            18:'cf_yuren_jirou',#魔鬼身材
            19:'cf_yuren_heheda',#霸气纹身
            20:'cf_yuren_guangtou',#聪明绝顶
            21:'cf_yuren_cungu',#采茶姑娘
            22:'cf_yuren_baozha',#摇滚青年
            23:'cf_xianjian_xiaoyao',#李逍遥
            24:'cf_xianjian_linger',#赵灵儿
            25:'cf_wzry_zhuge',#诸葛亮
            26:'cf_wzry_zhenji',#虞姬
            27:'cf_wzry_wangzhaojun',#昭君·新年
            28:'cf_wzry_nz',#哪吒
            29:'cf_wzry_libai',#李白·新年
            30:'cf_wzry_jingke',#阿珂
            31:'cf_nianhua_xnmmd',#新年萌萌哒
            32:'cf_nianhua_nnyy',#年年有余
            33:'cf_movie_yehua',#夜华
            34:'cf_movie_fengjiu',#凤九
            35:'cf_movie_baiqian',#白浅
            36:'cf_lover_yuhuan',#杨玉环
            37:'cf_lover_xishi',#西施
            38:'cf_lover_wuque',#周瑜
            39:'cf_lover_sunshang',#孙尚香
            40:'cf_lover_libai',#李白
            41:'cf_lover_fanli',#范蠡
            42:'cf_fuwa_yasuiqian',#压岁钱
            43:'cf_fuwa_qiji',#我就是奇迹
        }
        if model_id not in MODEL_TYPE:
            model_id = 0
        ...
        if ret['img_url']:
            if return_type == 0:
                ...
                filename = 'facemix_' + os.path.basename(src_image)
                req.urlretrieve(ret['img_url'],filename)
                return filename
            else:
                return ret
        else:
