...
def x_first_time_setup(mode):
    ...
    sql = "SELECT * FROM information_schema.tables WHERE table_schema = 'steemax' AND table_name = 'axlist' LIMIT 1;"
    ...
    # Check to see if the the table named "axglobal" is present in the database "steemax". If not make it

    sql = "SELECT * FROM information_schema.tables WHERE table_schema = 'steemax' AND table_name = 'axglobal' LIMIT 1;"
