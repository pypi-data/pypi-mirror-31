...
from djangoforandroid.core.logger import (warning, shprint, info, logger,
                                     debug, error)
from djangoforandroid.core.util import (current_directory, ensure_dir,
...
class Bootstrap(object):
    ...
    def get_bootstrap(cls, name, ctx):
        ...
        mod = importlib.import_module('djangoforandroid.core.bootstraps.{}'
                                      .format(name))
