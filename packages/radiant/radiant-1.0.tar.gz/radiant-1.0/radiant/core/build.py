...
from djangoforandroid.core.util import (ensure_dir, current_directory)
from djangoforandroid.core.logger import (info, warning, error, info_notify,
                                     Err_Fore, Err_Style, info_main,
                                     shprint)
from djangoforandroid.core.archs import ArchARM, ArchARMv7_a, Archx86, Archx86_64, ArchAarch_64
from djangoforandroid.core.recipe import Recipe
...
def run_pymodules_install(ctx, modules):
    ...
    with current_directory(join(ctx.build_dir)):
        ...
        shprint(sh.bash, '-c', (
            ...
            "PYTHONPATH={0} pip install --upgrade --target '{0}' --no-deps -r requirements.txt"
