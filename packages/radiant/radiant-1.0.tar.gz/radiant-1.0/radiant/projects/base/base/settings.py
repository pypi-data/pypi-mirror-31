...
INSTALLED_APPS = [
    ...
    'djangoforandroid.framework', #optional, for urls support
...
ANDROID = {
    ...
    'BUILD': {
        #'requirements': [],
        #'exclude_dirs': ['djangoforandroid', 'pythonforandroid', '.hg'],
        'include_exts': ['py', 'png', 'sqlite3', 'html', 'css', 'js', 'svg', 'ttf', 'eot', 'woff', 'woff2', 'otf', 'xml'],
        },

    'ANDROID': {
        'ARCH': '/absolute-path-to/armeabi-v7a',
