...
from publisher.git_handling.history import get_commits, get_commits_for_phase
...
from publisher.utils import get_content_directories, WorkingDirectory, get_user_selection, get_command_output
...
def publish_with_display(dist_group, number_of_commits_shown):
    ...
    with WorkingDirectory(settings.PROCEDURE_CHECKOUT_DIRECTORY):
        ...
        selected_commit = get_user_selection(message, display_commits)
