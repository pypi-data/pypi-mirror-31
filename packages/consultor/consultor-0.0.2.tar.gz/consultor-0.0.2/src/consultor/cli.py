...
def parse_args(args):
    ...
    parser = argparse.ArgumentParser(
        description="An explorer for consultor and courses using a command line interface.")
    ...
    parser.add_argument(
        dest="action",
        help="Can be: search [consultor, courses, colleges], show [consultor, courses, colleges], insert [career, course, college]",
        type=str,
        metavar="Action",
        choices=["view"],
        nargs="?",
