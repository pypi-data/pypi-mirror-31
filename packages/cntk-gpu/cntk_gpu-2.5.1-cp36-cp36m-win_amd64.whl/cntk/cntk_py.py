...
def spatial_convolution(*args):
    return _cntk_py.spatial_convolution(*args)
spatial_convolution = _cntk_py.spatial_convolution

def group_convolution(*args):
    return _cntk_py.group_convolution(*args)
group_convolution = _cntk_py.group_convolution
...
def enable_node_timing():
    return _cntk_py.enable_node_timing()
enable_node_timing = _cntk_py.enable_node_timing

def disable_node_timeing():
    return _cntk_py.disable_node_timeing()
disable_node_timeing = _cntk_py.disable_node_timeing

def enable_cpueval_optimization():
    return _cntk_py.enable_cpueval_optimization()
enable_cpueval_optimization = _cntk_py.enable_cpueval_optimization

def disable_cpueval_optimization():
    return _cntk_py.disable_cpueval_optimization()
disable_cpueval_optimization = _cntk_py.disable_cpueval_optimization

def set_mpipack_threshold(packThesholdInBytes):
    return _cntk_py.set_mpipack_threshold(packThesholdInBytes)
set_mpipack_threshold = _cntk_py.set_mpipack_threshold

def get_mpipack_threshold():
    return _cntk_py.get_mpipack_threshold()
get_mpipack_threshold = _cntk_py.get_mpipack_threshold
...
class SequenceDataBase(_object):
    ...
    __swig_setmethods__["m_holding_buffer"] = _cntk_py.SequenceDataBase_m_holding_buffer_set
    __swig_getmethods__["m_holding_buffer"] = _cntk_py.SequenceDataBase_m_holding_buffer_get
    if _newclass:
        m_holding_buffer = _swig_property(_cntk_py.SequenceDataBase_m_holding_buffer_get, _cntk_py.SequenceDataBase_m_holding_buffer_set)
...
class float16(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, float16, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, float16, name)
    __repr__ = _swig_repr

    def __init__(self, *args):
        this = _cntk_py.new_float16(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    if _newclass:
        create = staticmethod(_cntk_py.float16_create)
    else:
        create = _cntk_py.float16_create
    __swig_destroy__ = _cntk_py.delete_float16
    __del__ = lambda self: None
float16_swigregister = _cntk_py.float16_swigregister
float16_swigregister(float16)

def float16_create(*args):
    return _cntk_py.float16_create(*args)
float16_create = _cntk_py.float16_create
...
DataType_Float16 = _cntk_py.DataType_Float16
...
class NDShape(_object):
    ...
    def is_scalar(self):
        return _cntk_py.NDShape_is_scalar(self)
...
class StreamInformation(_object):
    ...
    __swig_setmethods__["m_is_binary"] = _cntk_py.StreamInformation_m_is_binary_set
    __swig_getmethods__["m_is_binary"] = _cntk_py.StreamInformation_m_is_binary_get
    if _newclass:
        m_is_binary = _swig_property(_cntk_py.StreamInformation_m_is_binary_get, _cntk_py.StreamInformation_m_is_binary_set)
...
class NDArrayView(_object):
    ...
    def is_slice_view(self):
        return _cntk_py.NDArrayView_is_slice_view(self)
...
class Variable(_object):
    ...
    def has_batch_axis(self):
        return _cntk_py.Variable_has_batch_axis(self)

    def has_sequence_axis(self):
        return _cntk_py.Variable_has_sequence_axis(self)

    def is_initialized(self):
        return _cntk_py.Variable_is_initialized(self)
    ...
    def get_value(self):
        return _cntk_py.Variable_get_value(self)
...
ModelFormat_CNTKv2 = _cntk_py.ModelFormat_CNTKv2
ModelFormat_ONNX = _cntk_py.ModelFormat_ONNX
...
class Function(IDictionarySerializable):
    ...
    def print_node_timing(self):
        return _cntk_py.Function_print_node_timing(self)
    ...
    def clone_flattened(self, *args):
        return _cntk_py.Function_clone_flattened(self, *args)
    if _newclass:
    ...
    def get_custom_attributes(self):
        return _cntk_py.Function_get_custom_attributes(self)

    def reset_custom_attributes(self):
        return _cntk_py.Function_reset_custom_attributes(self)
...
def element_and(*args):
    return _cntk_py.element_and(*args)
element_and = _cntk_py.element_and

def element_not(*args):
    return _cntk_py.element_not(*args)
element_not = _cntk_py.element_not

def element_or(*args):
    return _cntk_py.element_or(*args)
element_or = _cntk_py.element_or

def element_xor(*args):
    return _cntk_py.element_xor(*args)
element_xor = _cntk_py.element_xor
...
def atanh(*args):
    return _cntk_py.atanh(*args)
atanh = _cntk_py.atanh
...
def asinh(*args):
    return _cntk_py.asinh(*args)
asinh = _cntk_py.asinh
...
def log_softmax(*args):
    return _cntk_py.log_softmax(*args)
log_softmax = _cntk_py.log_softmax

def hardmax(*args):
    return _cntk_py.hardmax(*args)
hardmax = _cntk_py.hardmax

def hard_sigmoid(*args):
    return _cntk_py.hard_sigmoid(*args)
hard_sigmoid = _cntk_py.hard_sigmoid

def top_k(*args):
    return _cntk_py.top_k(*args)
top_k = _cntk_py.top_k
...
def flatten(*args):
    return _cntk_py.flatten(*args)
flatten = _cntk_py.flatten
...
def squeeze(*args):
    return _cntk_py.squeeze(*args)
squeeze = _cntk_py.squeeze

def expand_dims(*args):
    return _cntk_py.expand_dims(*args)
expand_dims = _cntk_py.expand_dims

def zeros_like(*args):
    return _cntk_py.zeros_like(*args)
zeros_like = _cntk_py.zeros_like

def ones_like(*args):
    return _cntk_py.ones_like(*args)
ones_like = _cntk_py.ones_like
...
def element_max(leftOperand, rightOperand, name):
    return _cntk_py.element_max(leftOperand, rightOperand, name)
element_max = _cntk_py.element_max

def element_min(leftOperand, rightOperand, name):
    return _cntk_py.element_min(leftOperand, rightOperand, name)
element_min = _cntk_py.element_min
...
def lattice_sequence_with_softmax(*args):
    return _cntk_py.lattice_sequence_with_softmax(*args)
lattice_sequence_with_softmax = _cntk_py.lattice_sequence_with_softmax
...
def depth_to_space(*args):
    return _cntk_py.depth_to_space(*args)
depth_to_space = _cntk_py.depth_to_space

def space_to_depth(*args):
    return _cntk_py.space_to_depth(*args)
space_to_depth = _cntk_py.space_to_depth
...
def reduce_l1(*args):
    return _cntk_py.reduce_l1(*args)
reduce_l1 = _cntk_py.reduce_l1

def reduce_l2(*args):
    return _cntk_py.reduce_l2(*args)
reduce_l2 = _cntk_py.reduce_l2

def reduce_sum_square(*args):
    return _cntk_py.reduce_sum_square(*args)
reduce_sum_square = _cntk_py.reduce_sum_square

def image_scaler(operand, scaler, biases, name):
    return _cntk_py.image_scaler(operand, scaler, biases, name)
image_scaler = _cntk_py.image_scaler
...
def mean_variance_normalization(*args):
    return _cntk_py.mean_variance_normalization(*args)
mean_variance_normalization = _cntk_py.mean_variance_normalization
...
def local_response_normalization(*args):
    return _cntk_py.local_response_normalization(*args)
local_response_normalization = _cntk_py.local_response_normalization
...
def mean(*args):
    return _cntk_py.mean(*args)
mean = _cntk_py.mean

def sum(*args):
    return _cntk_py.sum(*args)
sum = _cntk_py.sum
...
def softsign(*args):
    return _cntk_py.softsign(*args)
softsign = _cntk_py.softsign
...
class Learner(_object):
    ...
    def _update(self, gradientValues, trainingSampleCount, sweepEnd):
    ...
    def total_number_of_minibatches_seen(self):
        return _cntk_py.Learner_total_number_of_minibatches_seen(self)

    def total_number_of_sweeps_seen(self):
        return _cntk_py.Learner_total_number_of_sweeps_seen(self)
...
class DistributedLearner(Learner):
    ...
    def do_aggregate_metrics_if_needed(self, arg2, arg3):
        return _cntk_py.DistributedLearner_do_aggregate_metrics_if_needed(self, arg2, arg3)

    def set_as_metric_aggregator(self):
        return _cntk_py.DistributedLearner_set_as_metric_aggregator(self)

    def is_metric_aggregator(self):
        return _cntk_py.DistributedLearner_is_metric_aggregator(self)
...
class Evaluator(_object):
    ...
    def print_node_timing(self):
        return _cntk_py.Evaluator_print_node_timing(self)
...
DataUnit_Sweep = _cntk_py.DataUnit_Sweep
DataUnit_Sample = _cntk_py.DataUnit_Sample
DataUnit_Minibatch = _cntk_py.DataUnit_Minibatch
class Trainer(Evaluator):
    ...
    def total_number_of_units_seen(self, *args):
        return _cntk_py.Trainer_total_number_of_units_seen(self, *args)

    def summarize_training_progress(self):
        return _cntk_py.Trainer_summarize_training_progress(self)

    def print_node_timing(self):
        return _cntk_py.Trainer_print_node_timing(self)
...
class HTKFeatureConfiguration(_object):
    ...
    def __init__(self, *args):
        this = _cntk_py.new_HTKFeatureConfiguration(*args)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
    ...
    __swig_setmethods__["m_max_sequence_length"] = _cntk_py.HTKFeatureConfiguration_m_max_sequence_length_set
    __swig_getmethods__["m_max_sequence_length"] = _cntk_py.HTKFeatureConfiguration_m_max_sequence_length_get
    if _newclass:
        m_max_sequence_length = _swig_property(_cntk_py.HTKFeatureConfiguration_m_max_sequence_length_get, _cntk_py.HTKFeatureConfiguration_m_max_sequence_length_set)
...
def lattice_deserializer(streamName, latticeIndexFile):
    return _cntk_py.lattice_deserializer(streamName, latticeIndexFile)
lattice_deserializer = _cntk_py.lattice_deserializer
...
class TrainingSession(_object):
    ...
    def __init__(self, trainer, trainingSource, minibatchSizeSchedule, inputVarToStream, maxNumTrainingSamples, progressFrequency, progressFrequencyUnit, checkpointing, crossValidation, test):
        if self.__class__ == TrainingSession:
            _self = None
        else:
            _self = self
        this = _cntk_py.new_TrainingSession(_self, trainer, trainingSource, minibatchSizeSchedule, inputVarToStream, maxNumTrainingSamples, progressFrequency, progressFrequencyUnit, checkpointing, crossValidation, test)
        try:
            self.this.append(this)
        except __builtin__.Exception:
            self.this = this
