...
#define CASADI_VERSION_STRING "3.4.3"
#define CASADI_GIT_REVISION "54bde1c242fbb229e05fe87310dce3371b1a4af9"  // NOLINT(whitespace/line_length)
#define CASADI_GIT_DESCRIBE "3.3.0-213.54bde1c"  // NOLINT(whitespace/line_length)
