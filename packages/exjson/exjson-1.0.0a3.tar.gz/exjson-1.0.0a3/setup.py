...
setup(
    ...
    version='1.0.0a3',  # Required

    # This is a one-line description or tagline of what your project does. This
    # corresponds to the "Summary" metadata field:
    # https://packaging.python.org/specifications/core-metadata/#summary
    description='Extended JSON Parser Library for Python',  # Required
    ...
    # project.
    author='Pedro Rodriguez',  # Optional
    ...
    keywords='json serialization decoder encoder configuration',  # Optional
