...
if platform.system() == "Windows":
    dependancies = "serving/tools/modeldatacollector/lib/native/Windows/*"
elif platform.system() == "Darwin":
    dependancies = "serving/tools/modeldatacollector/lib/native/Darwin/*"
else:
    dependancies = "serving/tools/modeldatacollector/lib/native/Linux/*"
