...
class CodeCoverageManager(object):
    def __init__(self, config_data):
        ...
        config_data.include = config_data.include or []
        config_data.include.append("*%s*" % os.path.abspath(config_data.workspacepath))
        if constants.IN_TEST:
            ...
            config_data.include.append("*%s*" % python_agent.__name__)
            self.coverage = Coverage(source=None, include=config_data.include, omit=None, data_suffix=True, branch=False)
        else:
            self.coverage = Coverage(source=None, include=config_data.include, omit=config_data.exclude, branch=False)
