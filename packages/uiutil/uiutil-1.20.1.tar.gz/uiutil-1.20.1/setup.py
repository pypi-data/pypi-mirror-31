...
MODULE_NAME = u'uiutil'  # The module name must match this!
...
setup(
    ...
    install_requires=[
        ...
        u'future>=0.16.0'
        u'attrs>=16.3.0',
        u'logging-helper>=1.8.2',
        u'stateutil>=1.3.0',
        u'classutils>=1.5.5',
        u'configurationutil>=1.5.6',
        u'fdutil>=1.7.8',
        u'Pillow>=4.0.0',
        u'conversionutil>=1.2.1'
    ],
    ...
    package_data={
        '': ['*.md', '*.rst', '*.db', '*.txt', '*.json'],  # Include all files that contain *.db/*.md/*.txt/*.json
        'uiutil.resources': ['*.*', '**/*.*', '**/**/*.*'],  # Folders up to 2 levels deep will be included
    },
