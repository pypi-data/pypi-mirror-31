...
class PostgreSQLParserListener(ParseTreeListener):
    ...
    def enterSearch_modifier(self, ctx:PostgreSQLParser.Search_modifierContext):
        pass

    # Exit a parse tree produced by PostgreSQLParser#search_modifier.
    def exitSearch_modifier(self, ctx:PostgreSQLParser.Search_modifierContext):
        pass


    # Enter a parse tree produced by PostgreSQLParser#interval_unit.
    def enterInterval_unit(self, ctx:PostgreSQLParser.Interval_unitContext):
        pass

    # Exit a parse tree produced by PostgreSQLParser#interval_unit.
    def exitInterval_unit(self, ctx:PostgreSQLParser.Interval_unitContext):
        pass


    # Enter a parse tree produced by PostgreSQLParser#transcoding_name.
    def enterTranscoding_name(self, ctx:PostgreSQLParser.Transcoding_nameContext):
        pass

    # Exit a parse tree produced by PostgreSQLParser#transcoding_name.
    def exitTranscoding_name(self, ctx:PostgreSQLParser.Transcoding_nameContext):
        pass
    ...
    def enterExp_factor4(self, ctx:PostgreSQLParser.Exp_factor4Context):
        pass

    # Exit a parse tree produced by PostgreSQLParser#exp_factor4.
    def exitExp_factor4(self, ctx:PostgreSQLParser.Exp_factor4Context):
        pass
    ...
    def enterMatch_against_statement(self, ctx:PostgreSQLParser.Match_against_statementContext):
        pass

    # Exit a parse tree produced by PostgreSQLParser#match_against_statement.
    def exitMatch_against_statement(self, ctx:PostgreSQLParser.Match_against_statementContext):
        pass
