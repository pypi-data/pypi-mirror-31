...
class Transmitter():
    ...
    def __init__(self, port, slaveaddress, baudrate=BAUDRATE, timeout=0.05, close_port_after_each_call=False):
        self.modbus = Instrument(port, slaveaddress, close_port_after_each_call=close_port_after_each_call)
