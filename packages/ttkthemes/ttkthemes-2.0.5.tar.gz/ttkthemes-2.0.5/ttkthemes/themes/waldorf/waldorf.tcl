...
set presentThemes [ttk::style theme names]

if {"waldorf" in $presentThemes} {
    return
}
...
ttk::style element create Labelframe.border image ttk::theme::waldorf::surface \
    -border 5
...
image create photo ttk::theme::waldorf::sizegrip -height 1 -width 1
