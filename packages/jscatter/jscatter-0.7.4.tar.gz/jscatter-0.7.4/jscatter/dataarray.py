        ...
        """
         ...
         objekt : strings, list of array or dataArray
             Objects or filename(s) to read.
              ...
              - filenames with asterisk like exda=dataList(objekt='aa12*')
                as input for multiple file input.
...
shape=[%(ll)s] %(length)s     """
        ...
        *args,**kwargs :
        ...
        weight : None, protectedNames as 'eY' or int
            Column for weight as 1/err**2 in 'mean' calculation, weight column gets new error sqrt(1/sum_i(1/err_i**2))
             ...
             - If weight not existing or conatains zeros equal weights are used.
        keep : list of int
    ...
    def _errorfunction(self,*args,**kwargs):
        ...
        for name,par0 in self._freepar.items():
            ...
            i=i+l
        limitweigth,limits,hardlimits,nconstrain=self._checklimits(self._p)
        ...
        if self._lasterrortimecommandline<now-0.1:
            ...
            self._show_output(chi2,limitweigth,limits,hardlimits,nconstrain,kwargs)
    ...
    def _checklimits(self,parameters):
        ...
        if self.hasConstrain:
            ...
            limitweigth+=10*nconstrain

        return limitweigth,limits,hardlimits,nconstrain

    def _show_output(self,chi2,limitweigth=1,limits=[],hardlimits=[],nconstrain=0,kwargs={}):
    ...
    def fit(self,model,freepar={},fixpar={},mapNames={},method='leastsq',xslice=slice(None),condition=None,output=True,**kw):
        ...
        **Parameter result by name in lastfit** ::
        ...
        if isinstance(modelValues,int):
            print(  CSIr+'fit NOT succesfull!!'+CSIe)
            raise notSuccesfullFitException('model returns single integer. Error occured')
        ...
        limitweigth,limits,hardlimits,nconstrain=self._checklimits(best)
...
class dataArrayBase(np.ndarray):
    ...
    def __reduce__(self):
        ...
        """
        # from https://stackoverflow.com/questions/26598109/preserve-custom-attributes-when-pickling-subclass-of-numpy-array
    ...
    def prune(self,lower=None,upper=None,number=None,kind='lin',col='X',weight='eY',keep=None,type='mean'):
        ...
        Reduces dataArrays to data points in number of intervals between lower and upper
...
shape=%(shape)s    """
    ...
    def concatenate(self,others,axis=1,isort=None):
        ...
        -------
        dataArray
         with merged attributes and isorted
