...
class Collection(Client):
    ...
    async def all(self, page=1, per_page=10):
        ...
        """
        url = "/collections"
        result = await self._all(url, page=page, per_page=per_page)
        return CollectionModel.parse_list(result)

    async def featured(self, page=1, per_page=10):
        """
    ...
    async def curated(self, page=1, per_page=10):
        """
    ...
    async def get_curated(self, collection_id):
        """
    ...
    async def photos(self, collection_id, page=1, per_page=10):
        """
    ...
    async def curated_photos(self, collection_id, page=1, per_page=10):
        """
    ...
    async def related(self, collection_id):
        """
    ...
    async def create(self, title, description=None, private=False):
        """
    ...
    async def update(self, collection_id, title=None, description=None, private=False):
        """
    ...
    async def add_photo(self, collection_id, photo_id):
        """
