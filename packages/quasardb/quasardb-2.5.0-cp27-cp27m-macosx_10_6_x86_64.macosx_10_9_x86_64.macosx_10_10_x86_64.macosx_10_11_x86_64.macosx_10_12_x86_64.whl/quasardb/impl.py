...
filter_none = _qdb.filter_none
filter_unique = _qdb.filter_unique
filter_sample = _qdb.filter_sample
filter_double_inside_range = _qdb.filter_double_inside_range
filter_double_outside_range = _qdb.filter_double_outside_range
...
class qdb_ts_filter_t(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    type = _swig_property(_qdb.qdb_ts_filter_t_type_get, _qdb.qdb_ts_filter_t_type_set)

    def __init__(self):
        _qdb.qdb_ts_filter_t_swiginit(self, _qdb.new_qdb_ts_filter_t())
    __swig_destroy__ = _qdb.delete_qdb_ts_filter_t
qdb_ts_filter_t_swigregister = _qdb.qdb_ts_filter_t_swigregister
qdb_ts_filter_t_swigregister(qdb_ts_filter_t)

class qdb_ts_filtered_range_t(object):
    thisown = _swig_property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc='The membership flag')
    __repr__ = _swig_repr
    range = _swig_property(_qdb.qdb_ts_filtered_range_t_range_get, _qdb.qdb_ts_filtered_range_t_range_set)
    filter = _swig_property(_qdb.qdb_ts_filtered_range_t_filter_get, _qdb.qdb_ts_filtered_range_t_filter_set)

    def __init__(self):
        _qdb.qdb_ts_filtered_range_t_swiginit(self, _qdb.new_qdb_ts_filtered_range_t())
    __swig_destroy__ = _qdb.delete_qdb_ts_filtered_range_t
qdb_ts_filtered_range_t_swigregister = _qdb.qdb_ts_filtered_range_t_swigregister
qdb_ts_filtered_range_t_swigregister(qdb_ts_filtered_range_t)
...
class qdb_ts_blob_aggregation_t(object):
    ...
    filtered_range = _swig_property(_qdb.qdb_ts_blob_aggregation_t_filtered_range_get, _qdb.qdb_ts_blob_aggregation_t_filtered_range_set)
...
class qdb_ts_double_aggregation_t(object):
    ...
    filtered_range = _swig_property(_qdb.qdb_ts_double_aggregation_t_filtered_range_get, _qdb.qdb_ts_double_aggregation_t_filtered_range_set)
...
class qdb_ts_int64_aggregation_t(object):
    ...
    filtered_range = _swig_property(_qdb.qdb_ts_int64_aggregation_t_filtered_range_get, _qdb.qdb_ts_int64_aggregation_t_filtered_range_set)
...
class qdb_ts_timestamp_aggregation_t(object):
    ...
    filtered_range = _swig_property(_qdb.qdb_ts_timestamp_aggregation_t_filtered_range_get, _qdb.qdb_ts_timestamp_aggregation_t_filtered_range_set)
...
class FilteredRangeVec(object):
    ...
    def __init__(self, *args):
        _qdb.FilteredRangeVec_swiginit(self, _qdb.new_FilteredRangeVec(*args))
    __swig_destroy__ = _qdb.delete_FilteredRangeVec
FilteredRangeVec.iterator = new_instancemethod(_qdb.FilteredRangeVec_iterator, None, FilteredRangeVec)
FilteredRangeVec.__nonzero__ = new_instancemethod(_qdb.FilteredRangeVec___nonzero__, None, FilteredRangeVec)
FilteredRangeVec.__bool__ = new_instancemethod(_qdb.FilteredRangeVec___bool__, None, FilteredRangeVec)
FilteredRangeVec.__len__ = new_instancemethod(_qdb.FilteredRangeVec___len__, None, FilteredRangeVec)
FilteredRangeVec.__getslice__ = new_instancemethod(_qdb.FilteredRangeVec___getslice__, None, FilteredRangeVec)
FilteredRangeVec.__setslice__ = new_instancemethod(_qdb.FilteredRangeVec___setslice__, None, FilteredRangeVec)
FilteredRangeVec.__delslice__ = new_instancemethod(_qdb.FilteredRangeVec___delslice__, None, FilteredRangeVec)
FilteredRangeVec.__delitem__ = new_instancemethod(_qdb.FilteredRangeVec___delitem__, None, FilteredRangeVec)
FilteredRangeVec.__getitem__ = new_instancemethod(_qdb.FilteredRangeVec___getitem__, None, FilteredRangeVec)
FilteredRangeVec.__setitem__ = new_instancemethod(_qdb.FilteredRangeVec___setitem__, None, FilteredRangeVec)
FilteredRangeVec.pop = new_instancemethod(_qdb.FilteredRangeVec_pop, None, FilteredRangeVec)
FilteredRangeVec.append = new_instancemethod(_qdb.FilteredRangeVec_append, None, FilteredRangeVec)
FilteredRangeVec.empty = new_instancemethod(_qdb.FilteredRangeVec_empty, None, FilteredRangeVec)
FilteredRangeVec.size = new_instancemethod(_qdb.FilteredRangeVec_size, None, FilteredRangeVec)
FilteredRangeVec.swap = new_instancemethod(_qdb.FilteredRangeVec_swap, None, FilteredRangeVec)
FilteredRangeVec.begin = new_instancemethod(_qdb.FilteredRangeVec_begin, None, FilteredRangeVec)
FilteredRangeVec.end = new_instancemethod(_qdb.FilteredRangeVec_end, None, FilteredRangeVec)
FilteredRangeVec.rbegin = new_instancemethod(_qdb.FilteredRangeVec_rbegin, None, FilteredRangeVec)
FilteredRangeVec.rend = new_instancemethod(_qdb.FilteredRangeVec_rend, None, FilteredRangeVec)
FilteredRangeVec.clear = new_instancemethod(_qdb.FilteredRangeVec_clear, None, FilteredRangeVec)
FilteredRangeVec.get_allocator = new_instancemethod(_qdb.FilteredRangeVec_get_allocator, None, FilteredRangeVec)
FilteredRangeVec.pop_back = new_instancemethod(_qdb.FilteredRangeVec_pop_back, None, FilteredRangeVec)
FilteredRangeVec.erase = new_instancemethod(_qdb.FilteredRangeVec_erase, None, FilteredRangeVec)
FilteredRangeVec.push_back = new_instancemethod(_qdb.FilteredRangeVec_push_back, None, FilteredRangeVec)
FilteredRangeVec.front = new_instancemethod(_qdb.FilteredRangeVec_front, None, FilteredRangeVec)
FilteredRangeVec.back = new_instancemethod(_qdb.FilteredRangeVec_back, None, FilteredRangeVec)
FilteredRangeVec.assign = new_instancemethod(_qdb.FilteredRangeVec_assign, None, FilteredRangeVec)
FilteredRangeVec.resize = new_instancemethod(_qdb.FilteredRangeVec_resize, None, FilteredRangeVec)
FilteredRangeVec.insert = new_instancemethod(_qdb.FilteredRangeVec_insert, None, FilteredRangeVec)
FilteredRangeVec.reserve = new_instancemethod(_qdb.FilteredRangeVec_reserve, None, FilteredRangeVec)
FilteredRangeVec.capacity = new_instancemethod(_qdb.FilteredRangeVec_capacity, None, FilteredRangeVec)
FilteredRangeVec_swigregister = _qdb.FilteredRangeVec_swigregister
FilteredRangeVec_swigregister(FilteredRangeVec)
