        ...
        while True:
            ...
            for i, j in tn.items():
                ...
                if len(sgd.response_stream_dict[i]) < (len(sgd.time_index_list) - 1):
                    try:
                        padding_data = sgd.response_stream_dict[i][-1]
                    except:
                        padding_data = 0
                ...
                if add_task_num:
                    ...
                    if sgd.response_stream_dict[i]:
                        no_add_task_data = sgd.response_stream_dict[i][-1]
                    else:
                        no_add_task_data = 0
                ...
                if len(sgd.fail_stream_dict[i]) < (len(sgd.time_index_list) - 1):
                    try:
                        padding_data = sgd.fail_stream_dict[i][-1]
                    except:
                        padding_data = 0
