...
setup(name='surface_dynamics',
      ...
      project_urls={
          'Documentation': 'http://www.labri.fr/perso/vdelecro/surface-dynamics/',
          'Tutorial': 'http://www.labri.fr/perso/vdelecro/flatsurf.html',
          'Source': 'https://github.com/videlec/flatsurf-package',
          'Tracker': 'https://github.com/videlec/flatsurf-package/issues',
          },
      license="GPL v3",
