...
def main(args=None):
    ...
    actual_excelreader = exceladapter.excelreader.ExcelReader(cwd + '../inputs/PLANILLA CONTABILIDAD ACTIVA 2018 GSM.xlsx')
    current_accounts_excelreader = exceladapter.ExcelReader(cwd + '../inputs/CUENTAS CORRIENTES.xlsx')
