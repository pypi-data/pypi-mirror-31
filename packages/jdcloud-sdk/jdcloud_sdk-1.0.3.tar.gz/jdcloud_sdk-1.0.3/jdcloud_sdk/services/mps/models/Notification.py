...
class Notification(object):
    ...
    def __init__(self, enabled, endpoint=None, events=None, notifyStrategy=None, notifyContentFormat=None):
        """
        :param enabled:  是否启用通知
        :param endpoint: (Optional) 通知endpoint，当前支持http://和https://, 未来会支持sms:, email:, queues: 等
        :param events: (Optional) 触发通知的事件集合
        ...
        :param notifyContentFormat: (Optional) 描述了向 Endpoint 推送的消息格式, JSON包含消息正文和消息属性, SIMPLIFIED消息体即用户发布的消息，不包含任何属性信息
        """
