...
class DescribeCacheInstanceRequest(JDCloudRequest):
    """
    查询缓存Redis实例详情
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(DescribeCacheInstanceRequest, self).__init__(
            '/regions/{regionId}/cacheInstance/{cacheInstanceId}', 'GET', header, version)
        self.parameters = parameters


class DescribeCacheInstanceParameters(object):
