...
class UnassignSecondaryIpsRequest(JDCloudRequest):
    """
    给网卡删除secondaryIp接口
    """

    def __init__(self, parameters, header=None, version="v1"):
        super(UnassignSecondaryIpsRequest, self).__init__(
            '/regions/{regionId}/networkInterfaces/{networkInterfaceId}:unassignSecondaryIps', 'POST', header, version)
