...
class SecurityGroupRule(object):
    ...
    def __init__(self, ruleId=None, direction=None, protocol=None, addressPrefix=None, ipVersion=None, fromPort=None, toPort=None, createdTime=None):
        """
        ...
        :param ipVersion: (Optional) 匹配地址协议版本。4：IPv4；6：IPv6
