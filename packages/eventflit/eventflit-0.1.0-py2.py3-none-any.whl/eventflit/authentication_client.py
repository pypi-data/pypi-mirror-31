...
from eventflit.http import GET, POST, Request, request_method
...
class AuthenticationClient(Client):
    def __init__(
        ...
        if host:
            ...
            self._host = (
                six.text_type("cl-%s.eventflit.com") %
    ...
    def validate_webhook(self, key, signature, body):
        ...
        that the sender is Eventflit and not someone else impersonating it.
