...
class TestBroodClient(JsonSchemaTestMixin, unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.brood = BroodClient(url_handler=self.url_handler, api_version=1)
    ...
    def test_create_organization(self):
        ...
        responses.add(
            ...
            '{scheme}://{host}{path}'.format(
                ...
                path=URLS_V1.admin.organizations.format(),
            ),
        )
    ...
    def test_create_api_token(self):
        ...
        responses.add(
            ...
            '{scheme}://{host}{path}'.format(
                scheme=self.url_handler.scheme,
                host=self.url_handler.host,
                path=URLS_V1.tokens.api.format(),
            ),
            status=200,
    ...
    def test_delete_api_token(self):
        ...
        responses.add(
            ...
            '{scheme}://{host}{path}'.format(
                scheme=self.url_handler.scheme,
                host=self.url_handler.host,
                path=URLS_V1.tokens.api.delete.format(name=name),
            ),
            status=204,
        )
    ...
    def test_list_platforms(self):
        ...
        responses.add(
            ...
            '{scheme}://{host}{path}'.format(
                scheme=self.url_handler.scheme,
                host=self.url_handler.host,
                path=URLS_V1.metadata.platforms.format(),
            ),
            status=200,
    ...
    def test_list_python_tags(self):
        ...
        responses.add(
            ...
            '{scheme}://{host}{path}'.format(
                scheme=self.url_handler.scheme,
                host=self.url_handler.host,
                path=URLS_V1.metadata.python_tags.format(),
            ),
            status=200,
    ...
    def test_list_all_python_tags(self):
        ...
        responses.add(
            ...
            '{scheme}://{host}{path}'.format(
                scheme=self.url_handler.scheme,
                host=self.url_handler.host,
                path=URLS_V1.metadata.python_tags.all.format(),
            ),
            status=200,
            body=json.dumps({'python_tags': expected}),
            content_type='application/json',
    ...
    def test_list_available_repositories(self):
        ...
        responses.add(
            ...
            '{scheme}://{host}{path}'.format(
                scheme=self.url_handler.scheme,
                host=self.url_handler.host,
                path=URLS_V1.user.repositories.format(),
            ),
            status=200,
            body=json.dumps(response),
            content_type='application/json',
        )
        expected = ['acme/prod', 'enthought/free']
        ...
        self.assertFalse('include_indexable' in request.url)
    ...
    def test_list_available_repositories_include_indexable(self):
        ...
        expected = ['acme/prod', 'enthought/free', 'enthought/commercial']
