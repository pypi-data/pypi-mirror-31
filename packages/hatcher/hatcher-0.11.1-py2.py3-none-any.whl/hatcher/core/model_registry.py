...
class ModelRegistry(object):
    ...
    @versioned_model(v0=OrganizationV0)
    ...
    @versioned_model(v0=RepositoryV0,
                     v1=RepositoryV1)
    ...
    @versioned_model(v0=SinglePlatformRepositoryV0,
                     v1=SinglePlatformRepositoryV1)
