...
class StandardLevel(Level):
    ...
    def start(self):
        try:
            ...
            yield self.pregameCountdownPhase()

            yield self.mainGamePhase()

            self.gameOver()

            yield self.rabbitHuntPhase()

        finally:
            self.endLevel()

    @defer.inlineCallbacks
    def pregameCountdownPhase(self, delay=10):
    ...
    @defer.inlineCallbacks
    def rabbitHuntPhase(self, finalSleepTime=3):
        ...
        yield self.world.sleep(finalSleepTime)
