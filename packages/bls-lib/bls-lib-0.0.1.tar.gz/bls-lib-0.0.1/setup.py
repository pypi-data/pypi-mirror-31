...
setup(
    ...
    url='https://pypi.org/project/bls-lib',  # Optional
    ...
    keywords='cryptography signatures digital-signatures threhshold-cryptography',  # Optional
    ...
    project_urls={  # Optional
        ...
        'Bug Reports': 'https://github.com/asonnino/bls',
        'Source': 'https://github.com/asonnino/bls',
    },
)