...
setup(
	...
	url = 'https://github.com/Surrerstry/distributed_containers',
	download_url = 'https://github.com/Surrerstry/distributed_containers/archive/master.zip',
	keywords = ['pypy-stm', 'threading'],
	classifiers = [],
	)