...
id = "b2def1f8a58d648d511919fa851c6a5154637647"
date = "2018-04-29 02:25:39 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "b2def1f8a58d648d511919fa851c6a5154637647":
        return
    msg = "Program id (b2def1f8a58d648d511919fa851c6a5154637647) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
