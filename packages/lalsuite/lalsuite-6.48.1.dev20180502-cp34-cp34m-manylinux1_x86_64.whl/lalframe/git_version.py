...
id = "05d7769f47318a64837ea3a7fbbfbb9fa4eb5656"
date = "2018-05-2 09:38:44 +0000"
branch = "None"
tag = "None"
if tag == "None":
    tag = None
...
def check_match(foreign_id, onmismatch="raise"):
    ...
    if foreign_id == "05d7769f47318a64837ea3a7fbbfbb9fa4eb5656":
        return
    msg = "Program id (05d7769f47318a64837ea3a7fbbfbb9fa4eb5656) does not match given id (%s)." % foreign_id
    if onmismatch == "raise":
