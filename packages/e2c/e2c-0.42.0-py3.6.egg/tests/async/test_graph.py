...
from e2c.async.graph import BaseGraph
from e2c.async.graph import Graph
...
@pytest.mark.asyncio
async def test_analyse__visualize_runs_the_visualizer():
