import numpy as np
from rpi_featureSelection.tian_RecognizePC_faster import RecognizePC
...
def IPCMB (train_data, target, threshold = 0.02):  #train_data is not including targets, targets is the label vector
    NumTest = 0
