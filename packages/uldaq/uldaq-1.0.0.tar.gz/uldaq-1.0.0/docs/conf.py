...
copyright = u'2018, Measurement Computing Corporation'
author = u'mcc'
...
latex_documents = [
    (master_doc, 'UlLinux-Python.tex', u'UlLinux-Python Documentation',
     u'mcc', 'manual'),
]
...
man_pages = [
    (master_doc, 'ullinux-python', u'UlLinux-Python Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'UlLinux-Python', u'UlLinux-Python Documentation',
     author, 'UlLinux-Python', 'One line description of project.',
     'Miscellaneous'),
]
