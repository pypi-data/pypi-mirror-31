...
genotype.cython_c_in_temp = True
...
intersectCompare.cython_c_in_temp = True
haplotype = Extension(
    libLocation+"hap",
    language="c++",
...
pedigree.cython_c_in_temp = True
