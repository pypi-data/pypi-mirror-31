...
class Team(LoggedModel):
    ...
    :param can_view_wholesales: If ``True``, the members can inspect details of all wholesales of the associated events.
    :type can_view_wholesales: bool
    :param can_change_wholesales: If ``True``, the members can change and create wholesales for the associated events.
    :type can_change_wholesales: bool
    """
    ...
    can_view_wholesales = models.BooleanField(
        default=False,
        verbose_name=_("Can view wholesales")
    )
    can_change_wholesales = models.BooleanField(
        default=False,
        verbose_name=_("Can change wholesales")
    )
