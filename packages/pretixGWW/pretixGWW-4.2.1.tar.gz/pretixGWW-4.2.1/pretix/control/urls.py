...
from pretix.control.views import (
    ...
    vouchers, waitinglist, wholesales
)
...
urlpatterns = [
    ...
    url(r'^event/(?P<organizer>[^/]+)/(?P<event>[^/]+)/', include([
        ...
        url(r'^wholesales/$', wholesales.WholesaleListView.as_view(), name='event.wholesales'),
        url(r'^wholesales/add$', wholesales.WholesaleCreateView.as_view(), name='event.wholesale.add'),
        url(r'^wholesales/(?P<id>\d+)/$', wholesales.WholesaleUpdateView.as_view(), name='event.wholesale.edit'),
        url(r'^wholesales/(?P<id>\d+)/delete$', wholesales.WholesaleDeleteView.as_view(), name='event.wholesale.delete'),
