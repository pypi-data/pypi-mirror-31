...
TWILIO_ACCOUNT_SID = config.get('twilio', 'sid', fallback=None)
TWILIO_AUTH_TOKEN = config.get('twilio', 'token', fallback=None)
...
DEFAULT_CURRENCY = config.get('pretix', 'currency', fallback='USD')
...
ACCOUNT_TYPE = (
        ...
        ('Media Outlet', _("Media Outlet")),
        ('Retail Outlet', _("Retail Outlet")),
        ('Other', _("Other")),
    )
