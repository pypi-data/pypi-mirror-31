...
setup(
  ...
  url='http://modlit.readthedocs.io/en/latest/index.html',  # Use the URL to the github repo.
  download_url='https://github.com/patdaburu/modlit/archive/{version}.tar.gz'.format(version=version),
  keywords=[
