...
Test the grid storage:
  ...
  >>> chunks.full_name
  u'm01_grid_testing.test.chunks'

  >>> files = m01.grid.testing.getTestFilesCollection()
  >>> files.full_name
  u'm01_grid_testing.test.files'
...
Let's first setup the gridfs indexes:
  ...
  {u'key': {u'_id': 1},
   u'name': u'_id_',
   u'ns': u'm01_grid_testing.test.files',
   u'v': 2}
  {u'key': {u'filename': 1, u'uploadDate': 1},
   u'name': u'filename_1_uploadDate_1',
   u'ns': u'm01_grid_testing.test.files',
   u'v': 2}
  ...
  {u'key': {u'_id': 1},
   u'name': u'_id_',
   u'ns': u'm01_grid_testing.test.chunks',
   u'v': 2}
  {u'key': {u'files_id': 1, u'n': 1},
   u'name': u'files_id_1_n_1',
   u'ns': u'm01_grid_testing.test.chunks',
   u'unique': True,
   u'v': 2}
...
implicit uses the items __name__ as key.
  ...
  >>> item.chunkCollection
  Collection(Database(MongoClient(host=['localhost:45017'], document_class=dict, tz_aware=True, connect=True, j=True), u'm01_grid_testing'), u'test.chunks')
