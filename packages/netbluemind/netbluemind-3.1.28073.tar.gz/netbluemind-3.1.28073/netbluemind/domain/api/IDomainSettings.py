...
IDomainSettings_VERSION = "3.1.0.qualifier"
...
class IDomainSettings(BaseEndpoint):
	...
	def set (self, settings ):
		...
		response = requests.put( self.base + postUri, params = queryParams, verify=False, headers = {'X-BM-ApiKey' : self.apiKey, 'Accept' : 'application/json', 'X-BM-ClientVersion' : IDomainSettings_VERSION}, data = json.dumps(__data__));
