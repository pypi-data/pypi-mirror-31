...
IExternalSystem_VERSION = "3.1.0.qualifier"
...
class IExternalSystem(BaseEndpoint):
	...
	def getLogo (self, systemIdentifier ):
		...
		response = requests.get( self.base + postUri, params = queryParams, verify=False, headers = {'X-BM-ApiKey' : self.apiKey, 'Accept' : 'application/json', 'X-BM-ClientVersion' : IExternalSystem_VERSION}, data = json.dumps(__data__));
