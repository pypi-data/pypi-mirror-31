...
from editorium.bases import EditorInfo, Editorium
...
class Sc( stringcoercion.AbstractEnumCoercer ):
    
    
    def can_handle( self, info: CoercionInfo ):
        return info.annotation.value == "AAAA!"
