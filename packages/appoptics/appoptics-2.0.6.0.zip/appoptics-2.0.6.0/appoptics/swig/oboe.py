...
class Context(_object):
    ...
    if _newclass:
        init_reporter = staticmethod(_oboe.Context_init_reporter)
    __swig_getmethods__["disconnect"] = lambda x: _oboe.Context_disconnect
    if _newclass:
        disconnect = staticmethod(_oboe.Context_disconnect)
    __swig_getmethods__["reconnect"] = lambda x: _oboe.Context_reconnect
    if _newclass:
        reconnect = staticmethod(_oboe.Context_reconnect)
...
def Context_sampleRequest(layer, in_xtrace):
    return _oboe.Context_sampleRequest(layer, in_xtrace)
...
def Context_init(access_key, hostname_alias):
    return _oboe.Context_init(access_key, hostname_alias)
Context_init = _oboe.Context_init

def Context_init_reporter(protocol, args):
    return _oboe.Context_init_reporter(protocol, args)
Context_init_reporter = _oboe.Context_init_reporter

def Context_disconnect(rep):
    return _oboe.Context_disconnect(rep)
Context_disconnect = _oboe.Context_disconnect

def Context_reconnect(rep):
    return _oboe.Context_reconnect(rep)
Context_reconnect = _oboe.Context_reconnect
...
def Span_createHttpSpan(transaction, url, duration, status, method, has_error):
    return _oboe.Span_createHttpSpan(transaction, url, duration, status, method, has_error)
...
def CustomMetrics_summary(name, value, count, host_tag, tags, tags_count):
    return _oboe.CustomMetrics_summary(name, value, count, host_tag, tags, tags_count)
CustomMetrics_summary = _oboe.CustomMetrics_summary

def CustomMetrics_increment(name, count, host_tag, tags, tags_count):
    return _oboe.CustomMetrics_increment(name, count, host_tag, tags, tags_count)
...
class Reporter(_object):
    ...
    def __init__(self, protocol, args):
        this = _oboe.new_Reporter(protocol, args)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
...
class SslReporter(_object):
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, SslReporter, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, SslReporter, name)
    __repr__ = _swig_repr

    def __init__(self, config):
        this = _oboe.new_SslReporter(config)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_destroy__ = _oboe.delete_SslReporter
    __del__ = lambda self: None

    def sendReport(self, *args):
        return _oboe.SslReporter_sendReport(self, *args)

    def sendStatus(self, *args):
        return _oboe.SslReporter_sendStatus(self, *args)
SslReporter_swigregister = _oboe.SslReporter_swigregister
SslReporter_swigregister(SslReporter)
...
class UdpReporter(_object):
    ...
    def __init__(self, addr, port=None):
        this = _oboe.new_UdpReporter(addr, port)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_destroy__ = _oboe.delete_UdpReporter
    __del__ = lambda self: None

    def sendReport(self, *args):
        return _oboe.UdpReporter_sendReport(self, *args)

    def sendStatus(self, *args):
        return _oboe.UdpReporter_sendStatus(self, *args)
UdpReporter_swigregister = _oboe.UdpReporter_swigregister
...
class FileReporter(_object):
    ...
    def __init__(self, file):
        this = _oboe.new_FileReporter(file)
        try:
            self.this.append(this)
        except Exception:
            self.this = this
    __swig_destroy__ = _oboe.delete_FileReporter
    __del__ = lambda self: None

    def sendReport(self, *args):
        return _oboe.FileReporter_sendReport(self, *args)

    def sendStatus(self, *args):
        return _oboe.FileReporter_sendStatus(self, *args)
FileReporter_swigregister = _oboe.FileReporter_swigregister
