...
class Delegate:
    ...
    @staticmethod
    def trueshare(start_block=0, del_pubkey=None, del_address=None, blacklist=None, share_fees=False, max_weight=float('inf')):
        '''
...
#         FROM blocks
#         INNER JOIN
#           mem_accounts."publicKey" on blocks."generatorPublicKey"
#
#
#
#         ;""".format(delegate_pubkey))
