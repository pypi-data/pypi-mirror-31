...
class SGdata(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["sghash"] = _clipper_python_core.SGdata_sghash_set
    __swig_getmethods__["sghash"] = _clipper_python_core.SGdata_sghash_get
    if _newclass:
        sghash = _swig_property(_clipper_python_core.SGdata_sghash_get, _clipper_python_core.SGdata_sghash_set)
    __swig_getmethods__["hall"] = _clipper_python_core.SGdata_hall_get
    if _newclass:
        hall = _swig_property(_clipper_python_core.SGdata_hall_get)
    __swig_getmethods__["hm"] = _clipper_python_core.SGdata_hm_get
    if _newclass:
        hm = _swig_property(_clipper_python_core.SGdata_hm_get)
    __swig_setmethods__["ext"] = _clipper_python_core.SGdata_ext_set
    __swig_getmethods__["ext"] = _clipper_python_core.SGdata_ext_get
    if _newclass:
        ext = _swig_property(_clipper_python_core.SGdata_ext_get, _clipper_python_core.SGdata_ext_set)
    __swig_setmethods__["num"] = _clipper_python_core.SGdata_num_set
    __swig_getmethods__["num"] = _clipper_python_core.SGdata_num_get
    if _newclass:
...
class LGdata(_object):
    ...
    __repr__ = _swig_repr
    __swig_setmethods__["lghash"] = _clipper_python_core.LGdata_lghash_set
    __swig_getmethods__["lghash"] = _clipper_python_core.LGdata_lghash_get
    if _newclass:
        lghash = _swig_property(_clipper_python_core.LGdata_lghash_get, _clipper_python_core.LGdata_lghash_set)
    __swig_setmethods__["asufn"] = _clipper_python_core.LGdata_asufn_set
    __swig_getmethods__["asufn"] = _clipper_python_core.LGdata_asufn_get
    if _newclass:
        asufn = _swig_property(_clipper_python_core.LGdata_asufn_get, _clipper_python_core.LGdata_asufn_set)
    __swig_getmethods__["lgname"] = _clipper_python_core.LGdata_lgname_get
    if _newclass:
...
class Spgr_cacheobj(_object):
    ...
    __swig_setmethods__["spgr_cachekey_"] = _clipper_python_core.Spgr_cacheobj_spgr_cachekey__set
    __swig_getmethods__["spgr_cachekey_"] = _clipper_python_core.Spgr_cacheobj_spgr_cachekey__get
    if _newclass:
    ...
    __swig_setmethods__["nsym"] = _clipper_python_core.Spgr_cacheobj_nsym_set
    __swig_getmethods__["nsym"] = _clipper_python_core.Spgr_cacheobj_nsym_get
    if _newclass:
        nsym = _swig_property(_clipper_python_core.Spgr_cacheobj_nsym_get, _clipper_python_core.Spgr_cacheobj_nsym_set)
    __swig_setmethods__["nsymn"] = _clipper_python_core.Spgr_cacheobj_nsymn_set
    __swig_getmethods__["nsymn"] = _clipper_python_core.Spgr_cacheobj_nsymn_get
    if _newclass:
        nsymn = _swig_property(_clipper_python_core.Spgr_cacheobj_nsymn_get, _clipper_python_core.Spgr_cacheobj_nsymn_set)
    __swig_setmethods__["nsymi"] = _clipper_python_core.Spgr_cacheobj_nsymi_set
    __swig_getmethods__["nsymi"] = _clipper_python_core.Spgr_cacheobj_nsymi_get
    if _newclass:
        nsymi = _swig_property(_clipper_python_core.Spgr_cacheobj_nsymi_get, _clipper_python_core.Spgr_cacheobj_nsymi_set)
    __swig_setmethods__["nsymc"] = _clipper_python_core.Spgr_cacheobj_nsymc_set
    __swig_getmethods__["nsymc"] = _clipper_python_core.Spgr_cacheobj_nsymc_get
    if _newclass:
        nsymc = _swig_property(_clipper_python_core.Spgr_cacheobj_nsymc_get, _clipper_python_core.Spgr_cacheobj_nsymc_set)
    __swig_setmethods__["nsymp"] = _clipper_python_core.Spgr_cacheobj_nsymp_set
    __swig_getmethods__["nsymp"] = _clipper_python_core.Spgr_cacheobj_nsymp_get
    if _newclass:
        nsymp = _swig_property(_clipper_python_core.Spgr_cacheobj_nsymp_get, _clipper_python_core.Spgr_cacheobj_nsymp_set)
    __swig_setmethods__["lgrp"] = _clipper_python_core.Spgr_cacheobj_lgrp_set
    __swig_getmethods__["lgrp"] = _clipper_python_core.Spgr_cacheobj_lgrp_get
    if _newclass:
        lgrp = _swig_property(_clipper_python_core.Spgr_cacheobj_lgrp_get, _clipper_python_core.Spgr_cacheobj_lgrp_set)
    __swig_setmethods__["symops"] = _clipper_python_core.Spgr_cacheobj_symops_set
    __swig_getmethods__["symops"] = _clipper_python_core.Spgr_cacheobj_symops_get
    if _newclass:
        symops = _swig_property(_clipper_python_core.Spgr_cacheobj_symops_get, _clipper_python_core.Spgr_cacheobj_symops_set)
    __swig_setmethods__["isymops"] = _clipper_python_core.Spgr_cacheobj_isymops_set
    __swig_getmethods__["isymops"] = _clipper_python_core.Spgr_cacheobj_isymops_get
    if _newclass:
        isymops = _swig_property(_clipper_python_core.Spgr_cacheobj_isymops_get, _clipper_python_core.Spgr_cacheobj_isymops_set)
    __swig_setmethods__["asu_min_"] = _clipper_python_core.Spgr_cacheobj_asu_min__set
    __swig_getmethods__["asu_min_"] = _clipper_python_core.Spgr_cacheobj_asu_min__get
    if _newclass:
        asu_min_ = _swig_property(_clipper_python_core.Spgr_cacheobj_asu_min__get, _clipper_python_core.Spgr_cacheobj_asu_min__set)
    __swig_setmethods__["asu_max_"] = _clipper_python_core.Spgr_cacheobj_asu_max__set
    __swig_getmethods__["asu_max_"] = _clipper_python_core.Spgr_cacheobj_asu_max__get
    if _newclass:
        asu_max_ = _swig_property(_clipper_python_core.Spgr_cacheobj_asu_max__get, _clipper_python_core.Spgr_cacheobj_asu_max__set)
    __swig_setmethods__["mutex"] = _clipper_python_core.Spgr_cacheobj_mutex_set
    __swig_getmethods__["mutex"] = _clipper_python_core.Spgr_cacheobj_mutex_get
    if _newclass:
...
class Atom(_object):
    ...
    def _get_element_as_clipper_string(self):
        """
...
class Unit_Cell(_object):
    ...
    def all_symops_in_box(self, box_origin_xyz, box_size_uvw, always_include_identity=False, sample_frequency=2):
        """
...
class mat33_double(_object):
    ...
    __swig_setmethods__ = {}
    __setattr__ = lambda self, name, value: _swig_setattr(self, mat33_double, name, value)
    __swig_getmethods__ = {}
    __getattr__ = lambda self, name: _swig_getattr(self, mat33_double, name)
    __repr__ = _swig_repr
...
class HKL_data_cacheobj(HKL_info):
    ...
    __swig_setmethods__["mutex"] = _clipper_python_core.HKL_data_cacheobj_mutex_set
    __swig_getmethods__["mutex"] = _clipper_python_core.HKL_data_cacheobj_mutex_get
    if _newclass:
...
class Xmap_cacheobj(_object):
    ...
    __swig_setmethods__["key"] = _clipper_python_core.Xmap_cacheobj_key_set
    __swig_getmethods__["key"] = _clipper_python_core.Xmap_cacheobj_key_get
    if _newclass:
        key = _swig_property(_clipper_python_core.Xmap_cacheobj_key_get, _clipper_python_core.Xmap_cacheobj_key_set)
    __swig_setmethods__["xtl_grid"] = _clipper_python_core.Xmap_cacheobj_xtl_grid_set
    __swig_getmethods__["xtl_grid"] = _clipper_python_core.Xmap_cacheobj_xtl_grid_get
    if _newclass:
        xtl_grid = _swig_property(_clipper_python_core.Xmap_cacheobj_xtl_grid_get, _clipper_python_core.Xmap_cacheobj_xtl_grid_set)
    __swig_setmethods__["asu_grid"] = _clipper_python_core.Xmap_cacheobj_asu_grid_set
    __swig_getmethods__["asu_grid"] = _clipper_python_core.Xmap_cacheobj_asu_grid_get
    if _newclass:
        asu_grid = _swig_property(_clipper_python_core.Xmap_cacheobj_asu_grid_get, _clipper_python_core.Xmap_cacheobj_asu_grid_set)
    __swig_setmethods__["map_grid"] = _clipper_python_core.Xmap_cacheobj_map_grid_set
    __swig_getmethods__["map_grid"] = _clipper_python_core.Xmap_cacheobj_map_grid_get
    if _newclass:
        map_grid = _swig_property(_clipper_python_core.Xmap_cacheobj_map_grid_get, _clipper_python_core.Xmap_cacheobj_map_grid_set)
    __swig_setmethods__["nsym"] = _clipper_python_core.Xmap_cacheobj_nsym_set
    __swig_getmethods__["nsym"] = _clipper_python_core.Xmap_cacheobj_nsym_get
    if _newclass:
        nsym = _swig_property(_clipper_python_core.Xmap_cacheobj_nsym_get, _clipper_python_core.Xmap_cacheobj_nsym_set)
    __swig_setmethods__["asu"] = _clipper_python_core.Xmap_cacheobj_asu_set
    __swig_getmethods__["asu"] = _clipper_python_core.Xmap_cacheobj_asu_get
    if _newclass:
        asu = _swig_property(_clipper_python_core.Xmap_cacheobj_asu_get, _clipper_python_core.Xmap_cacheobj_asu_set)
    __swig_setmethods__["isymop"] = _clipper_python_core.Xmap_cacheobj_isymop_set
    __swig_getmethods__["isymop"] = _clipper_python_core.Xmap_cacheobj_isymop_get
    if _newclass:
        isymop = _swig_property(_clipper_python_core.Xmap_cacheobj_isymop_get, _clipper_python_core.Xmap_cacheobj_isymop_set)
    __swig_setmethods__["du"] = _clipper_python_core.Xmap_cacheobj_du_set
    __swig_getmethods__["du"] = _clipper_python_core.Xmap_cacheobj_du_get
    if _newclass:
        du = _swig_property(_clipper_python_core.Xmap_cacheobj_du_get, _clipper_python_core.Xmap_cacheobj_du_set)
    __swig_setmethods__["dv"] = _clipper_python_core.Xmap_cacheobj_dv_set
    __swig_getmethods__["dv"] = _clipper_python_core.Xmap_cacheobj_dv_get
    if _newclass:
        dv = _swig_property(_clipper_python_core.Xmap_cacheobj_dv_get, _clipper_python_core.Xmap_cacheobj_dv_set)
    __swig_setmethods__["dw"] = _clipper_python_core.Xmap_cacheobj_dw_set
    __swig_getmethods__["dw"] = _clipper_python_core.Xmap_cacheobj_dw_get
    if _newclass:
        dw = _swig_property(_clipper_python_core.Xmap_cacheobj_dw_get, _clipper_python_core.Xmap_cacheobj_dw_set)
    __swig_setmethods__["symperm"] = _clipper_python_core.Xmap_cacheobj_symperm_set
    __swig_getmethods__["symperm"] = _clipper_python_core.Xmap_cacheobj_symperm_get
    if _newclass:
        symperm = _swig_property(_clipper_python_core.Xmap_cacheobj_symperm_get, _clipper_python_core.Xmap_cacheobj_symperm_set)
    __swig_setmethods__["mat_grid_orth"] = _clipper_python_core.Xmap_cacheobj_mat_grid_orth_set
    __swig_getmethods__["mat_grid_orth"] = _clipper_python_core.Xmap_cacheobj_mat_grid_orth_get
    if _newclass:
    ...
    __swig_setmethods__["mutex"] = _clipper_python_core.Xmap_cacheobj_mutex_set
    __swig_getmethods__["mutex"] = _clipper_python_core.Xmap_cacheobj_mutex_get
    if _newclass:
...
class Xmap_float(Xmap_base):
    ...
    def _export_section_numpy(self, *args):
...
class CCP4MTZ_type_registry(_object):
    ...
    if _newclass:
        ...
        add_type = _clipper_python_core.CCP4MTZ_type_registry_add_type
    if _newclass:
        type = staticmethod(_clipper_python_core.CCP4MTZ_type_registry_type)
    else:
        type = _clipper_python_core.CCP4MTZ_type_registry_type
    if _newclass:
        scale = staticmethod(_clipper_python_core.CCP4MTZ_type_registry_scale)
    else:
        scale = _clipper_python_core.CCP4MTZ_type_registry_scale
    if _newclass:
        add_group = staticmethod(_clipper_python_core.CCP4MTZ_type_registry_add_group)
    else:
        add_group = _clipper_python_core.CCP4MTZ_type_registry_add_group
    if _newclass:
        group_type = staticmethod(_clipper_python_core.CCP4MTZ_type_registry_group_type)
    else:
        group_type = _clipper_python_core.CCP4MTZ_type_registry_group_type
...
class MAtom(Atom):
    ...
    if _newclass:
        ...
        id_tidy = _clipper_python_core.MAtom_id_tidy
    if _newclass:
        id_match = staticmethod(_clipper_python_core.MAtom_id_match)
    else:
        id_match = _clipper_python_core.MAtom_id_match
...
class MMonomer(_object):
    ...
    if _newclass:
        ...
        id_tidy = _clipper_python_core.MMonomer_id_tidy
    if _newclass:
        id_match = staticmethod(_clipper_python_core.MMonomer_id_match)
    else:
        id_match = _clipper_python_core.MMonomer_id_match
    ...
    if _newclass:
        ...
        protein_peptide_bond = _clipper_python_core.MMonomer_protein_peptide_bond
    if _newclass:
        protein_ramachandran_phi = staticmethod(_clipper_python_core.MMonomer_protein_ramachandran_phi)
    else:
        protein_ramachandran_phi = _clipper_python_core.MMonomer_protein_ramachandran_phi
    if _newclass:
        protein_ramachandran_psi = staticmethod(_clipper_python_core.MMonomer_protein_ramachandran_psi)
    else:
        protein_ramachandran_psi = _clipper_python_core.MMonomer_protein_ramachandran_psi
    if _newclass:
        default_type = staticmethod(_clipper_python_core.MMonomer_default_type)
    else:
        default_type = _clipper_python_core.MMonomer_default_type
...
class MPolymer(_object):
    ...
    if _newclass:
        ...
        id_tidy = _clipper_python_core.MPolymer_id_tidy
    if _newclass:
        id_match = staticmethod(_clipper_python_core.MPolymer_id_match)
    else:
        id_match = _clipper_python_core.MPolymer_id_match
...
class MPolymerSequence(_object):
    ...
    if _newclass:
        ...
        id_tidy = _clipper_python_core.MPolymerSequence_id_tidy
    if _newclass:
        id_match = staticmethod(_clipper_python_core.MPolymerSequence_id_match)
    else:
        id_match = _clipper_python_core.MPolymerSequence_id_match
...
class HKL_data_F_phi_float(HKL_data_base):
    ...
    def _getDataNumpy(self, numpy_array):
