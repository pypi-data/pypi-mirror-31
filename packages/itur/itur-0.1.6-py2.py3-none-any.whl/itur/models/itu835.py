...
class _ITU835_5():
    ...
    def low_latitude_pressure(self, h):
        ...
        return np.where(
            (0 <= h) & (h <= 10),
            1012.0306 - 109.0338 * h + 3.6316 * h ** 2, np.where(
                (10 < h) & (h <= 72),
    ...
    def mid_latitude_pressure_summer(self, h):
        ...
        return np.where(
            (0 <= h) & (h <= 10),
            1008.0278 - 113.2494 * h + 3.9408 * h ** 2, np.where(
                (10 < h) & (h <= 72),
    ...
    def mid_latitude_water_vapour_summer(self, h):
        ...
        """
        return np.where((0 <= h) & (
            h <= 15), 8.988 * np.exp(- 0.3614 * h - 0.005402 * h**2 - 0.001955 * h**3), 0)

    def mid_latitude_temperature_winter(self, h):
        """Section 4.2 of Recommendation ITU-R P.835
        """
        return np.where((0 <= h) & (h < 8.5),
                        257.4345 + 2.3474 * h - 1.5479 * h ** 2 + 0.08473 * h **
                        3, np.where(
                            (8.5 <= h) & (h < 30),
            217.5, np.where(
                                (30 <= h) & (h < 50),
                                217.5 + (h - 30) * 2.125, np.where(
                                    (50 <= h) & (h < 54),
                                    260, np.where(
                                        (54 <= h) & (h <= 100),
                                        260 - (h - 54) * 1.667),
    ...
    def mid_latitude_pressure_winter(self, h):
        ...
        return np.where(
            (0 <= h) & (h <= 10),
            1010.8828 - 122.2411 * h + 4.554 * h ** 2, np.where(
                (10 < h) & (h <= 72),
                P10 * np.exp(-0.147 * (h - 10)),
                np.where(
                    (72 < h) & (h <= 100),
                    P72 * np.exp(-0.150 * (h - 72)),
                    np.nan)))
    ...
    def mid_latitude_water_vapour_winter(self, h):
        ...
        """
        return np.where((0 <= h) & (
            h <= 10), 1.2319 * np.exp(0.07481 * h - 0.0981 * h**2 + 0.00281 * h**3), 0)

    ## Mid latitude standard atmosphere functions  (Section ITU-R P.835-5-2) ##
    def high_latitude_temperature_summer(self, h):
        """Section 3.1 of Recommendation ITU-R P.835
        """
        return np.where((0 <= h) & (h < 13),
                        294.9838 - 5.2159 * h - 9.07109 * h ** 2, np.where(
                            (13 <= h) & (h < 17),
                            215, np.where(
                                (17 <= h) & (h < 47),
    ...
    def high_latitude_water_vapour_summer(self, h):
        ...
        """
        return np.where((0 <= h) & (
            h <= 15), 14.3542 * np.exp(- 0.4174 * h - 0.02290 * h**2 + 0.001007 * h**3), 0)
    ...
    def high_latitude_pressure_winter(self, h):
        ...
        return np.where(
            (0 <= h) & (h <= 10),
            1018.8627 - 124.2954 * h + 4.8307 * h ** 2, np.where(
                (10 < h) & (h <= 72),
                P10 * np.exp(-0.147 * (h - 10)),
                np.where(
                    (72 < h) & (h <= 100),
                    P72 * np.exp(-0.155 * (h - 72)),
                    np.nan)))
