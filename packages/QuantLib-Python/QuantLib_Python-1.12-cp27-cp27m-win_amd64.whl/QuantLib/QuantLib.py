...
class FdBlackScholesVanillaEngine(PricingEngine):
    ...
    def __init__(self, process, tGrid=100, xGrid=100, dampingSteps=0):
...
class FdBatesVanillaEngine(PricingEngine):
    ...
    def __init__(self, model, tGrid=100, xGrid=100, vGrid=50, dampingSteps=0):
...
class ZeroCouponInflationSwapHelper(ZeroHelper):
    ...
    def __init__(self, rate, lag, maturity, calendar, bdc, dayCounter, index):
...
class CreditDefaultSwap(Instrument):
    ...
    def impliedHazardRate(self, targetNPV, discountCurve, dayCounter, recoveryRate=0.4, accuracy=1.0e-6):
