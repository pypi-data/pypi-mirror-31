...
from itertools import islice, cycle, repeat, product
...
class Conveyor(object):
    ...
    def cycling(self, **kwargs_seqs):
        ...
        self._generators.append(reduce(merged, kwargs, {})
                                for kwargs in zip(*gens))
    ...
    def generate_kwargs(self):
        ...
        for kwarg_dicts in zip(*self._generators):
            kwargs = reduce(merged, kwarg_dicts, {})
            yield kwargs
    ...
    def of_size(self, n):
        ...
        if not self.func or not callable(self.func):
            raise ValueError("Could not batch call because no callable was "
    ...
    def from_table(self, header, rows):
        ...
        (Conveyor.create_batch_from(PersonFactory)
         ...
         .from_table(('age', 'hair_color', 'job'),
            ...
            {'age': 36, 'hair_color': 'blond', 'job': 'Developer', alive: True},
            {'age': 18, 'hair_color': 'brown', 'job': 'Student', alive: True},
            {'age': 5, 'hair_color': 'black', 'job': None, alive: True},
            {'age': 72, 'hair_color': 'grey', 'job': 'Pensioner', alive: True},)
        """
