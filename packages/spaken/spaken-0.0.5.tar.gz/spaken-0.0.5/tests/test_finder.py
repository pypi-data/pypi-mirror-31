...
def test_find():
    ...
    whl = wheel_set.find('django-healthchecks==1.4.0')
    ...
    whl = wheel_set.find('django-healthchecks>=1.3.0,<1.4.0')
    assert whl.filename == 'django-healthchecks-1.3.1-py2.py3-none-any.whl'

    whl = wheel_set.find('django-healthchecks')
    assert whl.filename == 'django_healthchecks-1.4.0-py2.py3-none-any.whl'
...
def test_collect_filenames():
    ...
    requirements = [
        ...
        'wsgi-basic-auth-healthchecks==1.1.0',
    ]
    ...
    assert missing == ['wsgi-basic-auth-healthchecks==1.1.0']
