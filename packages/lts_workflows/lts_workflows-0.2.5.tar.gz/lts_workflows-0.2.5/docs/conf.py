...
# -*- coding: utf-8 -*-
#
# lts_workflows documentation build configuration file, created by
...
from lts_workflows import __version__
...
htmlhelp_basename = 'lts_workflowsdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'lts_workflows.tex',
     u'lts-workflows Documentation',
