...
class MlRepo(Repo):
    ...
    def __create_metadata(self):
        ...
        return BackendMetadataDB(self._connection_by_name('metadata'), self._config, handle_api, **self.__extra_repo_params)
    ...
    def create_object_store(self):
        ...
        if bucket_name is None:
            return BackendGCSObjectStore(
                ...
                self._config, handle_api, use_multiprocess=use_multiprocess, processes=processes)
    ...
    def remote_commit(self, message, isolation_token):
        ...
        return handle_api(self._config, requests.post, url, msg, async=True)
