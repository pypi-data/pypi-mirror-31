...
public:
    ...
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &LookupReplyPrx::_iceI_foundLocator, prx, context);
    }
...
public:
    ...
    findLocatorAsync(const ::std::string& instanceName, const ::std::shared_ptr<LookupReplyPrx>& reply,
                     ...
                     const ::Ice::Context& context = ::Ice::noExplicitContext)
    {
        return _makeLamdaOutgoing<void>(response, ex, sent, this, &LookupPrx::_iceI_findLocator, instanceName, reply, context);
    }
