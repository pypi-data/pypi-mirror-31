...
{
    outAsync->invoke(iceC_Ice_Process_shutdown_name, OperationMode::Normal, FormatType::DefaultFormat, context,
        nullptr,
        nullptr);
}
/// \endcond
...
{
    outAsync->invoke(iceC_Ice_Process_writeMessage_name, OperationMode::Normal, FormatType::DefaultFormat, context,
        [&](OutputStream* ostr)
        {
