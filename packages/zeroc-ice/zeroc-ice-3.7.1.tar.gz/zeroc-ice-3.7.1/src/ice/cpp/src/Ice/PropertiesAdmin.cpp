...
Ice::PropertiesAdminPrx::_iceI_getProperty(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<::std::string>>& outAsync, const ::std::string& iceP_key, const Context& context)
{
    ...
    outAsync->invoke(iceC_Ice_PropertiesAdmin_getProperty_name, OperationMode::Normal, FormatType::DefaultFormat, context,
        [&](OutputStream* ostr)
        {
...
Ice::PropertiesAdminPrx::_iceI_getPropertiesForPrefix(const ::std::shared_ptr<::IceInternal::OutgoingAsyncT<PropertyDict>>& outAsync, const ::std::string& iceP_prefix, const Context& context)
{
    ...
    outAsync->invoke(iceC_Ice_PropertiesAdmin_getPropertiesForPrefix_name, OperationMode::Normal, FormatType::DefaultFormat, context,
        [&](OutputStream* ostr)
        {
...
{
    outAsync->invoke(iceC_Ice_PropertiesAdmin_setProperties_name, OperationMode::Normal, FormatType::DefaultFormat, context,
        [&](OutputStream* ostr)
        {
