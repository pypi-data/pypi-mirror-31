...
class Project(object):
	def __init__(self, name='project', projecttype=ProjectTypes.tool, suffixenable=False):
		...
		self.configurations = [ConfigurationTypes.debug, ConfigurationTypes.internal, ConfigurationTypes.release]
...
class Solution(object):
	...
	def processcommandline(self, args):
		...
		if not configurations:
			configurations = [ConfigurationTypes.debug, ConfigurationTypes.internal, ConfigurationTypes.release]
