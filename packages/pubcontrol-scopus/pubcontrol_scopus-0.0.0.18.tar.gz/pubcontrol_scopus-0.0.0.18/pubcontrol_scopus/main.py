...
class PublicationDictAdapter(DictQuery):
    ...
    def process(self):
        ...
        Changed 22.04.2018
        The collaboration field will now also be in the publication dict
        ...
        self.publication_dict['collaboration'] = self.query('collaboration', 'none')
...
class StubBlacklist(BlacklistABC):
...
class Plugin:
    ...
    @hookimpl
    def fetch(self):
        self.logger.info('[fetch] entering the fetch method...')
