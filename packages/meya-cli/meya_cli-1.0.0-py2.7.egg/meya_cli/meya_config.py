...
DEFAULT_API_ROOT = "https://meya.ai/webhook"
...
class MeyaConfig(object):
    def __init__(self, root_dir, api_key, bot_id, api_root, ignore_files,
                 ignore_dot_files, autosync_files=DEFAULT_AUTO_SYNC_FILES,
                 verbose=False,
