...
setup(
    ...
    description='Sakura Secure Mobile Connect API tool',  # Required
    ...
    url='https://github.com/hitsumabushi/python-sakura-secure-mobile-connect',  # Optional

    # This should be your name or the name of the organization which owns the
    # project.
    author='hitsumabushi',  # Optional

    # This should be a valid email address corresponding to the author listed
    # above.
    author_email='hitsumabushi.org@gmail.com',  # Optional
    ...
    keywords='SAKURA Cloud SIM SakuraSecureMobileConnect SSMC',  # Optional
