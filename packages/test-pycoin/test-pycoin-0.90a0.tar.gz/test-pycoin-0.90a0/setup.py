...
setup(
    ...
    author_email="helen.hk@gmail.com",
    url="https://github.com/helenagu01/pycoin",
    license="http://opensource.org/licenses/MIT",
    description="Fork richard Utilities for Bitcoin and altcoin addresses and transaction manipulation.",
    classifiers=[
