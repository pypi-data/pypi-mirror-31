from Objects import Entity, Item, Living
...
class MapTile(object):
    ...
    def __init__(self, x, y, description):
        ...
        self.x = x # Where the tile is in world space
        self.y = y # Where the tile is in world space
        self.description = description # Description to send the player when they enter
        self.creatures = [] # List of Living Entities
        self.players = [] # List of Players
        self.items = [] # List of ItemDrops
