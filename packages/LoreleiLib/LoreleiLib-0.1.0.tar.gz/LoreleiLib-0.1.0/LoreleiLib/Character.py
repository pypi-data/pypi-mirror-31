...
class CharacterClass(object):
    ...
    def __init__(self, name, description, skill_list, weapon_list, armor_list):
        # type: (str, str, dict, list, list) -> None
        self.name = name # type: str
        self.description = description # type: str
        self.skill_list = skill_list # type: dict<int, list>
        self.weapons = weapon_list # type: list<WeaponType>
        self.armor = armor_list # type: list<ArmorType>
