...
class BigQueryMixin(ConnectionMixin):
    ...
    def _query_sync_by_job(self, query_job, max_results=None, start_index=0, process_row=None):
    ...
    def _query_sync(self, query, job_config, max_results=None, start_index=0, process_row=None):
        ...
        return self._query_sync_by_job(query_job, max_results, start_index, process_row)
