...
# With blackjack and hookers!
# ---
# This is a file writer that doesn't complain about unicode/string mismatches. It works for both python 2 and 3.
# This probably (hopefully?) does already exist, but after searching for almost an hour I gave up and just wrote the stupid thing myself.
##############################################################################################################


class open_with_blackjack_and_hookers:
    def __init__(self, file_path):
        super(open_with_blackjack_and_hookers, self).__init__()
        self.file_path = file_path
    def __enter__(self):
        self.file_writer = open(self.error_file, 'w', encoding='utf8')
