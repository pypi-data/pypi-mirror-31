...
class MessageBuilder(Message):
    ...
    def __init__(self, identifier=None):
        super(Message, self).__init__(create_preliminary_identifier('message') if identifier is None else identifier, [], 'all')
...
class ProgramExecutionRequest(Event):
    ...
    """
    def __init__(self):
        super(Event, self).__init__(create_preliminary_identifier('event'), 'execute_program', {'argument_dict' : {}})
