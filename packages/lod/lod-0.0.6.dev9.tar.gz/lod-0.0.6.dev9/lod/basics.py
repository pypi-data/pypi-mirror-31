...
class MessageBuilder(Message):
    ...
    def __init__(self, identifier=None):
        super(self, Message).__init__(create_preliminary_identifier('message') if identifier is None else identifier, [], 'all')
...
class ProgramExecutionRequest(Event):
    ...
    """
    def __init__(self):
        super(self, Event).__init__(create_preliminary_identifier('event'), 'execute_program', {'argument_dict' : {}})
