...
class Identifier(object):
    ...
    def __init__(self, model_id, type, preliminary=None, name=None):
        self.id = model_id
        self.type = type
        if not (preliminary is None or (isinstance(preliminary, (str, unicode)) and preliminary)): # if it's a string, it must be truthy
...
class TagBuilder():
    ...
    def comment(self, comment):
        ...
        """
        if comment is not None and not isinstance(comment, (str, unicode)):
...
class MessageBuilder(Message):
    ...
    def add_text(self, message_text):
        ...
        """
        if not isinstance(message_text, (str, unicode)):
    ...
    def add_html(self, html_code):
        ...
        """
        if not isinstance(html_code, (str, unicode)):
...
class ProgramExecutionRequest(Event):
    ...
    def program(self, program_identifier):
        ...
        elif isinstance(program_identifier, (str, unicode)):
    ...
    def argument(self, arg_name, object_or_identifier):
        ...
        """
        if not isinstance(arg_name, (str, unicode)):
