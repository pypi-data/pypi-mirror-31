...
## ------------------------------------------------------------------------------------------------------------------
## Code was generated at Tue Apr 24 14:26:53 IDT 2018
## vDirect version: 4.4.0
## Open issues:
...
class RestClient(object):
    ...
    def _prepare_value(self, value):
        return urllib.quote(value) if isinstance(value, basestring) else value
