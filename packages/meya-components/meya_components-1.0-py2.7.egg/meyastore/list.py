...
class QueryResult(list):
    def __init__(self, iterable, continuation):
...
class ListDB(BaseDB):
    ...
    def __init__(self, bot_id, item_id=None):
        super(ListDB, self).__init__(bot_id, item_id)
    ...
    def filter(self, order_by=None, limit=None, continuation=None,
               index_name=None, index_key_name=None, **kwargs):
        raise Exception("Feature not available in local testing!")
