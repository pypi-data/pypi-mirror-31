...
class GitWrapper:
    ...
    def init(self,onepanel_acc_uid,gitlab_token,home, account_uid, project_uid):
        git_cmd = 'git init'
    ...
    def clone(self,onepanel_acc_uid,gitlab_token, home, account_uid, project_uid, ext=''):
    ...
    def lfs_clone(self,onepanel_acc_uid,gitlab_token, home, account_uid, project_uid, ext='', include='', exclude=''):
