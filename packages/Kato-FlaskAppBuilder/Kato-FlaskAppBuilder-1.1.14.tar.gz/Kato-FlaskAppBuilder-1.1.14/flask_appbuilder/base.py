...
class AppBuilder(object):
    ...
    def init_app(self, app, session):
        ...
        config_urls['SCOPE_WORKER_URL'] = self.app.config['SCOPEWORKER_AUTHENTICATION_URL'];
        config_urls['SCOPE_WORKER_USER_URL'] = self.app.config['SCOPEWORKER_FETCH_USERS_URL'];
        if not self.app:
    ...
    def scopeworker_url(self):
        if(self.app):
            return self.app.config['SCOPEWORKER_AUTHENTICATION_URL'];
        else:
            return None;
