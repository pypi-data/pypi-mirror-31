...
class Run(Model):
    ...
    compare_fields = ["id", "status", "command", "gpu", "git_commit_hash", "docker_image", "framework", "workspace"]

    def __init__(self, id, status, command, gpu, git_commit_hash, framework, docker_image,
                 created_at, workspace, name, user_exit_code=None, started_at=None, ended_at=None, **kwargs):
        self.id = int(id)
        self.status = status
        self.user_exit_code = user_exit_code
...
class LsLine(Model):
    ...
    def __init__(self, path, size, date=None, upload_status=None, **kwargs):
        self.path = path
        self.size = size
        self.date = date
...
class BillingStatus(Model):
    ...
    def __init__(self, plan_id, plan_name, remaining_credit_cents, last_machine_invoice_date,
                 ...
                 concurrent_run_limit, total_runs, next_machine_invoice_date, **kwargs):
        ...
        self.last_machine_invoice_date = last_machine_invoice_date.date()
        self.next_machine_invoice_date = next_machine_invoice_date.date()
