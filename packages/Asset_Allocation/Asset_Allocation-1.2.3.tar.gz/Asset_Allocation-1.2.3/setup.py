...
setup(
    ...
    description='Asset Allocation project',  # Required
    ...
    url='https://github.com/MisterY/Asset-Allocation',  # Optional
    ...
    keywords='personal finance asset allocation',  # Optional
