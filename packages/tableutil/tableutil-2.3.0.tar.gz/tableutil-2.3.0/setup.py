...
MODULE_NAME = u'tableutil'  # The module name must match this!
...
setup(
    ...
    install_requires=[
        u'pip>=9.0.1',
        u'future>=0.16.0',
        u'logging-helper>=1.7.0',
        u'conversionutil>=1.1.0',
        u'fdutil>=1.8.0',
        u'attrs>=16.3.0',
        u'dominate>=2.3.1'
    ],
    ...
    package_data={
        ...
        'tableutil.resources': ['*.*', '**/*.*', '**/**/*.*'],  # Folders up to 2 levels deep will be included
    },
