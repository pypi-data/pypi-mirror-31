...
class MLang(object):
    ...
    def ssplit(cls, txt, impl='re', pattern='[\s,，.。:：!！?？、]'):
        ...
        :rtype: MResponse
        """
        return call_post(furl('nlp/ssplit'), locals())
    ...
    def tokenize(cls, txt, impl='ltp', vocabid=DEFAULT_VOCAB, max_len=4, update_cache=False):
        ...
        :rtype: MResponse
        """
        return call_post(furl('nlp/tokenize'), locals())
    ...
    def pos(cls, txt, impl='ltp', revise=False, norm=False):
        ...
        :rtype: MResponse
        """
        return call_post(furl('nlp/pos'), locals())
    ...
    def ner(cls, txt, impl='ltp'):
        ...
        :rtype: MResponse
        """
        return call_post(furl('nlp/ner'), locals())
    ...
    def parse(cls, txt, impl='ltp'):
        ...
        :rtype: MResponse
        """
        return call_post(furl('nlp/parse'), locals())
    ...
    def pinyin2hanzi(cls, txt, impl='Pinyin2Hanzi'):
        ...
        :rtype: MResponse
        """
        return call_post(furl('nlp/p2h'), locals())
    ...
    def hanzi2pinyin(cls, txt, impl='Pinyin2Hanzi'):
        ...
        :rtype: MResponse
        """
        return call_post(furl('nlp/h2p'), locals())
    ...
    def simplified2traditional(cls, txt, impl='zhconv'):
        ...
        :rtype: MResponse
        """
        return call_post(furl('nlp/s2t'), locals())
    ...
    def traditional2simplified(cls, txt, impl='zhconv'):
        ...
        :rtype: MResponse
        """
        return call_post(furl('nlp/t2s'), locals())
...
class MCorpus(object):
    ...
    def list(cls):
        ...
        :rtype: MResponse
        """
        return call_get(furl('corpus_list'), {})
    ...
    def info(cls, corpusid):
        ...
        :rtype: MResponse
        """
        return call_get(furl('corpus_info/%s' % corpusid), {})
    ...
    def upload(cls, corpusid, file_path, action='overwrite'):
        ...
        return upload_file(url, file_path, 'corpus', {'action': action})
    ...
    def remove(cls, corpusid):
        ...
        :rtype: MResponse
        """
        return call_delete(furl('corpus/%s' % corpusid), {})
...
class MVocab(object):
    ...
    def list(cls):
        ...
        :rtype: MResponse
        """
        return call_get(furl('vocab_list'), {})
    ...
    def info(cls, vocabid):
        ...
        :rtype: MResponse
        """
        return call_get(furl('vocab_info/%s' % vocabid), {})
    ...
    def upload(cls, vocabid, file_path, action='overwrite'):
        ...
        return upload_file(url, file_path, 'vocab', {'action': action})
    ...
    def remove(cls, vocabid):
        ...
        :rtype: MResponse
        """
        return call_delete(furl('vocab/%s' % vocabid), {})
    ...
    def build(cls, vocabid, corpusid, impl='ltp', topn=5000, min_freq=5):
        ...
        return call_post(furl('vocab/%s' % vocabid), {
            'corpusid': corpusid,
            'impl': impl,
            'topn': topn,
            'min_freq': min_freq
...
class MWordRepresentation(MRepresentation):
    ...
    def represent(cls, word, impl='w2v', update_cache=False, vocabid=DEFAULT_VOCAB, w2vid=DEFAULT_W2V):
        ...
        if impl == 'onehot':
            ...
            return call_get(url, {'word': word, 'vocabid': vocabid, 'update_cache': update_cache})
        elif impl == 'w2v':
            url = furl('rep/word/w2v')
            return call_get(url, {'word': word, 'w2vid': w2vid, 'update_cache': update_cache})
        else:
    ...
    def similarity(cls, word1, word2, impl='w2v', w2vid=DEFAULT_W2V, update_cache=False):
        ...
        if impl == 'w2v':
            ...
            return call_get(url, {'word1': word1, 'word2': word2, 'w2vid': w2vid, 'update_cache': update_cache})
        else:
...
class MTextRepresentation(MRepresentation):
    ...
    def represent(cls, txt, impl='w2v', d2vid=DEFAULT_D2V, w2vid=DEFAULT_W2V, vocabid=DEFAULT_VOCAB, update_cache=False,
        ...
        if impl == 'vocab':
            ...
            return call_post(url, {'txt': txt, 'vocabid': vocabid, 'update_cache': update_cache})
        elif impl == 'd2v':
            url = furl('rep/text/d2v')
            return call_post(url, {'txt': txt, 'd2vid': d2vid, 'tokenize': tokenize, 'vocabid': vocabid,
                                   'max_len': max_len, 'update_cache': update_cache})
        elif impl == 'w2v':
    ...
    def similarity(cls, txt1, txt2, impl='w2v', d2vid=DEFAULT_D2V, w2vid=DEFAULT_W2V, vocabid=DEFAULT_VOCAB,
        ...
        if impl == 'vocab':
            ...
            return call_post(url, {'txt1': txt1, 'txt2': txt2, 'vocabid': vocabid, 'update_cache': update_cache})
        elif impl == 'w2v':
...
class MLM(object):
    ...
    def info(cls, lmid):
        ...
        :rtype: MResponse
        """
        return call_get(furl('lm_info/%s' % lmid), {})
    ...
    def prob(cls, txt, lmid=DEFAULT_LM, tokenize=None, vocabid=DEFAULT_VOCAB, max_len=4, update_cache=False):
        ...
        :rtype: MResponse
        """
        return call_post(furl('lm/prob'), locals())
    ...
    def remove(cls, lmid):
        ...
        :rtype: MResponse
        """
        return call_delete(furl('lm/%s' % lmid), {})
...
class MWord2Vec(object):
    ...
    def info(cls, w2vid):
        ...
        :rtype: MResponse
        """
        return call_get(furl('w2v/info/%s' % w2vid), {})
    ...
    def build(cls, w2vid, corpusid,
        ...
        :rtype: MResponse
        """
        return call_post(furl('w2v/%s' % w2vid), locals())
    ...
    def download(cls, w2vid, file_path):
        ...
        :rtype: MResponse
        """
        return download_file(furl('w2v/%s' % w2vid), file_path)
    ...
    def remove(cls, w2vid):
        ...
        :rtype: MResponse
        """
        return call_delete(furl('w2v/%s' % w2vid), locals())
...
class MDoc2Vec(object):
    ...
    def info(cls, d2vid):
        ...
        :rtype: MResponse
        """
        return call_get(furl('d2v/info/%s' % d2vid), {})
    ...
    def build(cls, d2vid, corpusid,
        ...
        :rtype: MResponse
        """
        return call_post(furl('d2v/%s' % d2vid), locals())
    ...
    def download(cls, d2vid, file_path):
        ...
        :rtype: MResponse
        """
        return download_file(furl('d2v/%s' % d2vid), file_path)
    ...
    def remove(cls, d2vid):
        ...
        :rtype: MResponse
        """
        return call_delete(furl('d2v/%s' % d2vid), {'d2vid': d2vid})
...
class MSeq2Seq(object):
    ...
    def info(cls, s2sid):
        ...
        :rtype: MResponse
        """
        return call_get(furl('s2s_info/%s' % s2sid), {})
    ...
    def build(cls, s2sid, corpusid, epochs=10, batch_size=128, min_freq=5, max_length=50, hidden_size=128, layers=3):
        ...
        :rtype: MResponse
        """
        return call_post(furl('s2s/%s' % s2sid), locals())
    ...
    def predict(cls, s2sid, raw_seq, update_cache=False):
        ...
        :rtype: MResponse
        """
        return call_post(furl('s2s/predict'), {'s2sid': s2sid, 'seqs': raw_seq, 'update_cache': update_cache})
    ...
    def remove(cls, s2sid):
        ...
        :rtype: MResponse
        """
        return call_delete(furl('s2s/%s' % s2sid), {})
...
def call_post(url, data):
    ...
    return MResponse(requests.post(url, data=data))
...
def call_get(url, params):
    ...
    return MResponse(requests.get(url, params=params))
...
def call_delete(url, data):
    ...
    logger.debug('request params: %s' % data)
    return MResponse(requests.delete(url, params=data))
