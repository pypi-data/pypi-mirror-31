...
@_app.route("/entity-standalone-build/<string:entity_name>/<string:environment_name>/<string:instance_name>/<string:instance_type>/<string:accelerator_type>/<int:num_accelerators>/", methods=['GET'])
...
@_app.route("/entity-instance-start/<string:entity_name>/<string:environment_name>/<string:instance_name>/", methods=['GET'])
...
@_app.route("/entity-instance-stop/<string:entity_name>/<string:environment_name>/<string:instance_name>/", methods=['GET'])
...
@_app.route("/entity-instance-scale/<string:entity_name>/<string:environment_name>/<string:instance_name>/<int:replicas>", methods=['GET'])
...
@_app.route("/predict-tensorflow-describe/<string:model_name>/<string:model_tag>/<string:model_path>/", methods=['GET'])
...
@_app.route("/predict-kube-endpoint/<string:model_name>/", methods=['GET'])
...
@_app.route("/predict-kube-endpoints/", methods=['GET'])
...
@_app.route("/model-source-init/<string:model_name>/<string:model_tag>/<string:model_type>/<string:model_path>/", methods=['GET'])
...
@_app.route("/model-source-set/<string:model_name>/<string:model_tag>/<string:model_path>/<string:model_file_path>/<string:model_file_contents>/", methods=['GET'])
...
@_app.route("/model-source-list/", methods=['GET'])
...
@_app.route("/model-source-get/<string:model_name>/<string:model_tag>/<string:model_path>/<string:model_file_path>/", methods=['GET'])
...
# model_chip: gpu
#
@_app.route("/predict-server-build/<string:model_name>/<string:model_tag>/<string:model_type>/<string:model_runtime>/<string:model_chip>/<string:model_path>/<string:image_registry_url>/<string:image_registry_repo>/<string:image_registry_namespace>/", methods=['GET'])
...
@_app.route("/predict-server-register/<string:model_name>/<string:model_tag>/<string:image_registry_url>/<string:image_registry_repo>/", methods=['GET'])
...
#
# pipeline model-upload --model-name=pasta --model-tag=boo --model-type=python --upload-url=http://localhost:6970/model-upload/pasta/boo/python/python/cpu/ --upload-file-path=./pasta-boo.tar.gz
# NOTE:  MAKE SURE YOU ADD THE TRAILING SLASH TO THE URL ABOVE!
#
...
@_app.route("/model-archive-upload/<string:model_name>/<string:model_tag>/<string:model_type>/<string:model_path>/", methods=['POST'])
...
@_app.route("/predict-kube-start/<string:model_name>/<string:model_tag>/", methods=['GET'])
...
@_app.route("/stream-kube-start/<string:model_name>/<string:model_tag>/", methods=['GET'])
...
@_app.route("/stream-kube-stop/<string:model_name>/<string:model_tag>/", methods=['GET'])
...
@_app.route("/stream-kube-consume/<string:model_name>/<string:model_tag>/<string:stream_topic>/", methods=['GET'])
...
@_app.route("/predict-kube-logs/<string:model_name>/<string:model_tag>/", methods=['GET'])
...
@_app.route("/predict-kube-scale/<string:model_name>/<string:model_tag>/<int:replicas>/", methods=['GET'])
...
@_app.route("/predict-kube-autoscale/<string:model_name>/<string:model_tag>/<int:cpu_percent>/<int:min_replicas>/<int:max_replicas>/", methods=['GET'])
...
@_app.route("/spark-kube-scale/<int:replicas>/", methods=['GET'])
...
@_app.route("/predict-kube-describe/<string:model_name>/<string:model_tag>/", methods=['GET'])
...
@_app.route("/predict-kube-routes/<string:model_name>/", methods=['GET'])
def predict_kube_routes(model_name=None,
    ...
    model_split_tag_and_weight_dict = [ {route['labels']['tag']: route['weight']} for route in routes_json ]
...
@_app.route("/predict-kube-route/<string:model_name>/<string:model_split_tag_and_weight_dict>/<string:model_shadow_tag_list>/", methods=['GET'])
...
@_app.route("/predict-kube-stop/<string:model_name>/<string:model_tag>/", methods=['GET'])
...
# model_chip: gpu
#
@_app.route("/train-server-build/<string:model_name>/<string:model_tag>/<string:model_type>/<string:model_runtime>/<string:model_chip>/<string:model_path>/<string:image_registry_url>/<string:image_registry_repo>/<string:image_registry_namespace>/", methods=['GET'])
...
# ie. http://localhost:6970/train-local-noop/mnist/v1/L3Jvb3QvbW9kZWxzL21vZGVscy90ZW5zb3JmbG93L21uaXN0LXYxL21vZGVs
#@_app.route("/train-local-start/<string:model_name>/<string:model_tag>/<string:model_path>/", methods=['GET'])
...
# ie. http://localhost:6970/train-server-start/mnist/v1/<base64path>/<base64path>/<base64path>/<base64args>/
@_app.route("/train-server-start/<string:model_name>/<string:model_tag>/<string:input_host_path>/<string:output_host_path>/<string:runs_host_path>/<string:train_args>/", methods=['GET'])
def train_server_start(model_name,
    ...
    if _is_base64_encoded(runs_host_path):
        runs_host_path = _decode_base64(runs_host_path)
    runs_host_path = _os.path.expandvars(runs_host_path)
    runs_host_path = _os.path.expanduser(runs_host_path)
    runs_host_path = _os.path.normpath(runs_host_path)
    runs_host_path = _os.path.abspath(runs_host_path)

    print(runs_host_path)
    ...
    cmd = '%s run -itd -p 2222:2222 -p 6006:6006 -e PIPELINE_LOCAL_MODEL=true -e PIPELINE_STREAM_LOGGER_URL=%s -e PIPELINE_STREAM_LOGGER_TOPIC=%s -e PIPELINE_STREAM_INPUT_URL=%s -e PIPELINE_STREAM_INPUT_TOPIC=%s -e PIPELINE_STREAM_OUTPUT_URL=%s -e PIPELINE_STREAM_OUTPUT_TOPIC=%s -e TF_CONFIG=%s -e PIPELINE_TRAIN_ARGS="%s" -v %s:/opt/ml/input/ -v %s:/opt/ml/output/ -v %s:/opt/ml/runs/ --name=%s %s %s %s/%s/%s-%s:%s train' % (start_cmd, stream_logger_url, stream_logger_topic, stream_input_url, stream_input_topic, stream_output_url, stream_output_topic, tf_config_local_run, train_args, input_host_path, output_host_path, runs_host_path, container_name, memory_limit, start_cmd_extra_args, image_registry_url, image_registry_repo, image_registry_namespace, model_name, model_tag)
    print("")
    print(cmd)
    print("")
    process = _subprocess.call(cmd, shell=True)
...
def _create_train_kube_yaml(model_name,
    ...
    context = {
               ...
               'PIPELINE_RUNS_HOST_PATH': runs_host_path,
               'PIPELINE_STREAM_LOGGER_URL': stream_logger_url,
               'PIPELINE_STREAM_LOGGER_TOPIC': stream_logger_topic,
               'PIPELINE_STREAM_INPUT_URL': stream_input_url,
               'PIPELINE_STREAM_INPUT_TOPIC': stream_input_topic,
...
# ie. http://localhost:6970/train-kube-start/mnist/v1/<base64path>/<base64path>/<base64path>/<base64args>/
@_app.route("/train-kube-start/<string:model_name>/<string:model_tag>/<string:input_host_path>/<string:output_host_path>/<string:runs_host_path>/<string:train_args>/", methods=['GET'])
...
# ie. http://localhost:6970/train-kube-start/mnist/a/<base64path>/<base64path>/
@_app.route("/train-kube-stop/<string:model_name>/<string:model_tag>/", methods=['GET'])
...
@_app.route("/train-kube-logs/<string:model_name>/<string:model_tag>/", methods=['GET'])
...
# ie. http://localhost:6970/train-kube-scale/mnist/a/3/
@_app.route("/train-kube-scale/<string:model_name>/<string:model_tag>/<int:replicas>/", methods=['GET'])
...
@_app.route('/stream/<string:cli_command>/')
...
@_app.route('/stream-page/<string:cli_command>/')
def _stream_page(cli_command):
    return _redirect(_url_for('static', filename='stream-page.html', cli_command=cli_command))


# Http Mode:
#     pipeline http 6970 <debug=True|False> <_models_base_path>
# Http Mode with Stream:
#     gunicorn --bind 0.0.0.0:6970 --pythonpath <cli_pipeline_module_path> -k gevent cli_pipeline:_app http <debug=True|False> <_models_base_path>
def _main():
    #  WARNING:
