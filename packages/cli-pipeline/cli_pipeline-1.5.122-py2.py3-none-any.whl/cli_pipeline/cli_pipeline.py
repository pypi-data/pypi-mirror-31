...
@app.route("/model-init/<string:model_name>/<string:model_tag>/<string:model_type>/<string:new_model_path>/", methods=['GET'])
...
def predict_server_start(model_name,
    ...
    if not memory_limit:
        ...
        memory_limit = '--memory-limit=%s --memory-swap=%s' % (memory_limit, memory_limit)
    ...
    process = _subprocess.call(cmd, shell=True)
    print("")
    print("Start Container with Name: '%s'" % container_name)
...
def _model_tar_and_upload(model_name,
    ...
    return model_upload(model_name=model_name,
                                 model_tag=model_tag,
                                 model_type=model_type,
                                 model_runtime=model_runtime,
                                 model_chip=model_chip,
...
@app.route("/model-upload/<string:model_name>/<string:model_tag>/<string:model_type>/", methods=['POST'])
def model_upload(model_name,
                          model_tag,
                          model_type,
                          new_model_path=None, # defaults to ./<model-type>/<model-name>-<model-tag>/
                          upload_url=None,
