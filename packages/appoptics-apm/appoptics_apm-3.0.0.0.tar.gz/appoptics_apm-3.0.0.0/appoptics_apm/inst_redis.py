...
def wrap_send_packed_command(layer_name, func):
    ...
    def wrapper(*f_args, **f_kwargs):
        ...
        try:
            ...
            appoptics_apm_logger.debug('AppOptics APM error: {e}'.format(e=e))
        return ret
...
def wrap(layer_name, module):
    try:
        ...
        if cls:
            ...
            appoptics_apm_logger.error("AppOptics APM error: couldn't find redis.StrictRedis nor redis.Redis class to"
        ...
        if cls:
            ...
            appoptics_apm_logger.error("AppOptics APM error: couldn't find redis.Connection class to instrument, "
        ...
        if cls:
            ...
            appoptics_apm_logger.error("AppOptics APM error: couldn't find redis.client.BasePipeline nor "
        ...
        if cls:
            ...
            appoptics_apm_logger.error("AppOptics APM error: couldn't find redis.client.PubSub class to instrument, "
                              "redis coverage may be partial.")

    except Exception as e:
        appoptics_apm_logger.error("AppOptics APM error: {e}".format(e=e))
