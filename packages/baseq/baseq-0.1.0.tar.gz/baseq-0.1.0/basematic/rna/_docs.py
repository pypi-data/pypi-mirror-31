...
[Steps]
    ...
    basematic-RNA run_hisat2 -1 HMC_01.1.fq.gz -2 HMC_01.2.fq.gz -g hg38
    basematic-RNA run_star -1 HMC_01.1.fq.gz -2 HMC_01.2.fq.gz -g hg38
    basematic-RNA run_featurecount -1 HMC_01.1.fq.gz -2 HMC_01.2.fq.gz -g hg38
    basematic-RNA run_cufflinks -1 HMC_01.1.fq.gz -2 HMC_01.2.fq.gz -g hg38
    
    #scatter plot...
    basematic-RNA plot_corelation_scatter -1 sample03 -2 sample02 -t ./exptpm.txt
