...
class FileConfig:
    ...
    def dump(self):
        ...
        with open(self.path, 'w') as config_file:
            json.dump(self._data, config_file, indent=4, sort_keys=True)

    @classmethod
    def load(cls, path, initial=None):
        ...
        initial.update(file_config)
        return cls(path=path, initial=initial)


config = FileConfig.load('.gwfconf.json', initial=CONFIG_DEFAULTS)
