...
from steepbase.exceptions import AccountExistsException, MissingKeyError
...
class Commit(object):
    ...
    def create_account(
        ...
        """ Create new account in Steem
            ...
            (see `steepbase.account` for more details.
        ...
        if not creator:
            raise ValueError(
                ...
                "creator=x, or set the default_account using steeppy")
