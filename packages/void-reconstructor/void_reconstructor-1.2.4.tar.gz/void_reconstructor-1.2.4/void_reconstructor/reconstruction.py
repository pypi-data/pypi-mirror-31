...
class Reconstructor:
    ...
    def __init__(self, X,ID,mass,particle_mass = None, V = None, periodic_condition = True):
    ...
    def get_final_position(self, start=[0, 0, 0], stop=[100, 100, 100], Resolution=8, mirror_length=0,seed=1,box_size_total=100.0, periodic_condition=self.periodic_condition):
