...
class Reconstructor:
    ...
    def get_final_position(self, start=[0, 0, 0], stop=[100, 100, 100], Resolution=8, mirror_length=0,seed=1):
        ...
        X = X[iran, :]
        ID = ID[iran]
        X_mirror = self.mirror_positions(X,mirror_length=mirror_length)
    ...
    def full_reconstruction_nested(self,division_number,alpha,Resolution_full, Resolution_hom,beta,starts_all = None,rank=0,box_sizes_return = False):
