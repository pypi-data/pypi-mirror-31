...
class Job(object):
    ...
    def __init__(self, id=None, origin=None, gear_id=None, previous_job_id=None, inputs=None, destination=None, tags=None, state=None, attempt=None, created=None, modified=None, config=None, request=None, saved_files=None, produced_metadata=None):  # noqa: E501
