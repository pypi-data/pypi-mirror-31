...
class AnalysisListEntry(object):
    ...
    def __init__(self, id=None, inputs=None, files=None, job=None, notes=None, description=None, label=None, created=None, modified=None):  # noqa: E501
    ...
    def job(self, job):
        ...
        :type: str
        """
        if job is not None and not re.search('^[a-fA-F0-9]{24}$', job):  # noqa: E501
            raise ValueError("Invalid value for `job`, must be a follow pattern or equal to `/^[a-fA-F0-9]{24}$/`")  # noqa: E501
