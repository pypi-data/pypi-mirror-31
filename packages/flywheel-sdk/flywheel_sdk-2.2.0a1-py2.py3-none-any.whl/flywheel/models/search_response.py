...
class SearchResponse(object):
    ...
    def __init__(self, project=None, group=None, session=None, acquisition=None, subject=None, file=None, collection=None, analysis=None, parent=None, permissions=None):  # noqa: E501
