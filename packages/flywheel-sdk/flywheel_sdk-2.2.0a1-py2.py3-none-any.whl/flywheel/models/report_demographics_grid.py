...
class ReportDemographicsGrid(object):
    ...
    def group_label(self, group_label):
        ...
        :type: str
        """
        if group_label is not None and len(group_label) > 256:
            raise ValueError("Invalid value for `group_label`, length must be less than or equal to `256`")  # noqa: E501
        if group_label is not None and len(group_label) < 1:
            raise ValueError("Invalid value for `group_label`, length must be greater than or equal to `1`")  # noqa: E501
