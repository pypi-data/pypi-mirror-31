...
class Gear(object):
    ...
    def name(self, name):
        ...
        if name is not None and not re.search('^[a-z0-9\\-]+$', name):  # noqa: E501
            raise ValueError("Invalid value for `name`, must be a follow pattern or equal to `/^[a-z0-9\\-]+$/`")  # noqa: E501
