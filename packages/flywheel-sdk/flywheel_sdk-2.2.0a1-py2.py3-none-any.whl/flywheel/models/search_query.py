...
class SearchQuery(object):
    ...
    def __init__(self, return_type=None, search_string=None, all_data=False, filters=None):  # noqa: E501
    ...
    def return_type(self, return_type):
        ...
        allowed_values = ["file", "acquisition", "session", "analysis", "collection"]  # noqa: E501
        if return_type not in allowed_values:
            raise ValueError(
