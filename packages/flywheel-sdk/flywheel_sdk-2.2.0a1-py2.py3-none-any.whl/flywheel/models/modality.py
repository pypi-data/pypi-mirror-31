...
class Modality(object):
    ...
    def id(self, id):
        ...
        :type: str
        """
        if id is not None and not re.search('^[0-9a-zA-Z_-]{2,64}$', id):  # noqa: E501
            raise ValueError("Invalid value for `id`, must be a follow pattern or equal to `/^[0-9a-zA-Z_-]{2,64}$/`")  # noqa: E501
