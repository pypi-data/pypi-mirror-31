...
class BatchProposal(object):
    ...
    def __init__(self, id=None, gear_id=None, state=None, config=None, origin=None, proposal=None, ambiguous=None, matched=None, not_matched=None, improper_permissions=None, created=None, modified=None):  # noqa: E501
