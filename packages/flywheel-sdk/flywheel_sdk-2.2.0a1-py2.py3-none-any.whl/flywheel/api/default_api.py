...
class DefaultApi(object):
    ...
    def engine_upload(self, body, level, id, job, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.engine_upload_with_http_info(body, level, id, job, **kwargs)  # noqa: E501
        else:
            (data) = self.engine_upload_with_http_info(body, level, id, job, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def engine_upload_with_http_info(self, body, level, id, job, **kwargs):  # noqa: E501
        """Upload a list of file fields.
        ...
        all_params = ['body', 'level', 'id', 'job']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `engine_upload`")  # noqa: E501
        ...
        body_params = None
        if 'body' in params:
            body_params = flywheel.models.EnginemetadataEngineUploadInput.positional_to_model(params['body'])
        # HTTP header `Accept`
        header_params['Accept'] = self.api_client.select_header_accept(
            ['application/json'])  # noqa: E501
