...
class JobsApi(object):
    ...
    def prepare_compete(self, job_id, body, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.prepare_compete_with_http_info(job_id, body, **kwargs)  # noqa: E501
        else:
            (data) = self.prepare_compete_with_http_info(job_id, body, **kwargs)  # noqa: E501
            if data and hasattr(data, 'return_value'):
                return data.return_value()
            return data


    def prepare_compete_with_http_info(self, job_id, body, **kwargs):  # noqa: E501
        """Create a ticket with the job id and its status.
        ...
        if ('job_id' not in params or
                params['job_id'] is None):
            raise ValueError("Missing the required parameter `job_id` when calling `prepare_compete`")  # noqa: E501
        # verify the required parameter 'body' is set
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `prepare_compete`")  # noqa: E501
