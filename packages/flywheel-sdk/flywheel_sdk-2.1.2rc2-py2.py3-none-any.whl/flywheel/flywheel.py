...
"""
    ...
    OpenAPI spec version: 2.1.2-rc.2
...
class Flywheel:
    ...
    def add_acquisition_analysis(self, acquisition_id, body, **kwargs):  # noqa: E501
        ...
        :param AnalysisInputAny body: (required)
    ...
    def engine_upload(self, body, level, id, job, **kwargs):  # noqa: E501
        ...
        :param EnginemetadataEngineUploadInput body: Object encoded as a JSON string. By default JSON must match the specified enginemetadata.json schema If ``level`` is ``analysis``, JSON must match AnalysisUploadMetadata schema  (required)
        ...
        :return: object
        """
        return self.default_api.engine_upload(body, level, id, job, **kwargs)
    ...
    def search(self, body, **kwargs):  # noqa: E501
        ...
        """
        return self.default_api.search(body, **kwargs)
    ...
    def prepare_compete(self, job_id, body, **kwargs):  # noqa: E501
        ...
        :return: object
        """
        return self.jobs_api.prepare_compete(job_id, body, **kwargs)
    ...
    def set_project_template(self, project_id, body, **kwargs):  # noqa: E501
        ...
        :param str project_id: (required)
        :param ProjectTemplate body: (required)
        :param bool async: Perform the request asynchronously
        :return: InlineResponse2001
        """
    ...
    def set_acquisition_file_info(self, acquisition_id, file_name, body, **kwargs):
        ...
        """
        body = { 'set': body }
        self.acquisitions_api.modify_acquisition_file_info(acquisition_id, file_name, body, **kwargs)
    ...
    def delete_acquisition_file_info_fields(self, acquisition_id, file_name, body, **kwargs):
        """Delete the specified fields from info.
    ...
    def set_acquisition_info(self, acquisition_id, body, **kwargs):
        ...
        """
        body = { 'set': body }
        self.acquisitions_api.modify_acquisition_info(acquisition_id, body, **kwargs)
    ...
    def set_analysis_info(self, analysis_id, body, **kwargs):
        ...
        """
        body = { 'set': body }
        self.analyses_api.modify_analysis_info(analysis_id, body, **kwargs)
    ...
    def set_collection_file_info(self, collection_id, file_name, body, **kwargs):
        ...
        """
        body = { 'set': body }
        self.collections_api.modify_collection_file_info(collection_id, file_name, body, **kwargs)
    ...
    def set_collection_info(self, collection_id, body, **kwargs):
        ...
        """
        body = { 'set': body }
        self.collections_api.modify_collection_info(collection_id, body, **kwargs)
    ...
    def set_project_file_info(self, project_id, file_name, body, **kwargs):
        ...
        """
        body = { 'set': body }
        self.projects_api.modify_project_file_info(project_id, file_name, body, **kwargs)
    ...
    def set_project_info(self, project_id, body, **kwargs):
        ...
        """
        body = { 'set': body }
        self.projects_api.modify_project_info(project_id, body, **kwargs)
    ...
    def set_session_file_info(self, session_id, file_name, body, **kwargs):
        ...
        """
        body = { 'set': body }
        self.sessions_api.modify_session_file_info(session_id, file_name, body, **kwargs)
    ...
    def set_session_info(self, session_id, body, **kwargs):
        ...
        """
        body = { 'set': body }
        self.sessions_api.modify_session_info(session_id, body, **kwargs)
