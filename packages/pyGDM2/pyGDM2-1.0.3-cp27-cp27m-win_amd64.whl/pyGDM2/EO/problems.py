...
class BaseProblem(object):
    ...
    nthreads : int, default: -1
        ...
        Not directly used, stored internally as `self.nthreads`. Using it 
        lies in the user's responsibility ;-)
    
    """
    __name__ = 'BaseProblem'
    
    def __init__(self, model=None, field_index=0, maximize=True, nthreads=-1):
...
class ProblemDirectivity(BaseProblem):
    ...
    nthreads : int, default: -1
        passed to :func:`pyGDM2.core.scatter` and :func:`pyGDM2.linear.farfield`
    ...
    def __init__(self, model, field_index=0,
                       ...
                       consider_dS=False, averaging=True, absoluteI=False, 
                       kwargs_scatter={}, maximize=True, nthreads=-1):
        """constructor"""
