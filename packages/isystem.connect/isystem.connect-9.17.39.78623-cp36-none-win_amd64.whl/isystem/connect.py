...
_connect.SHARED_PTR_DISOWN_swigconstant(_connect)
...
class ucharArray(_object):
    ...
    __swig_getmethods__["frompointer"] = lambda x: _connect.ucharArray_frompointer
    if _newclass:
...
_connect.WINVER_swigconstant(_connect)
...
class ConnectionMgr(_object):
    ...
    __swig_getmethods__["isStartedFromWinIDEA"] = lambda x: _connect.ConnectionMgr_isStartedFromWinIDEA
    if _newclass:
...
class CAddressController(_object):
    ...
    __swig_getmethods__["getTestPointIdPrefix"] = lambda x: _connect.CAddressController_getTestPointIdPrefix
    if _newclass:
...
class CDataController(_object):
    ...
    __swig_getmethods__["setByte"] = lambda x: _connect.CDataController_setByte
    if _newclass:
        setByte = staticmethod(_connect.CDataController_setByte)
    __swig_getmethods__["getByte"] = lambda x: _connect.CDataController_getByte
    if _newclass:
        getByte = staticmethod(_connect.CDataController_getByte)
    __swig_getmethods__["byteArrayToVector"] = lambda x: _connect.CDataController_byteArrayToVector
    if _newclass:
        byteArrayToVector = staticmethod(_connect.CDataController_byteArrayToVector)
    __swig_getmethods__["vectorToByteArray"] = lambda x: _connect.CDataController_vectorToByteArray
    if _newclass:
...
class CIDEController(_object):
    ...
    __swig_getmethods__["parseServiceCallMap"] = lambda x: _connect.CIDEController_parseServiceCallMap
    if _newclass:
...
_connect.EXPORT_TrcAsText_swigconstant(_connect)
EXPORT_TrcAsText = _connect.EXPORT_TrcAsText

_connect.EXPORT_TrcAsCSV_swigconstant(_connect)
EXPORT_TrcAsCSV = _connect.EXPORT_TrcAsCSV

_connect.EXPORT_TrcAsXML_swigconstant(_connect)
EXPORT_TrcAsXML = _connect.EXPORT_TrcAsXML

_connect.EXPORT_TrcAsBinary_swigconstant(_connect)
EXPORT_TrcAsBinary = _connect.EXPORT_TrcAsBinary

_connect.EXPORT_ProfilerAsText_swigconstant(_connect)
EXPORT_ProfilerAsText = _connect.EXPORT_ProfilerAsText

_connect.EXPORT_ProfilerAsCSV_swigconstant(_connect)
EXPORT_ProfilerAsCSV = _connect.EXPORT_ProfilerAsCSV

_connect.EXPORT_ProfilerAsXML_swigconstant(_connect)
EXPORT_ProfilerAsXML = _connect.EXPORT_ProfilerAsXML

_connect.EXPORT_ProfilerAsBinary_swigconstant(_connect)
EXPORT_ProfilerAsBinary = _connect.EXPORT_ProfilerAsBinary

_connect.EXPORT_ProfilerAsText1_swigconstant(_connect)
EXPORT_ProfilerAsText1 = _connect.EXPORT_ProfilerAsText1

_connect.EXPORT_ProfilerAsXMLBinaryTimeline_swigconstant(_connect)
EXPORT_ProfilerAsXMLBinaryTimeline = _connect.EXPORT_ProfilerAsXMLBinaryTimeline

_connect.EXPORT_ProfilerAsBTF_swigconstant(_connect)
EXPORT_ProfilerAsBTF = _connect.EXPORT_ProfilerAsBTF

_connect.EXPORT_CCAsHTML_swigconstant(_connect)
EXPORT_CCAsHTML = _connect.EXPORT_CCAsHTML

_connect.EXPORT_CCAsText_swigconstant(_connect)
EXPORT_CCAsText = _connect.EXPORT_CCAsText

_connect.EXPORT_CCAsCSV_swigconstant(_connect)
EXPORT_CCAsCSV = _connect.EXPORT_CCAsCSV

_connect.EXPORT_CCAsXML_swigconstant(_connect)
EXPORT_CCAsXML = _connect.EXPORT_CCAsXML

_connect.EXPORT_CCAsReviewHTML_swigconstant(_connect)
EXPORT_CCAsReviewHTML = _connect.EXPORT_CCAsReviewHTML

_connect.EXPORT_CCAsReviewText_swigconstant(_connect)
EXPORT_CCAsReviewText = _connect.EXPORT_CCAsReviewText

_connect.EXPORT_CCAsXML2_swigconstant(_connect)
EXPORT_CCAsXML2 = _connect.EXPORT_CCAsXML2

_connect.EXPORT_CCAsGCOV_swigconstant(_connect)
...
class CCoverageStatistic2(_object):
    ...
    __swig_getmethods__["areaType2Str"] = lambda x: _connect.CCoverageStatistic2_areaType2Str
    if _newclass:
...
class CCoverageData2(_object):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_getmethods__["createInstance"] = lambda x: _connect.CCoverageData2_createInstance
    if _newclass:
...
class CProfilerArea2(_object):
    ...
    __swig_getmethods__["handle2AreaId"] = lambda x: _connect.CProfilerArea2_handle2AreaId
    if _newclass:
...
_connect.UNDEF_EVENT_SOURCE_swigconstant(_connect)
...
class CProfilerData2(_object):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_getmethods__["createInstance"] = lambda x: _connect.CProfilerData2_createInstance
    if _newclass:
...
class CTraceData(_object):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined")
    __repr__ = _swig_repr
    __swig_getmethods__["createInstance"] = lambda x: _connect.CTraceData_createInstance
    if _newclass:
...
class CTraceConfigWizard(_object):
    ...
    __swig_getmethods__["createImmediateTrigger"] = lambda x: _connect.CTraceConfigWizard_createImmediateTrigger
    if _newclass:
        createImmediateTrigger = staticmethod(_connect.CTraceConfigWizard_createImmediateTrigger)
    __swig_getmethods__["createDataAccessTrigger"] = lambda x: _connect.CTraceConfigWizard_createDataAccessTrigger
    if _newclass:
        createDataAccessTrigger = staticmethod(_connect.CTraceConfigWizard_createDataAccessTrigger)
    __swig_getmethods__["createCodeExecTrigger"] = lambda x: _connect.CTraceConfigWizard_createCodeExecTrigger
    if _newclass:
        createCodeExecTrigger = staticmethod(_connect.CTraceConfigWizard_createCodeExecTrigger)
    __swig_getmethods__["createAUXStateTrigger"] = lambda x: _connect.CTraceConfigWizard_createAUXStateTrigger
    if _newclass:
        createAUXStateTrigger = staticmethod(_connect.CTraceConfigWizard_createAUXStateTrigger)
    __swig_getmethods__["createAUXEdgeTrigger"] = lambda x: _connect.CTraceConfigWizard_createAUXEdgeTrigger
    if _newclass:
...
class CTestCaseController(ITestCaseController):
    ...
    __swig_getmethods__["setTestBatch"] = lambda x: _connect.CTestCaseController_setTestBatch
    if _newclass:
    ...
    __swig_getmethods__["clearAllTests"] = lambda x: _connect.CTestCaseController_clearAllTests
    if _newclass:
    ...
    __swig_getmethods__["testState2str"] = lambda x: _connect.CTestCaseController_testState2str
    if _newclass:
    ...
    __swig_getmethods__["s2i64"] = lambda x: _connect.CTestCaseController_s2i64
    if _newclass:
        s2i64 = staticmethod(_connect.CTestCaseController_s2i64)
    __swig_getmethods__["verifyRetVal"] = lambda x: _connect.CTestCaseController_verifyRetVal
    if _newclass:
...
class CLogger(_object):
    ...
    __swig_getmethods__["icDebugAccessFlags2str"] = lambda x: _connect.CLogger_icDebugAccessFlags2str
    if _newclass:
        icDebugAccessFlags2str = staticmethod(_connect.CLogger_icDebugAccessFlags2str)
    __swig_getmethods__["icDebugSymbolFlags2str"] = lambda x: _connect.CLogger_icDebugSymbolFlags2str
    if _newclass:
        icDebugSymbolFlags2str = staticmethod(_connect.CLogger_icDebugSymbolFlags2str)
    __swig_getmethods__["icDebugAddressFlags2str"] = lambda x: _connect.CLogger_icDebugAddressFlags2str
    if _newclass:
        icDebugAddressFlags2str = staticmethod(_connect.CLogger_icDebugAddressFlags2str)
    __swig_getmethods__["icDebugEvaluateFlags2str"] = lambda x: _connect.CLogger_icDebugEvaluateFlags2str
    if _newclass:
        icDebugEvaluateFlags2str = staticmethod(_connect.CLogger_icDebugEvaluateFlags2str)
    __swig_getmethods__["icSTypeType2str"] = lambda x: _connect.CLogger_icSTypeType2str
    if _newclass:
        icSTypeType2str = staticmethod(_connect.CLogger_icSTypeType2str)
    __swig_getmethods__["lang2str"] = lambda x: _connect.CLogger_lang2str
    if _newclass:
...
class CWinIDEAVersion(_object):
    ...
    def __init__(self, *args):
        ...
        try:
            ...
            self.this = this
    __swig_getmethods__["getFileVersion"] = lambda x: _connect.CWinIDEAVersion_getFileVersion
    if _newclass:
...
_connect.E_FALSE_swigconstant(_connect)
E_FALSE = _connect.E_FALSE

_connect.E_TRUE_swigconstant(_connect)
E_TRUE = _connect.E_TRUE

_connect.E_DEFAULT_swigconstant(_connect)
...
class CTestBase(CTestObject):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestBase_cast
    if _newclass:
...
class CTestBaseList(CTestObject):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestBaseList_cast
    if _newclass:
...
class CTestFilter(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestFilter_cast
    if _newclass:
...
class CTestBench(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestBench_cast
    if _newclass:
    ...
    __swig_getmethods__["load"] = lambda x: _connect.CTestBench_load
    if _newclass:
        load = staticmethod(_connect.CTestBench_load)
    __swig_getmethods__["parse"] = lambda x: _connect.CTestBench_parse
    if _newclass:
    ...
    __swig_getmethods__["addUserInfoToReportConfig"] = lambda x: _connect.CTestBench_addUserInfoToReportConfig
    if _newclass:
    ...
    __swig_getmethods__["createDirIfNotExists"] = lambda x: _connect.CTestBench_createDirIfNotExists
    if _newclass:
        createDirIfNotExists = staticmethod(_connect.CTestBench_createDirIfNotExists)
    __swig_getmethods__["saveTestResults"] = lambda x: _connect.CTestBench_saveTestResults
    if _newclass:
        saveTestResults = staticmethod(_connect.CTestBench_saveTestResults)
    __swig_getmethods__["saveCSV"] = lambda x: _connect.CTestBench_saveCSV
    if _newclass:
        saveCSV = staticmethod(_connect.CTestBench_saveCSV)
    __swig_getmethods__["saveYAML"] = lambda x: _connect.CTestBench_saveYAML
    if _newclass:
        saveYAML = staticmethod(_connect.CTestBench_saveYAML)
    __swig_getmethods__["saveXML"] = lambda x: _connect.CTestBench_saveXML
    if _newclass:
        saveXML = staticmethod(_connect.CTestBench_saveXML)
    __swig_getmethods__["initTargetForTest"] = lambda x: _connect.CTestBench_initTargetForTest
    if _newclass:
        initTargetForTest = staticmethod(_connect.CTestBench_initTargetForTest)
    __swig_getmethods__["executeInitAction"] = lambda x: _connect.CTestBench_executeInitAction
    if _newclass:
        executeInitAction = staticmethod(_connect.CTestBench_executeInitAction)
    __swig_getmethods__["restoreTargetAfterTest"] = lambda x: _connect.CTestBench_restoreTargetAfterTest
    if _newclass:
        restoreTargetAfterTest = staticmethod(_connect.CTestBench_restoreTargetAfterTest)
    __swig_getmethods__["configureInterrupts"] = lambda x: _connect.CTestBench_configureInterrupts
    if _newclass:
        configureInterrupts = staticmethod(_connect.CTestBench_configureInterrupts)
    __swig_getmethods__["restoreInterrupts"] = lambda x: _connect.CTestBench_restoreInterrupts
    if _newclass:
        restoreInterrupts = staticmethod(_connect.CTestBench_restoreInterrupts)
    __swig_getmethods__["execTestCaseInitSequence"] = lambda x: _connect.CTestBench_execTestCaseInitSequence
    if _newclass:
        execTestCaseInitSequence = staticmethod(_connect.CTestBench_execTestCaseInitSequence)
    __swig_getmethods__["configureBreakpointsMode"] = lambda x: _connect.CTestBench_configureBreakpointsMode
    if _newclass:
        configureBreakpointsMode = staticmethod(_connect.CTestBench_configureBreakpointsMode)
    __swig_getmethods__["configureStackUsage"] = lambda x: _connect.CTestBench_configureStackUsage
    if _newclass:
        configureStackUsage = staticmethod(_connect.CTestBench_configureStackUsage)
    __swig_getmethods__["isTestWithScripts"] = lambda x: _connect.CTestBench_isTestWithScripts
    if _newclass:
    ...
    __swig_getmethods__["getCvrgFilterCandidates"] = lambda x: _connect.CTestBench_getCvrgFilterCandidates
    if _newclass:
...
class CScriptConfig(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CScriptConfig_cast
    if _newclass:
...
class CEvaluatorConfig(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CEvaluatorConfig_cast
    if _newclass:
    ...
    __swig_getmethods__["charDisplayEnum2Str"] = lambda x: _connect.CEvaluatorConfig_charDisplayEnum2Str
    if _newclass:
        charDisplayEnum2Str = staticmethod(_connect.CEvaluatorConfig_charDisplayEnum2Str)
    __swig_getmethods__["binaryDisplayEnum2Str"] = lambda x: _connect.CEvaluatorConfig_binaryDisplayEnum2Str
    if _newclass:
        binaryDisplayEnum2Str = staticmethod(_connect.CEvaluatorConfig_binaryDisplayEnum2Str)
    __swig_getmethods__["addressDisplayEnum2Str"] = lambda x: _connect.CEvaluatorConfig_addressDisplayEnum2Str
    if _newclass:
        addressDisplayEnum2Str = staticmethod(_connect.CEvaluatorConfig_addressDisplayEnum2Str)
    __swig_getmethods__["enumDisplayEnum2Str"] = lambda x: _connect.CEvaluatorConfig_enumDisplayEnum2Str
    if _newclass:
...
class CInitSequenceAction(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CInitSequenceAction_cast
    if _newclass:
...
class CTestCaseTargetInitConfig(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestCaseTargetInitConfig_cast
    if _newclass:
...
class CStackUsageConfig(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CStackUsageConfig_cast
    if _newclass:
...
class CToolsConfig(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CToolsConfig_cast
    if _newclass:
...
class CTestEnvironmentConfig(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestEnvironmentConfig_cast
    if _newclass:
    ...
    __swig_getmethods__["getStaticVersion"] = lambda x: _connect.CTestEnvironmentConfig_getStaticVersion
    if _newclass:
...
class CTestReportConfig(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestReportConfig_cast
    if _newclass:
...
class CTestFunction(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestFunction_cast
    if _newclass:
...
class CTestAssert(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestAssert_cast
    if _newclass:
...
class CTestCase(_object):
    ...
    __swig_getmethods__["getISystemRetValName"] = lambda x: _connect.CTestCase_getISystemRetValName
    if _newclass:
    ...
    __swig_getmethods__["applyDryRun"] = lambda x: _connect.CTestCase_applyDryRun
    if _newclass:
...
class CTestAnalyzer(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestAnalyzer_cast
    if _newclass:
...
class CTestAnalyzerTrace(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestAnalyzerTrace_cast
    if _newclass:
...
class CTestAnalyzerCoverage(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestAnalyzerCoverage_cast
    if _newclass:
...
class CTestAnalyzerProfiler(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestAnalyzerProfiler_cast
    if _newclass:
...
class CTestCoverageStatistics(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestCoverageStatistics_cast
    if _newclass:
...
class CTestProfilerTime(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestProfilerTime_cast
    if _newclass:
    ...
    __swig_getmethods__["a2d"] = lambda x: _connect.CTestProfilerTime_a2d
    if _newclass:
...
class CTestProfilerStatistics(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestProfilerStatistics_cast
    if _newclass:
...
class CTestCoverageResult(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestCoverageResult_cast
    if _newclass:
...
class CTestTreeNode(CTestBase):
    ...
    def __init__(self, *args, **kwargs):
        raise AttributeError("No constructor defined - class is abstract")
    __repr__ = _swig_repr
    __swig_getmethods__["cast"] = lambda x: _connect.CTestTreeNode_cast
    if _newclass:
...
class CTestGroup(CTestTreeNode):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestGroup_cast
    if _newclass:
...
class CLogResult(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CLogResult_cast
    if _newclass:
...
class CTestPointResult(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestPointResult_cast
    if _newclass:
...
class CStackUsageResult(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CStackUsageResult_cast
    if _newclass:
...
class CTestExprResult(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestExprResult_cast
    if _newclass:
...
class CTestResult(CTestResultBase):
    ...
    __swig_getmethods__["funcType2PyVarName"] = lambda x: _connect.CTestResult_funcType2PyVarName
    if _newclass:
...
class CTestGroupResult(CTestResultBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestGroupResult_cast
    if _newclass:
...
class CTestGrpFuncStat(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestGrpFuncStat_cast
    if _newclass:
...
class EmitterFactory(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["createYamlEmitter"] = lambda x: _connect.EmitterFactory_createYamlEmitter
    if _newclass:
        createYamlEmitter = staticmethod(_connect.EmitterFactory_createYamlEmitter)
    __swig_getmethods__["createCSVEmitter"] = lambda x: _connect.EmitterFactory_createCSVEmitter
    if _newclass:
...
class CTestSpecification(CTestTreeNode):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestSpecification_cast
    if _newclass:
    ...
    __swig_getmethods__["load"] = lambda x: _connect.CTestSpecification_load
    if _newclass:
        load = staticmethod(_connect.CTestSpecification_load)
    __swig_getmethods__["parseTestSpec"] = lambda x: _connect.CTestSpecification_parseTestSpec
    if _newclass:
...
class CTestStub(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestStub_cast
    if _newclass:
...
class CTestLocation(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestLocation_cast
    if _newclass:
...
class CTestPoint(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestPoint_cast
    if _newclass:
...
class CTestMinMax(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestMinMax_cast
    if _newclass:
...
class CTestLog(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestLog_cast
    if _newclass:
...
class CTestEvalAssignStep(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestEvalAssignStep_cast
    if _newclass:
...
class CTestUserStub(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestUserStub_cast
    if _newclass:
...
class CTestHIL(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestHIL_cast
    if _newclass:
...
class CTestStackUsage(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestStackUsage_cast
    if _newclass:
...
class CTestPersistentVars(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestPersistentVars_cast
    if _newclass:
...
class CTestHostVars(_object):
    ...
    __swig_getmethods__["getDiagramFileName"] = lambda x: _connect.CTestHostVars_getDiagramFileName
    if _newclass:
    ...
    __swig_getmethods__["getHostVarsForAnalyzerFileName"] = lambda x: _connect.CTestHostVars_getHostVarsForAnalyzerFileName
    if _newclass:
        getHostVarsForAnalyzerFileName = staticmethod(_connect.CTestHostVars_getHostVarsForAnalyzerFileName)
    __swig_getmethods__["getHostVarsForGroupAnalyzerFileName"] = lambda x: _connect.CTestHostVars_getHostVarsForGroupAnalyzerFileName
    if _newclass:
        getHostVarsForGroupAnalyzerFileName = staticmethod(_connect.CTestHostVars_getHostVarsForGroupAnalyzerFileName)
    __swig_getmethods__["getHostVarsForAutoTestId"] = lambda x: _connect.CTestHostVars_getHostVarsForAutoTestId
    if _newclass:
    ...
    __swig_getmethods__["createDiagramVars"] = lambda x: _connect.CTestHostVars_createDiagramVars
    if _newclass:
        createDiagramVars = staticmethod(_connect.CTestHostVars_createDiagramVars)
    __swig_getmethods__["createTcAnalyzerFNameVars"] = lambda x: _connect.CTestHostVars_createTcAnalyzerFNameVars
    if _newclass:
        createTcAnalyzerFNameVars = staticmethod(_connect.CTestHostVars_createTcAnalyzerFNameVars)
    __swig_getmethods__["createGrpAnalyzerFNameVars"] = lambda x: _connect.CTestHostVars_createGrpAnalyzerFNameVars
    if _newclass:
...
class CTestDryRun(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestDryRun_cast
    if _newclass:
...
class CTestDiagramConfig(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestDiagramConfig_cast
    if _newclass:
...
class CTestDiagrams(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestDiagrams_cast
    if _newclass:
...
class CTestStopCondition(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestStopCondition_cast
    if _newclass:
...
class CTestImportSources(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestImportSources_cast
    if _newclass:
...
class CTestImports(CTestBase):
    ...
    __swig_getmethods__["cast"] = lambda x: _connect.CTestImports_cast
    if _newclass:
...
class CYAMLUtil(_object):
    ...
    __repr__ = _swig_repr
    __swig_getmethods__["parseTestBase"] = lambda x: _connect.CYAMLUtil_parseTestBase
    if _newclass:
        parseTestBase = staticmethod(_connect.CYAMLUtil_parseTestBase)
    __swig_getmethods__["parseTestBaseList"] = lambda x: _connect.CYAMLUtil_parseTestBaseList
    if _newclass:
        parseTestBaseList = staticmethod(_connect.CYAMLUtil_parseTestBaseList)
    __swig_getmethods__["cto2ctb"] = lambda x: _connect.CYAMLUtil_cto2ctb
    if _newclass:
        cto2ctb = staticmethod(_connect.CYAMLUtil_cto2ctb)
    __swig_getmethods__["cto2ctbl"] = lambda x: _connect.CYAMLUtil_cto2ctbl
    if _newclass:
        cto2ctbl = staticmethod(_connect.CYAMLUtil_cto2ctbl)
    __swig_getmethods__["isInstanceOfCtb"] = lambda x: _connect.CYAMLUtil_isInstanceOfCtb
    if _newclass:
        isInstanceOfCtb = staticmethod(_connect.CYAMLUtil_isInstanceOfCtb)
    __swig_getmethods__["isInstanceOfCtbList"] = lambda x: _connect.CYAMLUtil_isInstanceOfCtbList
    if _newclass:
        isInstanceOfCtbList = staticmethod(_connect.CYAMLUtil_isInstanceOfCtbList)
    __swig_getmethods__["strVector2Str"] = lambda x: _connect.CYAMLUtil_strVector2Str
    if _newclass:
        strVector2Str = staticmethod(_connect.CYAMLUtil_strVector2Str)
    __swig_getmethods__["strStrMap2OrderedStr"] = lambda x: _connect.CYAMLUtil_strStrMap2OrderedStr
    if _newclass:
        strStrMap2OrderedStr = staticmethod(_connect.CYAMLUtil_strStrMap2OrderedStr)
    __swig_getmethods__["strVectorVector2Str"] = lambda x: _connect.CYAMLUtil_strVectorVector2Str
    if _newclass:
        strVectorVector2Str = staticmethod(_connect.CYAMLUtil_strVectorVector2Str)
    __swig_getmethods__["strVector2Sequence"] = lambda x: _connect.CYAMLUtil_strVector2Sequence
    if _newclass:
        strVector2Sequence = staticmethod(_connect.CYAMLUtil_strVector2Sequence)
    __swig_getmethods__["verifyLimitedScalar"] = lambda x: _connect.CYAMLUtil_verifyLimitedScalar
    if _newclass:
        verifyLimitedScalar = staticmethod(_connect.CYAMLUtil_verifyLimitedScalar)
    __swig_getmethods__["getSymbolsAllowedTestId"] = lambda x: _connect.CYAMLUtil_getSymbolsAllowedTestId
    if _newclass:
        getSymbolsAllowedTestId = staticmethod(_connect.CYAMLUtil_getSymbolsAllowedTestId)
    __swig_getmethods__["verifyTestId"] = lambda x: _connect.CYAMLUtil_verifyTestId
    if _newclass:
        verifyTestId = staticmethod(_connect.CYAMLUtil_verifyTestId)
    __swig_getmethods__["verifyScalar"] = lambda x: _connect.CYAMLUtil_verifyScalar
    if _newclass:
        verifyScalar = staticmethod(_connect.CYAMLUtil_verifyScalar)
    __swig_getmethods__["verifyList"] = lambda x: _connect.CYAMLUtil_verifyList
    if _newclass:
        verifyList = staticmethod(_connect.CYAMLUtil_verifyList)
    __swig_getmethods__["verifyListOfLimitedScalars"] = lambda x: _connect.CYAMLUtil_verifyListOfLimitedScalars
    if _newclass:
        verifyListOfLimitedScalars = staticmethod(_connect.CYAMLUtil_verifyListOfLimitedScalars)
    __swig_getmethods__["verifyMap"] = lambda x: _connect.CYAMLUtil_verifyMap
    if _newclass:
        verifyMap = staticmethod(_connect.CYAMLUtil_verifyMap)
    __swig_getmethods__["isAllowedCharForTestId"] = lambda x: _connect.CYAMLUtil_isAllowedCharForTestId
    if _newclass:
        isAllowedCharForTestId = staticmethod(_connect.CYAMLUtil_isAllowedCharForTestId)
    __swig_getmethods__["replaceInvalidChars"] = lambda x: _connect.CYAMLUtil_replaceInvalidChars
    if _newclass:
        replaceInvalidChars = staticmethod(_connect.CYAMLUtil_replaceInvalidChars)
    __swig_getmethods__["join"] = lambda x: _connect.CYAMLUtil_join
    if _newclass:
        join = staticmethod(_connect.CYAMLUtil_join)
    __swig_getmethods__["getCurrentISODate"] = lambda x: _connect.CYAMLUtil_getCurrentISODate
    if _newclass:
        getCurrentISODate = staticmethod(_connect.CYAMLUtil_getCurrentISODate)
    __swig_getmethods__["getCurrentISOTime"] = lambda x: _connect.CYAMLUtil_getCurrentISOTime
    if _newclass:
...
class SPtrFactory(_object):
    ...
    __swig_getmethods__["cProfilerData2"] = lambda x: _connect.SPtrFactory_cProfilerData2
    if _newclass:
        cProfilerData2 = staticmethod(_connect.SPtrFactory_cProfilerData2)
    __swig_getmethods__["cCoverageData2"] = lambda x: _connect.SPtrFactory_cCoverageData2
    if _newclass:
...
_connect.ACCESS_OK_swigconstant(_connect)
ACCESS_OK = _connect.ACCESS_OK

_connect.ACCESS_FAIL_swigconstant(_connect)
ACCESS_FAIL = _connect.ACCESS_FAIL

_connect.arOK_swigconstant(_connect)
arOK = _connect.arOK

_connect.arAccess_swigconstant(_connect)
arAccess = _connect.arAccess

_connect.arScope_swigconstant(_connect)
arScope = _connect.arScope

_connect.arCPUMode_swigconstant(_connect)
arCPUMode = _connect.arCPUMode

_connect.arInvalid_swigconstant(_connect)
arInvalid = _connect.arInvalid

_connect.arNum_swigconstant(_connect)
...
_connect.endianLittle_swigconstant(_connect)
endianLittle = _connect.endianLittle

_connect.endianBig_swigconstant(_connect)
...
_connect.mempMode0_swigconstant(_connect)
mempMode0 = _connect.mempMode0

_connect.mempMode1_swigconstant(_connect)
mempMode1 = _connect.mempMode1

_connect.mempEndianBig_swigconstant(_connect)
mempEndianBig = _connect.mempEndianBig

_connect.mempEndianLittle_swigconstant(_connect)
mempEndianLittle = _connect.mempEndianLittle

_connect.mempReserved5_swigconstant(_connect)
mempReserved5 = _connect.mempReserved5

_connect.mempReserved6_swigconstant(_connect)
mempReserved6 = _connect.mempReserved6

_connect.mempReserved7_swigconstant(_connect)
mempReserved7 = _connect.mempReserved7

_connect.mempModeEx0_swigconstant(_connect)
mempModeEx0 = _connect.mempModeEx0

_connect.mempModeEx1_swigconstant(_connect)
mempModeEx1 = _connect.mempModeEx1

_connect.mempModeEx2_swigconstant(_connect)
mempModeEx2 = _connect.mempModeEx2

_connect.mempModeEx3_swigconstant(_connect)
mempModeEx3 = _connect.mempModeEx3

_connect.mempBlockRead_swigconstant(_connect)
mempBlockRead = _connect.mempBlockRead

_connect.mempBlockWrite_swigconstant(_connect)
mempBlockWrite = _connect.mempBlockWrite

_connect.mempBlock1MAUAccess_swigconstant(_connect)
mempBlock1MAUAccess = _connect.mempBlock1MAUAccess

_connect.mempBlock2MAUAccess_swigconstant(_connect)
mempBlock2MAUAccess = _connect.mempBlock2MAUAccess

_connect.mempBlock4MAUAccess_swigconstant(_connect)
mempBlock4MAUAccess = _connect.mempBlock4MAUAccess

_connect.mempBlock8MAUAccess_swigconstant(_connect)
mempBlock8MAUAccess = _connect.mempBlock8MAUAccess

_connect.mempNum_swigconstant(_connect)
mempNum = _connect.mempNum

_connect.mempISANum_swigconstant(_connect)
mempISANum = _connect.mempISANum

_connect.mempISAMask_swigconstant(_connect)
mempISAMask = _connect.mempISAMask

_connect.mempISA0_swigconstant(_connect)
mempISA0 = _connect.mempISA0

_connect.mempISA1_swigconstant(_connect)
mempISA1 = _connect.mempISA1

_connect.mempISA2_swigconstant(_connect)
mempISA2 = _connect.mempISA2

_connect.mempISA3_swigconstant(_connect)
mempISA3 = _connect.mempISA3

_connect.cpumodeAll_swigconstant(_connect)
cpumodeAll = _connect.cpumodeAll

_connect.maCODE31_swigconstant(_connect)
maCODE31 = _connect.maCODE31

_connect.maDATA31_swigconstant(_connect)
maDATA31 = _connect.maDATA31

_connect.maIDATA31_swigconstant(_connect)
maIDATA31 = _connect.maIDATA31

_connect.maBDATA31_swigconstant(_connect)
maBDATA31 = _connect.maBDATA31

_connect.maXDATA31_swigconstant(_connect)
maXDATA31 = _connect.maXDATA31

_connect.maPDATA31_swigconstant(_connect)
maPDATA31 = _connect.maPDATA31

_connect.maSFR31_swigconstant(_connect)
maSFR31 = _connect.maSFR31

_connect.maLogicalHC12_swigconstant(_connect)
maLogicalHC12 = _connect.maLogicalHC12

_connect.maBankHC12_swigconstant(_connect)
maBankHC12 = _connect.maBankHC12

_connect.maLinearHC12_swigconstant(_connect)
maLinearHC12 = _connect.maLinearHC12

_connect.maPhysical166_swigconstant(_connect)
maPhysical166 = _connect.maPhysical166

_connect.maLogical166_swigconstant(_connect)
maLogical166 = _connect.maLogical166

_connect.maBDATA166_swigconstant(_connect)
maBDATA166 = _connect.maBDATA166

_connect.mempModeEx166EXTR_swigconstant(_connect)
mempModeEx166EXTR = _connect.mempModeEx166EXTR

_connect.mempModeEx166EXTP_swigconstant(_connect)
mempModeEx166EXTP = _connect.mempModeEx166EXTP

_connect.mempModeEx166EXTS_swigconstant(_connect)
mempModeEx166EXTS = _connect.mempModeEx166EXTS

_connect.mempModePowerPCVLE_swigconstant(_connect)
mempModePowerPCVLE = _connect.mempModePowerPCVLE

_connect.mempISA_PPC_PPC_swigconstant(_connect)
mempISA_PPC_PPC = _connect.mempISA_PPC_PPC

_connect.mempISA_PPC_VLE_swigconstant(_connect)
mempISA_PPC_VLE = _connect.mempISA_PPC_VLE

_connect.maVirtualPowerPC_swigconstant(_connect)
maVirtualPowerPC = _connect.maVirtualPowerPC

_connect.maPPhysicalPowerPC_swigconstant(_connect)
maPPhysicalPowerPC = _connect.maPPhysicalPowerPC

_connect.maUPhysicalPowerPC_swigconstant(_connect)
maUPhysicalPowerPC = _connect.maUPhysicalPowerPC

_connect.maSPRPowerPC_swigconstant(_connect)
maSPRPowerPC = _connect.maSPRPowerPC

_connect.maDCRPowerPC_swigconstant(_connect)
maDCRPowerPC = _connect.maDCRPowerPC

_connect.maTLBPowerPC_swigconstant(_connect)
maTLBPowerPC = _connect.maTLBPowerPC

_connect.maPMRPowerPC_swigconstant(_connect)
maPMRPowerPC = _connect.maPMRPowerPC

_connect.mempModeARMThumb_swigconstant(_connect)
mempModeARMThumb = _connect.mempModeARMThumb

_connect.mempISA_ARM_A32_swigconstant(_connect)
mempISA_ARM_A32 = _connect.mempISA_ARM_A32

_connect.mempISA_ARM_T_swigconstant(_connect)
mempISA_ARM_T = _connect.mempISA_ARM_T

_connect.cpumodeUser_swigconstant(_connect)
cpumodeUser = _connect.cpumodeUser

_connect.cpumodeFIQ_swigconstant(_connect)
cpumodeFIQ = _connect.cpumodeFIQ

_connect.cpumodeIRQ_swigconstant(_connect)
cpumodeIRQ = _connect.cpumodeIRQ

_connect.cpumodeSupervisor_swigconstant(_connect)
cpumodeSupervisor = _connect.cpumodeSupervisor

_connect.cpumodeAbortMode_swigconstant(_connect)
cpumodeAbortMode = _connect.cpumodeAbortMode

_connect.cpumodeSystem_swigconstant(_connect)
cpumodeSystem = _connect.cpumodeSystem

_connect.cpumodeUndefined_swigconstant(_connect)
cpumodeUndefined = _connect.cpumodeUndefined

_connect.maVirtualARM_swigconstant(_connect)
maVirtualARM = _connect.maVirtualARM

_connect.maIPA_ARM_swigconstant(_connect)
maIPA_ARM = _connect.maIPA_ARM

_connect.maCPARM_swigconstant(_connect)
maCPARM = _connect.maCPARM

_connect.maVFPARM_swigconstant(_connect)
maVFPARM = _connect.maVFPARM

_connect.maSP_ARM_swigconstant(_connect)
maSP_ARM = _connect.maSP_ARM

_connect.maNP_ARM_swigconstant(_connect)
maNP_ARM = _connect.maNP_ARM

_connect.maEL1S_ARM_swigconstant(_connect)
maEL1S_ARM = _connect.maEL1S_ARM

_connect.maEL1N_ARM_swigconstant(_connect)
maEL1N_ARM = _connect.maEL1N_ARM

_connect.maEL2N_ARM_swigconstant(_connect)
maEL2N_ARM = _connect.maEL2N_ARM

_connect.maEL3S_ARM_swigconstant(_connect)
maEL3S_ARM = _connect.maEL3S_ARM

_connect.maPL1S_ARM_swigconstant(_connect)
maPL1S_ARM = _connect.maPL1S_ARM

_connect.maPL1N_ARM_swigconstant(_connect)
maPL1N_ARM = _connect.maPL1N_ARM

_connect.maPL2N_ARM_swigconstant(_connect)
maPL2N_ARM = _connect.maPL2N_ARM

_connect.maProgramCoolRISC_swigconstant(_connect)
maProgramCoolRISC = _connect.maProgramCoolRISC

_connect.maDataCoolRISC_swigconstant(_connect)
maDataCoolRISC = _connect.maDataCoolRISC

_connect.maASIICData_swigconstant(_connect)
maASIICData = _connect.maASIICData

_connect.maPhysicalV850_swigconstant(_connect)
maPhysicalV850 = _connect.maPhysicalV850

_connect.maHostV850_swigconstant(_connect)
maHostV850 = _connect.maHostV850

_connect.maSysRegV850_swigconstant(_connect)
maSysRegV850 = _connect.maSysRegV850

_connect.maPhysicalARC_swigconstant(_connect)
maPhysicalARC = _connect.maPhysicalARC

_connect.maAUXARC_swigconstant(_connect)
maAUXARC = _connect.maAUXARC

_connect.maPhysical78k_swigconstant(_connect)
maPhysical78k = _connect.maPhysical78k

_connect.maER78k_swigconstant(_connect)
maER78k = _connect.maER78k

_connect.maPhysicalMSP430_swigconstant(_connect)
maPhysicalMSP430 = _connect.maPhysicalMSP430

_connect.maPhysicalXGATE_swigconstant(_connect)
maPhysicalXGATE = _connect.maPhysicalXGATE

_connect.maSCMTPU_swigconstant(_connect)
maSCMTPU = _connect.maSCMTPU

_connect.maSPRAMTPU_swigconstant(_connect)
maSPRAMTPU = _connect.maSPRAMTPU

_connect.maVirtualGTM_swigconstant(_connect)
maVirtualGTM = _connect.maVirtualGTM

_connect.maVirtualTriCore_swigconstant(_connect)
maVirtualTriCore = _connect.maVirtualTriCore

_connect.maPhysicalTriCore_swigconstant(_connect)
maPhysicalTriCore = _connect.maPhysicalTriCore

_connect.maCerberusTricore_swigconstant(_connect)
maCerberusTricore = _connect.maCerberusTricore

_connect.maCMEMPCP_swigconstant(_connect)
maCMEMPCP = _connect.maCMEMPCP

_connect.maPRAMPCP_swigconstant(_connect)
maPRAMPCP = _connect.maPRAMPCP

_connect.maLinearS12Z_swigconstant(_connect)
maLinearS12Z = _connect.maLinearS12Z

_connect.maVirtualRX_swigconstant(_connect)
maVirtualRX = _connect.maVirtualRX

_connect.maVirtualSPT_swigconstant(_connect)
maVirtualSPT = _connect.maVirtualSPT

_connect.maOP_RAM_swigconstant(_connect)
maOP_RAM = _connect.maOP_RAM

_connect.maTW_RAM_swigconstant(_connect)
maTW_RAM = _connect.maTW_RAM

_connect.ICONNECT_E_CONNECT_FAILED_swigconstant(_connect)
ICONNECT_E_CONNECT_FAILED = _connect.ICONNECT_E_CONNECT_FAILED

_connect.ICONNECT_E_VERSION_CONFLICT_swigconstant(_connect)
ICONNECT_E_VERSION_CONFLICT = _connect.ICONNECT_E_VERSION_CONFLICT

_connect.ICONNECT_E_ALREADY_CONNECTED_swigconstant(_connect)
ICONNECT_E_ALREADY_CONNECTED = _connect.ICONNECT_E_ALREADY_CONNECTED

_connect.ICONNECT_E_NOT_CONNECTED_swigconstant(_connect)
ICONNECT_E_NOT_CONNECTED = _connect.ICONNECT_E_NOT_CONNECTED

_connect.ICONNECT_E_FILE_NOT_FOUND_swigconstant(_connect)
ICONNECT_E_FILE_NOT_FOUND = _connect.ICONNECT_E_FILE_NOT_FOUND

_connect.ICONNECT_E_CAN_NOT_ACCESS_swigconstant(_connect)
ICONNECT_E_CAN_NOT_ACCESS = _connect.ICONNECT_E_CAN_NOT_ACCESS

_connect.ICONNECT_E_BAD_ID_swigconstant(_connect)
ICONNECT_E_BAD_ID = _connect.ICONNECT_E_BAD_ID

_connect.ICONNECT_E_NOT_SIMPLE_TYPE_swigconstant(_connect)
ICONNECT_E_NOT_SIMPLE_TYPE = _connect.ICONNECT_E_NOT_SIMPLE_TYPE

_connect.ICONNECT_E_ERROR_swigconstant(_connect)
ICONNECT_E_ERROR = _connect.ICONNECT_E_ERROR

_connect.ICONNECT_E_NO_BREAKPOINT_swigconstant(_connect)
ICONNECT_E_NO_BREAKPOINT = _connect.ICONNECT_E_NO_BREAKPOINT

_connect.ICONNECT_E_NOT_AVAILABLE_swigconstant(_connect)
ICONNECT_E_NOT_AVAILABLE = _connect.ICONNECT_E_NOT_AVAILABLE

_connect.ICONNECT_E_SIZE_swigconstant(_connect)
ICONNECT_E_SIZE = _connect.ICONNECT_E_SIZE

_connect.ICONNECT_E_ALREADY_EXISTS_swigconstant(_connect)
ICONNECT_E_ALREADY_EXISTS = _connect.ICONNECT_E_ALREADY_EXISTS

_connect.ICONNECT_E_TIMEOUT_swigconstant(_connect)
ICONNECT_E_TIMEOUT = _connect.ICONNECT_E_TIMEOUT

_connect.ICONNECT_E_LICENSE_swigconstant(_connect)
ICONNECT_E_LICENSE = _connect.ICONNECT_E_LICENSE

_connect.ICONNECT_E_BUSY_swigconstant(_connect)
ICONNECT_E_BUSY = _connect.ICONNECT_E_BUSY

_connect.ICONNECT_E_MSG_FAIL_swigconstant(_connect)
ICONNECT_E_MSG_FAIL = _connect.ICONNECT_E_MSG_FAIL

_connect.ICONNECT_E_ROUTING_swigconstant(_connect)
ICONNECT_E_ROUTING = _connect.ICONNECT_E_ROUTING

_connect.ICONNECT_E_UMI_FAIL_swigconstant(_connect)
ICONNECT_E_UMI_FAIL = _connect.ICONNECT_E_UMI_FAIL

_connect.ICONNECT_S_SIZE_swigconstant(_connect)
ICONNECT_S_SIZE = _connect.ICONNECT_S_SIZE

_connect.ICONNECT_S_MSG_FAIL_swigconstant(_connect)
ICONNECT_S_MSG_FAIL = _connect.ICONNECT_S_MSG_FAIL

_connect.ICONNECT_S_MSG_WARN_swigconstant(_connect)
ICONNECT_S_MSG_WARN = _connect.ICONNECT_S_MSG_WARN

_connect.ICONNECT_S_STATUS_1_swigconstant(_connect)
ICONNECT_S_STATUS_1 = _connect.ICONNECT_S_STATUS_1

_connect.ICONNECT_S_STATUS_2_swigconstant(_connect)
ICONNECT_S_STATUS_2 = _connect.ICONNECT_S_STATUS_2

_connect.ICONNECT_S_STATUS_3_swigconstant(_connect)
ICONNECT_S_STATUS_3 = _connect.ICONNECT_S_STATUS_3

_connect.ICONNECT_S_STATUS_4_swigconstant(_connect)
ICONNECT_S_STATUS_4 = _connect.ICONNECT_S_STATUS_4

_connect.ICONNECT_S_STATUS_FLAGSMASK_swigconstant(_connect)
...
_connect.indxCoverage_swigconstant(_connect)
indxCoverage = _connect.indxCoverage

_connect.indxTest_swigconstant(_connect)
indxTest = _connect.indxTest

_connect.indxHIL_swigconstant(_connect)
indxHIL = _connect.indxHIL

_connect.indxUMI_swigconstant(_connect)
indxUMI = _connect.indxUMI

_connect.indxAnalyzer_swigconstant(_connect)
...
_connect.indxEclipse_swigconstant(_connect)
...
_connect.ofValNone_swigconstant(_connect)
ofValNone = _connect.ofValNone

_connect.ofValString_swigconstant(_connect)
ofValString = _connect.ofValString

_connect.ofValInt_swigconstant(_connect)
ofValInt = _connect.ofValInt

_connect.ofValFloat_swigconstant(_connect)
ofValFloat = _connect.ofValFloat

_connect.ofValStringInt_swigconstant(_connect)
ofValStringInt = _connect.ofValStringInt

_connect.ofValBuffer_swigconstant(_connect)
ofValBuffer = _connect.ofValBuffer

_connect.ofValFile_swigconstant(_connect)
ofValFile = _connect.ofValFile

_connect.ofValMask_swigconstant(_connect)
ofValMask = _connect.ofValMask

_connect.ofDestIDE_swigconstant(_connect)
ofDestIDE = _connect.ofDestIDE

_connect.ofDestDocument_swigconstant(_connect)
ofDestDocument = _connect.ofDestDocument

_connect.ofDestIOPEN_swigconstant(_connect)
ofDestIOPEN = _connect.ofDestIOPEN

_connect.ofDestPlugin_swigconstant(_connect)
ofDestPlugin = _connect.ofDestPlugin

_connect.ofDestHIL_swigconstant(_connect)
ofDestHIL = _connect.ofDestHIL

_connect.ofDestAuto_swigconstant(_connect)
ofDestAuto = _connect.ofDestAuto

_connect.ofDestMask_swigconstant(_connect)
ofDestMask = _connect.ofDestMask

_connect.ofSet_swigconstant(_connect)
ofSet = _connect.ofSet

_connect.ofGet_swigconstant(_connect)
ofGet = _connect.ofGet

_connect.ofAdd_swigconstant(_connect)
ofAdd = _connect.ofAdd

_connect.ofRemove_swigconstant(_connect)
ofRemove = _connect.ofRemove

_connect.ofGetSize_swigconstant(_connect)
ofGetSize = _connect.ofGetSize

_connect.ofCall_swigconstant(_connect)
ofCall = _connect.ofCall

_connect.ofGetType_swigconstant(_connect)
ofGetType = _connect.ofGetType

_connect.ofMask_swigconstant(_connect)
ofMask = _connect.ofMask

_connect.ofCommit_swigconstant(_connect)
ofCommit = _connect.ofCommit

_connect.ofGetDescriptor_swigconstant(_connect)
ofGetDescriptor = _connect.ofGetDescriptor

_connect.ofGetMenu_swigconstant(_connect)
ofGetMenu = _connect.ofGetMenu

_connect.ofGetObjectMask_swigconstant(_connect)
ofGetObjectMask = _connect.ofGetObjectMask

_connect.ofUseDescriptor_swigconstant(_connect)
ofUseDescriptor = _connect.ofUseDescriptor

_connect.ofDataCreate_swigconstant(_connect)
ofDataCreate = _connect.ofDataCreate

_connect.ofDataApply_swigconstant(_connect)
ofDataApply = _connect.ofDataApply

_connect.ofDataDestroy_swigconstant(_connect)
ofDataDestroy = _connect.ofDataDestroy

_connect.ofDataMask_swigconstant(_connect)
ofDataMask = _connect.ofDataMask

_connect.ofExact_swigconstant(_connect)
ofExact = _connect.ofExact

_connect.OPTION_URL_DestIDE_swigconstant(_connect)
OPTION_URL_DestIDE = _connect.OPTION_URL_DestIDE

_connect.OPTION_URL_DestDocument_swigconstant(_connect)
OPTION_URL_DestDocument = _connect.OPTION_URL_DestDocument

_connect.OPTION_URL_DestIOPEN_swigconstant(_connect)
OPTION_URL_DestIOPEN = _connect.OPTION_URL_DestIOPEN

_connect.OPTION_URL_DestPlugin_swigconstant(_connect)
OPTION_URL_DestPlugin = _connect.OPTION_URL_DestPlugin

_connect.OPTION_URL_DestHIL_swigconstant(_connect)
OPTION_URL_DestHIL = _connect.OPTION_URL_DestHIL

_connect.oseDataChanged_swigconstant(_connect)
oseDataChanged = _connect.oseDataChanged

_connect.oseDescChanged_swigconstant(_connect)
...
_connect.DD_INF_SEPARATOR_swigconstant(_connect)
DD_INF_SEPARATOR = _connect.DD_INF_SEPARATOR

_connect.DD_INF_TOKEN_LEADER_swigconstant(_connect)
DD_INF_TOKEN_LEADER = _connect.DD_INF_TOKEN_LEADER

_connect.DD_INF_FILE_FILTER_swigconstant(_connect)
DD_INF_FILE_FILTER = _connect.DD_INF_FILE_FILTER

_connect.DD_INF_FILE_DEFEXT_swigconstant(_connect)
DD_INF_FILE_DEFEXT = _connect.DD_INF_FILE_DEFEXT

_connect.DD_INF_GUI_swigconstant(_connect)
DD_INF_GUI = _connect.DD_INF_GUI

_connect.DD_INF_VALUE_FORMAT_swigconstant(_connect)
DD_INF_VALUE_FORMAT = _connect.DD_INF_VALUE_FORMAT

_connect.DD_INF_OPTIONS_ID_swigconstant(_connect)
DD_INF_OPTIONS_ID = _connect.DD_INF_OPTIONS_ID

_connect.DD_INF_GUI_DATA_swigconstant(_connect)
DD_INF_GUI_DATA = _connect.DD_INF_GUI_DATA

_connect.DD_INF_GUI_SHORT_swigconstant(_connect)
DD_INF_GUI_SHORT = _connect.DD_INF_GUI_SHORT

_connect.DD_INF_FILE_FOLDER_swigconstant(_connect)
DD_INF_FILE_FOLDER = _connect.DD_INF_FILE_FOLDER

_connect.DD_INF_HELP_swigconstant(_connect)
DD_INF_HELP = _connect.DD_INF_HELP

_connect.DD_INF_KEY_ALT_swigconstant(_connect)
DD_INF_KEY_ALT = _connect.DD_INF_KEY_ALT

_connect.optDisabled_swigconstant(_connect)
optDisabled = _connect.optDisabled

_connect.optRDOnly_swigconstant(_connect)
optRDOnly = _connect.optRDOnly

_connect.optHidden_swigconstant(_connect)
optHidden = _connect.optHidden

_connect.optNoSerialize_swigconstant(_connect)
optNoSerialize = _connect.optNoSerialize

_connect.optHex_swigconstant(_connect)
optHex = _connect.optHex

_connect.optBitField_swigconstant(_connect)
optBitField = _connect.optBitField

_connect.optValueSet_swigconstant(_connect)
optValueSet = _connect.optValueSet

_connect.optBitFieldSize_Pos_swigconstant(_connect)
optBitFieldSize_Pos = _connect.optBitFieldSize_Pos

_connect.optBitFieldSize_Num_swigconstant(_connect)
optBitFieldSize_Num = _connect.optBitFieldSize_Num

_connect.optBitFieldOffs_Pos_swigconstant(_connect)
optBitFieldOffs_Pos = _connect.optBitFieldOffs_Pos

_connect.optBitFieldOffs_Num_swigconstant(_connect)
optBitFieldOffs_Num = _connect.optBitFieldOffs_Num

_connect.optKindFilePath_swigconstant(_connect)
optKindFilePath = _connect.optKindFilePath

_connect.optKindFilePath_Open_swigconstant(_connect)
optKindFilePath_Open = _connect.optKindFilePath_Open

_connect.optKindFilePath_Overwrite_swigconstant(_connect)
optKindFilePath_Overwrite = _connect.optKindFilePath_Overwrite

_connect.optKindFilePath_RelMask_swigconstant(_connect)
optKindFilePath_RelMask = _connect.optKindFilePath_RelMask

_connect.optKindFilePath_RelWorkspace_swigconstant(_connect)
optKindFilePath_RelWorkspace = _connect.optKindFilePath_RelWorkspace

_connect.optKindFilePath_RelEXE_swigconstant(_connect)
optKindFilePath_RelEXE = _connect.optKindFilePath_RelEXE

_connect.optKindSymbol_swigconstant(_connect)
optKindSymbol = _connect.optKindSymbol

_connect.optKindColor_swigconstant(_connect)
optKindColor = _connect.optKindColor

_connect.optKindFont_swigconstant(_connect)
optKindFont = _connect.optKindFont

_connect.optKindFolder_swigconstant(_connect)
optKindFolder = _connect.optKindFolder

_connect.optKindUser_swigconstant(_connect)
optKindUser = _connect.optKindUser

_connect.optKindMask_swigconstant(_connect)
optKindMask = _connect.optKindMask

_connect.optMiscValMask_swigconstant(_connect)
...
_connect.cDefaultPathSeparator_swigconstant(_connect)
cDefaultPathSeparator = _connect.cDefaultPathSeparator

_connect.cDefaultValueSeparator_swigconstant(_connect)
cDefaultValueSeparator = _connect.cDefaultValueSeparator

_connect.cDefaultOptionSeparator_swigconstant(_connect)
...
_connect.acquTrace_swigconstant(_connect)
acquTrace = _connect.acquTrace

_connect.acquDAQ_swigconstant(_connect)
acquDAQ = _connect.acquDAQ

_connect.acquSampling_swigconstant(_connect)
acquSampling = _connect.acquSampling

_connect.acquInspector_swigconstant(_connect)
acquInspector = _connect.acquInspector

_connect.acquNetwork_swigconstant(_connect)
acquNetwork = _connect.acquNetwork

_connect.acquIOM_swigconstant(_connect)
acquIOM = _connect.acquIOM

_connect.acq_NUM_swigconstant(_connect)
acq_NUM = _connect.acq_NUM

_connect.vtState_swigconstant(_connect)
vtState = _connect.vtState

_connect.vtLSB_Exit_Entry_swigconstant(_connect)
vtLSB_Exit_Entry = _connect.vtLSB_Exit_Entry

_connect.vtZero_Exit_Entry_swigconstant(_connect)
vtZero_Exit_Entry = _connect.vtZero_Exit_Entry

_connect.vtRegular_swigconstant(_connect)
vtRegular = _connect.vtRegular

_connect.pdvdHex_swigconstant(_connect)
pdvdHex = _connect.pdvdHex

_connect.pdvdDec_swigconstant(_connect)
pdvdDec = _connect.pdvdDec

_connect.pdvdBin_swigconstant(_connect)
pdvdBin = _connect.pdvdBin

_connect.hValueInvalid_swigconstant(_connect)
hValueInvalid = _connect.hValueInvalid

_connect.hpInvalid_swigconstant(_connect)
hpInvalid = _connect.hpInvalid

_connect.hAllTasks_swigconstant(_connect)
hAllTasks = _connect.hAllTasks

_connect.plNone_swigconstant(_connect)
plNone = _connect.plNone

_connect.plTask_swigconstant(_connect)
plTask = _connect.plTask

_connect.plIRQ_Lowest_swigconstant(_connect)
plIRQ_Lowest = _connect.plIRQ_Lowest

_connect.plIRQ_Highest_swigconstant(_connect)
plIRQ_Highest = _connect.plIRQ_Highest

_connect.plApplication_swigconstant(_connect)
plApplication = _connect.plApplication

_connect.plRunnable_swigconstant(_connect)
plRunnable = _connect.plRunnable

_connect.plSignal_swigconstant(_connect)
plSignal = _connect.plSignal

_connect.plNum_swigconstant(_connect)
plNum = _connect.plNum

_connect.possUnknown_swigconstant(_connect)
possUnknown = _connect.possUnknown

_connect.possContextRET_swigconstant(_connect)
possContextRET = _connect.possContextRET

_connect.possContextRET_OS_swigconstant(_connect)
...
_connect.UNKNOWN_TASK_ID_swigconstant(_connect)
...
_connect.lfSet_swigconstant(_connect)
lfSet = _connect.lfSet

_connect.lfGet_swigconstant(_connect)
lfGet = _connect.lfGet

_connect.lVcc_swigconstant(_connect)
lVcc = _connect.lVcc

_connect.lRESET_swigconstant(_connect)
lRESET = _connect.lRESET

_connect.lSRESET_swigconstant(_connect)
lSRESET = _connect.lSRESET

_connect.lBREAK_swigconstant(_connect)
lBREAK = _connect.lBREAK

_connect.lTRISTATE_swigconstant(_connect)
lTRISTATE = _connect.lTRISTATE

_connect.lJTAG_TCK_swigconstant(_connect)
lJTAG_TCK = _connect.lJTAG_TCK

_connect.lJTAG_TRST_swigconstant(_connect)
lJTAG_TRST = _connect.lJTAG_TRST

_connect.lJTAG_TMS_swigconstant(_connect)
lJTAG_TMS = _connect.lJTAG_TMS

_connect.lJTAG_TDI_swigconstant(_connect)
lJTAG_TDI = _connect.lJTAG_TDI

_connect.lJTAG_TDO_swigconstant(_connect)
lJTAG_TDO = _connect.lJTAG_TDO

_connect.lslLow_swigconstant(_connect)
lslLow = _connect.lslLow

_connect.lslHigh_swigconstant(_connect)
...
_connect.JTAG_flTestLogicReset_RTI_swigconstant(_connect)
JTAG_flTestLogicReset_RTI = _connect.JTAG_flTestLogicReset_RTI

_connect.JTAG_flInvertOrder_swigconstant(_connect)
JTAG_flInvertOrder = _connect.JTAG_flInvertOrder

_connect.JTAG_flShortTDO_TDI_swigconstant(_connect)
JTAG_flShortTDO_TDI = _connect.JTAG_flShortTDO_TDI

_connect.JTAG_flPAUSE_EXIT2_swigconstant(_connect)
JTAG_flPAUSE_EXIT2 = _connect.JTAG_flPAUSE_EXIT2

_connect.JTAG_flOverridePrePostFix_swigconstant(_connect)
JTAG_flOverridePrePostFix = _connect.JTAG_flOverridePrePostFix

_connect.JTAG_flIgnoreTDI_swigconstant(_connect)
JTAG_flIgnoreTDI = _connect.JTAG_flIgnoreTDI

_connect.JTAG_flIgnoreTDO_swigconstant(_connect)
JTAG_flIgnoreTDO = _connect.JTAG_flIgnoreTDO

_connect.JTAG_SCAN_IR_swigconstant(_connect)
JTAG_SCAN_IR = _connect.JTAG_SCAN_IR

_connect.JTAG_SCAN_DR_swigconstant(_connect)
JTAG_SCAN_DR = _connect.JTAG_SCAN_DR

_connect.JTAG_SCAN_MASK_swigconstant(_connect)
JTAG_SCAN_MASK = _connect.JTAG_SCAN_MASK

_connect.JTAG_EXIT_RTI_swigconstant(_connect)
JTAG_EXIT_RTI = _connect.JTAG_EXIT_RTI

_connect.JTAG_EXIT_SDRS_swigconstant(_connect)
JTAG_EXIT_SDRS = _connect.JTAG_EXIT_SDRS

_connect.JTAG_EXIT_P_swigconstant(_connect)
JTAG_EXIT_P = _connect.JTAG_EXIT_P

_connect.JTAG_EXIT_MASK_swigconstant(_connect)
JTAG_EXIT_MASK = _connect.JTAG_EXIT_MASK

_connect.JTAG_flRTI_IR_swigconstant(_connect)
JTAG_flRTI_IR = _connect.JTAG_flRTI_IR

_connect.JTAG_flRTI_DR_swigconstant(_connect)
JTAG_flRTI_DR = _connect.JTAG_flRTI_DR

_connect.JTAG_flSDRS_IR_swigconstant(_connect)
JTAG_flSDRS_IR = _connect.JTAG_flSDRS_IR

_connect.JTAG_flSDRS_DR_swigconstant(_connect)
JTAG_flSDRS_DR = _connect.JTAG_flSDRS_DR

_connect.JTAG_flP_IR_swigconstant(_connect)
JTAG_flP_IR = _connect.JTAG_flP_IR

_connect.JTAG_flP_DR_swigconstant(_connect)
JTAG_flP_DR = _connect.JTAG_flP_DR

_connect.JTAG_flResetByTRSTPin_swigconstant(_connect)
JTAG_flResetByTRSTPin = _connect.JTAG_flResetByTRSTPin

_connect.JTAG_flResetByTMS_RTI_swigconstant(_connect)
...
_connect.mmu_None_swigconstant(_connect)
mmu_None = _connect.mmu_None

_connect.mmu_z1_swigconstant(_connect)
mmu_z1 = _connect.mmu_z1

_connect.mmu_z3_swigconstant(_connect)
mmu_z3 = _connect.mmu_z3

_connect.mmu_z4_swigconstant(_connect)
mmu_z4 = _connect.mmu_z4

_connect.mmu_z6_swigconstant(_connect)
mmu_z6 = _connect.mmu_z6

_connect.mmu_z7_swigconstant(_connect)
mmu_z7 = _connect.mmu_z7

_connect.mmu_Mask_swigconstant(_connect)
mmu_Mask = _connect.mmu_Mask

_connect.mmu_NumTLBsMask_swigconstant(_connect)
...
_connect.CPUSFR_PROP_AREAS_swigconstant(_connect)
CPUSFR_PROP_AREAS = _connect.CPUSFR_PROP_AREAS

_connect.CPUSFR_PROP_AREA_swigconstant(_connect)
CPUSFR_PROP_AREA = _connect.CPUSFR_PROP_AREA

_connect.CPUSFR_PROP_AREA_START_swigconstant(_connect)
CPUSFR_PROP_AREA_START = _connect.CPUSFR_PROP_AREA_START

_connect.CPUSFR_PROP_AREA_END_swigconstant(_connect)
CPUSFR_PROP_AREA_END = _connect.CPUSFR_PROP_AREA_END

_connect.CPUSFR_PROP_AREA_MAU_swigconstant(_connect)
CPUSFR_PROP_AREA_MAU = _connect.CPUSFR_PROP_AREA_MAU

_connect.CPUSFR_PROP_AREA_VISIBLE_swigconstant(_connect)
CPUSFR_PROP_AREA_VISIBLE = _connect.CPUSFR_PROP_AREA_VISIBLE

_connect.CPUSFR_PROP_REGISTERS_swigconstant(_connect)
CPUSFR_PROP_REGISTERS = _connect.CPUSFR_PROP_REGISTERS

_connect.CPUSFR_PROP_REGISTER_swigconstant(_connect)
CPUSFR_PROP_REGISTER = _connect.CPUSFR_PROP_REGISTER

_connect.CPUSFR_PROP_REGISTER_SIZE_swigconstant(_connect)
CPUSFR_PROP_REGISTER_SIZE = _connect.CPUSFR_PROP_REGISTER_SIZE

_connect.CPUSFR_PROP_REGISTER_VISIBLE_swigconstant(_connect)
