...
class App(AppModelBase):
    ...
    app_path = Column(String(50), default="", nullable=False)  # 应用路径
    log_path = Column(String(50), default="", nullable=False)  # 日志路径
    ping_url = Column(String(80), default="", nullable=False)  # Ping地址
