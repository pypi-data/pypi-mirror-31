...
class Ui_PyMDFMainWindow(object):
    def setupUi(self, PyMDFMainWindow):
        ...
        self.page.setGeometry(QtCore.QRect(0, 0, 145, 56))
        ...
        self.open_multiple_files_btn = QtWidgets.QPushButton(self.page_2)
        self.open_multiple_files_btn.setIcon(icon1)
        self.open_multiple_files_btn.setObjectName("open_multiple_files_btn")
        self.files_layout.addWidget(self.open_multiple_files_btn, 0, 0, 1, 1)
        spacerItem1 = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.files_layout.addItem(spacerItem1, 0, 1, 1, 1)
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/stack.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.cs_btn.setIcon(icon3)
        ...
        self.files_layout.addLayout(self.gridLayout_2, 1, 2, 1, 1)
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/list.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
