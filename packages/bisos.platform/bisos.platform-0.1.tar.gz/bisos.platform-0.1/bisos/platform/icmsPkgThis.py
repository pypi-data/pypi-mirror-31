...
"""
*  This file:/de/bx/nne/dev-py/pypi/pkgs/unisos/marme/dev/unisos/marme/new-icmsPkgThis.py :: [[elisp:(org-cycle)][| ]]
...
__libName__ = "new-icmsPkgThis"
####+END:

####+BEGIN: bx:global:timestamp:version-py :style "date"
__version__ = "201712255630"
####+END:
...
"""
class icmsPkgThis_LibOverview(icm.Cmnd):
    cmndParamsMandatory = [ ]
    cmndParamsOptional = [ ]
...
"""
*  [[elisp:(org-cycle)][| ]]  [[elisp:(blee:ppmm:org-mode-toggle)][Nat]] [[elisp:(beginning-of-buffer)][Top]] [[elisp:(delete-other-windows)][(1)]] || IIF       ::  icmsPkgBase_dir    [[elisp:(org-cycle)][| ]]
"""
def icmsPkgBase_dir():
    """
