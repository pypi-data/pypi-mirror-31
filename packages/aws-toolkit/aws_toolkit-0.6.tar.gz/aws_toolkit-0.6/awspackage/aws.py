...
class AWS(object):
    ...
    def create_instance(self, count, region, server_type, subnetid, secgrp, imageid, vpcid):
    ...
    def initiate_instance(self, count, region, server_type, subnetid, secgrp, imageid, vpcid):
        servers = self.create_instance(count, region, server_type, subnetid, secgrp, imageid, vpcid)
                    ...
                    if subnet_ref != "":
                        ...
                        try:
                            ...
                            if 'yes' in rule_change:
                                ...
                                pass
                            try:
                                self.initiate_instance(int(count), region, server_type, subnet_id, secgrp, imageid, vpcid)
                            except Exception, e:
