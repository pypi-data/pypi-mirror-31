...
class DashboardsMixin(object):
    ...
    def new_dashboard(self, project_id, title, search=None, type=None,
                      ...
                      sidepanel=None, loaders=None, mobileSections=None,
        ...
        :param mobileSections: List of dashboard mobile sections
    ...
    def modify_dashboard(self, project_id, dashboard_id, title=None,
                         ...
                         loaders=None, widgets=None, mobileSections=None,
                         desyncFromDesktop=None):
        """Update a dashboard.
        ...
        if sections and widgets:
            raise ValueError(
                'Sections and widgets arguments can not be mixed.')
