...
from datatableview_user_columns import __name__, __version__, __author__

base_url = 'https://github.com/icmanage/django-datatable-view-user-columns'
name = __name__
...
setup(
    ...
    description='Allows a user to specify columns for a datatableview',  # Required
    ...
    install_requires=['django>=1.7,<1.9', 'django-datatable-view'],  # Optional
