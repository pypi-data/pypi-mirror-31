...
class CheckPoliciesRequest(BaseRequest):
    ...
    def __init__(self, org_token, product, product_version, projects=[], force_check_all_dependencies = False):
        BaseRequest.__init__(self, org_token, product, product_version, RequestType.CHECK_POLICY_COMPLIANCE)
