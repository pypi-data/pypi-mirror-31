...
def readme():
	try:
		open('README.md', 'r', encoding='utf8').read().replace('\r', '')
	except:
		return 'Youtube_subscription_manager is an alternative to youtube.com to recover or analyze your subscriptions without requires an account.'
