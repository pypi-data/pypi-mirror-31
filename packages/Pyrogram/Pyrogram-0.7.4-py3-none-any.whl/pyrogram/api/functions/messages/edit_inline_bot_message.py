...
class EditInlineBotMessage(Object):
    ...
    def __init__(self, id, no_webpage: bool = None, stop_geo_live: bool = None, message: str = None, reply_markup=None, entities: list = None, geo_point=None):
    ...
    def read(b: BytesIO, *args) -> "EditInlineBotMessage":
        ...
        return EditInlineBotMessage(id, no_webpage, stop_geo_live, message, reply_markup, entities, geo_point)
