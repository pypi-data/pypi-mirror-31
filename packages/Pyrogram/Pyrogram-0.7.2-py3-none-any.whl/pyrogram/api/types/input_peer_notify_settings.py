...
class InputPeerNotifySettings(Object):
    """Attributes:
        ID: ``0x38935eb2``

    Args:
        mute_until: ``int`` ``32-bit``
        sound: ``str``
    ...
    def __init__(self, mute_until: int, sound: str, show_previews: bool = None, silent: bool = None):
    ...
    @staticmethod
    def read(b: BytesIO, *args) -> "InputPeerNotifySettings":
        flags = Int.read(b)
        ...
        return InputPeerNotifySettings(mute_until, sound, show_previews, silent)
