...
class ChannelAdminLogEventActionUpdatePinned(Object):
    """Attributes:
        ID: ``0xe9e82c18``
    ...
    @staticmethod
    def read(b: BytesIO, *args) -> "ChannelAdminLogEventActionUpdatePinned":
        # No flags
        
        message = Object.read(b)
        
        return ChannelAdminLogEventActionUpdatePinned(message)
