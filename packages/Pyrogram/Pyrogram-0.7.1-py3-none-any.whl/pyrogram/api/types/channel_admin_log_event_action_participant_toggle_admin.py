...
class ChannelAdminLogEventActionParticipantToggleAdmin(Object):
    """Attributes:
        ID: ``0xd5676710``
    ...
    @staticmethod
    def read(b: BytesIO, *args) -> "ChannelAdminLogEventActionParticipantToggleAdmin":
        # No flags
        ...
        return ChannelAdminLogEventActionParticipantToggleAdmin(prev_participant, new_participant)
