...
class Document(Object):
    ...
    def __init__(self, file_id, thumb=None, file_name=None, mime_type=None, file_size=None, date=None):
    ...
    def read(b: BytesIO, *args) -> "Document":
        ...
        return Document(file_id, thumb, file_name, mime_type, file_size, date)
