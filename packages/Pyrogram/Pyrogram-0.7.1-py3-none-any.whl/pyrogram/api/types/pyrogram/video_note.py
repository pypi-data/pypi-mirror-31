...
class VideoNote(Object):
    ...
    def __init__(self, file_id, length, duration, thumb=None, file_name=None, mime_type=None, file_size=None, date=None):
    ...
    @staticmethod
    def read(b: BytesIO, *args) -> "VideoNote":
        flags = Int.read(b)
        ...
        return VideoNote(file_id, length, duration, thumb, file_name, mime_type, file_size, date)
