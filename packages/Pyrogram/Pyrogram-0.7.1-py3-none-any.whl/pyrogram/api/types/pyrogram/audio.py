...
class Audio(Object):
    ...
    def __init__(self, file_id, duration, thumb=None, file_name=None, mime_type=None, file_size=None, date=None, performer=None, title=None):
    ...
    def read(b: BytesIO, *args) -> "Audio":
        ...
        performer = String.read(b) if flags & (1 << 5) else None
        title = String.read(b) if flags & (1 << 6) else None
        return Audio(file_id, duration, thumb, file_name, mime_type, file_size, date, performer, title)
    ...
    def write(self) -> bytes:
        ...
        flags |= (1 << 5) if self.performer is not None else 0
        flags |= (1 << 6) if self.title is not None else 0
        b.write(Int(flags))
