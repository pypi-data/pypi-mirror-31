...
class UpdateShortChatMessage(Object):
    """Attributes:
        ID: ``0x16812688``
    ...
    def read(b: BytesIO, *args) -> "UpdateShortChatMessage":
        ...
        return UpdateShortChatMessage(id, from_id, chat_id, message, pts, pts_count, date, out, mentioned, media_unread, silent, fwd_from, via_bot_id, reply_to_msg_id, entities)
