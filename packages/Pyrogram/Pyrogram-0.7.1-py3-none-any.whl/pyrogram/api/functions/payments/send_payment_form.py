...
class SendPaymentForm(Object):
    ...
    Returns:
        Either :obj:`ents.PaymentResult <pyrogram.api.types.ents.PaymentResult>` or :obj:`ents.PaymentVerficationNeeded <pyrogram.api.types.ents.PaymentVerficationNeeded>`
    """
    ID = 0x2b8879b3
