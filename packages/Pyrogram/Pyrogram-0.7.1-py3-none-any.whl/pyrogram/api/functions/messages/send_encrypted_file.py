...
class SendEncryptedFile(Object):
    ...
    Returns:
        Either :obj:`essages.SentEncryptedMessage <pyrogram.api.types.essages.SentEncryptedMessage>` or :obj:`essages.SentEncryptedFile <pyrogram.api.types.essages.SentEncryptedFile>`
    """
    ID = 0x9a901b66
