...
class InstallStickerSet(Object):
    """Attributes:
        ID: ``0xc78fe460``
    ...
    Returns:
        Either :obj:`essages.StickerSetInstallResultSuccess <pyrogram.api.types.essages.StickerSetInstallResultSuccess>` or :obj:`essages.StickerSetInstallResultArchive <pyrogram.api.types.essages.StickerSetInstallResultArchive>`
    """
    ID = 0xc78fe460
    ...
    def read(b: BytesIO, *args) -> "InstallStickerSet":
        ...
        return InstallStickerSet(stickerset, archived)
