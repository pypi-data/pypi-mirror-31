...
class GetRecentStickers(Object):
    ...
    Returns:
        Either :obj:`essages.RecentStickersNotModified <pyrogram.api.types.essages.RecentStickersNotModified>` or :obj:`essages.RecentStickers <pyrogram.api.types.essages.RecentStickers>`
    """
    ID = 0x5ea192c9
