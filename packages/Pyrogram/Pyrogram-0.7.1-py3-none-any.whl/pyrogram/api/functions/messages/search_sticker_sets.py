...
class SearchStickerSets(Object):
    ...
    Returns:
        Either :obj:`essages.FoundStickerSetsNotModified <pyrogram.api.types.essages.FoundStickerSetsNotModified>` or :obj:`essages.FoundStickerSets <pyrogram.api.types.essages.FoundStickerSets>`
    """
    ID = 0xc2b7d08b
