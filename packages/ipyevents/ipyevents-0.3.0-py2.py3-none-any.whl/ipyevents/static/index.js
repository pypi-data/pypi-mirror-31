...
var EventModel = (function (_super) {
    ...
    EventModel.prototype._add_key_listener = function (event_type, view) {
        ...
        var enable_key_listen = function () { document.addEventListener(event_type, key_handler, capture_event); };
        var disable_key_listen = function () { document.removeEventListener(event_type, key_handler, capture_event); };
