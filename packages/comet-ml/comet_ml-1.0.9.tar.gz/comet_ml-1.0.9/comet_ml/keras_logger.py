...
def patch(module_finder):
    ...
    module_finder.register('tensorflow.python.keras.models', 'Model.fit_generator', fit_logger)
    module_finder.register('keras.utils.training_utils', 'multi_gpu_model', multi_gpu_model_wrapper)
