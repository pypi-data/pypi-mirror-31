...
setup(
    ...
    name = "kernelml",
    version = "1.01",
    description='An algorithm to learn non-linear parameters and custom loss functions',
    ...
    data_files=[('my_data', ['data/kc_house_test_data.csv','data/kc_house_train_data.csv'])],
