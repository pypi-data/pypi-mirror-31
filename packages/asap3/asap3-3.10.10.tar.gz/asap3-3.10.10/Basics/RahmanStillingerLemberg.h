// -*- C++ -*-
// RahmanStillingerLemberg.h: The Lennard-Jones potential.
//
...
#ifndef RahmanStillingerLemberg_H
#define RahmanStillingerLemberg_H
...
class RahmanStillingerLemberg : public Potential
{
 public:
  ...
  */
  RahmanStillingerLemberg(PyObject *self,
			  int numElements,
			  ...
			  double rCut, int verbose);
  ~RahmanStillingerLemberg();

  virtual string GetName() const {return "RahmanStillingerLemberg";}
...
private:
  ...
  */
  void Internalize(int numElements, 
	const std::vector<double> &D0,
	const std::vector<double> &R0,
	const std::vector<double> &y,
	const std::vector<double> &a1,
  ...
  vector<double> D0, R0, y, a1, b1, c1, a2, b2, c2, a3, b3, c3;
