...
class AuthenticationClient:
    ...
    def __init__(self, connection_config):
        self._serviceconnector = ServiceConnector(copy.copy(connection_config))

    def fetch_auth_token(self, tenant_id, username, password):
        """Retrieve the JWT token for a given user in a given tenant.

        :param tenant_id: The ID of the Tenant to log in to.
