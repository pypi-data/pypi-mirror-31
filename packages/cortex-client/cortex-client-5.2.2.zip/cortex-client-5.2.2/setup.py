...
setup(name='cortex-client',
      description="Python SDK for Cognitive Scale's Cortex AI Platform",
      long_description="Python SDK for Cognitive Scale's Cortex AI Platform",
      version='5.2.2',
      author='CognitiveScale',
      author_email='info@cognitivescale.com',
      url='https://docs.cortex.insights.ai',
      license='Cognitive Scale Inc.',
      platforms=['linux', 'osx'],
