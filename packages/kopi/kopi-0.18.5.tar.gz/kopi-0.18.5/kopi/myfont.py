__all__ = ["fontname", "GetFontWidth","GetStringWidth","ShortFontName",
            "ChangeSuperSub", "ChangeFontSize", "ChangeFontAttrib"]
...
class fontwidth:
    ...
    Helvetica_10_Width =    (    2.77975, # 32 Space {{{
                    2.77975, # 33 !
                    3.54758, # 34 "
                    5.5595,
                    5.5595,
    ...
    HelveticaBold_10_Width = (    2.77975, #{{{
                    3.32728,
                    4.73983,
                    5.5595,
                    5.5595,
    ...
    HelveticaOblique_10_Width = (    2.77975,#{{{
                    2.77975,
                    3.54758,
                    5.5595,
                    5.5595,
...
def ChangeSuperSub(fontsize, attrib):
    ...
    if attrib == "superscript":
        yoffset = fontsize * myglobal.FONT_HEIGHT_RATIO * Superscript_YoffsetRatio
        fontsize = fontsize - SuperScript_FontSizeReduction
    elif attrib == "subscript":
        fontsize = fontsize - Subscript_FontSizeReduction
        yoffset = -1*fontsize * myglobal.FONT_HEIGHT_RATIO * Subscript_YoffsetRatio
    else:
        yoffset = 0
