            ...
            for field_name in field_names:
                ...
                if hasattr(field, 'auto_now'):
                    ...
                    if type(field).__name__ in ['BooleanField', 'NullBooleanField']:
                        ...
                        form.fields[form_field_name] = forms.ModelChoiceField(qs, label=normalyze(field.verbose_name), initial=initial, empty_label=empty_label, required=False) # , lazy=True, ignore_lookup=True
