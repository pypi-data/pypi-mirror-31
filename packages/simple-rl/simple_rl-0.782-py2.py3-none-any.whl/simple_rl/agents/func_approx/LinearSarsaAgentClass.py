...
# Other imports.
from simple_rl.agents.func_approx.LinearQLearningAgentClass import LinearQLearningAgent

class LinearSarsaAgent(LinearQLearningAgent):
    '''
    ...
    def __init__(self, actions, num_features, rand_init=False, name="Linear-SARSA", alpha=0.05, gamma=0.99, epsilon=0.01, explore="uniform", rbf=False, anneal=True):
        ...
        LinearQLearningAgent.__init__(self, actions=list(actions), rand_init=rand_init, num_features=num_features, name=name, alpha=alpha, gamma=gamma, epsilon=epsilon, explore=explore, anneal=anneal)
