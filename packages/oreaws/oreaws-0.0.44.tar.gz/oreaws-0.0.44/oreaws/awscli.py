...
def describe_instances(ctx, instance_id):
    ec2.describe_instances(ctx, instance_id)
...
def start_instances(ctx, instance_id):
    ec2.start_instances(ctx, instance_id)
...
def create_ami(ctx, instance_id, aminame):
    ec2.create_ami(ctx, instance_id, aminame)
...
def update_max(ctx, asgname, max):
    autoscaling.update_max(ctx, asgname, max)
...
def update_min(ctx, asgname, min):
    autoscaling.update_min(ctx, asgname, min)
...
def update_desire(ctx, asgname, desire):
    autoscaling.update_desire(ctx, asgname, desire)
...
def describe_records(ctx, zone_id):
    route53.describe_records(ctx, zone_id)
