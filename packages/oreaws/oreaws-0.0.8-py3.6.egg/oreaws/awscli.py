...
def describe_instances(ctx, instance_id):
    def_ec2.describe_instances(ctx, instance_id)
...
def start_instances(ctx, instance_id):
    def_ec2.start_instances(ctx, instance_id)
...
def create_ami(ctx, instance_id, aminame):
    def_ec2.create_ami(ctx, instance_id, aminame)
...
def delete_ami(ctx, imageid):
    def_ec2.delete_ami(ctx, imageid)
...
def describe_asg(ctx):
    def_autoscaling.describe_asg(ctx)
...
def update_max(ctx, asgname, max):
    def_autoscaling.update_max(ctx, asgname, max)
...
def update_min(ctx, asgname, min):
    def_autoscaling.update_min(ctx, asgname, min)
...
def update_desire(ctx, asgname, desire):
    def_autoscaling.update_desire(ctx, asgname, desire)
...
def describe_zones(ctx):
    def_route53.describe_zones(ctx)
...
def describe_records(ctx, zone_id):
    def_route53.describe_records(ctx, zone_id)
