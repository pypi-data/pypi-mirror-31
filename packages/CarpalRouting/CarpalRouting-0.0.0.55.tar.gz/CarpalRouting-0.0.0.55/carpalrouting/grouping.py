...
class LocationGrouping(object):
    ...
    def group_locations(self, locations, schedules, merge_identical=False):
        ...
        Sample processed:
        {'pickup1': {(12000, 18000) : {
        (43140, 79200): [<carpalrouting.models.Location object at 0x110b62be0>],
        (0, 43140): [<carpalrouting.models.Location object at 0x1127d66d8>,
                        <carpalrouting.models.Location object at 0x112a15748>]}},
        'pickup2': {(12000, 18000) : {
        (28800, 79200): [<carpalrouting.models.Location object at 0x110778320>,
                         <carpalrouting.models.Location object at 0x112f0ecf8>,
                         <carpalrouting.models.Location object at 0x112f0ee48>]}},
        'pickup3': {(12000, 18000) : {
        (28800, 79200): [<carpalrouting.models.Location object at 0x112a15dd8>]}}}

        Sample unprocessed:
        {'pickup1': [],
         'pickup2': [],
         'pickup3': [<carpalrouting.models.Location object at 0x110778390>]}
        """
        result = {}
        not_found = set()
