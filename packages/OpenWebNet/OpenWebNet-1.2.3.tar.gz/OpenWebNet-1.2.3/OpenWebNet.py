...
#Calculate the password to start operation
    ...
    def stato_answer(self,who,where,set):
        print('stato answer',who,where,set)
        for answer in self.risposta:
            if who == '1':
                if answer['who']==who and answer['where']==where:
                    what= answer['what']
                    self.risposta.remove(answer)
                    return what
            elif who == '4':
                if answer['who']==who and answer['set']==set and answer['where']==where:
