...
class Family(family.SubdomainFamily, family.WikimediaFamily):
    ...
    def __init__(self):
        ...
        self.languages_by_size = [
            ...
            'oc', 'lv', 'tl', 'ky', 'tt', 'bs', 'ast', 'sq', 'azb', 'new',
            'te', 'zh-yue', 'br', 'pms', 'be-tarask', 'bn', 'ml', 'jv', 'ht',
            'lb', 'sco', 'mr', 'af', 'ga', 'pnb', 'is', 'ba', 'cv', 'sw', 'fy',
            'su', 'my', 'lmo', 'an', 'yo', 'ne', 'nds', 'pa', 'gu', 'io',
            'scn', 'bar', 'bpy', 'als', 'ku', 'kn', 'ckb', 'ia', 'qu', 'arz',
            'mn', 'bat-smg', 'si', 'gd', 'wa', 'nap', 'yi', 'am', 'bug', 'or',
            'cdo', 'map-bms', 'fo', 'hsb', 'mzn', 'mai', 'xmf', 'li', 'sah',
            'sa', 'vec', 'ilo', 'os', 'mrj', 'mhr', 'hif', 'eml', 'bh', 'sd',
            'roa-tara', 'ps', 'diq', 'pam', 'wuu', 'hak', 'nso',
            'zh-classical', 'bcl', 'se', 'ace', 'mi', 'szl', 'nah', 'nds-nl',
            'frr', 'rue', 'vls', 'gan', 'km', 'bo', 'crh', 'sc', 'vep', 'glk',
            'co', 'fiu-vro', 'tk', 'lrc', 'kv', 'csb', 'myv', 'gv', 'as', 'nv',
            'so', 'zea', 'udm', 'ay', 'lez', 'stq', 'ie', 'nrm', 'ug', 'kw',
            'lad', 'pcd', 'mwl', 'sn', 'rm', 'gom', 'gn', 'koi', 'ab', 'lij',
            'mt', 'fur', 'dsb', 'dv', 'ang', 'frp', 'ln', 'cbk-zam', 'kab',
            'ext', 'dty', 'ksh', 'lo', 'gag', 'olo', 'pag', 'pi', 'av', 'haw',
            'bxr', 'pfl', 'xal', 'krc', 'pap', 'kaa', 'rw', 'pdc', 'bjn', 'ha',
            'to', 'nov', 'kl', 'lfn', 'arc', 'jam', 'kbd', 'tyv', 'tpi', 'kbp',
            'tet', 'ki', 'na', 'ig', 'jbo', 'lbe', 'roa-rup', 'ty', 'mdf',
            'za', 'kg', 'gor', 'bi', 'wo', 'lg', 'srn', 'tcy', 'zu', 'chr',
            'ltg', 'sm', 'om', 'inh', 'xh', 'rmy', 'cu', 'bm', 'tn', 'pih',
            'rn', 'chy', 'tw', 'tum', 'ts', 'ak', 'got', 'st', 'atj', 'pnt',
            'ss', 'ch', 'fj', 'ady', 'iu', 'ny', 'ee', 'ks', 'ik', 'sg', 've',
            'ff', 'dz', 'ti', 'cr', 'din',
        ]
