...
Attributes:
    module_level_variable_1 (int): Module level variables may be documented in
        either the ``Attributes`` section of the module docstring,
        or in an **inline docstring** immediately following the variable, like module_level_variable_2.

        Either form is acceptable, but the two should not be mixed.
        Choose one convention to document module level variables and be consistent with it.
...
module_level_variable_1 = 12345

module_level_variable_2 = 98765
...
def module_level_function(param1, param2=None, *args, **kwargs):
    ...
    The name of each parameter is required. The type and description of each parameter is optional.
    ...
    Examples:
        ...
        The Second should show the result, otherwise will failure in doctest

        >>> print(module_level_function(1, '2'))
        True
...
class ExampleError(Exception):
    ...
    The __init__ method may be documented in either the class level docstring,
    or as a docstring on the __init__ method itself.

    Either form is acceptable, but the two should not be mixed.
    Choose one convention to document the __init__ method and be consistent with it.
...
class ExampleClass(object):
    ...
    Alternatively, attributes may be documented inline with the attribute's declaration
