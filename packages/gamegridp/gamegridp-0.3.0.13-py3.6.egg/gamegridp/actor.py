...
class Actor(object):
    ...
    def __init__(self, title, grid, location, img_path=None, img_action="do_nothing", img_heading="E"):
        ...
        _animations = []
        # Set Actor image
        self.__logging__.debug("Target-Location:" + str(self.location))
        ...
        try:
            ...
            self.__logging__.error("Achtung.... kein Grid angegeben! ")
        self.__logging__.debug("Actor " + title + " wurde initialisiert")
    ...
    def direction(self, value):
        self.__logging__.debug("Direction set" + str(value))
        __logging__.info("rotated by " + str(value) + " degrees. Is rotatable?: " + str(self._is_rotatable))
    ...
    def image_add(self, img_path: str, img_action, data=None):
        self.__grid__.draw_queue.append(pygame.Rect(self.image_rect))
        self._original_images.append(pygame.image.load(img_path).convert_alpha())
        self.__logging__.debug("Number of Actor images:" + str(self._original_images.__len__()))
    ...
    def image_next(self):
        ...
        self.draw()
        self.__grid__.draw_queue.append(pygame.Rect(self.image_rect))
        self.__logging__.debug("Actual image:" + str(self._image_index) + "/" + str(self._original_images.__len__() - 1))
    ...
    def log(self):
        self.__logging__ = __logging__.getLogger('actor-' + self.title)
    ...
    def location(self, value):
        self.__logging__.debug("Location set")
        self.__grid__.draw_queue.append(pygame.Rect(self.image_rect))
    ...
    def turn_left(self, degrees=90):
        ...
        self.__logging__.debug("Richtung:" + str(self.direction))
    ...
    def move(self, distance=1):
        ...
        self.__logging__.debug("self" + str(self.location) + ", target" + str(target))
    ...
    def look_forward(self, distance=1):
        __logging__.debug("Location:" + str(self.location) + "Direction" + str(self.direction))
