...
The sources for minds-cli can be downloaded from the `Github repo`_.
...
.. _Github repo: https://gitlab.com/granitosaurus/minds-cli
.. _tarball: https://gitlab.com/granitosaurus/minds-cli/tarball/master
