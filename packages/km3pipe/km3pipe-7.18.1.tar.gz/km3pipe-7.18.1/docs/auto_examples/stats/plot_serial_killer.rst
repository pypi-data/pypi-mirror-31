...
.. rst-class:: sphx-glr-script-out
 ...
 Out::
    ...
    pareto
    --------------
      loc: +0.430 ∈ [+0.361, +0.531] (95%)
    scale: -0.053 ∈ [-0.010, -0.002] (95%)
        b: +3.133 ∈ [+3.002, +5.534] (95%)
...
.. rst-class:: sphx-glr-script-out
 ...
 Out::
    ...
    lognorm
    --------------
      loc: +2.213 ∈ [+1.160, +8.282] (95%)
    scale: +2.349 ∈ [+0.690, +4.509] (95%)
        s: +26.935 ∈ [+0.486, +51.131] (95%)
...
**Total running time of the script:** ( 0 minutes  11.341 seconds)
