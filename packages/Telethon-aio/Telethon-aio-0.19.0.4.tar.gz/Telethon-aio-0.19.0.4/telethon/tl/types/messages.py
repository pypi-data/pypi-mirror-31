...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeStickerPack, TypeMessage, TypeChat, TypeBotInlineResult, TypeInlineBotSwitchPM, TypeUser, TypeEncryptedFile, TypeStickerSetCovered, TypeStickerSet, TypeChatFull, TypeDialog, TypeFoundGif, TypeHighScore, TypeDocument
