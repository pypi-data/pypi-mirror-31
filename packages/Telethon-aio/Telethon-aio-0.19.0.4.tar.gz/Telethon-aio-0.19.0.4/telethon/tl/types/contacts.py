...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypePopularContact, TypeContact, TypeChat, TypePeer, TypeContactLink, TypeUser, TypeTopPeerCategoryPeers, TypeImportedContact, TypeContactBlocked
