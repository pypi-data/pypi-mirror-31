...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelAdminRights, TypeInputMessage, TypeInputStickerSet, TypeChannelBannedRights, TypeInputChatPhoto, TypeChannelAdminLogEventsFilter, TypeBool, TypeChannelParticipantsFilter, TypeInputChannel, TypeInputUser
