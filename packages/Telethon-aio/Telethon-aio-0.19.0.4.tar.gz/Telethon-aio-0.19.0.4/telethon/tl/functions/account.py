...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeAccountDaysTTL, TypeInputPrivacyRule, TypeInputPrivacyKey, TypeBool, TypeInputPeer, TypeInputNotifyPeer, TypeReportReason, TypeInputPeerNotifySettings
