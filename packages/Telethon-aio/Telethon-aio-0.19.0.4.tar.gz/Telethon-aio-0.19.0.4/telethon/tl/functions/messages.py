...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputEncryptedChat, TypeInputBotInlineMessageID, TypeInlineBotSwitchPM, TypeMessagesFilter, TypeInputStickeredMedia, TypeInputBotInlineResult, TypeInputGeoPoint, TypeInputMessage, TypeInputStickerSet, TypeReplyMarkup, TypeShippingOption, TypeInputMedia, TypeBool, TypeInputUser, TypeInputDialogPeer, TypeInputChatPhoto, TypeInputEncryptedFile, TypeMessageEntity, TypeSendMessageAction, TypeInputSingleMedia, TypeInputDocument, TypeInputPeer, TypeReportReason
