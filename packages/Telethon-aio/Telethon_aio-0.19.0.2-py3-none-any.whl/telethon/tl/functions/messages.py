...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputDocument, TypeBool, TypeInlineBotSwitchPM, TypeInputStickeredMedia, TypeInputPeer, TypeInputChatPhoto, TypeMessagesFilter, TypeInputBotInlineMessageID, TypeInputBotInlineResult, TypeInputEncryptedFile, TypeInputDialogPeer, TypeMessageEntity, TypeInputStickerSet, TypeInputMedia, TypeReplyMarkup, TypeInputGeoPoint, TypeInputEncryptedChat, TypeReportReason, TypeInputUser, TypeInputMessage, TypeInputSingleMedia, TypeSendMessageAction, TypeShippingOption
