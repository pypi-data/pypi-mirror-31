...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeReportReason, TypeBool, TypeInputPrivacyRule, TypeInputNotifyPeer, TypeAccountDaysTTL, TypeInputPeer, TypeInputPrivacyKey, TypeInputPeerNotifySettings
