...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputUser, TypeInputMessage, TypeBool, TypeChannelAdminRights, TypeInputChannel, TypeChannelAdminLogEventsFilter, TypeInputStickerSet, TypeChannelParticipantsFilter, TypeInputChatPhoto, TypeChannelBannedRights
