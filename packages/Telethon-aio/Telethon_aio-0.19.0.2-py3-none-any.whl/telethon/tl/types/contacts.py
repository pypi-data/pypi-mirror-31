...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactBlocked, TypeChat, TypeImportedContact, TypeContact, TypePopularContact, TypeTopPeerCategoryPeers, TypeUser, TypePeer, TypeContactLink
