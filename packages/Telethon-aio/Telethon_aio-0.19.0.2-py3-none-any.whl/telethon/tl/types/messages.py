...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeStickerSet, TypeInlineBotSwitchPM, TypeChat, TypeStickerSetCovered, TypeStickerPack, TypeHighScore, TypeDialog, TypeChatFull, TypeEncryptedFile, TypeBotInlineResult, TypeUser, TypeDocument, TypeFoundGif, TypeMessage
