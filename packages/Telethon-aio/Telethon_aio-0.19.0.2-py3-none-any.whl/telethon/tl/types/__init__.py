...
import struct
if TYPE_CHECKING:
    from ...tl.types import Typedouble, TypeBool, Typefuture_salt
...
class BotInlineMessageMediaContact(TLObject):
    ...
    def from_reader(cls, reader):
        ...
        if flags & 4:
            ...
            _reply_markup = None
        return cls(phone_number=_phone_number, first_name=_first_name, last_name=_last_name, reply_markup=_reply_markup)
...
class BotInlineMessageMediaVenue(TLObject):
    ...
    def from_reader(cls, reader):
        ...
        if flags & 4:
            ...
            _reply_markup = None
        return cls(geo=_geo, title=_title, address=_address, provider=_provider, venue_id=_venue_id, reply_markup=_reply_markup)
...
class ChannelAdminRights(TLObject):
    ...
    def from_reader(cls, reader):
        ...
        return cls(change_info=_change_info, post_messages=_post_messages, edit_messages=_edit_messages, delete_messages=_delete_messages, ban_users=_ban_users, invite_users=_invite_users, invite_link=_invite_link, pin_messages=_pin_messages, add_admins=_add_admins)
...
class Chat(TLObject):
    ...
    async def resolve(self, client, utils):
        if self.migrated_to:
            self.migrated_to = utils.get_input_channel(await client.get_input_entity(self.migrated_to))
...
class Config(TLObject):
    ...
    def __bytes__(self):
        ...
        return b''.join((
            b'\x8ew\xb5\x86',
            struct.pack('<I', (0 if self.phonecalls_enabled is None or self.phonecalls_enabled is False else 2) | (0 if self.default_p2p_contacts is None or self.default_p2p_contacts is False else 8) | (0 if self.preload_featured_stickers is None or self.preload_featured_stickers is False else 16) | (0 if self.ignore_phone_entities is None or self.ignore_phone_entities is False else 32) | (0 if self.revoke_pm_inbox is None or self.revoke_pm_inbox is False else 64) | (0 if self.tmp_sessions is None or self.tmp_sessions is False else 1) | (0 if self.suggested_lang_code is None or self.suggested_lang_code is False else 4) | (0 if self.lang_pack_version is None or self.lang_pack_version is False else 4)),
            TLObject.serialize_datetime(self.date),
...
class DcOption(TLObject):
    ...
    def from_reader(cls, reader):
        ...
        return cls(id=_id, ip_address=_ip_address, port=_port, ipv6=_ipv6, media_only=_media_only, tcpo_only=_tcpo_only, cdn=_cdn, static=_static)
...
class Dialog(TLObject):
    ...
    def from_reader(cls, reader):
        ...
        if flags & 2:
            ...
            _draft = None
        return cls(peer=_peer, top_message=_top_message, read_inbox_max_id=_read_inbox_max_id, read_outbox_max_id=_read_outbox_max_id, unread_count=_unread_count, unread_mentions_count=_unread_mentions_count, notify_settings=_notify_settings, pinned=_pinned, pts=_pts, draft=_draft)
...
class GeoPoint(TLObject):
    ...
    def from_reader(cls, reader):
        ...
        return cls(long=_long, lat=_lat)
...
class GzipPacked(TLObject):
    ...
    SUBCLASS_OF_ID = 0xaf01aeda

    def __init__(self, packed_data):
        """
        :param bytes packed_data:

        Constructor for Object: Instance of GzipPacked.
        """
        super().__init__()

        self.packed_data = packed_data  # type: bytes
    ...
    def __bytes__(self):
        return b''.join((
            b'\xa1\xcfr0',
            TLObject.serialize_bytes(self.packed_data),
        ))

    @classmethod
    def from_reader(cls, reader):
        _packed_data = reader.tgread_bytes()
        return cls(packed_data=_packed_data)
...
class InputBotInlineMessageMediaVenue(TLObject):
    ...
    def from_reader(cls, reader):
        ...
        if flags & 4:
            ...
            _reply_markup = None
        return cls(geo_point=_geo_point, title=_title, address=_address, provider=_provider, venue_id=_venue_id, reply_markup=_reply_markup)
...
class InputMediaContact(TLObject):
    ...
    def from_reader(cls, reader):
        ...
        _first_name = reader.tgread_string()
        _last_name = reader.tgread_string()
        return cls(phone_number=_phone_number, first_name=_first_name, last_name=_last_name)
...
class InputPeerNotifySettings(TLObject):
    ...
    def __init__(self, mute_until, sound, show_previews=None, silent=None):
        ...
        :param str sound:
        :param Optional[bool] show_previews:
    ...
    def from_reader(cls, reader):
        ...
        return cls(mute_until=_mute_until, sound=_sound, show_previews=_show_previews, silent=_silent)
...
class Message(TLObject):
    ...
    def __init__(self, id, to_id, date, message, out=None, mentioned=None, media_unread=None, silent=None, post=None, from_id=None, fwd_from=None, via_bot_id=None, reply_to_msg_id=None, media=None, reply_markup=None, entities=None, views=None, edit_date=None, post_author=None, grouped_id=None):
        ...
        :param Optional[TypeReplyMarkup] reply_markup:
        :param Optional[List[TypeMessageEntity]] entities:
        :param Optional[int] views:
        :param Optional[datetime] edit_date:
        :param Optional[str] post_author:
        :param Optional[int] grouped_id:
...
class MessageActionBotAllowed(TLObject):
    ...
    def __init__(self, domain):
        ...
        Constructor for MessageAction: Instance of either MessageActionEmpty, MessageActionChatCreate, MessageActionChatEditTitle, MessageActionChatEditPhoto, MessageActionChatDeletePhoto, MessageActionChatAddUser, MessageActionChatDeleteUser, MessageActionChatJoinedByLink, MessageActionChannelCreate, MessageActionChatMigrateTo, MessageActionChannelMigrateFrom, MessageActionPinMessage, MessageActionHistoryClear, MessageActionGameScore, MessageActionPaymentSentMe, MessageActionPaymentSent, MessageActionPhoneCall, MessageActionScreenshotTaken, MessageActionCustomAction, MessageActionBotAllowed.
        """
        super().__init__()
    ...
    def __bytes__(self):
        return b''.join((
            b'\xfe\xaf\xe9\xab',
            TLObject.serialize_bytes(self.domain),
        ))
...
class MessageService(TLObject):
    ...
    def __init__(self, id, to_id, date, action, out=None, mentioned=None, media_unread=None, silent=None, post=None, from_id=None, reply_to_msg_id=None):
        ...
        :param TypePeer to_id:
        :param Optional[datetime] date:
        :param TypeMessageAction action:
        :param Optional[bool] out:
        :param Optional[bool] mentioned:
        :param Optional[bool] media_unread:
        :param Optional[bool] silent:
...
class RsaPublicKey(TLObject):
    ...
    def __bytes__(self):
        return b''.join((
            b'v\xcb\x19z',
            TLObject.serialize_bytes(self.n),
            TLObject.serialize_bytes(self.e),
        ))
...
class StickerSet(TLObject):
    ...
    def __bytes__(self):
        return b''.join((
            ...
            b'' if self.installed_date is None or self.installed_date is False else (TLObject.serialize_datetime(self.installed_date)),
            struct.pack('<q', self.id),
            struct.pack('<q', self.access_hash),
            TLObject.serialize_bytes(self.title),
            TLObject.serialize_bytes(self.short_name),
...
class WebAuthorization(TLObject):
    ...
    def __bytes__(self):
        return b''.join((
            ...
            TLObject.serialize_bytes(self.domain),
            TLObject.serialize_bytes(self.browser),
            TLObject.serialize_bytes(self.platform),
            struct.pack('<i', self.date_created),
            struct.pack('<i', self.date_active),
            TLObject.serialize_bytes(self.ip),
...
class WebDocument(TLObject):
    ...
    def from_reader(cls, reader):
        ...
        _dc_id = reader.read_int()
        return cls(url=_url, access_hash=_access_hash, size=_size, mime_type=_mime_type, attributes=_attributes, dc_id=_dc_id)
