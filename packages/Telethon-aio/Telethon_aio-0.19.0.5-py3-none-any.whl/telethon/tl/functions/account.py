...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeAccountDaysTTL, TypeInputNotifyPeer, TypeBool, TypeInputPeerNotifySettings, TypeInputPeer, TypeReportReason, TypeInputPrivacyRule, TypeInputPrivacyKey
