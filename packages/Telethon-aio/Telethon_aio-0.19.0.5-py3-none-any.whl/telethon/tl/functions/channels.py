...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputUser, TypeChannelAdminRights, TypeInputChatPhoto, TypeChannelBannedRights, TypeInputChannel, TypeBool, TypeChannelAdminLogEventsFilter, TypeChannelParticipantsFilter, TypeInputStickerSet, TypeInputMessage
