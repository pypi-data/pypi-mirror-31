...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputDocument, TypeMessageEntity, TypeInputMessage, TypeInputStickeredMedia, TypeReplyMarkup, TypeBool, TypeInputDialogPeer, TypeInputBotInlineResult, TypeInputEncryptedChat, TypeInputSingleMedia, TypeInputPeer, TypeMessagesFilter, TypeReportReason, TypeSendMessageAction, TypeInputBotInlineMessageID, TypeInputStickerSet, TypeInputGeoPoint, TypeInputUser, TypeInputMedia, TypeInlineBotSwitchPM, TypeInputChatPhoto, TypeInputEncryptedFile, TypeShippingOption
