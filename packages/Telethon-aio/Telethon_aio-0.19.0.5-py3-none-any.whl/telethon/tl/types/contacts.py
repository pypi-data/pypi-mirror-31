...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChat, TypeTopPeerCategoryPeers, TypePopularContact, TypeContact, TypeUser, TypeContactLink, TypeImportedContact, TypeContactBlocked, TypePeer
