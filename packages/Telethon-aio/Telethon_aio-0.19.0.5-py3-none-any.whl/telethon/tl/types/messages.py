...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeHighScore, TypeInlineBotSwitchPM, TypeChat, TypeDialog, TypeBotInlineResult, TypeChatFull, TypeUser, TypeEncryptedFile, TypeStickerSet, TypeMessage, TypeStickerSetCovered, TypeDocument, TypeStickerPack, TypeFoundGif
