...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactBlocked, TypeContact, TypePeer, TypeChat, TypeUser, TypeImportedContact, TypeTopPeerCategoryPeers, TypeContactLink, TypePopularContact
