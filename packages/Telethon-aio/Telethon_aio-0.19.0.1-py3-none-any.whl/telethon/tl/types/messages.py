...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeFoundGif, TypeDialog, TypeDocument, TypeEncryptedFile, TypeStickerSet, TypeInlineBotSwitchPM, TypeChat, TypeUser, TypeStickerSetCovered, TypeChatFull, TypeStickerPack, TypeBotInlineResult, TypeHighScore, TypeMessage
