...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputChannel, TypeInputMessage, TypeInputUser, TypeBool, TypeChannelAdminLogEventsFilter, TypeInputStickerSet, TypeChannelBannedRights, TypeInputChatPhoto, TypeChannelParticipantsFilter, TypeChannelAdminRights
