...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputMessage, TypeInputGeoPoint, TypeInputChatPhoto, TypeInputBotInlineMessageID, TypeSendMessageAction, TypeMessageEntity, TypeInputPeer, TypeInputUser, TypeBool, TypeInlineBotSwitchPM, TypeInputMedia, TypeInputStickeredMedia, TypeInputDocument, TypeMessagesFilter, TypeReplyMarkup, TypeInputEncryptedChat, TypeShippingOption, TypeInputSingleMedia, TypeInputDialogPeer, TypeInputEncryptedFile, TypeInputStickerSet, TypeReportReason, TypeInputBotInlineResult
