...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputNotifyPeer, TypeInputPeer, TypeBool, TypeInputPeerNotifySettings, TypeAccountDaysTTL, TypeReportReason, TypeInputPrivacyRule, TypeInputPrivacyKey
