...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputChannel, TypeChannelAdminRights, TypeChannelBannedRights, TypeInputMessage, TypeBool, TypeInputChatPhoto, TypeChannelAdminLogEventsFilter, TypeInputUser, TypeChannelParticipantsFilter, TypeInputStickerSet
