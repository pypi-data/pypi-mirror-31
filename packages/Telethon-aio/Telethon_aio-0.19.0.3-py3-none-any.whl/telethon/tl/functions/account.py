...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeAccountDaysTTL, TypeInputPrivacyKey, TypeBool, TypeReportReason, TypeInputPrivacyRule, TypeInputPeer, TypeInputPeerNotifySettings, TypeInputNotifyPeer
