...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputMedia, TypeInputEncryptedFile, TypeInputPeer, TypeSendMessageAction, TypeInputGeoPoint, TypeReportReason, TypeInputDocument, TypeInputBotInlineMessageID, TypeInputStickeredMedia, TypeInputUser, TypeInlineBotSwitchPM, TypeMessagesFilter, TypeInputSingleMedia, TypeInputEncryptedChat, TypeReplyMarkup, TypeInputMessage, TypeBool, TypeInputBotInlineResult, TypeInputChatPhoto, TypeShippingOption, TypeInputDialogPeer, TypeMessageEntity, TypeInputStickerSet
