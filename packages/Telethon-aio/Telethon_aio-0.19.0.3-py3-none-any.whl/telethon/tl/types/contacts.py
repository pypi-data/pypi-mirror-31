...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContact, TypeContactBlocked, TypePeer, TypeChat, TypeImportedContact, TypeContactLink, TypeTopPeerCategoryPeers, TypePopularContact, TypeUser
