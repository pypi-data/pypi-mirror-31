...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeEncryptedFile, TypeMessage, TypeChatFull, TypeBotInlineResult, TypeStickerPack, TypeHighScore, TypeChat, TypeDocument, TypeStickerSetCovered, TypeInlineBotSwitchPM, TypeDialog, TypeFoundGif, TypeStickerSet, TypeUser
