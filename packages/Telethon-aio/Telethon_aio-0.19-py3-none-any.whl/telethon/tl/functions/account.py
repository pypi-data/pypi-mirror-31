...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBool, TypeInputNotifyPeer, TypeInputPrivacyKey, TypeInputPeerNotifySettings, TypeAccountDaysTTL, TypeInputPrivacyRule, TypeInputPeer, TypeReportReason
