...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputMessage, TypeInputMedia, TypeMessagesFilter, TypeInputBotInlineMessageID, TypeInputBotInlineResult, TypeInlineBotSwitchPM, TypeSendMessageAction, TypeInputDocument, TypeBool, TypeReplyMarkup, TypeInputEncryptedFile, TypeInputSingleMedia, TypeInputStickeredMedia, TypeMessageEntity, TypeInputUser, TypeInputGeoPoint, TypeInputStickerSet, TypeShippingOption, TypeInputEncryptedChat, TypeInputDialogPeer, TypeInputPeer, TypeInputChatPhoto, TypeReportReason
