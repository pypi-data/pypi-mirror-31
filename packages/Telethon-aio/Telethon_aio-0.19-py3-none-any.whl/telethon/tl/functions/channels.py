...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputMessage, TypeInputStickerSet, TypeChannelBannedRights, TypeChannelParticipantsFilter, TypeBool, TypeChannelAdminLogEventsFilter, TypeInputChannel, TypeInputChatPhoto, TypeInputUser, TypeChannelAdminRights
