...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypePeer, TypeContactBlocked, TypeChat, TypeContactLink, TypeTopPeerCategoryPeers, TypeContact, TypeImportedContact, TypePopularContact, TypeUser
