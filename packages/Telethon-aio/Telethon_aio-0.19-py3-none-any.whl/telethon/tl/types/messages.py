...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeDocument, TypeDialog, TypeChat, TypeMessage, TypeHighScore, TypeStickerPack, TypeEncryptedFile, TypeFoundGif, TypeChatFull, TypeUser, TypeInlineBotSwitchPM, TypeStickerSet, TypeStickerSetCovered, TypeBotInlineResult
