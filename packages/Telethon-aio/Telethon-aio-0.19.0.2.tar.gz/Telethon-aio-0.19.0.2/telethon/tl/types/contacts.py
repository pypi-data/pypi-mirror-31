...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactBlocked, TypeUser, TypeChat, TypePeer, TypeImportedContact, TypeContactLink, TypePopularContact, TypeTopPeerCategoryPeers, TypeContact
