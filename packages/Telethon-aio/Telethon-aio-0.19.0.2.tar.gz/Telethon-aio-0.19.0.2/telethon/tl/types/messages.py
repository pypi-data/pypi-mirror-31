...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBotInlineResult, TypeInlineBotSwitchPM, TypeHighScore, TypeUser, TypeChat, TypeStickerSet, TypeDocument, TypeFoundGif, TypeStickerSetCovered, TypeChatFull, TypeEncryptedFile, TypeStickerPack, TypeMessage, TypeDialog
