...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputMessage, TypeBool, TypeChannelBannedRights, TypeChannelAdminLogEventsFilter, TypeChannelParticipantsFilter, TypeInputStickerSet, TypeInputChannel, TypeInputChatPhoto, TypeChannelAdminRights, TypeInputUser
