...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputMedia, TypeInputBotInlineResult, TypeInputUser, TypeInputPeer, TypeMessageEntity, TypeInputDialogPeer, TypeReportReason, TypeInputEncryptedFile, TypeInputStickeredMedia, TypeInputSingleMedia, TypeInputDocument, TypeBool, TypeInputStickerSet, TypeReplyMarkup, TypeInputGeoPoint, TypeMessagesFilter, TypeInputEncryptedChat, TypeInlineBotSwitchPM, TypeInputMessage, TypeInputChatPhoto, TypeInputBotInlineMessageID, TypeSendMessageAction, TypeShippingOption
