...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBool, TypeInputPrivacyKey, TypeInputPrivacyRule, TypeInputNotifyPeer, TypeAccountDaysTTL, TypeReportReason, TypeInputPeer, TypeInputPeerNotifySettings
