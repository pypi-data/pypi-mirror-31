...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputStickerSet, TypeChannelAdminLogEventsFilter, TypeInputMessage, TypeBool, TypeInputChatPhoto, TypeInputChannel, TypeChannelAdminRights, TypeChannelBannedRights, TypeChannelParticipantsFilter, TypeInputUser
