...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputSingleMedia, TypeInputDialogPeer, TypeInputPeer, TypeInputGeoPoint, TypeInputStickeredMedia, TypeInputBotInlineResult, TypeInputUser, TypeMessagesFilter, TypeInputEncryptedFile, TypeInputChatPhoto, TypeShippingOption, TypeReportReason, TypeInputEncryptedChat, TypeInputStickerSet, TypeInputMessage, TypeInputMedia, TypeInputBotInlineMessageID, TypeReplyMarkup, TypeMessageEntity, TypeInlineBotSwitchPM, TypeBool, TypeSendMessageAction, TypeInputDocument
