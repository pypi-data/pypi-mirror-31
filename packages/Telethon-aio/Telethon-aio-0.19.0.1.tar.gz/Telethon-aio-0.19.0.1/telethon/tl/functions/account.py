...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputPeer, TypeBool, TypeInputPrivacyRule, TypeAccountDaysTTL, TypeInputNotifyPeer, TypeInputPeerNotifySettings, TypeReportReason, TypeInputPrivacyKey
