...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChatFull, TypeDocument, TypeFoundGif, TypeInlineBotSwitchPM, TypeStickerSet, TypeStickerSetCovered, TypeEncryptedFile, TypeChat, TypeMessage, TypeDialog, TypeUser, TypeHighScore, TypeStickerPack, TypeBotInlineResult
