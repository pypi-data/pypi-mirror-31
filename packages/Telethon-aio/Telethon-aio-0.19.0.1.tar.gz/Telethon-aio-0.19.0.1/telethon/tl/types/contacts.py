...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeTopPeerCategoryPeers, TypeImportedContact, TypeChat, TypeContactLink, TypeUser, TypeContact, TypePeer, TypePopularContact, TypeContactBlocked
