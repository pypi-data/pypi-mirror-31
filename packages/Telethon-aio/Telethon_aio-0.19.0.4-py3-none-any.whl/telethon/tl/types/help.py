...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChat, TypeUser, TypeRecentMeUrl, TypeipPort, TypeBool
...
class ConfigSimple(TLObject):
    ...
    def __init__(self, date, expires, dc_id, ip_port_list):
        ...
        :param int dc_id:
        :param List[TypeipPort] ip_port_list:
        ...
        self.ip_port_list = ip_port_list  # type: List[TypeipPort]
    ...
    def from_reader(cls, reader):
        ...
        return cls(date=_date, expires=_expires, dc_id=_dc_id, ip_port_list=_ip_port_list)
