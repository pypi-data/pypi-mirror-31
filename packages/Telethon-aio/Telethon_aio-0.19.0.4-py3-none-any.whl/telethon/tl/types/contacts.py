...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeContactBlocked, TypePeer, TypeChat, TypeUser, TypeContact, TypeTopPeerCategoryPeers, TypeImportedContact, TypePopularContact, TypeContactLink
