...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeMessage, TypeStickerSet, TypeChat, TypeStickerPack, TypeStickerSetCovered, TypeUser, TypeEncryptedFile, TypeHighScore, TypeInlineBotSwitchPM, TypeDialog, TypeFoundGif, TypeBotInlineResult, TypeDocument, TypeChatFull
