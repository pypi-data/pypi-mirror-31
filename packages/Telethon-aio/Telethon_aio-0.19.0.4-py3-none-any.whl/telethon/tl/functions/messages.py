...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeShippingOption, TypeInputMessage, TypeInlineBotSwitchPM, TypeInputBotInlineMessageID, TypeInputMedia, TypeInputBotInlineResult, TypeInputDialogPeer, TypeBool, TypeInputPeer, TypeInputDocument, TypeInputSingleMedia, TypeReportReason, TypeSendMessageAction, TypeInputUser, TypeInputGeoPoint, TypeInputEncryptedChat, TypeInputChatPhoto, TypeMessageEntity, TypeMessagesFilter, TypeInputStickerSet, TypeInputStickeredMedia, TypeReplyMarkup, TypeInputEncryptedFile
