...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeAccountDaysTTL, TypeInputPeer, TypeInputPrivacyKey, TypeInputPrivacyRule, TypeInputNotifyPeer, TypeReportReason, TypeBool, TypeInputPeerNotifySettings
