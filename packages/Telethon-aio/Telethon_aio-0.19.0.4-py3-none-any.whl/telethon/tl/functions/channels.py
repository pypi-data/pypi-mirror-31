...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputUser, TypeInputChannel, TypeInputStickerSet, TypeInputMessage, TypeChannelAdminLogEventsFilter, TypeChannelParticipantsFilter, TypeChannelAdminRights, TypeInputChatPhoto, TypeBool, TypeChannelBannedRights
