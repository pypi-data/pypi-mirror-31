...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChat, TypeContactLink, TypeTopPeerCategoryPeers, TypeContact, TypePeer, TypeContactBlocked, TypePopularContact, TypeImportedContact, TypeUser
