...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeStickerSetCovered, TypeStickerSet, TypeChat, TypeStickerPack, TypeMessage, TypeChatFull, TypeDocument, TypeEncryptedFile, TypeInlineBotSwitchPM, TypeFoundGif, TypeHighScore, TypeBotInlineResult, TypeDialog, TypeUser
