...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelParticipantsFilter, TypeInputStickerSet, TypeBool, TypeInputUser, TypeChannelAdminLogEventsFilter, TypeInputMessage, TypeChannelBannedRights, TypeInputChatPhoto, TypeChannelAdminRights, TypeInputChannel
