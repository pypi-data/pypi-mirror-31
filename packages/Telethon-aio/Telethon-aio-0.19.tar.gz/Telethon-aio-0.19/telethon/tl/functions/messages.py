...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeMessagesFilter, TypeInputDocument, TypeInlineBotSwitchPM, TypeInputDialogPeer, TypeInputBotInlineResult, TypeShippingOption, TypeReportReason, TypeInputStickerSet, TypeInputUser, TypeMessageEntity, TypeInputMessage, TypeInputChatPhoto, TypeInputGeoPoint, TypeBool, TypeInputPeer, TypeInputStickeredMedia, TypeInputBotInlineMessageID, TypeSendMessageAction, TypeReplyMarkup, TypeInputMedia, TypeInputEncryptedChat, TypeInputEncryptedFile, TypeInputSingleMedia
