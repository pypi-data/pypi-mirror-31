...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeDialog, TypeStickerSet, TypeStickerSetCovered, TypeStickerPack, TypeChat, TypeBotInlineResult, TypeChatFull, TypeDocument, TypeMessage, TypeInlineBotSwitchPM, TypeFoundGif, TypeUser, TypeHighScore, TypeEncryptedFile
