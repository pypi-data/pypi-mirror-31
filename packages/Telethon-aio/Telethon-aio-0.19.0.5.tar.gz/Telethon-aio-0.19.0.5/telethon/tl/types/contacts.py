...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypePeer, TypeImportedContact, TypeChat, TypePopularContact, TypeContactLink, TypeContact, TypeUser, TypeContactBlocked, TypeTopPeerCategoryPeers
