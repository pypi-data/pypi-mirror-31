...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputNotifyPeer, TypeInputPrivacyRule, TypeInputPeer, TypeInputPeerNotifySettings, TypeAccountDaysTTL, TypeReportReason, TypeInputPrivacyKey, TypeBool
