...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputMedia, TypeInputMessage, TypeInputDocument, TypeMessagesFilter, TypeShippingOption, TypeInputPeer, TypeReportReason, TypeMessageEntity, TypeInputStickeredMedia, TypeInlineBotSwitchPM, TypeInputGeoPoint, TypeInputDialogPeer, TypeSendMessageAction, TypeReplyMarkup, TypeInputStickerSet, TypeInputEncryptedFile, TypeInputSingleMedia, TypeBool, TypeInputBotInlineResult, TypeInputUser, TypeInputBotInlineMessageID, TypeInputEncryptedChat, TypeInputChatPhoto
