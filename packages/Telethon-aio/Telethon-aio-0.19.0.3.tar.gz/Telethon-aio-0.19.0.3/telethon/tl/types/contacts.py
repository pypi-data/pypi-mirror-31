...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypePopularContact, TypeChat, TypeContactBlocked, TypeImportedContact, TypeContactLink, TypeTopPeerCategoryPeers, TypeUser, TypeContact, TypePeer
