...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChat, TypeFoundGif, TypeEncryptedFile, TypeChatFull, TypeInlineBotSwitchPM, TypeStickerSetCovered, TypeBotInlineResult, TypeStickerPack, TypeDialog, TypeHighScore, TypeMessage, TypeUser, TypeDocument, TypeStickerSet
