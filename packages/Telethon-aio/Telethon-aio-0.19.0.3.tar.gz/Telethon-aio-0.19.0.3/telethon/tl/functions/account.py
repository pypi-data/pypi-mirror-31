...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeBool, TypeInputNotifyPeer, TypeReportReason, TypeInputPeer, TypeInputPeerNotifySettings, TypeAccountDaysTTL, TypeInputPrivacyRule, TypeInputPrivacyKey
