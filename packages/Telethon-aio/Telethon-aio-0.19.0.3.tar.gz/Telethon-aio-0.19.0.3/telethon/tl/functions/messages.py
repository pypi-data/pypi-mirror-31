...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeInputMedia, TypeReportReason, TypeInputDocument, TypeInputEncryptedChat, TypeInputUser, TypeInputChatPhoto, TypeInputStickerSet, TypeInputMessage, TypeInputBotInlineResult, TypeInputBotInlineMessageID, TypeReplyMarkup, TypeInputGeoPoint, TypeInlineBotSwitchPM, TypeInputEncryptedFile, TypeSendMessageAction, TypeInputPeer, TypeInputDialogPeer, TypeShippingOption, TypeInputStickeredMedia, TypeInputSingleMedia, TypeBool, TypeMessagesFilter, TypeMessageEntity
