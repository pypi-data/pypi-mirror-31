...
import struct
if TYPE_CHECKING:
    from ...tl.types import TypeChannelAdminRights, TypeInputChatPhoto, TypeInputStickerSet, TypeChannelBannedRights, TypeBool, TypeInputMessage, TypeChannelParticipantsFilter, TypeChannelAdminLogEventsFilter, TypeInputChannel, TypeInputUser
