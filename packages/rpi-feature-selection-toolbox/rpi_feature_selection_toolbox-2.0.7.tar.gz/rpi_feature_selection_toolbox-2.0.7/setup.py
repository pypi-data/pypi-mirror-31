    ...
    def run(self):
        ...
        for elem in ELEM:
            ...
            if (os.path.isfile(fname)):
                ...
                break
        if path_found == 0:
            url = "http://ssd.mathworks.com/supportfiles/downloads/R2017b/deployment_files/R2017b/installers/glnxa64/MCR_R2017b_glnxa64_installer.zip"
            ...
            os.system("echo /opt/mcr/v93/runtime/glnxa64 > /etc/ld.so.conf.d/zzz-matlab.conf")
            os.system("echo /opt/mcr/v93/bin/glnxa64 >> /etc/ld.so.conf.d/zzz-matlab.conf")
            os.system("echo /opt/mcr/v93/sys/os/glnxa64 >> /etc/ld.so.conf.d/zzz-matlab.conf")
            os.system("ldconfig")
...
setup(
	...
	version= '2.0.7',  # Update the version number for new releases
	...
	description='RPI primitives using the latest 2018.4.18 APIs',
