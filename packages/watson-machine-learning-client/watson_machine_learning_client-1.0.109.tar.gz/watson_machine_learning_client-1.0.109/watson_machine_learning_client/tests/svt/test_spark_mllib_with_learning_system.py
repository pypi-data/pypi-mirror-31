...
class TestWMLClientWithSpark(unittest.TestCase):
    ...
    def test_03_create_learning_system(self):
    ...
    def test_04_update_learning_system(self):
        meta_prop = {
            self.client.learning_system.ConfigurationMetaNames.FEEDBACK_DATA_REFERENCE: {
                "name": "DRUG feedback",
                "connection": get_feedback_data_reference(),
            ...
            self.client.learning_system.ConfigurationMetaNames.SPARK_REFERENCE: get_spark_reference(),
            self.client.learning_system.ConfigurationMetaNames.AUTO_RETRAIN: "conditionally",
    ...
    def test_06_run_learning_system(self):
    ...
    def test_11_list_all_runs(self):
        captured_output = io.StringIO()  # Create StringIO object
        sys.stdout = captured_output  # and redirect stdout.
    ...
    def test_12_get_run_details(self):
    ...
    def test_13_send_feedback(self):
