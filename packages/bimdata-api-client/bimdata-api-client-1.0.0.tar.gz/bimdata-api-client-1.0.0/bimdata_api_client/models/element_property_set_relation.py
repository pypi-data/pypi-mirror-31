...
class ElementPropertySetRelation(object):
    ...
    def __init__(self, element_uuid=None, property_set_id=None):  # noqa: E501
        """ElementPropertySetRelation - a model defined in Swagger"""  # noqa: E501
