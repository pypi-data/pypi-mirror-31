...
from DigitalSystems.config import *
from DigitalSystems.connectors.linker import *
...
class Connector(object):
    ...
    index             :      The index of the connector instance registered with the DigitalSystemsIndexer
    ...
    def __init__(self, state=None, voltage=None, analog=False, name=""):
        ...
        self._name = name
        self.name_set = (name != "")
        self._index = DigitalSystemsIndexer.index(self)
    ...
    def __del__(self):
        try:
            ...
            DigitalSystemsIndexer.unindex(self)
