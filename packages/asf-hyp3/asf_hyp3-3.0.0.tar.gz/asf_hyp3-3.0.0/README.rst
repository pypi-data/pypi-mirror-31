...
:Parameters:
    ...
    Optional - id, sub_id, sub_ids, sub_name, creation_date, start_date, end_date,
               name, group_id, group_ids, process_id, page, page_size, format
...
:Returns:
    ...
    Product info contains fields:
        ...
        Attributes `browse_thumbnail`, `browse_geo_immage`, `browse_geo_xml`
        are dictionaries with the following fields:
