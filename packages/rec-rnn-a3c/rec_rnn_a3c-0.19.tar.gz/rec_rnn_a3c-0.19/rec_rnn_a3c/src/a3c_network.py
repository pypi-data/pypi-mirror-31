...
class LightA3CNetwork(object):
    def __init__(self, scope, optimizer, params):
        ...
        with tf.variable_scope(self.scope):
            ...
            self.policy_log_prob_output = tf.nn.bias_add(self.logit_dist, self.b)
            self.policy_log_prob_output = tf.reshape(self.logit_dist, [output_shape[0], output_shape[1], self.item_dim])
