...
class StraksExplorer:
    ...
    def cmc_ticker(self, coin='STRAKS', currency='USD'):
        ...
        [
            {
                ...
                "rank": "98",
                "price_usd": "0.547011",
                "price_btc": "0.00006923",
                "24h_volume_usd": "8656.56",
                "market_cap_usd": "1838012.0",
                "available_supply": "3360101.0",
                "total_supply": "43163430.0",
                "max_supply": "150000000.0",
                "percent_change_1h": "-0.74",
                "percent_change_24h": "67.35",
                "percent_change_7d": "115.16",
                "last_updated": "1524006561",
                "price_eur": "0.4427348401",
                "24h_volume_eur": "7006.36862376",
                "market_cap_eur": "1487634.0"
            }
        ]
        ...
        return requests.get(self.cmc_base + 'ticker/%s/?convert=%s'%(coin, currency)).json()