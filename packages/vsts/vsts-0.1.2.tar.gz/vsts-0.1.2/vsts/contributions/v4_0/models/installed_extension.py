...
class InstalledExtension(ExtensionManifest):
    ...
    :type contributions: list of :class:`Contribution <contributions.v4_0.models.Contribution>`
    :param contribution_types: List of contribution types defined by this extension
    :type contribution_types: list of :class:`ContributionType <contributions.v4_0.models.ContributionType>`
    ...
    :type event_callbacks: :class:`ExtensionEventCallbackCollection <contributions.v4_0.models.ExtensionEventCallbackCollection>`
    ...
    :type files: list of :class:`ExtensionFile <contributions.v4_0.models.ExtensionFile>`
    ...
    :type install_state: :class:`InstalledExtensionState <contributions.v4_0.models.InstalledExtensionState>`
