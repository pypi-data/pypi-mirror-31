...
class InstalledExtension(ExtensionManifest):
    ...
    :type constraints: list of :class:`ContributionConstraint <extension-management.v4_1.models.ContributionConstraint>`
    :param contributions: List of contributions made by this extension
    :type contributions: list of :class:`Contribution <extension-management.v4_1.models.Contribution>`
    :param contribution_types: List of contribution types defined by this extension
    :type contribution_types: list of :class:`ContributionType <extension-management.v4_1.models.ContributionType>`
    ...
    :type event_callbacks: :class:`ExtensionEventCallbackCollection <extension-management.v4_1.models.ExtensionEventCallbackCollection>`
    ...
    :type files: list of :class:`ExtensionFile <extension-management.v4_1.models.ExtensionFile>`
    ...
    :type install_state: :class:`InstalledExtensionState <extension-management.v4_1.models.InstalledExtensionState>`
