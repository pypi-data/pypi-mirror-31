...
class JsonApiPropertiesClassCreator(object):
    ...
    def __init__(self,
        ...
        Example generates the following code:
            ...
            from classutils.api_support import JsonApiPropertiesClass
    ...
    def code(self):
        code = [u'# encoding: utf-8',
                u'# Code generated by classutils.responses.JsonApiPropertiesClassCreator',
                u'',
                u'from classutils.api_support import JsonApiPropertiesClass']
        if self.key:
    ...
    def write_source_code(self,
        ...
        if path_in_site_or_user_packages(self.folder_path):
            logging.info(u'Site or user package location has been detected. '
