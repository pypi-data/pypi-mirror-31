...
setup(
    ...
    description=('Python functions and decorators for various '
                'backoff/retry strategies'),  # Required
    ...
    url='https://github.com/insightindustry/backoff-utils',  # Optional
    ...
    keywords='backoff exponential fibonacci polynomial linear defined fixed retry',  # Optional
